...
public class UnixFileAttributes implements PosixFileAttributes {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static UnixFileAttributes get(UnixPath path, boolean followLinks) throws UnixException {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static UnixFileAttributes get(int fd2) throws UnixException {
        UnixFileAttributes attrs = new UnixFileAttributes();
        UnixNativeDispatcher.fstat(fd2, attrs);
        return attrs;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static UnixFileAttributes get(int dfd, UnixPath path, boolean followLinks) throws UnixException {
        UnixFileAttributes attrs = new UnixFileAttributes();
    ...
    private static FileTime toFileTime(long sec, long nsec) {
        ...
        long micro = (1000000 * sec) + (nsec / 1000);
