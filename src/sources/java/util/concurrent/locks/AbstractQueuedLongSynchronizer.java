 ...
 */
    ...
    public static abstract class Node {
        ...
        volatile int status;
        Thread waiter;
        private static final long STATUS = AbstractQueuedLongSynchronizer.U.objectFieldOffset(Node.class, "status");
        ...
        final boolean casPrev(Node c4, Node v2) {
            return AbstractQueuedLongSynchronizer.U.weakCompareAndSetReference(this, PREV, c4, v2);
        }

        final boolean casNext(Node c4, Node v2) {
            return AbstractQueuedLongSynchronizer.U.weakCompareAndSetReference(this, NEXT, c4, v2);
        }

        final int getAndUnsetStatus(int v2) {
            return AbstractQueuedLongSynchronizer.U.getAndBitwiseAndInt(this, STATUS, ~v2);
        }

        final void setPrevRelaxed(Node p10) {
            AbstractQueuedLongSynchronizer.U.putReference(this, PREV, p10);
        }

        final void setStatusRelaxed(int s2) {
            AbstractQueuedLongSynchronizer.U.putInt(this, STATUS, s2);
        }
 ...
 */
    ...
    /* JADX WARN: Removed duplicated region for block: B:77:0x0056 A[Catch: all -> 0x010c, TRY_LEAVE, TryCatch #0 {all -> 0x010c, blocks: (B:88:0x004b, B:77:0x0056), top: B:87:0x004b }] */
    ...
    */
    final int acquire(java.util.concurrent.locks.AbstractQueuedLongSynchronizer.Node r20, long r21, boolean r23, boolean r24, boolean r25, long r26) {
        /*
    ...
    */
    private void cleanQueue() {
        /*
            r5 = this;
        L1:
            java.util.concurrent.locks.AbstractQueuedLongSynchronizer$Node r0 = r5.tail
            r1 = 0
        L4:
            if (r0 == 0) goto L59
            java.util.concurrent.locks.AbstractQueuedLongSynchronizer$Node r2 = r0.prev
            r3 = r2
            if (r2 != 0) goto Lc
            goto L59
        Lc:
            if (r1 != 0) goto L13
            java.util.concurrent.locks.AbstractQueuedLongSynchronizer$Node r2 = r5.tail
            if (r2 == r0) goto L1c
            goto L58
        L13:
            java.util.concurrent.locks.AbstractQueuedLongSynchronizer$Node r2 = r1.prev
            if (r2 != r0) goto L58
            int r2 = r1.status
            if (r2 >= 0) goto L1c
            goto L58
        ...
        L2f:
            ...
            if (r2 != r3) goto L58
            r3.casNext(r0, r1)
            java.util.concurrent.locks.AbstractQueuedLongSynchronizer$Node r2 = r3.prev
            if (r2 != 0) goto L58
            signalNext(r3)
            goto L58
        L3e:
            java.util.concurrent.locks.AbstractQueuedLongSynchronizer$Node r2 = r3.next
            r4 = r2
            if (r2 == r0) goto L54
            if (r4 == 0) goto L58
            java.util.concurrent.locks.AbstractQueuedLongSynchronizer$Node r2 = r0.prev
    ...
    */
    public final java.lang.Thread getFirstQueuedThread() {
        /*
            r7 = this;
            r0 = 0
            java.util.concurrent.locks.AbstractQueuedLongSynchronizer$Node r1 = r7.head
            r2 = r1
            if (r1 == 0) goto L25
            java.util.concurrent.locks.AbstractQueuedLongSynchronizer$Node r1 = r2.next
            r3 = r1
            if (r1 == 0) goto L14
            java.lang.Thread r1 = r3.waiter
            r0 = r1
            if (r1 == 0) goto L14
            java.util.concurrent.locks.AbstractQueuedLongSynchronizer$Node r1 = r3.prev
            if (r1 != 0) goto L25
        L14:
            java.util.concurrent.locks.AbstractQueuedLongSynchronizer$Node r1 = r7.tail
        L16:
            if (r1 == 0) goto L25
            java.util.concurrent.locks.AbstractQueuedLongSynchronizer$Node r4 = r1.prev
            r5 = r4
            if (r4 == 0) goto L25
    ...
    */
    public final boolean hasQueuedPredecessors() {
        /*
            r4 = this;
            r0 = 0
            java.util.concurrent.locks.AbstractQueuedLongSynchronizer$Node r1 = r4.head
            r2 = r1
            if (r1 == 0) goto L18
            java.util.concurrent.locks.AbstractQueuedLongSynchronizer$Node r1 = r2.next
            r3 = r1
 ...
 */
    ...
    public class ConditionObject implements Condition, Serializable {
        ...
        private void doSignal(ConditionNode first, boolean all) {
            while (first != null) {
                ...
                if ((2 & first.getAndUnsetStatus(2)) != 0) {
                    AbstractQueuedLongSynchronizer.this.enqueue(first);
                    if (!all) {
                        return;
                    }
                }
        ...
        private long enableWait(ConditionNode node) {
            if (AbstractQueuedLongSynchronizer.this.isHeldExclusively()) {
                ...
                long savedState = AbstractQueuedLongSynchronizer.this.getState();
                if (AbstractQueuedLongSynchronizer.this.release(savedState)) {
                    return savedState;
                }
            }
            node.status = Integer.MIN_VALUE;
        ...
        private boolean canReacquire(ConditionNode node) {
            return (node == null || node.prev == null || !AbstractQueuedLongSynchronizer.this.isEnqueued(node)) ? false : true;
        }
        ...
        */
        public final void awaitUninterruptibly() {
            /*
                r14 = this;
                java.util.concurrent.locks.AbstractQueuedLongSynchronizer$ConditionNode r0 = new java.util.concurrent.locks.AbstractQueuedLongSynchronizer$ConditionNode
                r0.<init>()
                long r10 = r14.enableWait(r0)
                java.util.concurrent.locks.LockSupport.setCurrentBlocker(r14)
                r1 = 0
                r2 = 0
                r12 = r1
                r13 = r2
            L10:
                boolean r1 = r14.canReacquire(r0)
                if (r1 != 0) goto L38
            ...
            L38:
                ...
                r0.clearStatus()
                java.util.concurrent.locks.AbstractQueuedLongSynchronizer r1 = java.util.concurrent.locks.AbstractQueuedLongSynchronizer.this
                r5 = 0
                r6 = 0
                r7 = 0
                r8 = 0
        ...
        public final void await() throws InterruptedException {
            ...
            node.clearStatus();
            AbstractQueuedLongSynchronizer.this.acquire(node, savedState, false, false, false, 0L);
            if (interrupted) {
                if (cancelled) {
    ...
    static {
        ...
        U = unsafe;
        STATE = unsafe.objectFieldOffset(AbstractQueuedLongSynchronizer.class, "state");
        HEAD = unsafe.objectFieldOffset(AbstractQueuedLongSynchronizer.class, "head");
        TAIL = unsafe.objectFieldOffset(AbstractQueuedLongSynchronizer.class, "tail");
    }
}
