...
public interface DatabaseMetaData extends Wrapper {
    ...
    boolean deletesAreDetected(int i10) throws SQLException;

    boolean doesMaxRowSizeIncludeBlobs() throws SQLException;

    ResultSet getAttributes(String str, String str2, String str3, String str4) throws SQLException;

    ResultSet getBestRowIdentifier(String str, String str2, String str3, int i10, boolean z10) throws SQLException;
    ...
    ResultSet getIndexInfo(String str, String str2, String str3, boolean z10, boolean z11) throws SQLException;
    ...
    boolean insertsAreDetected(int i10) throws SQLException;
    ...
    boolean othersDeletesAreVisible(int i10) throws SQLException;

    boolean othersInsertsAreVisible(int i10) throws SQLException;

    boolean othersUpdatesAreVisible(int i10) throws SQLException;

    boolean ownDeletesAreVisible(int i10) throws SQLException;

    boolean ownInsertsAreVisible(int i10) throws SQLException;

    boolean ownUpdatesAreVisible(int i10) throws SQLException;
    ...
    boolean supportsConvert(int i10, int i11) throws SQLException;
    ...
    boolean supportsResultSetConcurrency(int i10, int i11) throws SQLException;

    boolean supportsResultSetHoldability(int i10) throws SQLException;

    boolean supportsResultSetType(int i10) throws SQLException;
    ...
    boolean supportsTransactionIsolationLevel(int i10) throws SQLException;
    ...
    boolean updatesAreDetected(int i10) throws SQLException;
