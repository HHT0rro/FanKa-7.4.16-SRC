    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i10 = 0; i10 < pathDataNodeArr.length; i10++) {
                str = str + pathDataNodeArr[i10].mType + u.bD;
    ...
    public static class VFullPath extends VPath {
        ...
        private void updateStateFromTypedArray(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme) {
            ...
            if (TypedArrayUtils.hasAttribute(xmlPullParser, "pathData")) {
                ...
                this.mStrokeWidth = TypedArrayUtils.getNamedFloat(typedArray, xmlPullParser, Attributes.Style.STROKE_WIDTH, 4, this.mStrokeWidth);
