...
public class AudioFocusRequestCompat {
    ...
    public AudioFocusRequestCompat(int i10, AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener, Handler handler, AudioAttributesCompat audioAttributesCompat, boolean z10) {
        ...
        if (i11 >= 26) {
            this.mFrameworkAudioFocusRequest = new AudioFocusRequest.Builder(i10).setAudioAttributes(getAudioAttributes()).setWillPauseWhenDucked(z10).setOnAudioFocusChangeListener(this.mOnAudioFocusChangeListener, handler).build();
        } else {
