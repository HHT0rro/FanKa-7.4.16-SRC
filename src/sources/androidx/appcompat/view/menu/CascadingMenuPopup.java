...
final class CascadingMenuPopup extends MenuPopup implements View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    public final ViewTreeObserver.OnGlobalLayoutListener mGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.appcompat.view.menu.CascadingMenuPopup.1
        ...
        public void onGlobalLayout() {
            ...
            if (view != null && view.isShown()) {
                Iterator<CascadingMenuInfo> iterator2 = CascadingMenuPopup.this.mShowingMenus.iterator2();
                while (iterator2.hasNext()) {
                    iterator2.next().window.show();
                }
                return;
            }
    ...
    public void show() {
        ...
        Iterator<MenuBuilder> iterator2 = this.mPendingMenus.iterator2();
        while (iterator2.hasNext()) {
            showMenu(iterator2.next());
        }
    ...
    public void updateMenuView(boolean z10) {
        Iterator<CascadingMenuInfo> iterator2 = this.mShowingMenus.iterator2();
        while (iterator2.hasNext()) {
            MenuPopup.toMenuAdapter(iterator2.next().getListView().getAdapter()).notifyDataSetChanged();
        }
    }
}
