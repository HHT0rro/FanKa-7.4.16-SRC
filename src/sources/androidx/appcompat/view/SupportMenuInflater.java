    ...
    public class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(i10)) {
                this.itemCheckable = obtainStyledAttributes.getBoolean(i10, false) ? 1 : 0;
            } else {
            ...
            if (obtainStyledAttributes.hasValue(i11)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(i11, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            int i12 = R.styleable.MenuItem_iconTint;
            if (obtainStyledAttributes.hasValue(i12)) {
                this.itemIconTintList = obtainStyledAttributes.getColorStateList(i12);
            } else {
