    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i10) {
        ...
        try {
            ...
            if (obtainStyledAttributes.hasValue(i11)) {
                this.mBackgroundResId = obtainStyledAttributes.getResourceId(i11, -1);
            ...
            if (obtainStyledAttributes.hasValue(i12)) {
                ViewCompat.setBackgroundTintList(this.mView, obtainStyledAttributes.getColorStateList(i12));
            }
            int i13 = R.styleable.ViewBackgroundHelper_backgroundTintMode;
            if (obtainStyledAttributes.hasValue(i13)) {
                ViewCompat.setBackgroundTintMode(this.mView, DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(i13, -1), null));
            }
        } finally {
