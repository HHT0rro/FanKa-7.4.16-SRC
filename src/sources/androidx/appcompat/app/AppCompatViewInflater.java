...
public class AppCompatViewInflater {
    ...
    public static class DeclaredOnClickListener implements View.OnClickListener {
        ...
        private void resolveMethod(@Nullable Context context) {
            ...
            throw new IllegalStateException("Could not find method " + this.mMethodName + "(View) in a parent or ancestor Context for android:onClick attribute defined on view " + ((Object) this.mHostView.getClass()) + str);
        }
