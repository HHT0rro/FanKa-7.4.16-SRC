    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        public final void applyTheme(Resources.Theme theme) {
            if (theme != null) {
                ...
                for (int i11 = 0; i11 < i10; i11++) {
                    if (drawableArr[i11] != null && DrawableCompat.canApplyTheme(drawableArr[i11])) {
        ...
        public final boolean setLayoutDirection(int i10, int i11) {
            ...
            for (int i13 = 0; i13 < i12; i13++) {
                if (drawableArr[i13] != null) {
                    boolean layoutDirection = Build.VERSION.SDK_INT >= 23 ? DrawableCompat.setLayoutDirection(drawableArr[i13], i10) : false;
                    if (i13 == i11) {
                        z10 = layoutDirection;
                    }
                }
