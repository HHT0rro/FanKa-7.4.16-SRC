...
public class ProfileInstallReceiver extends BroadcastReceiver {
    ...
    public void onReceive(@NonNull Context context, @Nullable Intent intent) {
        ...
        if (ACTION_INSTALL_PROFILE.equals(action)) {
            ProfileInstaller.writeProfile(context, b.f987b, new ResultDiagnostics(), true);
            return;
        }
        if (ACTION_SKIP_FILE.equals(action)) {
            ...
            if (extras2 != null) {
                ...
                if (EXTRA_SKIP_FILE_OPERATION_WRITE.equals(string)) {
                    ProfileInstaller.writeSkipFile(context, b.f987b, new ResultDiagnostics());
                    return;
                } else {
                    if (EXTRA_SKIP_FILE_OPERATION_DELETE.equals(string)) {
                        ProfileInstaller.deleteSkipFile(context, b.f987b, new ResultDiagnostics());
                        return;
                    }
                    return;
                }
