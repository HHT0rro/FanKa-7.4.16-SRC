...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (z10 || z11 || z13 || z12) {
            Iterator<RecyclerView.ViewHolder> iterator2 = this.mPendingRemovals.iterator2();
            while (iterator2.hasNext()) {
                animateRemoveImpl(iterator2.next());
            }
                ...
                Runnable runnable = new Runnable() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.1
                    ...
                    public void run() {
                        ...
                        while (iterator22.hasNext()) {
                            MoveInfo moveInfo = (MoveInfo) iterator22.next();
            ...
            if (z12) {
                ...
                Runnable runnable2 = new Runnable() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.2
                    ...
                    public void run() {
                        ...
                        while (iterator22.hasNext()) {
                            DefaultItemAnimator.this.animateChangeImpl((ChangeInfo) iterator22.next());
                        }
                        arrayList2.clear();
            ...
            if (z13) {
                ...
                Runnable runnable3 = new Runnable() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.3
                    ...
                    public void run() {
                        ...
                        while (iterator22.hasNext()) {
                            DefaultItemAnimator.this.animateAddImpl((RecyclerView.ViewHolder) iterator22.next());
                        }
                        arrayList3.clear();
