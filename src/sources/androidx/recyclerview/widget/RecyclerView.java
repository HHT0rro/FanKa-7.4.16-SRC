...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(@NonNull VH vh, int i10) {
            ...
            if (z10) {
                ...
                vh.setFlags(1, MetricsProto.MetricsEvent.PROVISIONING_PROVISIONING_ACTIVITY_TIME_MS);
    ...
    public static abstract class SmoothScroller {
        ...
        public PointF computeScrollVectorForPosition(int i10) {
            ...
            sb2.append(ScrollVectorProvider.class.getCanonicalName());
            return null;
        }
    ...
    private void handleMissingPreInfoForChangeError(long j10, ViewHolder viewHolder, ViewHolder viewHolder2) {
        ...
        sb2.append((Object) viewHolder2);
        sb2.append(" cannot be found but it is necessary for ");
        sb2.append((Object) viewHolder);
    ...
    */
    ...
    public int getAdapterPositionInRecyclerView(ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags(MetricsProto.MetricsEvent.PROVISIONING_POST_ENCRYPTION_ACTIVITY_TIME_MS) || !viewHolder.isBound()) {
            return -1;
        }
