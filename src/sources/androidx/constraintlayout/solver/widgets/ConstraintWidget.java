...
public class ConstraintWidget {
    ...
    */
    ...
    public void addChildrenToSolverByDependency(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, HashSet<ConstraintWidget> hashSet, int i10, boolean z10) {
        ...
        if (i10 == 0) {
            ...
            if (dependents != null) {
                Iterator<ConstraintAnchor> iterator2 = dependents.iterator2();
                while (iterator2.hasNext()) {
                    iterator2.next().mOwner.addChildrenToSolverByDependency(constraintWidgetContainer, linearSystem, hashSet, i10, true);
                }
            }
            HashSet<ConstraintAnchor> dependents2 = this.mRight.getDependents();
            if (dependents2 != null) {
                Iterator<ConstraintAnchor> iterator22 = dependents2.iterator2();
                while (iterator22.hasNext()) {
                    iterator22.next().mOwner.addChildrenToSolverByDependency(constraintWidgetContainer, linearSystem, hashSet, i10, true);
                }
                return;
            }
            return;
        ...
        if (dependents3 != null) {
            Iterator<ConstraintAnchor> iterator23 = dependents3.iterator2();
            while (iterator23.hasNext()) {
                iterator23.next().mOwner.addChildrenToSolverByDependency(constraintWidgetContainer, linearSystem, hashSet, i10, true);
            }
        }
        HashSet<ConstraintAnchor> dependents4 = this.mBottom.getDependents();
        if (dependents4 != null) {
            Iterator<ConstraintAnchor> iterator24 = dependents4.iterator2();
            while (iterator24.hasNext()) {
                iterator24.next().mOwner.addChildrenToSolverByDependency(constraintWidgetContainer, linearSystem, hashSet, i10, true);
            }
        }
        HashSet<ConstraintAnchor> dependents5 = this.mBaseline.getDependents();
        if (dependents5 != null) {
            Iterator<ConstraintAnchor> iterator25 = dependents5.iterator2();
            while (iterator25.hasNext()) {
                iterator25.next().mOwner.addChildrenToSolverByDependency(constraintWidgetContainer, linearSystem, hashSet, i10, true);
            }
        }
    }
    ...
    */
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int i10) {
        int i11 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$widgets$ConstraintAnchor$Type[type.ordinal()];
        if (i11 == 1) {
