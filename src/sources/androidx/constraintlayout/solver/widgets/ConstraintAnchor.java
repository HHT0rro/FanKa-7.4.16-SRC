...
public class ConstraintAnchor {
    ...
    public void findDependents(int i10, ArrayList<WidgetGroup> arrayList, WidgetGroup widgetGroup) {
        ...
        if (hashSet != null) {
            Iterator<ConstraintAnchor> iterator2 = hashSet.iterator2();
            while (iterator2.hasNext()) {
                Grouping.findDependents(iterator2.next().mOwner, i10, arrayList, widgetGroup);
            }
        }
    }
    ...
    public boolean hasCenteredDependents() {
        ...
        Iterator<ConstraintAnchor> iterator2 = hashSet.iterator2();
        while (iterator2.hasNext()) {
            if (iterator2.next().getOpposite().isConnected()) {
                return true;
            }
        }
        return false;
    ...
    public String toString() {
        return this.mOwner.getDebugName() + u.bD + this.mType.toString();
    }
