...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            ...
            paint.getTextBounds(SymbolValues.QUESTION_EN_SYMBOL, 0, 1, rect);
            canvas.drawText(SymbolValues.QUESTION_EN_SYMBOL, ((width / 2.0f) - (rect.width() / 2.0f)) - rect.left, ((height / 2.0f) + (rect.height() / 2.0f)) - rect.bottom, paint);
        }
    }
