...
public class FragmentStore {
    ...
    public void moveToExpectedState() {
        Iterator<Fragment> iterator2 = this.mAdded.iterator2();
        while (iterator2.hasNext()) {
            FragmentStateManager fragmentStateManager = this.mActive.get(iterator2.next().mWho);
            if (fragmentStateManager != null) {
            ...
            for (String str : list) {
                ...
                if (findActiveFragment != null) {
                    if (FragmentManager.isLoggingEnabled(2)) {
                        ...
                        sb2.append(str);
                        sb2.append("): ");
                        sb2.append((Object) findActiveFragment);
                    }
        ...
        for (FragmentStateManager fragmentStateManager : this.mActive.values()) {
            if (fragmentStateManager != null) {
                ...
                if (FragmentManager.isLoggingEnabled(2)) {
                    ...
                    sb2.append((Object) fragment);
                    sb2.append(": ");
                    sb2.append((Object) saveState.mSavedFragmentState);
                }
            }
        }
        return arrayList;
