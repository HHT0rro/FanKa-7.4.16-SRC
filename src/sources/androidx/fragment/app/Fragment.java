...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(@NonNull final ActivityResultContract<I, O> activityResultContract, @NonNull final Function<Void, ActivityResultRegistry> function, @NonNull final ActivityResultCallback<O> activityResultCallback) {
        ...
        throw new IllegalStateException("Fragment " + ((Object) this) + " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate()).");
    }
    ...
    public FragmentContainer createFragmentContainer() {
        return new FragmentContainer() { // from class: androidx.fragment.app.Fragment.4
            ...
            public View onFindViewById(int i10) {
                ...
                throw new IllegalStateException("Fragment " + ((Object) Fragment.this) + " does not have a view");
            }
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        printWriter.print(str);
        printWriter.println("Child " + ((Object) this.mChildFragmentManager) + u.bD);
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        throw new IllegalStateException("Fragment " + ((Object) this) + " has not been attached yet.");
    }
        ...
        if (this.mFragmentManager != null) {
            if (this.mDefaultFactory == null) {
                ...
                if (application == null && FragmentManager.isLoggingEnabled(3)) {
                    ...
                    sb2.append((Object) requireContext().getApplicationContext());
    ...
    public void performAttach() {
        Iterator<OnPreAttachedListener> iterator2 = this.mOnPreAttachedListeners.iterator2();
        ...
        if (this.mCalled) {
            ...
            throw new SuperNotCalledException("Fragment " + ((Object) this) + " did not call through to super.onAttach()");
        }
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException("Fragment " + ((Object) this) + " does not have any arguments.");
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            throw new IllegalStateException("Fragment " + ((Object) this) + " is not attached to any Fragment or host");
        }
        throw new IllegalStateException("Fragment " + ((Object) this) + " is not a child Fragment, it is directly attached to " + ((Object) getContext()));
    }
    ...
    public final View requireView() {
        ...
        throw new IllegalStateException("Fragment " + ((Object) this) + " did not return a View from onCreateView() or this was called before onCreateView().");
    }
    ...
    public void startIntentSenderForResult(IntentSender intentSender, int i10, @Nullable Intent intent, int i11, int i12, int i13, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (this.mHost != null) {
            if (FragmentManager.isLoggingEnabled(2)) {
                ...
                sb2.append((Object) intentSender);
