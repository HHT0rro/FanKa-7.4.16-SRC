...
public class FragmentStateManager {
    ...
    public void attach() {
        ...
        if (fragment2 != null) {
            ...
            if (fragmentStateManager2 != null) {
                ...
                throw new IllegalStateException("Fragment " + ((Object) this.mFragment) + " declared target fragment " + ((Object) this.mFragment.mTarget) + " that does not belong to this FragmentManager!");
            }
        } else {
            String str = fragment.mTargetWho;
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                throw new IllegalStateException("Fragment " + ((Object) this.mFragment) + " declared target fragment " + this.mFragment.mTargetWho + " that does not belong to this FragmentManager!");
            }
        }
    ...
    public int computeExpectedState() {
        ...
        int i11 = AnonymousClass2.$SwitchMap$androidx$lifecycle$Lifecycle$State[fragment2.mMaxState.ordinal()];
        if (i11 != 1) {
            if (i11 == 2) {
                i10 = Math.min(i10, 5);
            } else if (i11 == 3) {
        ...
        if (fragment3.mFromLayout) {
            if (fragment3.mInLayout) {
                ...
                i10 = this.mFragmentManagerState < 4 ? Math.min(i10, fragment3.mState) : Math.min(i10, 1);
            }
        }
                ...
                if (i10 != -1) {
                    ...
                    if (viewGroup == null) {
                        ...
                        if (!fragment3.mRestored) {
                            ...
                            throw new IllegalArgumentException("No view found for id 0x" + Integer.toHexString(this.mFragment.mContainerId) + " (" + str + ") for fragment " + ((Object) this.mFragment));
                        }
                    }
                } else {
                    throw new IllegalArgumentException("Cannot create fragment " + ((Object) this.mFragment) + " for a container view with no id");
                }
            }
        }
        Fragment fragment4 = this.mFragment;
    ...
    public void resume() {
        ...
        if (focusedView != null && isFragmentViewChild(focusedView)) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                ...
                sb3.append((Object) focusedView);
                sb3.append(" ");
                sb3.append(requestFocus ? "succeeded" : e.f4721a);
                sb3.append(" on Fragment ");
                sb3.append((Object) this.mFragment);
                sb3.append(" resulting in focused view ");
                sb3.append((Object) this.mFragment.mView.findFocus());
            }
        }
