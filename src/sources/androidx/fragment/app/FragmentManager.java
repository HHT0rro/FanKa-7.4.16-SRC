...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    private void cancelExitAnimation(@NonNull Fragment fragment) {
        ...
        if (hashSet != null) {
            Iterator<CancellationSignal> iterator2 = hashSet.iterator2();
    ...
    private Set<SpecialEffectsController> collectAllSpecialEffectsController() {
        ...
        Iterator<FragmentStateManager> iterator2 = this.mFragmentStore.getActiveFragmentStateManagers().iterator2();
        while (iterator2.hasNext()) {
    ...
    private Set<SpecialEffectsController> collectChangedControllers(@NonNull ArrayList<BackStackRecord> arrayList, int i10, int i11) {
        ...
        HashSet hashSet = new HashSet();
        while (i10 < i11) {
            Iterator<FragmentTransaction.Op> iterator2 = arrayList.get(i10).mOps.iterator2();
            while (iterator2.hasNext()) {
                Fragment fragment = iterator2.next().mFragment;
    ...
    private void dispatchStateChange(int i10) {
        try {
            ...
            if (USE_STATE_MANAGER) {
                Iterator<SpecialEffectsController> iterator2 = collectAllSpecialEffectsController().iterator2();
                while (iterator2.hasNext()) {
    ...
    private void endAnimatingAwayFragments() {
        if (USE_STATE_MANAGER) {
            ...
            for (Fragment fragment : this.mExitAnimationCancellationSignals.h()) {
    ...
    */
    ...
    public static <F extends Fragment> F findFragment(@NonNull View view) {
        ...
        throw new IllegalStateException("View " + ((Object) view) + " does not have a Fragment set");
    }
    ...
    public static FragmentManager findFragmentManager(@NonNull View view) {
        ...
        if (findViewFragment != null) {
            ...
            throw new IllegalStateException("The Fragment " + ((Object) findViewFragment) + " that owns View " + ((Object) view) + " has already been destroyed. Nested fragments should always use the child FragmentManager.");
        }
        ...
        throw new IllegalStateException("View " + ((Object) view) + " is not within a subclass of FragmentActivity.");
    }
    ...
    private void startPendingDeferredFragments() {
        Iterator<FragmentStateManager> iterator2 = this.mFragmentStore.getActiveFragmentStateManagers().iterator2();
        while (iterator2.hasNext()) {
            performPendingDeferredStart(iterator2.next());
        }
    }
    ...
    public void dispatchOnAttachFragment(@NonNull Fragment fragment) {
        Iterator<FragmentOnAttachListener> iterator2 = this.mOnAttachListeners.iterator2();
        while (iterator2.hasNext()) {
    ...
    public void launchStartActivityForResult(@NonNull Fragment fragment, Intent intent, int i10, @Nullable Bundle bundle) {
    ...
    public void launchStartIntentSenderForResult(@NonNull Fragment fragment, IntentSender intentSender, int i10, @Nullable Intent intent, int i11, int i12, int i13, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        Intent intent2;
    ...
    */
    ...
    public void restoreSaveState(@Nullable Parcelable parcelable) {
        ...
        Iterator<FragmentState> iterator2 = fragmentManagerState.mActive.iterator2();
        while (iterator2.hasNext()) {
            FragmentState next = iterator2.next();
            if (next != null) {
                ...
                if (findRetainedFragmentByWho != null) {
                    if (isLoggingEnabled(2)) {
                        ...
                        sb2.append((Object) findRetainedFragmentByWho);
                    }
        ...
        for (Fragment fragment2 : this.mNonConfig.getRetainedFragments()) {
            if (!this.mFragmentStore.containsActiveFragment(fragment2.mWho)) {
                if (isLoggingEnabled(2)) {
                    ...
                    sb4.append((Object) fragmentManagerState.mActive);
                }
        ...
        if (fragmentManagerState.mBackStack != null) {
            ...
            while (true) {
                ...
                BackStackRecord instantiate = backStackStateArr[i10].instantiate(this);
                if (isLoggingEnabled(2)) {
    ...
    public Parcelable saveAllState() {
        ...
        if (arrayList != null && (size = arrayList.size()) > 0) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                if (isLoggingEnabled(2)) {
                    ...
                    sb2.append(i10);
                    sb2.append(": ");
                    sb2.append((Object) this.mBackStack.get(i10));
                }
            }
        }
        ...
        fragmentManagerState.mResultKeys.addAll(this.mResults.h());
    ...
    public void setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        ...
        throw new IllegalArgumentException("Fragment " + ((Object) fragment) + " is not an active fragment of FragmentManager " + ((Object) this));
    }
    ...
    public void moveToState(int i10, boolean z10) {
        ...
        if (z10 || i10 != this.mCurState) {
            ...
            if (USE_STATE_MANAGER) {
                ...
                Iterator<Fragment> iterator2 = this.mFragmentStore.getFragments().iterator2();
                while (iterator2.hasNext()) {
                    moveFragmentToExpectedState(iterator2.next());
                }
                for (FragmentStateManager fragmentStateManager : this.mFragmentStore.getActiveFragmentStateManagers()) {
                    Fragment fragment = fragmentStateManager.getFragment();
