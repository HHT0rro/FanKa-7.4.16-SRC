                ...
                mainHandler.postAtFrontOfQueue(new Runnable() { // from class: androidx.core.app.ActivityRecreator.3
                    ...
                    public void run() {
                        try {
                            ...
                            if (method != null) {
                                method.invoke(Object.this, obj2, Boolean.FALSE, "AppCompat recreation");
                            } else {
                                ActivityRecreator.performStopActivity2ParamsMethod.invoke(Object.this, obj2, Boolean.FALSE);
                            }
