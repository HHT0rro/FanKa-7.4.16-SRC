...
public class ContextCompat {
    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            hashMap.put(CameraManager.class, ZegoConstants.DeviceNameType.DeviceNameCamera);
            ...
            hashMap.put(BluetoothManager.class, NetworkUtils.NETWORK_TYPE_BLUETOOTH);
            hashMap.put(DisplayManager.class, Attributes.Style.DISPLAY);
            hashMap.put(UserManager.class, UserData.NAME);
            hashMap.put(InputManager.class, "input");
            hashMap.put(MediaRouter.class, "media_router");
            hashMap.put(NsdManager.class, "servicediscovery");
            hashMap.put(AccessibilityManager.class, "accessibility");
            hashMap.put(AccountManager.class, InnoMain.INNO_KEY_ACCOUNT);
            hashMap.put(ActivityManager.class, "activity");
            hashMap.put(AlarmManager.class, NotificationCompat.CATEGORY_ALARM);
            hashMap.put(AudioManager.class, PowerProfile.POWER_AUDIO);
            hashMap.put(ClipboardManager.class, TextClassifier.WIDGET_TYPE_CLIPBOARD);
    ...
    public static int checkSelfPermission(@NonNull Context context, @NonNull String str) {
        ...
        if (BuildCompat.isAtLeastT() || !TextUtils.equals(com.huawei.openalliance.ad.constant.u.cw, str)) {
