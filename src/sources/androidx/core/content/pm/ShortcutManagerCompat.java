...
public class ShortcutManagerCompat {
    ...
    public static boolean addDynamicShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (i10 >= 25) {
            ...
            Iterator<ShortcutInfoCompat> iterator2 = removeShortcutsExcludedFromSurface.iterator2();
        ...
        Iterator<ShortcutInfoChangeListener> iterator22 = getShortcutInfoListeners(context).iterator2();
        while (iterator22.hasNext()) {
            iterator22.next().onShortcutAdded(list);
        }
        return true;
    }
    ...
    public static void disableShortcuts(@NonNull Context context, @NonNull List<String> list, @Nullable CharSequence charSequence) {
        ...
        Iterator<ShortcutInfoChangeListener> iterator2 = getShortcutInfoListeners(context).iterator2();
        while (iterator2.hasNext()) {
            iterator2.next().onShortcutRemoved(list);
        }
    }
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(@NonNull Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            Iterator<ShortcutInfo> iterator2 = dynamicShortcuts.iterator2();
            while (iterator2.hasNext()) {
                arrayList.add(new ShortcutInfoCompat.Builder(context, iterator2.next()).build());
            }
            return arrayList;
        }
        try {
    ...
    private static List<ShortcutInfoChangeListener> getShortcutInfoListeners(Context context) {
        ...
        if (sShortcutInfoChangeListeners == null) {
            ...
            Iterator<ResolveInfo> iterator2 = packageManager.queryIntentActivities(intent, 128).iterator2();
            while (iterator2.hasNext()) {
    ...
    public static boolean isRequestPinShortcutSupported(@NonNull Context context) {
        ...
        Iterator<ResolveInfo> iterator2 = context.getPackageManager().queryBroadcastReceivers(new Intent(ACTION_INSTALL_SHORTCUT), 0).iterator2();
        while (iterator2.hasNext()) {
            String str = iterator2.next().activityInfo.permission;
    ...
    public static boolean pushDynamicShortcut(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        ...
        try {
            ...
            Iterator<ShortcutInfoChangeListener> iterator22 = getShortcutInfoListeners(context).iterator2();
            while (iterator22.hasNext()) {
                iterator22.next().onShortcutAdded(Collections.singletonList(shortcutInfoCompat));
            }
            reportShortcutUsed(context, shortcutInfoCompat.getId());
            return true;
        } catch (Exception unused) {
            Iterator<ShortcutInfoChangeListener> iterator23 = getShortcutInfoListeners(context).iterator2();
            while (iterator23.hasNext()) {
                iterator23.next().onShortcutAdded(Collections.singletonList(shortcutInfoCompat));
            }
            reportShortcutUsed(context, shortcutInfoCompat.getId());
            return false;
        } catch (Throwable th) {
            Iterator<ShortcutInfoChangeListener> iterator24 = getShortcutInfoListeners(context).iterator2();
            while (iterator24.hasNext()) {
                iterator24.next().onShortcutAdded(Collections.singletonList(shortcutInfoCompat));
            }
            reportShortcutUsed(context, shortcutInfoCompat.getId());
            throw th;
        }
    ...
    public static void removeAllDynamicShortcuts(@NonNull Context context) {
        ...
        Iterator<ShortcutInfoChangeListener> iterator2 = getShortcutInfoListeners(context).iterator2();
        while (iterator2.hasNext()) {
            iterator2.next().onAllShortcutsRemoved();
        }
    }
    ...
    public static void reportShortcutUsed(@NonNull Context context, @NonNull String str) {
        ...
        Iterator<ShortcutInfoChangeListener> iterator2 = getShortcutInfoListeners(context).iterator2();
        while (iterator2.hasNext()) {
            iterator2.next().onShortcutUsageReported(Collections.singletonList(str));
        }
    }
    ...
    public static boolean updateShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        Iterator<ShortcutInfoChangeListener> iterator22 = getShortcutInfoListeners(context).iterator2();
        while (iterator22.hasNext()) {
            iterator22.next().onShortcutUpdated(list);
        }
        return true;
    }
}
