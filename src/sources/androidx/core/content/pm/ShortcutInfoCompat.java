...
public class ShortcutInfoCompat {
            ...
            if (!TextUtils.isEmpty(this.mInfo.mLabel)) {
                ...
                if (intentArr != null && intentArr.length != 0) {
                    ...
                    if (this.mCapabilityBindingParams != null) {
                        ...
                        for (String str : this.mCapabilityBindingParams.h()) {
                            Map<String, List<String>> map = this.mCapabilityBindingParams.get(str);
                            this.mInfo.mExtras.putStringArray(str, (String[]) map.h().toArray(new String[0]));
    ...
    public static List<ShortcutInfoCompat> fromShortcuts(@NonNull Context context, @NonNull List<ShortcutInfo> list) {
        ...
        Iterator<ShortcutInfo> iterator2 = list.iterator2();
        while (iterator2.hasNext()) {
            arrayList.add(new Builder(context, iterator2.next()).build());
        }
        return arrayList;
    }
