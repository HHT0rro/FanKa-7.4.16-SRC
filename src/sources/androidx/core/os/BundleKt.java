        ...
        for (Pair<String, ? extends Object> pair : pairs) {
            ...
            if (component2 == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    s.g(component2, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(component1, (Parcelable[]) component2);
                } else if (String.class.isAssignableFrom(componentType)) {
                    s.g(component2, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(component1, (String[]) component2);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    s.g(component2, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
