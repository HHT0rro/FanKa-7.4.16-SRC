...
public class DeferredComponentChannel {
    ...
    public void completeInstallError(String str, String str2) {
        if (this.componentNameToResults.containsKey(str)) {
            Iterator<MethodChannel.Result> iterator2 = this.componentNameToResults.get(str).iterator2();
            while (iterator2.hasNext()) {
                iterator2.next().error("DeferredComponent Install failure", str2, null);
            }
