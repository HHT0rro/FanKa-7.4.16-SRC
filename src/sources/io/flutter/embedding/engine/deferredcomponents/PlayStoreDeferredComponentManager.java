...
public class PlayStoreDeferredComponentManager implements DeferredComponentManager {
            ...
            if (PlayStoreDeferredComponentManager.this.sessionIdToName.get(sessionId) != null) {
                switch (splitInstallSessionState.status()) {
                    ...
                    case 4:
                        ...
                        PlayStoreDeferredComponentManager.this.sessionIdToState.put(sessionId, as.ah);
                        return;
                    case 5:
                    ...
                    case 6:
                        ...
                        PlayStoreDeferredComponentManager.this.sessionIdToName.delete(sessionId);
                        PlayStoreDeferredComponentManager.this.sessionIdToLoadingUnitId.delete(sessionId);
                        PlayStoreDeferredComponentManager.this.sessionIdToState.put(sessionId, e.f4721a);
                        return;
                    case 7:
    ...
    private void initLoadingUnitMappingToComponentNames() {
        ...
        for (String str2 : string.split(",")) {
            String[] split = str2.split(u.bD, -1);
    ...
    @Override // io.flutter.embedding.engine.deferredcomponents.DeferredComponentManager
    @NonNull
    public String getDeferredComponentInstallState(int i10, @Nullable String str) {
        if (str == null) {
    ...
    @Override // io.flutter.embedding.engine.deferredcomponents.DeferredComponentManager
    public void installDeferredComponent(final int i10, @Nullable final String str) {
    ...
    @Override // io.flutter.embedding.engine.deferredcomponents.DeferredComponentManager
    public void loadAssets(int i10, @NonNull String str) {
        if (verifyJNI()) {
            try {
    ...
    @Override // io.flutter.embedding.engine.deferredcomponents.DeferredComponentManager
    public void loadDartLibrary(int i10, @NonNull String str) {
        if (verifyJNI() && i10 >= 0) {
            ...
            while (iterator2.hasNext()) {
                arrayList3.add(((String) iterator2.next()) + "!lib/" + str3 + "/" + str2);
            }
            Iterator<E> iterator22 = arrayList2.iterator2();
            while (iterator22.hasNext()) {
                arrayList3.add((String) iterator22.next());
            }
    ...
    @Override // io.flutter.embedding.engine.deferredcomponents.DeferredComponentManager
    public boolean uninstallDeferredComponent(int i10, @Nullable String str) {
        if (str == null) {
            str = this.loadingUnitIdToComponentNames.get(i10);
        }
        if (str == null) {
