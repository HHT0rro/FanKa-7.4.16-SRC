...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> just(T t2, T t10) {
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> just(T t2, T t10, T t11) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t10, "item2 is null");
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> just(T t2, T t10, T t11, T t12) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t10, "item2 is null");
        ObjectHelper.requireNonNull(t11, "item3 is null");
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> just(T t2, T t10, T t11, T t12, T t13) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t10, "item2 is null");
        ObjectHelper.requireNonNull(t11, "item3 is null");
        ObjectHelper.requireNonNull(t12, "item4 is null");
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> just(T t2, T t10, T t11, T t12, T t13, T t14) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t10, "item2 is null");
        ObjectHelper.requireNonNull(t11, "item3 is null");
        ObjectHelper.requireNonNull(t12, "item4 is null");
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> just(T t2, T t10, T t11, T t12, T t13, T t14, T t15) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t10, "item2 is null");
        ObjectHelper.requireNonNull(t11, "item3 is null");
        ObjectHelper.requireNonNull(t12, "item4 is null");
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> just(T t2, T t10, T t11, T t12, T t13, T t14, T t15, T t16) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t10, "item2 is null");
        ObjectHelper.requireNonNull(t11, "item3 is null");
        ObjectHelper.requireNonNull(t12, "item4 is null");
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> just(T t2, T t10, T t11, T t12, T t13, T t14, T t15, T t16, T t17) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t10, "item2 is null");
        ObjectHelper.requireNonNull(t11, "item3 is null");
        ObjectHelper.requireNonNull(t12, "item4 is null");
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Observable<T> just(T t2, T t10, T t11, T t12, T t13, T t14, T t15, T t16, T t17, T t18) {
        ObjectHelper.requireNonNull(t2, "item1 is null");
        ObjectHelper.requireNonNull(t10, "item2 is null");
        ObjectHelper.requireNonNull(t11, "item3 is null");
        ObjectHelper.requireNonNull(t12, "item4 is null");
