...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public static <T> Maybe<T> just(T t2) {
        ...
        return RxJavaPlugins.onAssembly(new MaybeJust(t2));
    }
    ...
    public final Single<T> toSingle(T t2) {
        ...
        return RxJavaPlugins.onAssembly(new MaybeToSingle(this, t2));
    }
    ...
    public static <T> Flowable<T> merge(Publisher<? extends MaybeSource<? extends T>> publisher, int i10) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(publisher, MaybeToPublisher.instance(), false, i10, 1));
    }
    ...
    public static <T> Flowable<T> mergeDelayError(Publisher<? extends MaybeSource<? extends T>> publisher, int i10) {
        ObjectHelper.requireNonNull(publisher, "source is null");
        ObjectHelper.verifyPositive(i10, "maxConcurrency");
        return RxJavaPlugins.onAssembly(new FlowableFlatMapPublisher(publisher, MaybeToPublisher.instance(), true, i10, 1));
    }
    ...
    public static <T> Flowable<T> concat(Publisher<? extends MaybeSource<? extends T>> publisher, int i10) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableConcatMapPublisher(publisher, MaybeToPublisher.instance(), i10, ErrorMode.IMMEDIATE));
    }
