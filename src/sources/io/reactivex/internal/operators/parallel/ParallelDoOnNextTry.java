        ...
        if (validate(subscriberArr)) {
            ...
            for (int i10 = 0; i10 < length; i10++) {
                ...
                if (subscriber instanceof ConditionalSubscriber) {
                    subscriberArr2[i10] = new ParallelDoOnNextConditionalSubscriber((ConditionalSubscriber) subscriber, this.onNext, this.errorHandler);
                } else {
                    subscriberArr2[i10] = new ParallelDoOnNextSubscriber(subscriber, this.onNext, this.errorHandler);
                }
            }
