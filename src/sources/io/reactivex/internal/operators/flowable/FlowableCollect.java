...
public final class FlowableCollect<T, U> extends AbstractFlowableWithUpstream<T, U> {
    ...
    public static final class CollectSubscriber<T, U> extends DeferredScalarSubscription<U> implements FlowableSubscriber<T> {
        ...
        public final U f50116u;
        public Subscription upstream;

        public CollectSubscriber(Subscriber<? super U> subscriber, U u10, BiConsumer<? super U, ? super T> biConsumer) {
            super(subscriber);
        ...
        public void onNext(T t2) {
            ...
            try {
                this.collector.accept(this.f50116u, t2);
            } catch (Throwable th) {
