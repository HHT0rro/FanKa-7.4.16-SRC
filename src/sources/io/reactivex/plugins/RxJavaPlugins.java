...
public final class RxJavaPlugins {
    ...
    @NonNull
    public static <T, R> R apply(@NonNull Function<T, R> function, @NonNull T t2) {
        try {
    ...
    @NonNull
    public static <T, U, R> R apply(@NonNull BiFunction<T, U, R> biFunction, @NonNull T t2, @NonNull U u10) {
        try {
            return biFunction.apply(t2, u10);
        } catch (Throwable th) {
            throw ExceptionHelper.wrapOrThrow(th);
        }
    }
