...
public class a {
    ...
    public static byte[] a(String str) {
        ...
        for (int i15 = 0; i15 < str.length(); i15++) {
            ...
            byte b10 = charAt > 255 ? (byte) -1 : f52391a[charAt];
            if (b10 >= 0) {
                i14 += 6;
                i13 = (i13 << 6) | b10;
                if (i14 >= 8) {
    ...
    public static int b(String str) {
        ...
        for (int i10 = 0; i10 < str.length(); i10++) {
            ...
            if (charAt > 255 || f52391a[charAt] < 0) {
                length--;
            }
        }
        return length;
