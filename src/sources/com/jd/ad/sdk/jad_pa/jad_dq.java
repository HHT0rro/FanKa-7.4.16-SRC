...
public final class jad_dq<DataT> implements jad_na<Uri, DataT> {
    ...
    /* renamed from: com.jd.ad.sdk.jad_pa.jad_dq$jad_dq, reason: collision with other inner class name */
    /* loaded from: C:\Users\35037\Desktop\fankahook\2\class.dex */
    public static final class C0388jad_dq<DataT> implements com.jd.ad.sdk.jad_it.jad_dq<DataT> {
        ...
        @Nullable
        public volatile com.jd.ad.sdk.jad_it.jad_dq<DataT> jad_jw;

        public C0388jad_dq(Context context, jad_na<File, DataT> jad_naVar, jad_na<Uri, DataT> jad_naVar2, Uri uri, int i10, int i11, jad_jw jad_jwVar, Class<DataT> cls) {
        ...
        public void jad_an(@NonNull jad_jt jad_jtVar, @NonNull jad_dq.jad_an<? super DataT> jad_anVar) {
            try {
                com.jd.ad.sdk.jad_it.jad_dq<DataT> jad_er = jad_er();
                if (jad_er == null) {
                    jad_anVar.jad_an((Exception) new IllegalArgumentException("Failed to build fetcher for: " + ((Object) this.jad_dq)));
                    return;
                }
                this.jad_jw = jad_er;
                if (this.jad_iv) {
        ...
        @Override // com.jd.ad.sdk.jad_it.jad_dq
        public void jad_bo() {
            com.jd.ad.sdk.jad_it.jad_dq<DataT> jad_dqVar = this.jad_jw;
            if (jad_dqVar != null) {
                jad_dqVar.jad_bo();
            }
        }
        ...
        @Nullable
        public final com.jd.ad.sdk.jad_it.jad_dq<DataT> jad_er() {
    ...
    public jad_na.jad_an jad_an(@NonNull Uri uri, int i10, int i11, @NonNull jad_jw jad_jwVar) {
        Uri uri2 = uri;
        return new jad_na.jad_an(new com.jd.ad.sdk.jad_fo.jad_bo(uri2), Collections.emptyList(), new C0388jad_dq(this.jad_an, this.jad_bo, this.jad_cp, uri2, i10, i11, jad_jwVar, this.jad_dq));
    }

    @Override // com.jd.ad.sdk.jad_oz.jad_na
    public boolean jad_an(@NonNull Uri uri) {
        return Build.VERSION.SDK_INT >= 29 && com.jd.ad.sdk.jad_ju.jad_bo.jad_an(uri);
    }
}
