...
public class jad_bo<Data> implements jad_na<byte[], Data> {
    public final InterfaceC0385jad_bo<Data> jad_an;
    ...
    public static class jad_an implements jad_ob<byte[], ByteBuffer> {
        ...
        /* loaded from: C:\Users\35037\Desktop\fankahook\2\class.dex */
        public class C0384jad_an implements InterfaceC0385jad_bo<ByteBuffer> {
            public C0384jad_an(jad_an jad_anVar) {
            }

            @Override // com.jd.ad.sdk.jad_oz.jad_bo.InterfaceC0385jad_bo
    ...
    public static class jad_cp<Data> implements com.jd.ad.sdk.jad_it.jad_dq<Data> {
        ...
        public final InterfaceC0385jad_bo<Data> jad_bo;

        public jad_cp(byte[] bArr, InterfaceC0385jad_bo<Data> interfaceC0385jad_bo) {
            this.jad_an = bArr;
            this.jad_bo = interfaceC0385jad_bo;
        }
    ...
    public static class jad_dq implements jad_ob<byte[], InputStream> {
        ...
        /* loaded from: C:\Users\35037\Desktop\fankahook\2\class.dex */
        public class jad_an implements InterfaceC0385jad_bo<InputStream> {
    ...
    public jad_bo(InterfaceC0385jad_bo<Data> interfaceC0385jad_bo) {
        this.jad_an = interfaceC0385jad_bo;
    }

    @Override // com.jd.ad.sdk.jad_oz.jad_na
    public jad_na.jad_an jad_an(@NonNull byte[] bArr, int i10, int i11, @NonNull com.jd.ad.sdk.jad_hs.jad_jw jad_jwVar) {
        byte[] bArr2 = bArr;
