...
public class jad_ob implements jad_cp {
    ...
    public jad_ob(String str, boolean z10, Path.FillType fillType, @Nullable com.jd.ad.sdk.jad_py.jad_an jad_anVar, @Nullable com.jd.ad.sdk.jad_py.jad_dq jad_dqVar, boolean z11) {
        this.jad_cp = str;
        this.jad_an = z10;
