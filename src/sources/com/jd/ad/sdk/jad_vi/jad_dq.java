...
public class jad_dq implements Serializable {
    ...
    public final void jad_an(JSONObject jSONObject) {
        try {
            ...
            this.jad_re = jSONObject.optString(a.f4667h);
            ...
            this.jad_fq = jSONObject.optString(a.f4668i);
            ...
            Logger.w("parse event from json ", e2.getMessage());
        }
    }
    ...
    public JSONObject jad_an() {
        ...
        try {
            ...
            JsonUtils.put(jSONObject, a.f4668i, this.jad_fq);
            ...
            Logger.w("Event to json ", e2.getMessage());
        }
        return jSONObject;
    }
}
