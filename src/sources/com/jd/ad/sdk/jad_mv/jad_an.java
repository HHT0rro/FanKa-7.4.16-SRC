...
public abstract class jad_an<K, A> {
    ...
    public final List<InterfaceC0374jad_an> jad_an = new ArrayList(1);
    ...
    /* loaded from: C:\Users\35037\Desktop\fankahook\2\class.dex */
    public interface InterfaceC0374jad_an {
        void jad_an();
    }
    ...
    public static final class jad_dq<T> implements jad_cp<T> {
        ...
        public final com.jd.ad.sdk.jad_wf.jad_an<T> jad_cp(float f10) {
            ...
            while (true) {
                ...
                if (this.jad_bo != jad_anVar2) {
                    if (f10 >= jad_anVar2.jad_bo() && f10 < jad_anVar2.jad_an()) {
                        z10 = true;
                    }
                    if (z10) {
                        return jad_anVar2;
    ...
    public abstract A jad_an(com.jd.ad.sdk.jad_wf.jad_an<K> jad_anVar, float f10);

    public A jad_an(com.jd.ad.sdk.jad_wf.jad_an<K> jad_anVar, float f10, float f11, float f12) {
    ...
    public void jad_an(InterfaceC0374jad_an interfaceC0374jad_an) {
        this.jad_an.add(interfaceC0374jad_an);
    }
