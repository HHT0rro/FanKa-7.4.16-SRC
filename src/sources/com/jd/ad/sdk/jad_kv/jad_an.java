...
public final class jad_an {
    ...
    /* loaded from: C:\Users\35037\Desktop\fankahook\2\class.dex */
    public class ThreadFactoryC0369jad_an implements ThreadFactory {

        /* renamed from: com.jd.ad.sdk.jad_kv.jad_an$jad_an$jad_an, reason: collision with other inner class name */
        /* loaded from: C:\Users\35037\Desktop\fankahook\2\class.dex */
        public class RunnableC0370jad_an implements Runnable {
            public final /* synthetic */ Runnable jad_an;

            public RunnableC0370jad_an(ThreadFactoryC0369jad_an threadFactoryC0369jad_an, Runnable runnable) {
        ...
        public Thread newThread(@NonNull Runnable runnable) {
            return new Thread(new RunnableC0370jad_an(this, runnable), "glide-active-resources");
        }
    }
    ...
    public static final class jad_cp extends WeakReference<jad_re<?>> {
        ...
        public jad_cp(@NonNull com.jd.ad.sdk.jad_hs.jad_hu jad_huVar, @NonNull jad_re<?> jad_reVar, @NonNull ReferenceQueue<? super jad_re<?>> referenceQueue, boolean z10) {
            super(jad_reVar, referenceQueue);
            this.jad_an = (com.jd.ad.sdk.jad_hs.jad_hu) com.jd.ad.sdk.jad_gp.jad_kx.jad_an(jad_huVar);
            this.jad_cp = (jad_reVar.jad_fs() && z10) ? (jad_xk) com.jd.ad.sdk.jad_gp.jad_kx.jad_an(jad_reVar.jad_er()) : null;
            this.jad_bo = jad_reVar.jad_fs();
        }
    }

    public jad_an(boolean z10) {
        this(z10, Executors.newSingleThreadExecutor(new ThreadFactoryC0369jad_an()));
    }
