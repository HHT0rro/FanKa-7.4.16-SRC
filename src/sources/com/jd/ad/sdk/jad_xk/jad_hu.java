...
public final class jad_hu extends jad_an {
    ...
    public URLConnection jad_an(jad_kx jad_kxVar) {
        ...
        int i10 = jad_kxVar.jad_an;
        this.jad_bo.setRequestMethod(jad_jw.jad_an(i10));
        ...
        if (jad_fsVar != null) {
            List<String> list = jad_fsVar.jad_an.get(HttpHeaders.HEAD_KEY_CONNECTION);
            if (list != null && !list.isEmpty()) {
                jad_fsVar.jad_bo(HttpHeaders.HEAD_KEY_CONNECTION, list.get(0));
            }
