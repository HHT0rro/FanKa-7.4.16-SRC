...
public class jad_an implements Runnable {
    ...
    public void run() {
        ...
        jad_an3.jad_jt = new C0366jad_an();
        ...
        if (jADSlot != null) {
            ...
            int tolerateTime = (jADSlot.isFromNativeAd() || adType != 1) ? 0 : (int) jADSlot.getTolerateTime();
            if (jADSlot.getAdDataRequestSourceType() != 1 && jADSlot.getAdDataRequestSourceType() != 2) {
                com.jd.ad.sdk.jad_vi.jad_fs.jad_an(requestId, slotID, 1, adType, sen, i11, i10, templateId, rem, currentTimeMillis, ds, r10, 0, tolerateTime);
            } else {
                com.jd.ad.sdk.jad_vi.jad_fs.jad_an(requestId, slotID, 1, adType, sen, i11, i10, templateId, rem, currentTimeMillis, ds, r10, 1, tolerateTime);
            }
        }
    ...
    /* loaded from: C:\Users\35037\Desktop\fankahook\2\class.dex */
    public class C0366jad_an implements jad_kx.jad_an {

        /* compiled from: JADLoader.java */
        /* renamed from: com.jd.ad.sdk.jad_jt.jad_an$jad_an$jad_an, reason: collision with other inner class name */
        /* loaded from: C:\Users\35037\Desktop\fankahook\2\class.dex */
        public class RunnableC0367jad_an implements Runnable {
            public RunnableC0367jad_an() {
            }
        ...
        public void jad_an(jad_ly jad_lyVar) {
            ...
            try {
                if (jad_lyVar.jad_cp() != 200) {
                    ...
                    String jad_bo = jad_lyVar.jad_bo() != null ? jad_lyVar.jad_bo().jad_bo() : "";
                    Logger.d("【load】loadAd error code:" + jad_lyVar.jad_cp() + ",msg=" + jad_bo);
                    ...
                    com.jd.ad.sdk.jad_vi.jad_fs.jad_an(str, 3, jad_cp, jad_an8, jad_an.this.jad_an.getSen());
                    return;
                }
                if (jad_lyVar.jad_bo() == null) {
                    ...
                    com.jd.ad.sdk.jad_vi.jad_fs.jad_an(str2, 3, jad_an9, jad_an7, jad_an.this.jad_an.getSen());
                    return;
                }
                String jad_bo2 = jad_lyVar.jad_bo().jad_bo();
                Logger.d("loadAd gw response: " + jad_bo2);
                if (TextUtils.isEmpty(jad_bo2)) {
                    ...
                    com.jd.ad.sdk.jad_vi.jad_fs.jad_an(str3, 3, jad_an10, jad_an6, jad_an.this.jad_an.getSen());
                    return;
                }
                ...
                if (TextUtils.isEmpty(je2)) {
                    ...
                    com.jd.ad.sdk.jad_vi.jad_fs.jad_an(str4, 3, jad_an11, jad_an5, jad_an.this.jad_an.getSen());
                    return;
                }
                com.jd.ad.sdk.jad_wj.jad_jt jad_an12 = com.jd.ad.sdk.jad_wj.jad_jt.jad_an(je2);
                if (jad_an12.jad_an() != 0) {
                    ...
                    com.jd.ad.sdk.jad_vi.jad_fs.jad_an(str5, 3, jad_an13, jad_an4, jad_an.this.jad_an.getSen());
                    return;
                }
                ...
                HandlerUtils.runOnUiThread(new RunnableC0367jad_an());
                ...
                jad_an3 = jad_anVar19.jad_er.jad_an(jad_anVar19.jad_an.getSlotID(), jad_an.this.jad_an.getAdType(), jad_anVar18.jad_an(e2.getMessage()));
                com.jd.ad.sdk.jad_vi.jad_fs.jad_an(str6, 3, jad_an14, jad_an3, jad_an.this.jad_an.getSen());
                ...
                jad_an2 = jad_anVar22.jad_er.jad_an(jad_anVar22.jad_an.getSlotID(), jad_an.this.jad_an.getAdType(), jad_anVar21.jad_an(e10.getMessage()));
                com.jd.ad.sdk.jad_vi.jad_fs.jad_an(str7, 3, jad_an15, jad_an2, jad_an.this.jad_an.getSen());
            } catch (Exception e11) {
                ...
                jad_an = jad_anVar25.jad_er.jad_an(jad_anVar25.jad_an.getSlotID(), jad_an.this.jad_an.getAdType(), com.jd.ad.sdk.jad_uh.jad_an.GW_RESPONSE_DATA_IO_ERROR.jad_an(e11.getMessage()));
                com.jd.ad.sdk.jad_vi.jad_fs.jad_an(str8, 3, jad_an16, jad_an, jad_an.this.jad_an.getSen());
            }
        }
        ...
        public void jad_an(int i10, String str) {
            ...
            jad_an jad_anVar2 = jad_an.this;
            com.jd.ad.sdk.jad_vi.jad_fs.jad_an(jad_anVar2.jad_cp, 3, i10, jad_anVar2.jad_er.jad_an(jad_anVar2.jad_an.getSlotID(), jad_an.this.jad_an.getAdType(), str), jad_an.this.jad_an.getSen());
        }
    }
}
