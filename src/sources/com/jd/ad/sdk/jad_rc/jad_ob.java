...
public interface jad_ob {
    ...
    public static final class jad_an implements jad_ob {
        ...
        public Bitmap jad_an(BitmapFactory.Options options) {
            return BitmapFactory.decodeStream(new jad_an.C0361jad_an(com.jd.ad.sdk.jad_gp.jad_an.jad_an(this.jad_an)), null, options);
        }
    ...
    public static final class jad_cp implements jad_ob {
        ...
        public int jad_cp() {
            ...
            int size = list.size();
            for (int i10 = 0; i10 < size; i10++) {
                com.jd.ad.sdk.jad_hs.jad_fs jad_fsVar = list.get(i10);
