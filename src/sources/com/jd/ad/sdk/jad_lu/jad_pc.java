...
public class jad_pc implements jad_er, jad_mz, jad_jw, jad_an.InterfaceC0374jad_an, jad_kx {
    ...
    public <T> void jad_an(T t2, @Nullable com.jd.ad.sdk.jad_wf.jad_cp<T> jad_cpVar) {
        ...
        if (this.jad_iv.jad_an(t2, jad_cpVar)) {
            return;
        }
        if (t2 == com.jd.ad.sdk.jad_js.jad_re.jad_uh) {
            jad_anVar = this.jad_jt;
        } else if (t2 != com.jd.ad.sdk.jad_js.jad_re.jad_vi) {
            return;
        } else {
    ...
    public void jad_an(Canvas canvas, Matrix matrix, int i10) {
        ...
        for (int i11 = ((int) floatValue) - 1; i11 >= 0; i11--) {
            ...
            this.jad_jw.jad_an(canvas, this.jad_an, (int) (com.jd.ad.sdk.jad_ve.jad_jt.jad_an(floatValue3, floatValue4, f10 / floatValue) * i10));
        }
    }
}
