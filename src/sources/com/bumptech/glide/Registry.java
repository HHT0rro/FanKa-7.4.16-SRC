...
public class Registry {
    ...
    public <Model, TResource, Transcode> List<Class<?>> getRegisteredResourceClasses(@NonNull Class<Model> cls, @NonNull Class<TResource> cls2, @NonNull Class<Transcode> cls3) {
        ...
        if (list == null) {
            list = new ArrayList<>();
            Iterator<Class<?>> iterator2 = this.modelLoaderRegistry.getDataClasses(cls).iterator2();
            while (iterator2.hasNext()) {
                for (Class<?> cls4 : this.decoderRegistry.getResourceClasses(iterator2.next(), cls2)) {
