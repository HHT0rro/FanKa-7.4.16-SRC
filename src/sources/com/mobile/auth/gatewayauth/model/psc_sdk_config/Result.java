...
public class Result implements Jsoner {
    ...
    public void fromJson(JSONObject jSONObject) {
        try {
            ...
            if (jSONObject != null) {
                setModel(ConfigRule.fromJson(jSONObject.optJSONObject(bk.f9900i)));
            }
        } catch (Throwable th) {
            try {
    ...
    public JSONObject toJson() {
        try {
            ...
            try {
                ...
                json.put(bk.f9900i, configRule == null ? new JSONObject() : configRule.toJsonString());
    ...
    public JSONObject toJsonControlPop() {
        try {
            ...
            try {
                ConfigRule configRule = this.model;
                json.put(bk.f9900i, configRule == null ? new JSONObject() : configRule.toJson());
            } catch (JSONException e2) {
                e2.printStackTrace();
            }
            return json;
