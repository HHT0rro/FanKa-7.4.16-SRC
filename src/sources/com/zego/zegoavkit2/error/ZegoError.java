...
public class ZegoError {
    public static final int kAccessDeniedError = 15720018;
    public static final int kConfigDecryptError = 20000001;
    public static final int kConfigDomainError = 20000003;
    public static final int kConfigEndlessRedirectError = 21200047;
    ...
    public static final int kDispatchAgentDroppedError = 35500002;
    public static final int kDispatchAgentTimeoutError = 35500001;
    ...
    public static final int kDispatchPlayAuthFailedError = 32001016;
    ...
    public static final int kEngineAlreadyStartDumpDataError = 12200302;
    public static final int kEngineConnectServerError = 12200001;
    public static final int kEngineCreateDumpDataFolderError = 12200304;
    public static final int kEngineCreateError = 12101001;
    public static final int kEngineDumpDataExceedMaxSizeError = 12200305;
    ...
    public static final int kEngineNoDumpDataError = 12200303;
    public static final int kEngineNoPlayDataError = 12102001;
    public static final int kEngineNoPublishDataError = 12102002;
    public static final int kEnginePublishNotReadyError = 12102005;
    ...
    public static final int kEngineRtpDecryptError = 12200107;
    public static final int kEngineRtpDecryptNotSupport = 12200108;
    ...
    public static final int kLiveRoomAgentDroppedError = 55500002;
    public static final int kLiveRoomAgentTimeoutError = 55500001;
    ...
    public static final int kLiveRoomInputParamsLengthLimitError = 52000003;
    ...
    public static final int kLoginAgentDroppedError = 45500002;
    public static final int kLoginAgentTimeoutError = 45500001;
    ...
    public static final int kMixStreamAgentDroppedError = 85500002;
    public static final int kMixStreamAgentTimeoutError = 85500001;
    ...
    public static final int kMixStreamInputImageFormatError = 82000141;
    public static final int kMixStreamInputImageSizeError = 82000142;
    ...
    public static final int kMixStreamTextWaterMarkIllegalParamError = 82000179;
    ...
    public static final int kNotMallocEnoughMemError = 10004003;
    ...
    public static final int kSDKNotInit = 10008002;
    ...
    public static final int kUploadLogAuthFailure = 14000101;
    public static final int kUploadLogForbidUpload = 14000209;
    public static final int kUploadLogFreqLimited = 14000001;
    public static final int kUploadLogIllegalParams = 14000002;
    public static final int kUploadLogInBlackList = 14000210;
    public static final int kUploadLogInvalidTask = 14010005;
    public static final int kUploadLogInvalidTaskConfig = 14010006;
    public static final int kUploadLogNetworkError = 14010003;
    public static final int kUploadLogNoPackError = 14010002;
    public static final int kUploadLogNoUploadFile = 14000201;
    public static final int kUploadLogSaveFileFailed = 14000205;
    public static final int kUploadLogStartSendFail = 14010001;
    public static final int kUploadLogUnknownServiceError = 14010004;
    public static final int kUploadLogUploadTimeout = 14010007;

    public static native String getErrorMsg(int i10);

    public static native boolean isDNSResolveError(int i10);

    public static native boolean isHttpProtocolError(int i10);

    public static native boolean isInitSDKError(int i10);

    public static native boolean isLiveRoomError(int i10);

    public static native boolean isLogicServerNetWrokError(int i10);

    public static native boolean isManualKickoutError(int i10);

    public static native boolean isMediaServerNetWorkError(int i10);

    public static native boolean isMixStreamNotExistError(int i10);

    public static native boolean isMultiLoginError(int i10);

    public static native boolean isNetworkUnreachError(int i10);

    public static native boolean isNotLoginError(int i10);

    public static native boolean isPlayDeniedError(int i10);

    public static native boolean isPlayForbidError(int i10);

    public static native boolean isPlayStreamNotExistError(int i10);

    public static native boolean isPublishBadNameError(int i10);

    public static native boolean isPublishDeniedError(int i10);

    public static native boolean isPublishForbidError(int i10);

    public static native boolean isPublishStopError(int i10);

    public static native boolean isReqFrequencyLimitError(int i10);

    public static native boolean isRoomSessionError(int i10);
}
