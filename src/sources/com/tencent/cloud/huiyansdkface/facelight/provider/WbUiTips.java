...
public class WbUiTips {
    public String kyc_make_sure = "确定";
    public String kyc_cancel = "取消";
    ...
    public String kyc_camera_setup_android = "您可尝试在应用权限管理中打开摄像头权限";
