...
public interface b extends IInterface {
    ...
    public static abstract class a extends Binder implements b {
        ...
        public static class C0634a implements b {
            ...
            private IBinder f42616a;

            public C0634a(IBinder iBinder) {
                this.f42616a = iBinder;
            }
            ...
            public final boolean a() throws RemoteException {
                ...
                try {
                    ...
                    this.f42616a.transact(1, obtain, obtain2, 0);
            ...
            public final int b() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.huawei.multimedia.audioengine.IHwAudioKaraokeFeature");
                    this.f42616a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public final int a(boolean z10) throws RemoteException {
                ...
                try {
                    ...
                    this.f42616a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readInt();
                } finally {
                    obtain2.recycle();
            ...
            public final int a(String str, int i10) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i10);
                    this.f42616a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readInt();
                } finally {
                    obtain2.recycle();
            ...
            public final void a(String str) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.huawei.multimedia.audioengine.IHwAudioKaraokeFeature");
                    obtain.writeString(str);
                    this.f42616a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
