...
public class DrawableTypeRequest<ModelType> extends DrawableRequestBuilder<ModelType> implements DownloadOptions {
    public final ModelLoader<ModelType, ParcelFileDescriptor> fileDescriptorModelLoader;
    public final RequestManager.OptionsApplier optionsApplier;
    public final ModelLoader<ModelType, InputStream> streamModelLoader;
    ...
    public static <A, Z, R> FixedLoadProvider<A, ImageVideoWrapper, Z, R> buildProvider(Glide glide, ModelLoader<A, InputStream> modelLoader, ModelLoader<A, ParcelFileDescriptor> modelLoader2, Class<Z> cls, Class<R> cls2, ResourceTranscoder<Z, R> resourceTranscoder) {
