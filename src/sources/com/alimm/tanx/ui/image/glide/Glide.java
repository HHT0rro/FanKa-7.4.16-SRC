...
public class Glide {
    ...
    public final DataLoadProviderRegistry dataLoadProviderRegistry;
    public final DecodeFormat decodeFormat;
    public final GifBitmapWrapperTransformation drawableCenterCrop;
    public final GifBitmapWrapperTransformation drawableFitCenter;
    public final Engine engine;
    public final ImageViewTargetFactory imageViewTargetFactory = new ImageViewTargetFactory();
        ...
        if (glide == null) {
            synchronized (Glide.class) {
                if (glide == null) {
                    ...
                    Iterator<GlideModule> iterator2 = parseGlideModules.iterator2();
                    while (iterator2.hasNext()) {
                        iterator2.next().applyOptions(applicationContext, glideBuilder);
                    }
                    glide = glideBuilder.createGlide();
                    Iterator<GlideModule> iterator22 = parseGlideModules.iterator2();
                    while (iterator22.hasNext()) {
                        iterator22.next().registerComponents(applicationContext, glide);
                    }
                }
            }
        }
    ...
    public static List<GlideModule> parseGlideModules(Context context) {
        if (modulesEnabled) {
    ...
    public static <T, Y> ModelLoader<T, Y> buildModelLoader(T t2, Class<Y> cls, Context context) {
