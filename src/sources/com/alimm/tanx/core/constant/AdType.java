...
public class AdType implements NotConfused {
    public static final int AD_TIME_POINT = 10000;
    public static final int BANNER = 1433218285;
    public static final int BOTTOM_FLOATING = 917;
    ...
    public static final int POP = 2008;
    ...
    public static final int SOFT_AD_MONITOR = 932;
