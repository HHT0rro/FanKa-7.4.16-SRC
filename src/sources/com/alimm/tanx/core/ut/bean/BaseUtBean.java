...
public class BaseUtBean extends BaseBean {
    ...
    public BaseUtBean() {
        ...
        AdRequestBean.AdDeviceBean utDeviceBean = AndroidUtils.getUtDeviceBean();
        if (config != null) {
            ...
            this.imei = config.getImei();
            this.oaid = config.getOaid();
        ...
        this.network = NetWorkUtil.getNetworkType(TanxCoreSdk.getApplication()).getKey();
