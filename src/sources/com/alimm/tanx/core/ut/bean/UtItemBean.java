...
public class UtItemBean extends BaseBean {
    ...
    public String toString() {
        return "UtItemBean{ eventId=" + this.eventId + ", reqId='" + this.reqId + "', pid='" + this.pid + "', page='" + this.page + "', eventTime=" + this.eventTime + ", eventStatus=" + this.eventStatus + ", arg1='" + this.arg1 + "', arg2='" + this.arg2 + "', arg3='" + this.arg3 + "', args='" + ((Object) this.args) + "', sessionId='" + this.sessionId + "'} " + super.toString();
    }
