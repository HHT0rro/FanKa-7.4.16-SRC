...
public class FileThreadPool {
    ...
    static {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(1, 4, 60L, TimeUnit.SECONDS, new LinkedBlockingQueue(100), new ThreadFactory() { // from class: com.alimm.tanx.core.ut.core.thread.FileThreadPool.1
            ...
            public Thread newThread(@NonNull Runnable runnable) {
                return new Thread(runnable, "UserReportAddThreadPool-" + FileThreadPool.access$008());
            }
        });
    ...
    public static void postDelayed(@NonNull final Runnable runnable, int i10) {
        if (i10 == 0) {
            ...
            sHandler.postDelayed(new Runnable() { // from class: com.alimm.tanx.core.ut.core.thread.FileThreadPool.3
                @Override // java.lang.Runnable
                public void run() {
                    FileThreadPool.post(Runnable.this);
                }
            }, i10);
        }
    }
