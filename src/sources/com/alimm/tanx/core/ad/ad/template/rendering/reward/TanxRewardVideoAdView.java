...
public class TanxRewardVideoAdView extends TanxAdView {
    ...
    public TanxRewardVideoAdView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
    }

    public TanxRewardVideoAdView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10, int i11) {
