...
public class NewTanxAdLoader extends TanxRequestLoader implements ITanxAdLoader {
    ...
    public tanxc_do mFeedPresenter;
    public tanxc_int mRewardVideoPresenter;
    public com.alimm.tanx.core.ad.ad.template.rendering.splash.tanxc_int mSplashAdPresenter;
    public com.alimm.tanx.core.ad.ad.template.rendering.table.screen.tanxc_do mTableScreenPresenter;
    ...
    private void rewardAdExecute(final TanxAdSlot tanxAdSlot, final ITanxAdLoader.OnRewardAdLoadListener<ITanxRewardExpressAd> onRewardAdLoadListener, long j10) {
        try {
            ...
            this.mRewardVideoPresenter.request(tanxAdSlot, new ITanxAdLoader.OnAdLoadListener<ITanxRewardExpressAd>() { // from class: com.alimm.tanx.core.ad.loader.NewTanxAdLoader.4
                ...
                public void onTimeOut() {
                    TanxInterfaceUt.sendMethodCallback(tanxAdSlot, TanxInterfaceUt.TEMPLATE_REWARD, "time_out", System.currentTimeMillis() - currentTimeMillis);
                    ITanxAdLoader.OnRewardAdLoadListener onRewardAdLoadListener2 = onRewardAdLoadListener;
                    if (onRewardAdLoadListener2 != null) {
            ...
            if (onRewardAdLoadListener != null) {
                onRewardAdLoadListener.onError(new TanxError("loadRewardAd异常:" + LogUtils.getStackTraceMessage(e2)));
            }
    ...
    private void tableScreenAdAdExecute(final TanxAdSlot tanxAdSlot, final ITanxAdLoader.OnAdLoadListener<ITanxTableScreenExpressAd> onAdLoadListener, long j10) {
        try {
            final long currentTimeMillis = System.currentTimeMillis();
            ...
            this.mTableScreenPresenter.request(tanxAdSlot, new ITanxAdLoader.OnAdLoadListener<ITanxTableScreenExpressAd>() { // from class: com.alimm.tanx.core.ad.loader.NewTanxAdLoader.3
                ...
                @Override // com.alimm.tanx.core.ad.listener.ITanxAdLoader.BaseAdLoadListener
                public void onTimeOut() {
                    TanxInterfaceUt.sendMethodCallback(tanxAdSlot, TanxInterfaceUt.TEMPLATE_TABLE_SCREEN, "time_out", System.currentTimeMillis() - currentTimeMillis);
                    ITanxAdLoader.OnAdLoadListener onAdLoadListener2 = onAdLoadListener;
                    if (onAdLoadListener2 != null) {
            ...
            if (onAdLoadListener != null) {
                onAdLoadListener.onError(new TanxError("tableScreenAdAdExecute异常:" + LogUtils.getStackTraceMessage(e2)));
            }
    ...
    public void loadFeedAd(final TanxAdSlot tanxAdSlot, final ITanxAdLoader.OnAdLoadListener<ITanxFeedExpressAd> onAdLoadListener) {
        try {
            ...
            this.mFeedPresenter.request(tanxAdSlot, new ITanxAdLoader.OnAdLoadListener() { // from class: com.alimm.tanx.core.ad.loader.NewTanxAdLoader.1
                ...
                @Override // com.alimm.tanx.core.ad.listener.ITanxAdLoader.BaseAdLoadListener
                public void onTimeOut() {
                    TanxInterfaceUt.sendMethodCallback(tanxAdSlot, TanxInterfaceUt.TEMPLATE_FEED, "time_out", System.currentTimeMillis() - currentTimeMillis);
                    ITanxAdLoader.OnAdLoadListener onAdLoadListener2 = onAdLoadListener;
                    if (onAdLoadListener2 != null) {
                        onAdLoadListener2.onTimeOut();
                    }
            ...
            if (onAdLoadListener != null) {
                onAdLoadListener.onError(new TanxError("feedAdListener异常:" + LogUtils.getStackTraceMessage(e2)));
            }
        }
    }
    ...
    @Override // com.alimm.tanx.core.ad.listener.ITanxAdLoader
    public void loadSplashAd(final TanxAdSlot tanxAdSlot, final ITanxAdLoader.OnAdLoadListener<ITanxSplashExpressAd> onAdLoadListener, long j10) {
        final long currentTimeMillis = System.currentTimeMillis();
        try {
            ...
            this.mSplashAdPresenter.tanxc_do(tanxAdSlot, new ITanxAdLoader.OnAdLoadListener<ITanxSplashExpressAd>() { // from class: com.alimm.tanx.core.ad.loader.NewTanxAdLoader.2
                ...
                public void onTimeOut() {
                    NewTanxAdLoader.this.splashTimeConsuming = System.currentTimeMillis() - currentTimeMillis;
                    LogUtils.d("splashTimeConsuming", NewTanxAdLoader.this.splashTimeConsuming + "");
                    TanxInterfaceUt.sendMethodCallback(tanxAdSlot, TanxInterfaceUt.TEMPLATE_SPLASH, "time_out", System.currentTimeMillis() - currentTimeMillis);
                    ITanxAdLoader.OnAdLoadListener onAdLoadListener2 = onAdLoadListener;
                    if (onAdLoadListener2 != null) {
                        onAdLoadListener2.onTimeOut();
                    }
            ...
            if (onAdLoadListener != null) {
                onAdLoadListener.onError(new TanxError("loadSplashAd异常:" + LogUtils.getStackTraceMessage(e2)));
