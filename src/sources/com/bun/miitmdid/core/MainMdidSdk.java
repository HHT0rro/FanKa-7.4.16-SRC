...
public class MainMdidSdk implements IIdentifierListener {
    ...
    @Keep
    public MainMdidSdk(boolean z10) {
    }

    private int _InnerFailed(int i10, IdSupplier idSupplier) {
        return ((Integer) Utils.rL(new Object[]{this, Integer.valueOf(i10), idSupplier, 24, 1598952044246L})).intValue();
    }

    @Keep
    public int OnInit(Context context, IIdentifierListener iIdentifierListener) {
        return ((Integer) Utils.rL(new Object[]{this, context, iIdentifierListener, 25, 1598952044247L})).intValue();
    }

    @Override // com.bun.miitmdid.interfaces.IIdentifierListener
    public void OnSupport(boolean z10, IdSupplier idSupplier) {
        Utils.rL(new Object[]{this, Boolean.valueOf(z10), idSupplier, 26, 1598952044248L});
    }
}
