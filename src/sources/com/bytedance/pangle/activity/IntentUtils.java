...
public class IntentUtils {
    ...
    public static HashMap<Long, WeakReference<Bundle>> f10623a = new HashMap<>();
    ...
    public static void a(Intent intent, String str) {
        ...
        if (longExtra != 0) {
            ...
            f10623a.put(Long.valueOf(longExtra), new WeakReference<>(extras));
    ...
    public static void a(Intent intent) {
        long longExtra = intent.getLongExtra("pangle_use_memory", 0L);
        if (longExtra != 0) {
            WeakReference<Bundle> remove = f10623a.remove(Long.valueOf(longExtra));
