...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    @Override // com.alibaba.security.common.http.okio.BufferedSource, com.alibaba.security.common.http.okio.BufferedSink
    public Buffer buffer() {
        return this;
    }
    ...
    @Override // com.alibaba.security.common.http.okio.BufferedSource
    ...
    public final byte getByte(long j10) {
        int i10;
        RPOkioUtil.checkOffsetAndCount(this.size, j10, 1L);
        long j11 = this.size;
        if (j11 - j10 > j10) {
            Segment segment = this.head;
            while (true) {
    ...
    public InputStream inputStream() {
        return new InputStream() { // from class: com.alibaba.security.common.http.okio.Buffer.2
    ...
    public OutputStream outputStream() {
        return new OutputStream() { // from class: com.alibaba.security.common.http.okio.Buffer.1
    ...
    public BufferedSource peek() {
        return RPOkio.buffer(new PeekSource(this));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x003d, code lost:
        ...
        r1 = new com.alibaba.security.common.http.okio.Buffer().writeDecimalLong(r3).writeByte((int) r15);
     */
    ...
    */
    public long readDecimalLong() {
        /*
            ...
            r9 = 0
        L14:
            com.alibaba.security.common.http.okio.Segment r10 = r0.head
            byte[] r11 = r10.data
            int r12 = r10.pos
            int r13 = r10.limit
        L1c:
        ...
        L36:
            ...
            goto L74
        L3d:
            com.alibaba.security.common.http.okio.Buffer r1 = new com.alibaba.security.common.http.okio.Buffer
            r1.<init>()
            com.alibaba.security.common.http.okio.Buffer r1 = r1.writeDecimalLong(r3)
            com.alibaba.security.common.http.okio.Buffer r1 = r1.writeByte(r15)
            if (r8 != 0) goto L4f
            r1.readByte()
        L4f:
        ...
        L9d:
            if (r12 != r13) goto La9
            com.alibaba.security.common.http.okio.Segment r1 = r10.pop()
            r0.head = r1
            com.alibaba.security.common.http.okio.SegmentPool.recycle(r10)
            goto Lab
        La9:
            r10.pos = r12
        Lab:
            if (r9 != 0) goto Lb9
            com.alibaba.security.common.http.okio.Segment r1 = r0.head
            if (r1 != 0) goto Lb2
            goto Lb9
        Lb2:
            r1 = -922337203685477580(0xf333333333333334, double:-8.390303882365713E246)
        ...
        Lc4:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alibaba.security.common.http.okio.Buffer.readDecimalLong():long");
    }
    ...
    */
    public long readHexadecimalUnsignedLong() {
        /*
            ...
            r1 = 0
        Lb:
            com.alibaba.security.common.http.okio.Segment r6 = r15.head
            byte[] r7 = r6.data
            int r8 = r6.pos
            int r9 = r6.limit
        L13:
        ...
        L3a:
            ...
            goto L13
        L4a:
            com.alibaba.security.common.http.okio.Buffer r0 = new com.alibaba.security.common.http.okio.Buffer
            r0.<init>()
            com.alibaba.security.common.http.okio.Buffer r0 = r0.writeHexadecimalUnsignedLong(r4)
            com.alibaba.security.common.http.okio.Buffer r0 = r0.writeByte(r10)
            java.lang.NumberFormatException r1 = new java.lang.NumberFormatException
            java.lang.StringBuilder r2 = new java.lang.StringBuilder
            r2.<init>()
        ...
        L91:
            if (r8 != r9) goto L9d
            com.alibaba.security.common.http.okio.Segment r7 = r6.pop()
            r15.head = r7
            com.alibaba.security.common.http.okio.SegmentPool.recycle(r6)
            goto L9f
        L9d:
            r6.pos = r8
        L9f:
        ...
        Lac:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alibaba.security.common.http.okio.Buffer.readHexadecimalUnsignedLong():long");
    }
    ...
    public int readIntLe() {
        return RPOkioUtil.reverseBytesInt(readInt());
    }
    ...
    public long readLongLe() {
        return RPOkioUtil.reverseBytesLong(readLong());
    }
    ...
    public short readShortLe() {
        return RPOkioUtil.reverseBytesShort(readShort());
    }
    ...
    public String readUtf8() {
        try {
            return readString(this.size, RPOkioUtil.UTF_8);
        } catch (EOFException e2) {
            throw new AssertionError(e2);
        }
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public int selectPrefix(com.alibaba.security.common.http.okio.Options r18, boolean r19) {
        /*
            Method dump skipped, instructions count: 161
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alibaba.security.common.http.okio.Buffer.selectPrefix(com.alibaba.security.common.http.okio.Options, boolean):int");
    }
    ...
    public final Buffer copyTo(OutputStream outputStream, long j10, long j11) throws IOException {
        if (outputStream != null) {
            RPOkioUtil.checkOffsetAndCount(this.size, j10, j11);
            if (j11 == 0) {
                return this;
            }
            Segment segment = this.head;
    ...
    @Override // com.alibaba.security.common.http.okio.BufferedSource
    public int read(byte[] bArr, int i10, int i11) {
        RPOkioUtil.checkOffsetAndCount(bArr.length, i10, i11);
        Segment segment = this.head;
        if (segment == null) {
            return -1;
        }
    ...
    public Buffer writeIntLe(int i10) {
        return writeInt(RPOkioUtil.reverseBytesInt(i10));
    }
    ...
    public Buffer writeLongLe(long j10) {
        return writeLong(RPOkioUtil.reverseBytesLong(j10));
    }
    ...
    public Buffer writeShortLe(int i10) {
        return writeShort((int) RPOkioUtil.reverseBytesShort((short) i10));
    }

    public final Buffer writeTo(OutputStream outputStream, long j10) throws IOException {
        if (outputStream != null) {
            RPOkioUtil.checkOffsetAndCount(this.size, 0L, j10);
            Segment segment = this.head;
            while (j10 > 0) {
    ...
    public String readUtf8(long j10) throws EOFException {
        return readString(j10, RPOkioUtil.UTF_8);
    }
    ...
    public Buffer writeString(String str, int i10, int i11, Charset charset) {
        ...
        if (i11 >= i10) {
            if (i11 <= str.length()) {
                if (charset != null) {
                    if (charset.equals(RPOkioUtil.UTF_8)) {
    ...
    public Buffer write(byte[] bArr, int i10, int i11) {
        if (bArr != null) {
            long j10 = i11;
            RPOkioUtil.checkOffsetAndCount(bArr.length, i10, j10);
            int i12 = i11 + i10;
            while (i10 < i12) {
                Segment writableSegment = writableSegment(1);
