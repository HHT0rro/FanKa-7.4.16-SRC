...
public interface INoCaptchaComponent extends IComponent {
    ...
    public static final String f4173x1 = "x1";

    /* renamed from: x2, reason: collision with root package name */
    public static final String f4174x2 = "x2";
    public static final String y1 = "y1";

    /* renamed from: y2, reason: collision with root package name */
    public static final String f4175y2 = "y2";

    void initNoCaptcha(String str, String str2, int i10, int i11, int i12, Handler handler, String str3) throws SecException;

    String noCaptchaForwardAuth(String str, HashMap<String, String> hashMap, String str2, int i10) throws SecException;
