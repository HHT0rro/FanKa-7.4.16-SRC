...
public interface IStaticKeyEncryptComponent extends IComponent {
    ...
    byte[] decrypt(int i10, String str, byte[] bArr) throws SecException;

    byte[] encrypt(int i10, String str, byte[] bArr) throws SecException;

    byte[] encryptSecretData(int i10, String str, String str2) throws SecException;
