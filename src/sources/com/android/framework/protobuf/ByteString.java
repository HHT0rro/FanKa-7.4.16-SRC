 ...
 */
    ...
    private static final class SystemByteArrayCopier implements ByteArrayCopier {
        ...
        public byte[] copyFrom(byte[] bytes, int offset, int size) {
            ...
            System.arraycopy((Object) bytes, offset, (Object) copy, 0, size);
            return copy;
        }
    }
 ...
 */
    ...
    public static ByteString fromHex(String hexString) {
        ...
        for (int i10 = 0; i10 < bytes.length; i10++) {
            int d12 = extractHexDigit(hexString, i10 * 2);
            int d22 = extractHexDigit(hexString, (i10 * 2) + 1);
            bytes[i10] = (byte) ((d12 << 4) | d22);
        }
    ...
    public final ByteString concat(ByteString other) {
        if (Integer.MAX_VALUE - size() < other.size()) {
            throw new IllegalArgumentException("ByteString would be too long: " + size() + BadgeDrawable.DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX + other.size());
        }
    ...
    public static ByteString copyFrom(Iterable<ByteString> byteStrings) {
        ...
        if (!(byteStrings instanceof Collection)) {
            tempSize = 0;
            Iterator<ByteString> iter = byteStrings.iterator2();
            while (iter.hasNext()) {
                iter.next();
                tempSize++;
            }
        ...
        return balancedConcat(byteStrings.iterator2(), tempSize);
    }
 ...
 */
    ...
    public static final class Output extends OutputStream {
        ...
        @Override // java.io.OutputStream
        public synchronized void write(byte[] b4, int offset, int length) {
            byte[] bArr = this.buffer;
            int length2 = bArr.length;
            int i10 = this.bufferPos;
            if (length <= length2 - i10) {
                System.arraycopy((Object) b4, offset, (Object) bArr, i10, length);
                this.bufferPos += length;
            } else {
                int copySize = bArr.length - i10;
                System.arraycopy((Object) b4, offset, (Object) bArr, i10, copySize);
                int length3 = length - copySize;
                flushFullBuffer(length3);
                System.arraycopy((Object) b4, offset + copySize, (Object) this.buffer, 0, length3);
        ...
        private byte[] copyArray(byte[] buffer, int length) {
            ...
            System.arraycopy((Object) buffer, 0, (Object) result, 0, Math.min(buffer.length, length));
            return result;
        }
        ...
        private void flushLastBuffer() {
            ...
            if (i10 < bArr.length) {
                if (i10 > 0) {
                    byte[] bufferCopy = copyArray(bArr, i10);
 ...
 */
    ...
    public static class LiteralByteString extends LeafByteString {
        ...
        protected void copyToInternal(byte[] target, int sourceOffset, int targetOffset, int numberToCopy) {
            System.arraycopy((Object) this.bytes, sourceOffset, (Object) target, targetOffset, numberToCopy);
        }
        ...
        @Override // com.android.framework.protobuf.ByteString
        protected final int partialHash(int h10, int offset, int length) {
 ...
 */
    ...
    public static final class BoundedByteString extends LiteralByteString {
        ...
        @Override // com.android.framework.protobuf.ByteString.LiteralByteString, com.android.framework.protobuf.ByteString
        protected void copyToInternal(byte[] target, int sourceOffset, int targetOffset, int numberToCopy) {
            System.arraycopy((Object) this.bytes, getOffsetIntoBytes() + sourceOffset, (Object) target, targetOffset, numberToCopy);
        }
