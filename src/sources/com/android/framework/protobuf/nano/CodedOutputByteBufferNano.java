    ...
    private static void encodeDirect(CharSequence sequence, ByteBuffer byteBuffer) {
        ...
        while (i10 < utf16Length) {
            ...
            if (c4 < 128) {
                ...
                byteBuffer.put((byte) ((c4 >>> 6) | 960));
                byteBuffer.put((byte) (128 | (c4 & '?')));
            } else if (c4 < 55296 || 57343 < c4) {
                byteBuffer.put((byte) ((c4 >>> '\f') | 480));
                byteBuffer.put((byte) (((c4 >>> 6) & 63) | 128));
                byteBuffer.put((byte) (128 | (c4 & '?')));
            } else {
                if (i10 + 1 != sequence.length()) {
                    i10++;
                    char low = sequence.charAt(i10);
                ...
                throw new IllegalArgumentException("Unpaired surrogate at index " + (i10 - 1));
            }
            i10++;
        }
    }
