 ...
 */
    ...
    public static abstract class Builder<MessageType extends AbstractMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> implements MessageLite.Builder {
        ...
        public abstract BuilderType mo1996clone();
 ...
 */
        ...
        public static final class LimitedInputStream extends FilterInputStream {
            ...
            public int read(byte[] b4, int off, int len) throws IOException {
                ...
                int result = super.read(b4, off, Math.min(len, i10));
                if (result >= 0) {
                    this.limit -= result;
                }
                return result;
            ...
            public long skip(long n10) throws IOException {
                int result = (int) super.skip(Math.min(n10, this.limit));
                if (result >= 0) {
                    this.limit -= result;
                }
                return result;
        ...
        private static <T> void addAllCheckingNulls(Iterable<T> values, List<? super T> list) {
            ...
            for (T value : values) {
                if (value == null) {
                    ...
                    for (int i10 = list.size() - 1; i10 >= begin; i10--) {
                        list.remove(i10);
                    }
            ...
            if (values instanceof LazyStringList) {
                ...
                for (Object value : lazyValues) {
                    if (value == null) {
                        ...
                        for (int i10 = lazyList.size() - 1; i10 >= begin; i10--) {
                            lazyList.remove(i10);
                        }
                        throw new NullPointerException(message);
                    }
                    if (value instanceof ByteString) {
                        ...
                        lazyList.add((LazyStringList) value);
                    }
                }
                return;
            }
