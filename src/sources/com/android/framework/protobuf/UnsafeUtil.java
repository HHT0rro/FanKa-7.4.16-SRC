...
public final class UnsafeUtil {
    ...
    static void copyMemory(byte[] src, long srcIndex, byte[] target, long targetIndex, long length) {
        System.arraycopy((Object) src, (int) srcIndex, (Object) target, (int) targetIndex, (int) length);
    }
        ...
        try {
            Unsafe unsafe = (Unsafe) AccessController.doPrivileged(new PrivilegedExceptionAction<Unsafe>() { // from class: com.android.framework.protobuf.UnsafeUtil.1
                ...
                public Unsafe run() throws Exception {
                    for (Field f10 : Unsafe.class.getDeclaredFields()) {
                        f10.setAccessible(true);
                        Object x10 = f10.get(null);
                        if (Unsafe.class.isInstance(x10)) {
                            return (Unsafe) Unsafe.class.cast(x10);
                        }
                    }
                    return null;
                }
    ...
    private static Field bufferAddressField() {
        ...
        Field field2 = field(Buffer.class, TextClassifier.TYPE_ADDRESS);
    ...
    private static int firstDifferingByteIndexNativeEndian(long left, long right) {
        int n10;
        if (IS_BIG_ENDIAN) {
            n10 = Long.numberOfLeadingZeros(left ^ right);
        } else {
            n10 = Long.numberOfTrailingZeros(left ^ right);
        }
        return n10 >> 3;
    }
    ...
    static int mismatch(byte[] left, int leftOff, byte[] right, int rightOff, int length) {
        ...
        if (HAS_UNSAFE_ARRAY_OPERATIONS) {
            ...
            while (index < strideLength) {
                ...
                long leftLongWord = getLong((Object) left, leftOff + j10 + index);
                long rightLongWord = getLong((Object) right, j10 + rightOff + index);
    ...
    public static abstract class MemoryAccessor {
        ...
        public boolean supportsUnsafeArrayOperations() {
            ...
            try {
                ...
                UnsafeUtil.logMissingMethod(e2);
                return false;
            }
        }
 ...
 */
    ...
    public static void logMissingMethod(Throwable e2) {
        Logger.getLogger(UnsafeUtil.class.getName()).log(Level.WARNING, "platform method missing - proto runtime falling back to safer methods: " + ((Object) e2));
    }
}
