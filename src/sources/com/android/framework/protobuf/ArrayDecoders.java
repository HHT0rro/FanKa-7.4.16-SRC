 ...
 */
    ...
    public static int decodeVarint32(int firstByte, byte[] data, int position, Registers registers) {
        ...
        int position2 = position + 1;
        byte b22 = data[position];
        if (b22 >= 0) {
            registers.int1 = (b22 << 7) | value;
            return position2;
        }
        int value2 = value | ((b22 & Byte.MAX_VALUE) << 7);
        int position3 = position2 + 1;
        byte b32 = data[position2];
        if (b32 >= 0) {
            registers.int1 = (b32 << 14) | value2;
            return position3;
        }
        int value3 = value2 | ((b32 & Byte.MAX_VALUE) << 14);
        ...
        byte b52 = data[position4];
        if (b52 >= 0) {
            registers.int1 = (b52 << 28) | value4;
            return position5;
        }
        int value5 = value4 | ((b52 & Byte.MAX_VALUE) << 28);
        while (true) {
    ...
    public static int mergeMessageField(Object msg, Schema schema, byte[] bArr, int position, int limit, Registers registers) throws IOException {
        ...
        int i10 = bArr[position];
        if (i10 >= 0) {
            position2 = position3;
        } else {
            int position4 = decodeVarint32(i10, bArr, position3, registers);
            i10 = registers.int1;
            position2 = position4;
        }
        if (i10 < 0 || i10 > limit - position2) {
            throw InvalidProtocolBufferException.truncatedMessage();
        }
        schema.mergeFrom(msg, bArr, position2, position2 + i10, registers);
        registers.object1 = msg;
        return position2 + i10;
    }
        ...
        if (extension.descriptor.isRepeated() && extension.descriptor.isPacked()) {
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[extension.getLiteType().ordinal()]) {
                ...
                case 14:
                    ...
                    return position12;
                default:
                    throw new IllegalStateException("Type cannot be packed: " + ((Object) extension.descriptor.getLiteType()));
            }
        }
        Object value = null;
