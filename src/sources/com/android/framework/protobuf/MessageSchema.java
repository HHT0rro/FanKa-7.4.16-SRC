...
public final class MessageSchema<T> implements Schema<T> {
    ...
    static <T> MessageSchema<T> newSchemaForRawMessageInfo(RawMessageInfo messageInfo, NewInstanceSchema newInstanceSchema, ListFieldSchema listFieldSchema, UnknownFieldSchema<?, ?> unknownFieldSchema, ExtensionSchema<?> extensionSchema, MapFieldSchema mapFieldSchema) {
        ...
        int i26 = 55296;
        if (next16 >= 55296) {
            int result = next16 & HmsScanBase.ALL_SCAN_TYPE;
            int shift = 13;
            while (true) {
                i24 = i25 + 1;
                next15 = info2.charAt(i25);
                if (next15 < 55296) {
                    break;
                }
                result |= (next15 & HmsScanBase.ALL_SCAN_TYPE) << shift;
                shift += 13;
                i25 = i24;
            }
        ...
        int i27 = i25 + 1;
        int next17 = info2.charAt(i25);
        if (next17 >= 55296) {
            int result2 = next17 & HmsScanBase.ALL_SCAN_TYPE;
            int shift2 = 13;
            while (true) {
                i23 = i27 + 1;
                next14 = info2.charAt(i27);
                if (next14 < 55296) {
                    break;
                }
                result2 |= (next14 & HmsScanBase.ALL_SCAN_TYPE) << shift2;
                shift2 += 13;
                i27 = i23;
            }
        ...
        if (fieldCount == 0) {
            ...
            int i28 = i27 + 1;
            int next18 = info2.charAt(i27);
            if (next18 >= 55296) {
                int result3 = next18 & HmsScanBase.ALL_SCAN_TYPE;
                int shift3 = 13;
                while (true) {
                    i17 = i28 + 1;
                    next8 = info2.charAt(i28);
                    if (next8 < 55296) {
                        break;
                    }
                    result3 |= (next8 & HmsScanBase.ALL_SCAN_TYPE) << shift3;
                    shift3 += 13;
                    i28 = i17;
                }
            ...
            int result4 = next18;
            int i29 = i28 + 1;
            int next19 = info2.charAt(i28);
            if (next19 >= 55296) {
                int result5 = next19 & HmsScanBase.ALL_SCAN_TYPE;
                int shift4 = 13;
                while (true) {
                    i16 = i29 + 1;
                    next7 = info2.charAt(i29);
                    if (next7 < 55296) {
                        break;
                    }
                    result5 |= (next7 & HmsScanBase.ALL_SCAN_TYPE) << shift4;
                    shift4 += 13;
                    i29 = i16;
                }
            ...
            int result6 = next19;
            int i30 = i29 + 1;
            int next20 = info2.charAt(i29);
            if (next20 >= 55296) {
                int result7 = next20 & HmsScanBase.ALL_SCAN_TYPE;
                int shift5 = 13;
                while (true) {
                    i15 = i30 + 1;
                    next6 = info2.charAt(i30);
                    if (next6 < 55296) {
                        break;
                    }
                    result7 |= (next6 & HmsScanBase.ALL_SCAN_TYPE) << shift5;
                    shift5 += 13;
                    i30 = i15;
                }
            ...
            int result8 = next20;
            int i31 = i30 + 1;
            int next21 = info2.charAt(i30);
            if (next21 >= 55296) {
                int result9 = next21 & HmsScanBase.ALL_SCAN_TYPE;
                int shift6 = 13;
                while (true) {
                    i14 = i31 + 1;
                    next5 = info2.charAt(i31);
                    if (next5 < 55296) {
                        break;
                    }
                    result9 |= (next5 & HmsScanBase.ALL_SCAN_TYPE) << shift6;
                    shift6 += 13;
                    i31 = i14;
                }
            ...
            int result10 = next21;
            int i32 = i31 + 1;
            int next22 = info2.charAt(i31);
            if (next22 >= 55296) {
                int result11 = next22 & HmsScanBase.ALL_SCAN_TYPE;
                int shift7 = 13;
                while (true) {
                    i13 = i32 + 1;
                    next4 = info2.charAt(i32);
                    if (next4 < 55296) {
                        break;
                    }
                    result11 |= (next4 & HmsScanBase.ALL_SCAN_TYPE) << shift7;
                    shift7 += 13;
                    i32 = i13;
                }
            ...
            int result12 = next22;
            int i33 = i32 + 1;
            int next23 = info2.charAt(i32);
            if (next23 >= 55296) {
                int result13 = next23 & HmsScanBase.ALL_SCAN_TYPE;
                int shift8 = 13;
                while (true) {
                    i12 = i33 + 1;
                    next3 = info2.charAt(i33);
                    if (next3 < 55296) {
                        break;
                    }
                    result13 |= (next3 & HmsScanBase.ALL_SCAN_TYPE) << shift8;
                    shift8 += 13;
                    i33 = i12;
                }
            ...
            int result14 = next23;
            int i34 = i33 + 1;
            int next24 = info2.charAt(i33);
            if (next24 >= 55296) {
                int result15 = next24 & HmsScanBase.ALL_SCAN_TYPE;
                int shift9 = 13;
                while (true) {
                    i11 = i34 + 1;
                    next2 = info2.charAt(i34);
                    if (next2 < 55296) {
                        break;
                    }
                    result15 |= (next2 & HmsScanBase.ALL_SCAN_TYPE) << shift9;
                    shift9 += 13;
                    i34 = i11;
                }
            ...
            int result16 = next24;
            int i35 = i34 + 1;
            next17 = info2.charAt(i34);
            if (next17 >= 55296) {
                int result17 = next17 & HmsScanBase.ALL_SCAN_TYPE;
                int shift10 = 13;
                while (true) {
                    i10 = i35 + 1;
                    next = info2.charAt(i35);
                    if (next < 55296) {
                        break;
                    }
                    result17 |= (next & HmsScanBase.ALL_SCAN_TYPE) << shift10;
                    shift10 += 13;
                    i35 = i10;
                }
        ...
        while (i36 < length) {
            int i37 = i36 + 1;
            int next25 = info2.charAt(i36);
            if (next25 >= i26) {
                int result19 = next25 & HmsScanBase.ALL_SCAN_TYPE;
                int shift11 = 13;
                while (true) {
                    i22 = i37 + 1;
                    next13 = info2.charAt(i37);
                    if (next13 < i26) {
                        break;
                    }
                    result19 |= (next13 & HmsScanBase.ALL_SCAN_TYPE) << shift11;
                    shift11 += 13;
                    i37 = i22;
                }
            ...
            int result20 = next25;
            int i38 = i37 + 1;
            int next26 = info2.charAt(i37);
            if (next26 >= i26) {
                int result21 = next26 & HmsScanBase.ALL_SCAN_TYPE;
                int shift12 = 13;
                while (true) {
                    i21 = i38 + 1;
                    next12 = info2.charAt(i38);
                    if (next12 < i26) {
                        break;
                    }
                    result21 |= (next12 & HmsScanBase.ALL_SCAN_TYPE) << shift12;
                    shift12 += 13;
                    i38 = i21;
                }
            ...
            if (fieldType >= 51) {
                i36 = i38 + 1;
                int next27 = info2.charAt(i38);
                if (next27 >= i26) {
                    int result23 = next27 & HmsScanBase.ALL_SCAN_TYPE;
                    int shift13 = 13;
                    while (true) {
                        i20 = i36 + 1;
                        next11 = info2.charAt(i36);
                        if (next11 < i26) {
                            break;
                        }
                        result23 |= (next11 & HmsScanBase.ALL_SCAN_TYPE) << shift13;
                        shift13 += 13;
                        i36 = i20;
                    }
                ...
                Object o10 = messageInfoObjects[index];
                if (o10 instanceof Field) {
                    oneofField = (Field) o10;
                } else {
                    oneofField = reflectField(messageClass, (String) o10);
                    messageInfoObjects[index] = oneofField;
                }
                fieldNumber = result20;
                fieldOffset = (int) unsafe.objectFieldOffset(oneofField);
                int index2 = index + 1;
                Object o11 = messageInfoObjects[index2];
                if (o11 instanceof Field) {
                    oneofCaseField = (Field) o11;
                } else {
                    oneofCaseField = reflectField(messageClass, (String) o11);
                ...
                boolean hasHasBit = (result22 & 4096) == 4096 ? z10 : false;
                if (!hasHasBit || fieldType > 17) {
                    ...
                    i18 = i39 + 1;
                    int next28 = info2.charAt(i39);
                    if (next28 < 55296) {
                        info = info2;
                    } else {
                        int result25 = next28 & HmsScanBase.ALL_SCAN_TYPE;
                        int shift14 = 13;
                        while (true) {
                            i19 = i18 + 1;
                            next10 = info2.charAt(i18);
                            info = info2;
                            if (next10 < 55296) {
                                break;
                            }
                            result25 |= (next10 & HmsScanBase.ALL_SCAN_TYPE) << shift14;
                            shift14 += 13;
                            i18 = i19;
                            info2 = info;
                        }
                    ...
                    Object o12 = messageInfoObjects[index3];
                    oneofCount2 = oneofCount;
                    if (o12 instanceof Field) {
                        hasBitsField = (Field) o12;
                    } else {
                        hasBitsField = reflectField(messageClass, (String) o12);
    ...
    */
    ...
    private void mergeMessage(T targetParent, T sourceParent, int pos) {
        ...
        if (source == null) {
            throw new IllegalStateException("Source subfield " + numberAt(pos) + " is present but null: " + ((Object) sourceParent));
        }
    ...
    private int getSerializedSizeProto2(T message) {
        ...
        while (i10 < this.buffer.length) {
            int typeAndOffset = typeAndOffsetAt(i10);
            int number = numberAt(i10);
            ...
            if (fieldType > 17) {
                if (this.useCachedSizeField && fieldType >= FieldType.DOUBLE_LIST_PACKED.id() && fieldType <= FieldType.SINT64_LIST_PACKED.id()) {
                    presenceMaskAndOffset = this.buffer[i10 + 2] & 1048575;
                }
            } else {
                presenceMaskAndOffset = this.buffer[i10 + 2];
            ...
            switch (fieldType) {
                case 0:
                    ...
                    if (currentPresenceFieldOffset3 == 0) {
                        ...
                        size += CodedOutputStream.computeDoubleSize(number, ShadowDrawableWrapper.COS_45);
                        break;
                    }
                case 1:
                    currentPresenceFieldOffset = currentPresenceFieldOffset2;
                ...
                case 9:
                    ...
                    if (currentPresenceFieldOffset12 == 0) {
                        ...
                        size += SchemaUtil.computeSizeMessage(number, unsafe.getObject(message, offset), getMessageFieldSchema(i10));
                        break;
                    }
                case 10:
                    currentPresenceFieldOffset = currentPresenceFieldOffset2;
                ...
                case 17:
                    ...
                    if (currentPresenceFieldOffset20 == 0) {
                        ...
                        size += CodedOutputStream.computeGroupSize(number, (MessageLite) unsafe.getObject(message, offset), getMessageFieldSchema(i10));
                        break;
                    }
                case 18:
                    currentPresenceFieldOffset = currentPresenceFieldOffset2;
                ...
                case 27:
                    currentPresenceFieldOffset = currentPresenceFieldOffset2;
                    size += SchemaUtil.computeSizeMessageList(number, (List) unsafe.getObject(message, offset), getMessageFieldSchema(i10));
                    break;
                case 28:
                    currentPresenceFieldOffset = currentPresenceFieldOffset2;
                ...
                case 49:
                    currentPresenceFieldOffset = currentPresenceFieldOffset2;
                    size += SchemaUtil.computeSizeGroupList(number, (List) unsafe.getObject(message, offset), getMessageFieldSchema(i10));
                    break;
                case 50:
                    currentPresenceFieldOffset = currentPresenceFieldOffset2;
                    size += this.mapFieldSchema.getSerializedSize(number, unsafe.getObject(message, offset), getMapFieldDefaultEntry(i10));
                    break;
                case 51:
                    if (!isOneofPresent(message, number, i10)) {
                        currentPresenceFieldOffset = currentPresenceFieldOffset2;
                        break;
                    } else {
                        size += CodedOutputStream.computeDoubleSize(number, ShadowDrawableWrapper.COS_45);
    ...
    private int getSerializedSizeProto3(T message) {
        ...
        for (int i10 = 0; i10 < this.buffer.length; i10 += 3) {
            ...
            if (fieldType >= FieldType.DOUBLE_LIST_PACKED.id() && fieldType <= FieldType.SINT64_LIST_PACKED.id()) {
                cachedSizeOffset = this.buffer[i10 + 2] & 1048575;
            } else {
                cachedSizeOffset = 0;
            }
            switch (fieldType) {
                ...
                case 9:
                    if (isFieldPresent(message, i10)) {
                        size += SchemaUtil.computeSizeMessage(number, UnsafeUtil.getObject(message, offset), getMessageFieldSchema(i10));
                        break;
                    } else {
                        break;
                    }
                ...
                case 17:
                    if (isFieldPresent(message, i10)) {
                        size += CodedOutputStream.computeGroupSize(number, (MessageLite) UnsafeUtil.getObject(message, offset), getMessageFieldSchema(i10));
                        break;
                    } else {
                        break;
                    }
                ...
                case 26:
                    ...
                    break;
                case 27:
                    size += SchemaUtil.computeSizeMessageList(number, listAt(message, offset), getMessageFieldSchema(i10));
                    break;
                case 28:
                ...
                case 49:
                    size += SchemaUtil.computeSizeGroupList(number, listAt(message, offset), getMessageFieldSchema(i10));
                    break;
                case 50:
                    size += this.mapFieldSchema.getSerializedSize(number, UnsafeUtil.getObject(message, offset), getMapFieldDefaultEntry(i10));
                    break;
                case 51:
                    if (isOneofPresent(message, number, i10)) {
                        size += CodedOutputStream.computeDoubleSize(number, ShadowDrawableWrapper.COS_45);
 ...
 */
    ...
    private int parseRepeatedField(T message, byte[] data, int position, int limit, int tag, int number, int wireType, int bufferPosition, long typeAndOffset, int fieldType, long fieldOffset, ArrayDecoders.Registers registers) throws IOException {
        ...
        switch (fieldType) {
            ...
            case 26:
                ...
                if (wireType == 2) {
                    return (typeAndOffset & HttpProxyCacheServer.Builder.DEFAULT_MAX_SIZE) == 0 ? ArrayDecoders.decodeStringList(tag, data, position, limit, list11, registers) : ArrayDecoders.decodeStringListRequireUtf8(tag, data, position, limit, list11, registers);
                }
                position2 = position;
                return position2;
            case 27:
    ...
    public int parseProto2Message(T message, byte[] data, int position, int limit, int endGroup, ArrayDecoders.Registers registers) throws IOException {
                    ...
                    if (fieldType <= 17) {
                        ...
                        if (presenceFieldOffset2 == currentPresenceFieldOffset3) {
                            ...
                            if (currentPresenceFieldOffset3 == 1048575) {
                                ...
                                position5 = position3;
                                unsafe2.putInt(t10, currentPresenceFieldOffset3, currentPresenceField2);
                            }
                            currentPresenceField2 = unsafe2.getInt(t10, presenceFieldOffset2);
                        ...
                        switch (fieldType) {
                            case 0:
                                ...
                                if (presenceFieldOffset == 1) {
                                    UnsafeUtil.putDouble(t10, fieldOffset, ArrayDecoders.decodeDouble(data, currentPresenceFieldOffset2));
                            ...
                            case 1:
                                ...
                                if (presenceFieldOffset == 5) {
                                    UnsafeUtil.putFloat(t10, fieldOffset, ArrayDecoders.decodeFloat(data, currentPresenceFieldOffset2));
                            ...
                            case 11:
                                ...
                                if (presenceFieldOffset == 0) {
                                    ...
                                    unsafe2.putInt(t10, fieldOffset, registers3.int1);
                                    currentPresenceField2 |= presenceMask;
                                    pos4 = limit;
                                    wireType2 = endGroup;
                                    pos5 = pos8;
                            ...
                            case 13:
                                ...
                                tag4 = tag8;
                                if (presenceFieldOffset == 5) {
                                    unsafe2.putInt(t10, fieldOffset, ArrayDecoders.decodeFixed32(data, currentPresenceFieldOffset2));
                            ...
                            case 7:
                                ...
                                if (presenceFieldOffset != 0) {
                                    ...
                                    UnsafeUtil.putBoolean(t10, fieldOffset, registers3.long1 != 0);
                                    currentPresenceField2 |= presenceMask;
                                    pos4 = limit;
                                    wireType2 = endGroup;
                                    pos5 = pos11;
                            ...
                            case 8:
                                ...
                                if (presenceFieldOffset != 2) {
                                    ...
                                    unsafe2 = unsafe3;
                                    unsafe2.putObject(t10, fieldOffset, registers3.object1);
                                    currentPresenceField2 |= presenceMask;
                                    pos4 = limit;
                                    wireType2 = endGroup;
                                    pos5 = pos12;
                            ...
                            case 9:
                                ...
                                if (presenceFieldOffset != 2) {
                                    ...
                                    Object current = messageSchema2.mutableMessageFieldForMerge(t10, pos13);
                                    ...
                                    messageSchema2.storeMessageField(t10, pos13, current);
                                    currentPresenceField2 |= presenceMask;
                                    pos4 = limit;
                                    wireType2 = endGroup;
                                    pos5 = pos13;
                            ...
                            case 12:
                                ...
                                if (presenceFieldOffset != 0) {
                                    ...
                                    if (enumVerifier == null || enumVerifier.isInRange(enumValue)) {
                                        unsafe2.putInt(t10, fieldOffset, enumValue);
                                        currentPresenceField2 |= presenceMask;
                                        pos4 = limit;
                                        wireType2 = endGroup;
                                        tag5 = tag8;
                            ...
                            case 15:
                                ...
                                if (presenceFieldOffset != 0) {
                                    ...
                                    position6 = ArrayDecoders.decodeVarint32(data, currentPresenceFieldOffset2, registers3);
                                    unsafe2.putInt(t10, fieldOffset, CodedInputStream.decodeZigZag32(registers3.int1));
                                    currentPresenceField2 |= presenceMask;
                                    tag5 = tag8;
                                    pos4 = limit;
                                    wireType2 = endGroup;
                            ...
                            case 17:
                                if (wireType3 == 3) {
                                    Object current2 = messageSchema2.mutableMessageFieldForMerge(t10, pos);
                                    int endTag = pos;
                                    ...
                                    messageSchema2.storeMessageField(t10, endTag, current2);
                                    currentPresenceField2 |= presenceMask;
                                    bArr = data;
                                    tag5 = tag8;
                                    wireType2 = endGroup;
                        ...
                        if (fieldType != 27) {
                            ...
                            Internal.ProtobufList<?> list = (Internal.ProtobufList) unsafe2.getObject(t10, fieldOffset);
                            if (!list.isModifiable()) {
                                int size = list.size();
                                list = list.mutableCopyWithCapacity2(size == 0 ? 10 : size * 2);
                                unsafe2.putObject(t10, fieldOffset, list);
                            }
        ...
        if (currentPresenceFieldOffset3 == 1048575) {
            ...
            t2 = message;
            unsafe.putInt(t2, currentPresenceFieldOffset3, currentPresenceField2);
        }
        UnknownFieldSetLite unknownFields = null;
        for (int i11 = messageSchema.checkInitializedCount; i11 < messageSchema.repeatedFieldOffsetStart; i11++) {
            unknownFields = (UnknownFieldSetLite) filterMapUnknownEnumValues(message, messageSchema.intArray[i11], unknownFields, messageSchema.unknownFieldSchema, message);
        }
        if (unknownFields != null) {
            messageSchema.unknownFieldSchema.setBuilderToMessage(t2, unknownFields);
        }
        if (i10 == 0) {
            if (position2 != limit) {
                throw InvalidProtocolBufferException.parseFailure();
            }
        } else if (position2 > limit || tag != i10) {
            throw InvalidProtocolBufferException.parseFailure();
        }
        return position2;
    }
                ...
                if (fieldType <= 17) {
                    ...
                    if (presenceFieldOffset2 == currentPresenceFieldOffset4) {
                        ...
                        if (currentPresenceFieldOffset4 == 1048575) {
                            ...
                            typeAndOffset = typeAndOffset3;
                            unsafe2.putInt(t2, currentPresenceFieldOffset4, currentPresenceField2);
                        }
                    ...
                    switch (fieldType) {
                        case 0:
                            ...
                            if (currentPresenceFieldOffset2 != 1) {
                                ...
                                UnsafeUtil.putDouble(t2, fieldOffset, ArrayDecoders.decodeDouble(bArr, position3));
                        ...
                        case 1:
                            ...
                            if (currentPresenceFieldOffset2 != 5) {
                                ...
                                UnsafeUtil.putFloat(t2, fieldOffset, ArrayDecoders.decodeFloat(bArr, position3));
                        ...
                        case 13:
                            ...
                            if (currentPresenceFieldOffset2 != 5) {
                                ...
                                unsafe2.putInt(t2, fieldOffset, ArrayDecoders.decodeFixed32(bArr, position3));
                                position5 = position3 + 4;
                                currentPresenceField2 |= presenceMask;
                                pos3 = presenceFieldOffset;
                                oldNumber = number;
                        ...
                        case 8:
                            ...
                            if (currentPresenceFieldOffset2 != 2) {
                                ...
                                unsafe2.putObject(t2, fieldOffset, registers2.object1);
                                currentPresenceField2 |= presenceMask;
                                pos3 = presenceFieldOffset;
                                oldNumber = number;
                                currentPresenceFieldOffset4 = typeAndOffset2;
                        ...
                        case 9:
                            ...
                            if (currentPresenceFieldOffset2 != 2) {
                                ...
                                Object current = messageSchema.mutableMessageFieldForMerge(t2, presenceFieldOffset);
                                ...
                                messageSchema.storeMessageField(t2, presenceFieldOffset, current);
                                currentPresenceField2 |= presenceMask;
                                pos3 = presenceFieldOffset;
                                oldNumber = number;
                                currentPresenceFieldOffset4 = typeAndOffset2;
                        ...
                        case 15:
                            ...
                            if (currentPresenceFieldOffset2 != 0) {
                                ...
                                position5 = ArrayDecoders.decodeVarint32(bArr, position8, registers2);
                                unsafe2.putInt(t2, fieldOffset, CodedInputStream.decodeZigZag32(registers2.int1));
                                currentPresenceField2 |= presenceMask;
                                pos3 = presenceFieldOffset;
                                oldNumber = number;
                                currentPresenceFieldOffset4 = typeAndOffset2;
    ...
    public void makeImmutable(T t2) {
        ...
        if (t2 instanceof GeneratedMessageLite) {
            GeneratedMessageLite<?, ?> generatedMessage = (GeneratedMessageLite) t2;
        ...
        for (int pos = 0; pos < bufferLength; pos += 3) {
            ...
            switch (type(typeAndOffset)) {
                case 9:
                case 17:
                    if (isFieldPresent(t2, pos)) {
                        getMessageFieldSchema(pos).makeImmutable(UNSAFE.getObject(t2, offset));
                        break;
                    } else {
                        break;
                    }
                ...
                case 50:
                    Unsafe unsafe = UNSAFE;
                    Object mapField = unsafe.getObject(t2, offset);
                    if (mapField != null) {
                        unsafe.putObject(t2, offset, this.mapFieldSchema.toImmutable(mapField));
                        break;
                    } else {
                        break;
                    }
