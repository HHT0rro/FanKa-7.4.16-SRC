 ...
 */
    ...
    /* synthetic */ FieldSet(SmallSortedMap x02, AnonymousClass1 x12) {
        this(x02);
    }
    ...
    public void makeImmutable() {
        ...
        for (int i10 = 0; i10 < this.fields.getNumArrayEntries(); i10++) {
            Map.Entry<T, Object> entry = this.fields.getArrayEntryAt(i10);
    ...
    public static <T extends FieldDescriptorLite<T>> SmallSortedMap<T, Object> cloneAllFieldsMap(SmallSortedMap<T, Object> fields, boolean copyList) {
        ...
        for (int i10 = 0; i10 < fields.getNumArrayEntries(); i10++) {
            cloneFieldEntry(result, fields.getArrayEntryAt(i10), copyList);
        }
    ...
    public Object getField(T descriptor) {
        Object o10 = this.fields.get(descriptor);
        if (o10 instanceof LazyField) {
            return ((LazyField) o10).getValue();
        }
        return o10;
    }
    ...
    public static Object cloneIfMutable(Object value) {
        if (value instanceof byte[]) {
            ...
            System.arraycopy((Object) bytes, 0, (Object) copy, 0, bytes.length);
            return copy;
        }
        return value;
    }
 ...
 */
    ...
    public int getMessageSetSerializedSize() {
        int size = 0;
        for (int i10 = 0; i10 < this.fields.getNumArrayEntries(); i10++) {
            size += getMessageSetSerializedSize(this.fields.getArrayEntryAt(i10));
        }
        for (Map.Entry<T, Object> entry : this.fields.getOverflowEntries()) {
