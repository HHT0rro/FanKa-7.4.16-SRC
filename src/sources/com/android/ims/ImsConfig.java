 ...
 */
    ...
    public static class ConfigConstants {
        ...
        public static final int PROVISIONED_CONFIG_END = 100;
        ...
        public static final int USSD_ENABLED = 100;
 ...
 */
    ...
    public int getConfigInt(int item) throws ImsException {
        try {
            ...
            throw new ImsException("getInt()", e2, 131);
        }
    }
    ...
    public String getConfigString(int item) throws ImsException {
        try {
            ...
            throw new ImsException("getConfigString()", e2, 131);
        }
    }
    ...
    public int setConfig(int item, int value) throws ImsException {
        ...
        try {
            ...
            throw new ImsException("setConfig()", e2, 131);
        }
    }
    ...
    public void addConfigCallback(IImsConfigCallback callback) throws ImsException {
        if (this.DBG) {
            Rlog.d(TAG, "addConfigCallback: " + ((Object) callback));
        }
        try {
            this.miConfig.addImsConfigCallback(callback);
        } catch (RemoteException e2) {
            throw new ImsException("addConfigCallback()", e2, 131);
        }
    }

    public void removeConfigCallback(IImsConfigCallback callback) throws ImsException {
        if (this.DBG) {
            Rlog.d(TAG, "removeConfigCallback: " + ((Object) callback));
        }
        try {
            this.miConfig.removeImsConfigCallback(callback);
        } catch (RemoteException e2) {
            throw new ImsException("removeConfigCallback()", e2, 131);
        }
    }
