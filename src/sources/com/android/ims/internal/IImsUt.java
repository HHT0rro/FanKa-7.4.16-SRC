...
public interface IImsUt extends IInterface {
    ...
    int queryCFForServiceClass(int i10, String str, int i11) throws RemoteException;
    ...
    int queryCallBarring(int i10) throws RemoteException;

    int queryCallBarringForServiceClass(int i10, int i11) throws RemoteException;

    int queryCallForward(int i10, String str) throws RemoteException;
    ...
    int updateCLIP(boolean z10) throws RemoteException;

    int updateCLIR(int i10) throws RemoteException;

    int updateCOLP(boolean z10) throws RemoteException;

    int updateCOLR(int i10) throws RemoteException;

    int updateCallBarring(int i10, int i11, String[] strArr) throws RemoteException;

    int updateCallBarringForServiceClass(int i10, int i11, String[] strArr, int i12) throws RemoteException;

    int updateCallBarringWithPassword(int i10, int i11, String[] strArr, int i12, String str) throws RemoteException;

    int updateCallForward(int i10, int i11, String str, int i12, int i13) throws RemoteException;

    int updateCallWaiting(boolean z10, int i10) throws RemoteException;
                ...
                default:
                    switch (code) {
                        ...
                        case 21:
                            ...
                            data.enforceNoDataAvail();
                            int _result19 = queryCFForServiceClass(_arg015, _arg18, _arg25);
                            reply.writeNoException();
