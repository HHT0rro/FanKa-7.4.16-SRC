...
public interface IImsCallSessionListener extends IInterface {
    ...
    void callSessionHandover(IImsCallSession iImsCallSession, int i10, int i11, ImsReasonInfo imsReasonInfo) throws RemoteException;

    void callSessionHandoverFailed(IImsCallSession iImsCallSession, int i10, int i11, ImsReasonInfo imsReasonInfo) throws RemoteException;
    ...
    void callSessionMayHandover(IImsCallSession iImsCallSession, int i10, int i11) throws RemoteException;
    ...
    void callSessionMultipartyStateChanged(IImsCallSession iImsCallSession, boolean z10) throws RemoteException;
    ...
    void callSessionRttModifyResponseReceived(int i10) throws RemoteException;

    void callSessionSendAnbrQuery(int i10, int i11, int i12) throws RemoteException;
    ...
    void callSessionTtyModeReceived(IImsCallSession iImsCallSession, int i10) throws RemoteException;
    ...
    void callSessionUssdMessageReceived(IImsCallSession iImsCallSession, int i10, String str) throws RemoteException;
