...
public interface IImsMMTelFeature extends IInterface {
    ...
    IImsCallSession createCallSession(int i10, ImsCallProfile imsCallProfile) throws RemoteException;

    void endSession(int i10) throws RemoteException;
    ...
    boolean isConnected(int i10, int i11) throws RemoteException;
    ...
    void setUiTTYMode(int i10, Message message) throws RemoteException;
