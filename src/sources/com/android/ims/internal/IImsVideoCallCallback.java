...
public interface IImsVideoCallCallback extends IInterface {
    void changeCallDataUsage(long j10) throws RemoteException;

    void changeCameraCapabilities(VideoProfile.CameraCapabilities cameraCapabilities) throws RemoteException;

    void changePeerDimensions(int i10, int i11) throws RemoteException;

    void changeVideoQuality(int i10) throws RemoteException;

    void handleCallSessionEvent(int i10) throws RemoteException;

    void receiveSessionModifyRequest(VideoProfile videoProfile) throws RemoteException;

    void receiveSessionModifyResponse(int i10, VideoProfile videoProfile, VideoProfile videoProfile2) throws RemoteException;
