...
public interface IPresenceService extends IInterface {
    StatusCode addListener(int i10, IPresenceListener iPresenceListener, UceLong uceLong) throws RemoteException;
    ...
    StatusCode publishMyCap(int i10, PresCapInfo presCapInfo, int i11) throws RemoteException;

    StatusCode reenableService(int i10, int i11) throws RemoteException;

    StatusCode removeListener(int i10, UceLong uceLong) throws RemoteException;

    StatusCode setNewFeatureTag(int i10, String str, PresServiceInfo presServiceInfo, int i11) throws RemoteException;
