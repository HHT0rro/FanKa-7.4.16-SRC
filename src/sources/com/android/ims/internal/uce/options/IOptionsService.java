...
public interface IOptionsService extends IInterface {
    StatusCode addListener(int i10, IOptionsListener iOptionsListener, UceLong uceLong) throws RemoteException;

    StatusCode getContactCap(int i10, String str, int i11) throws RemoteException;

    StatusCode getContactListCap(int i10, String[] strArr, int i11) throws RemoteException;

    StatusCode getMyInfo(int i10, int i11) throws RemoteException;

    StatusCode getVersion(int i10) throws RemoteException;

    StatusCode removeListener(int i10, UceLong uceLong) throws RemoteException;

    StatusCode responseIncomingOptions(int i10, int i11, int i12, String str, OptionsCapInfo optionsCapInfo, boolean z10) throws RemoteException;

    StatusCode setMyInfo(int i10, CapInfo capInfo, int i11) throws RemoteException;
