...
public interface IImsRegistrationListener extends IInterface {
    ...
    void registrationChangeFailed(int i10, ImsReasonInfo imsReasonInfo) throws RemoteException;

    @Deprecated
    void registrationConnected() throws RemoteException;

    void registrationConnectedWithRadioTech(int i10) throws RemoteException;

    void registrationDisconnected(ImsReasonInfo imsReasonInfo) throws RemoteException;

    void registrationFeatureCapabilityChanged(int i10, int[] iArr, int[] iArr2) throws RemoteException;

    @Deprecated
    void registrationProgressing() throws RemoteException;

    void registrationProgressingWithRadioTech(int i10) throws RemoteException;

    void registrationResumed() throws RemoteException;

    void registrationServiceCapabilityChanged(int i10, int i11) throws RemoteException;

    void registrationSuspended() throws RemoteException;

    void voiceMessageCountUpdate(int i10) throws RemoteException;
