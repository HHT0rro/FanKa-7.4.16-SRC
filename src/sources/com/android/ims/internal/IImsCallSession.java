...
public interface IImsCallSession extends IInterface {
    void accept(int i10, ImsStreamMediaProfile imsStreamMediaProfile) throws RemoteException;

    void callSessionNotifyAnbr(int i10, int i11, int i12) throws RemoteException;
    ...
    void reject(int i10) throws RemoteException;
    ...
    void sendDtmf(char c4, Message message) throws RemoteException;
    ...
    void sendRttModifyResponse(boolean z10) throws RemoteException;
    ...
    void startDtmf(char c4) throws RemoteException;

    void stopDtmf() throws RemoteException;

    void terminate(int i10) throws RemoteException;

    void transfer(String str, boolean z10) throws RemoteException;

    void update(int i10, ImsStreamMediaProfile imsStreamMediaProfile) throws RemoteException;
 ...
 */
    ...
    public static class Default implements IImsCallSession {
        ...
        @Override // com.android.ims.internal.IImsCallSession
        public void sendDtmf(char c4, Message result) throws RemoteException {
        }

        @Override // com.android.ims.internal.IImsCallSession
        public void startDtmf(char c4) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IImsCallSession {
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 13:
                    return SecurityConstants.SOCKET_ACCEPT_ACTION;
                case 14:
                    return "deflect";
                case 15:
                    return "reject";
