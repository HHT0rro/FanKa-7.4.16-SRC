...
public interface IImsVideoCallProvider extends IInterface {
    ...
    void setCamera(String str, int i10) throws RemoteException;

    void setDeviceOrientation(int i10) throws RemoteException;
    ...
    void setZoom(float f10) throws RemoteException;
