...
public interface IImsServiceController extends IInterface {
    void addFeatureStatusCallback(int i10, int i11, IImsFeatureStatusCallback iImsFeatureStatusCallback) throws RemoteException;

    IImsMMTelFeature createEmergencyMMTelFeature(int i10) throws RemoteException;

    IImsMMTelFeature createMMTelFeature(int i10) throws RemoteException;

    IImsRcsFeature createRcsFeature(int i10) throws RemoteException;

    void removeFeatureStatusCallback(int i10, int i11, IImsFeatureStatusCallback iImsFeatureStatusCallback) throws RemoteException;

    void removeImsFeature(int i10, int i11) throws RemoteException;
 ...
 */
    ...
    public static class Default implements IImsServiceController {
        ...
        @Override // com.android.ims.internal.IImsServiceController
        public void addFeatureStatusCallback(int slotId, int featureType, IImsFeatureStatusCallback c4) throws RemoteException {
        }

        @Override // com.android.ims.internal.IImsServiceController
        public void removeFeatureStatusCallback(int slotId, int featureType, IImsFeatureStatusCallback c4) throws RemoteException {
        }
