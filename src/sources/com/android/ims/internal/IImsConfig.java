...
public interface IImsConfig extends IInterface {
    void getFeatureValue(int i10, int i11, ImsConfigListener imsConfigListener) throws RemoteException;

    String getProvisionedStringValue(int i10) throws RemoteException;

    int getProvisionedValue(int i10) throws RemoteException;
    ...
    void setFeatureValue(int i10, int i11, int i12, ImsConfigListener imsConfigListener) throws RemoteException;

    int setProvisionedStringValue(int i10, String str) throws RemoteException;

    int setProvisionedValue(int i10, int i11) throws RemoteException;

    void setVideoQuality(int i10, ImsConfigListener imsConfigListener) throws RemoteException;
