 ...
 */
    ...
    private boolean dataValid() {
        return this.mData.size() > 0 && SystemClock.elapsedRealtime() - this.mLastReadTime < 500;
    }
 ...
 */
    ...
    public class BpfMapIterator implements AutoCloseable {
        ...
        public boolean getNextUid(long[] buf) {
            ...
            System.arraycopy((Object) KernelCpuUidBpfMapReader.this.mData.valueAt(this.mPos), 0, (Object) buf, 1, KernelCpuUidBpfMapReader.this.mData.valueAt(this.mPos).length);
            this.mPos++;
            return true;
        }
 ...
 */
    ...
    public static class KernelCpuUidFreqTimeBpfMapReader extends KernelCpuUidBpfMapReader {
        private final native boolean removeUidRange(int i10, int i11);
