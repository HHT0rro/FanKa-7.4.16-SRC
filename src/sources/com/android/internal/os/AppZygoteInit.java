        ...
        protected void handlePreloadApp(ApplicationInfo appInfo) {
            ...
            if (appInfo.zygotePreloadName != null) {
                try {
                    ...
                    Log.e(AppZygoteInit.TAG, "AppZygote application preload failed for " + appInfo.zygotePreloadName, e2);
                }
            } else {
            ...
            try {
                ...
                throw new IllegalStateException("Error writing to command socket", e10);
            }
        }
    }
