...
public interface IDropBoxManagerService extends IInterface {
    void addData(String str, byte[] bArr, int i10) throws RemoteException;

    void addFile(String str, ParcelFileDescriptor parcelFileDescriptor, int i10) throws RemoteException;

    DropBoxManager.Entry getNextEntry(String str, long j10, String str2) throws RemoteException;

    DropBoxManager.Entry getNextEntryWithAttribution(String str, long j10, String str2, String str3) throws RemoteException;
 ...
 */
    ...
    public static class Default implements IDropBoxManagerService {
        ...
        @Override // com.android.internal.os.IDropBoxManagerService
        public void addFile(String tag, ParcelFileDescriptor fd2, int flags) throws RemoteException {
        }
