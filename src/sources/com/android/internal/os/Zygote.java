...
public final class Zygote {
    ...
    public static final String TERTIARY_SOCKET_NAME = "zygote_tertiary";
    ...
    public static final String USAP_POOL_TERTIARY_SOCKET_NAME = "usap_pool_tertiary";
    ...
    private static final IZygoteExt STATIC_ZYGOTE_EXT = (IZygoteExt) ZygoteExtPlugin.constructor.newInstance();
    private static final boolean ENABLE_JDWP = SystemProperties.get("persist.debug.dalvik.vm.jdwp.enabled").equals("1");

    @CriticalNative
    private static native void nativeAddUsapTableEntry(int i10, int i11);
    ...
    private static native int nativeForkAndSpecialize(int i10, int i11, int[] iArr, int i12, int[][] iArr2, int i13, String str, String str2, int[] iArr3, int[] iArr4, boolean z10, String str3, String str4, boolean z11, String[] strArr, String[] strArr2, boolean z12, boolean z13);

    private static native int nativeForkApp(int i10, int i11, int[] iArr, boolean z10, boolean z11);

    private static native int nativeForkSystemServer(int i10, int i11, int[] iArr, int i12, int[][] iArr2, long j10, long j11);
    ...
    protected static native void nativeInitNativeState(boolean z10);

    protected static native void nativeInitZygoteTertiary();

    /* JADX INFO: Access modifiers changed from: protected */
    public static native void nativeInstallSeccompUidGidFilter(int i10, int i11);

    private static native void nativeMarkOpenedFilesBeforePreload();

    @FastNative
    public static native int nativeParseSigChld(byte[] bArr, int i10, int[] iArr);

    /* JADX INFO: Access modifiers changed from: package-private */
    public static native void nativePreApplicationInit();

    @CriticalNative
    private static native boolean nativeRemoveUsapTableEntry(int i10);

    private static native void nativeReserveRlimitStack();

    private static native void nativeSpecializeAppProcess(int i10, int i11, int[] iArr, int i12, int[][] iArr2, int i13, String str, String str2, boolean z10, String str3, String str4, boolean z11, String[] strArr, String[] strArr2, boolean z12, boolean z13);
    ...
    static void initNativeState() {
        nativeInitZygoteTertiary();
    }

    public static String getConfigurationProperty(String propertyName, String defaultValue) {
        return SystemProperties.get(String.join(".", ZygoteConfig.PROPERTY_PREFIX_DEVICE_CONFIG, "runtime_native", propertyName), defaultValue);
    }
    ...
    public static boolean getConfigurationPropertyBoolean(String propertyName, Boolean defaultValue) {
        return SystemProperties.getBoolean(String.join(".", ZygoteConfig.PROPERTY_PREFIX_DEVICE_CONFIG, "runtime_native", propertyName), defaultValue.booleanValue());
    }
    ...
    public static FileDescriptor getUsapPoolEventFD() {
        ...
        fd2.setInt$(nativeGetUsapPoolEventFD());
        return fd2;
    }
    ...
    private static Runnable childMain(ZygoteCommandBuffer argBuffer, LocalServerSocket usapPoolSocket, FileDescriptor writePipe) {
        ...
        try {
            if ((args.mRuntimeFlags & 1073741824) != 0) {
                try {
                    if (!Process.is64Bit()) {
            ...
            try {
                ...
                try {
                    FileDescriptor fd3 = usapPoolSocket.getFileDescriptor();
                    usapPoolSocket.close();
                    Os.close(fd3);
                    throw ex5;
    ...
    public static LocalServerSocket createManagedSocketFromInitSocket(String socketName) {
        ...
        try {
            ...
            try {
                FileDescriptor fd2 = new FileDescriptor();
                fd2.setInt$(fileDesc);
                return new LocalServerSocket(fd2);
