 ...
 */
    ...
    public interface AsyncRequest<I extends IInterface> {
        void run(I i10) throws RemoteException;
    }
 ...
 */
    ...
    protected long getRemoteRequestMillis() {
        throw new UnsupportedOperationException("not implemented by " + ((Object) getClass()));
    }
    ...
    public final void handlePendingRequest(BasePendingRequest<S, I> pendingRequest) {
        ...
        if (!handleIsBound()) {
            if (this.mVerbose) {
                Slog.v(this.mTag, "handlePendingRequest(): queuing " + ((Object) pendingRequest));
            }
        ...
        if (this.mVerbose) {
            Slog.v(this.mTag, "handlePendingRequest(): " + ((Object) pendingRequest));
        }
    ...
    public void handleEnsureBound() {
        ...
        this.mBound = true;
        if (!willBind) {
            Slog.w(this.mTag, "could not bind to " + ((Object) this.mIntent) + " using flags " + flags);
 ...
 */
    ...
    private boolean checkIfDestroyed() {
        if (this.mDestroyed && this.mVerbose) {
            Slog.v(this.mTag, "Not handling operation as service for " + ((Object) this.mComponentName) + " is already destroyed");
        }
        return this.mDestroyed;
    }

    public String toString() {
        return getClass().getSimpleName() + "[" + ((Object) this.mComponentName) + " " + System.identityHashCode(this) + (this.mService != null ? " (bound)" : " (unbound)") + (this.mDestroyed ? " (destroyed)" : "") + "]";
    }
 ...
 */
    ...
    public static abstract class PendingRequest<S extends AbstractRemoteService<S, I>, I extends IInterface> extends BasePendingRequest<S, I> {
        ...
        protected abstract void onTimeout(S s2);
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    ...
                    Slog.w(TAG, "exception handling async request (" + ((Object) this) + "): " + ((Object) e2));
                }
            } finally {
                finish();
            }
