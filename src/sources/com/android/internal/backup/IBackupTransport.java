...
public interface IBackupTransport extends IInterface {
    ...
    void checkFullBackupSize(long j10, ITransportStatusCallback iTransportStatusCallback) throws RemoteException;
    ...
    void getBackupQuota(String str, boolean z10, AndroidFuture<Long> androidFuture) throws RemoteException;
    ...
    void isAppEligibleForBackup(PackageInfo packageInfo, boolean z10, AndroidFuture<Boolean> androidFuture) throws RemoteException;
    ...
    void performBackup(PackageInfo packageInfo, ParcelFileDescriptor parcelFileDescriptor, int i10, ITransportStatusCallback iTransportStatusCallback) throws RemoteException;

    void performFullBackup(PackageInfo packageInfo, ParcelFileDescriptor parcelFileDescriptor, int i10, ITransportStatusCallback iTransportStatusCallback) throws RemoteException;
    ...
    void sendBackupData(int i10, ITransportStatusCallback iTransportStatusCallback) throws RemoteException;

    void startRestore(long j10, PackageInfo[] packageInfoArr, ITransportStatusCallback iTransportStatusCallback) throws RemoteException;
