...
public class DSAUtil {
    ...
    public static AsymmetricKeyParameter generatePrivateKeyParameter(PrivateKey key) throws InvalidKeyException {
        if (key instanceof DSAPrivateKey) {
            DSAPrivateKey k10 = (DSAPrivateKey) key;
            return new DSAPrivateKeyParameters(k10.getX(), new DSAParameters(k10.getParams().getP(), k10.getParams().getQ(), k10.getParams().getG()));
        }
        throw new InvalidKeyException("can't identify DSA private key.");
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static String generateKeyFingerprint(BigInteger y10, DSAParams params) {
        return new Fingerprint(Arrays.concatenate(y10.toByteArray(), params.getP().toByteArray(), params.getQ().toByteArray(), params.getG().toByteArray())).toString();
    }
}
