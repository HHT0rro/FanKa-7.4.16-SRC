 ...
 */
    ...
    public static class BasePBKDF2 extends BaseSecretKeyFactory {
        ...
        private int getDigestCode(ASN1ObjectIdentifier algorithm) throws InvalidKeySpecException {
            ...
            throw new InvalidKeySpecException("Invalid KeySpec: unknown PRF algorithm " + ((Object) algorithm));
        }
    }
 ...
 */
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider provider) {
            ...
            String str = PREFIX;
            provider.addAlgorithm("SecretKeyFactory.PBKDF2WithHmacSHA1", sb2.append(str).append("$PBKDF2WithHmacSHA1UTF8").toString());
            ...
            provider.addPrivateAlgorithm("Alg.Alias.SecretKeyFactory.1.2.840.113549.1.5.12", a.f53789a);
        }
    }
}
