 ...
 */
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider provider) {
            ...
            for (int i10 = 0; i10 != DSAUtil.dsaOids.length; i10++) {
                provider.addAlgorithm("Alg.Alias.Signature." + ((Object) DSAUtil.dsaOids[i10]), "SHA1withDSA");
                registerOid(provider, DSAUtil.dsaOids[i10], "DSA", keyFact);
                registerOidAlgorithmParameterGenerator(provider, DSAUtil.dsaOids[i10], "DSA");
            }
        }
    }
}
