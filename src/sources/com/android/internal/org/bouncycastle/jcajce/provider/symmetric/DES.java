 ...
 */
    ...
    public static class KeyGenerator extends BaseKeyGenerator {
        public KeyGenerator() {
            super(DESCoderUtils.SECRETFACTORY_ALGORITHM, 64, new DESKeyGenerator());
        }
 ...
 */
    ...
    public static class KeyFactory extends BaseSecretKeyFactory {
        public KeyFactory() {
            super(DESCoderUtils.SECRETFACTORY_ALGORITHM, null);
        }
        ...
        public SecretKey engineGenerateSecret(KeySpec keySpec) throws InvalidKeySpecException {
            if (keySpec instanceof DESKeySpec) {
                ...
                return new SecretKeySpec(desKeySpec.getKey(), DESCoderUtils.SECRETFACTORY_ALGORITHM);
            }
 ...
 */
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider provider) {
            ...
            String str = PREFIX;
            provider.addAlgorithm("Cipher.DES", sb2.append(str).append("$ECB").toString());
            ...
            provider.addAlgorithm("Alg.Alias.AlgorithmParameters", OIWObjectIdentifiers.desCBC, DESCoderUtils.SECRETFACTORY_ALGORITHM);
            ...
            provider.addAlgorithm("Alg.Alias.SecretKeyFactory." + ((Object) PKCSObjectIdentifiers.pbeWithMD5AndDES_CBC), "PBEWITHMD5ANDDES");
            provider.addAlgorithm("Alg.Alias.SecretKeyFactory." + ((Object) PKCSObjectIdentifiers.pbeWithSHA1AndDES_CBC), "PBEWITHSHA1ANDDES");
        }
