...
public class BCECPublicKey implements ECPublicKey, com.android.internal.org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public BCECPublicKey(String algorithm, com.android.internal.org.bouncycastle.jce.spec.ECPublicKeySpec spec, ProviderConfiguration configuration) {
        ...
        if (spec.getParams() != null) {
            ...
            com.android.internal.org.bouncycastle.jce.spec.ECParameterSpec s2 = configuration.getEcImplicitlyCa();
            this.ecPublicKey = new ECPublicKeyParameters(s2.getCurve().createPoint(spec.getQ().getAffineXCoord().toBigInteger(), spec.getQ().getAffineYCoord().toBigInteger()), EC5Util.getDomainParameters(configuration, null));
            this.ecSpec = null;
        }
        this.configuration = configuration;
    }
    ...
    public com.android.internal.org.bouncycastle.math.ec.ECPoint getQ() {
        com.android.internal.org.bouncycastle.math.ec.ECPoint q10 = this.ecPublicKey.getQ();
        if (this.ecSpec == null) {
            return q10.getDetachedPoint();
        }
        return q10;
    }
    ...
    public boolean equals(Object o10) {
        if (!(o10 instanceof BCECPublicKey)) {
            return false;
        }
        BCECPublicKey other = (BCECPublicKey) o10;
