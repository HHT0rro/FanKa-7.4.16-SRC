 ...
 */
    ...
    public static class EC extends KeyPairGeneratorSpi {
        ...
        static {
            ...
            ecParameters.put(Integers.valueOf(MetricsProto.MetricsEvent.PROVISIONING_ENCRYPT_DEVICE_ACTIVITY_TIME_MS), new ECGenParameterSpec("P-521"));
        }
        ...
        public void initialize(AlgorithmParameterSpec params, SecureRandom random) throws InvalidAlgorithmParameterException {
            ...
            if (params == null) {
                ...
                if (name != null) {
                    ...
                    throw new InvalidAlgorithmParameterException("invalid parameterSpec: " + ((Object) params));
                }
            }
        ...
        public KeyPair generateKeyPair() {
            ...
            if (obj instanceof ECParameterSpec) {
                ECParameterSpec p10 = (ECParameterSpec) obj;
                BCECPublicKey pubKey = new BCECPublicKey(this.algorithm, pub, p10, this.configuration);
                return new KeyPair(pubKey, new BCECPrivateKey(this.algorithm, priv, pubKey, p10, this.configuration));
            }
            if (obj == null) {
            ...
            java.security.spec.ECParameterSpec p11 = (java.security.spec.ECParameterSpec) obj;
            BCECPublicKey pubKey2 = new BCECPublicKey(this.algorithm, pub, p11, this.configuration);
            return new KeyPair(pubKey2, new BCECPrivateKey(this.algorithm, priv, pubKey2, p11, this.configuration));
        }

        protected ECKeyGenerationParameters createKeyGenParamsBC(ECParameterSpec p10, SecureRandom r10) {
            return new ECKeyGenerationParameters(new ECDomainParameters(p10.getCurve(), p10.getG(), p10.getN(), p10.getH()), r10);
        }

        protected ECKeyGenerationParameters createKeyGenParamsJCE(java.security.spec.ECParameterSpec p10, SecureRandom r10) {
            X9ECParameters x9P;
            if ((p10 instanceof ECNamedCurveSpec) && (x9P = ECUtils.getDomainParametersFromName(((ECNamedCurveSpec) p10).getName())) != null) {
                ECDomainParameters dp = new ECDomainParameters(x9P.getCurve(), x9P.getG(), x9P.getN(), x9P.getH());
                return new ECKeyGenerationParameters(dp, r10);
            }
            ECCurve curve = EC5Util.convertCurve(p10.getCurve());
            ECPoint g3 = EC5Util.convertPoint(curve, p10.getGenerator());
            BigInteger n10 = p10.getOrder();
            BigInteger h10 = BigInteger.valueOf(p10.getCofactor());
            ECDomainParameters dp2 = new ECDomainParameters(curve, g3, n10, h10);
            return new ECKeyGenerationParameters(dp2, r10);
        }

        protected ECNamedCurveSpec createNamedCurveSpec(String curveName) throws InvalidAlgorithmParameterException {
            X9ECParameters p10 = ECUtils.getDomainParametersFromName(curveName);
            if (p10 == null) {
                try {
                    p10 = ECNamedCurveTable.getByOID(new ASN1ObjectIdentifier(curveName));
                    if (p10 == null) {
                        Map extraCurves = this.configuration.getAdditionalECParameters();
                        p10 = (X9ECParameters) extraCurves.get(new ASN1ObjectIdentifier(curveName));
                        if (p10 == null) {
            ...
            return new ECNamedCurveSpec(curveName, p10.getCurve(), p10.getG(), p10.getN(), p10.getH(), null);
        }
