...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    private TBSCertList.CRLEntry f9243c;
    private X500Name certificateIssuer;
    private volatile int hashValue;
    private volatile boolean hashValueSet;

    protected X509CRLEntryObject(TBSCertList.CRLEntry c4) {
        this.f9243c = c4;
    ...
    private Set getExtensionOIDs(boolean critical) {
        Extensions extensions = this.f9243c.getExtensions();
        if (extensions != null) {
            Set set = new HashSet();
    ...
    private Extension getExtension(ASN1ObjectIdentifier oid) {
        Extensions exts = this.f9243c.getExtensions();
        if (exts != null) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof X509CRLEntryObject) {
            ...
            return this.f9243c.equals(otherBC.f9243c);
        }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f9243c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e2) {
    ...
    public BigInteger getSerialNumber() {
        return this.f9243c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public Date getRevocationDate() {
        return this.f9243c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f9243c.getExtensions() != null;
    }
