...
public class BCDHPrivateKey implements DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    public BCDHPrivateKey(PrivateKeyInfo info) throws IOException {
        ...
        this.info = info;
        this.f9235x = derX.getValue();
        if (id2.equals((ASN1Primitive) PKCSObjectIdentifiers.dhKeyAgreement)) {
            DHParameter params = DHParameter.getInstance(seq);
            if (params.getL() != null) {
                this.dhSpec = new DHParameterSpec(params.getP(), params.getG(), params.getL().intValue());
                this.dhPrivateKey = new DHPrivateKeyParameters(this.f9235x, new DHParameters(params.getP(), params.getG(), null, params.getL().intValue()));
                return;
            } else {
                this.dhSpec = new DHParameterSpec(params.getP(), params.getG());
                this.dhPrivateKey = new DHPrivateKeyParameters(this.f9235x, new DHParameters(params.getP(), params.getG()));
                return;
            }
        }
        if (id2.equals((ASN1Primitive) X9ObjectIdentifiers.dhpublicnumber)) {
            ...
            this.dhPrivateKey = new DHPrivateKeyParameters(this.f9235x, new DHParameters(params2.getP(), params2.getG(), params2.getQ(), params2.getJ(), (DHValidationParameters) null));
            return;
        }
    ...
    public String toString() {
        return DHUtil.privateKeyToString("DH", this.f9235x, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
    }
    ...
    public DHPrivateKeyParameters engineGetKeyParameters() {
        ...
        if (dHParameterSpec instanceof DHDomainParameterSpec) {
            return new DHPrivateKeyParameters(this.f9235x, ((DHDomainParameterSpec) dHParameterSpec).getDomainParameters());
        }
        return new DHPrivateKeyParameters(this.f9235x, new DHParameters(dHParameterSpec.getP(), this.dhSpec.getG(), null, this.dhSpec.getL()));
    }

    public boolean equals(Object o10) {
        if (!(o10 instanceof DHPrivateKey)) {
            return false;
        }
        DHPrivateKey other = (DHPrivateKey) o10;
