...
public class BCECPrivateKey implements ECPrivateKey, com.android.internal.org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private transient BigInteger f9242d;
    ...
    private void populateFromPrivKeyInfo(PrivateKeyInfo info) throws IOException {
        ...
        if (privKey instanceof ASN1Integer) {
            ...
            this.f9242d = derD.getValue();
        } else {
            com.android.internal.org.bouncycastle.asn1.sec.ECPrivateKey ec2 = com.android.internal.org.bouncycastle.asn1.sec.ECPrivateKey.getInstance(privKey);
            this.f9242d = ec2.getKey();
            this.publicKey = ec2.getPublicKey();
        }
    }
    ...
    public boolean equals(Object o10) {
        if (!(o10 instanceof BCECPrivateKey)) {
            return false;
        }
        BCECPrivateKey other = (BCECPrivateKey) o10;
    ...
    public String toString() {
        return ECUtil.privateKeyToString("EC", this.f9242d, engineGetSpec());
    }
