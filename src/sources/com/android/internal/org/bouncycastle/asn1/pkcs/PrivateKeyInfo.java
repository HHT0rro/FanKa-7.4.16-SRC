...
public class PrivateKeyInfo extends ASN1Object {
    ...
    private PrivateKeyInfo(ASN1Sequence seq) {
        ...
        ASN1Integer aSN1Integer = ASN1Integer.getInstance(e2.nextElement());
        this.version = aSN1Integer;
        int versionValue = getVersionValue(aSN1Integer);
        this.privateKeyAlgorithm = AlgorithmIdentifier.getInstance(e2.nextElement());
        this.privateKey = ASN1OctetString.getInstance(e2.nextElement());
        int lastTag = -1;
        while (e2.hasMoreElements()) {
            ASN1TaggedObject tagged = (ASN1TaggedObject) e2.nextElement();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        v2.add(this.version);
        v2.add(this.privateKeyAlgorithm);
        v2.add(this.privateKey);
        ...
        ASN1BitString aSN1BitString = this.publicKey;
        if (aSN1BitString != null) {
            v2.add(new DERTaggedObject(false, 1, aSN1BitString));
        }
