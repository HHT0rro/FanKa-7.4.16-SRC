...
public class RSASSAPSSparams extends ASN1Object {
        ...
        for (int i10 = 0; i10 != seq.size(); i10++) {
            ...
            switch (o10.getTagNo()) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    this.saltLength = ASN1Integer.getInstance(o10, true);
                    break;
                case 3:
                    this.trailerField = ASN1Integer.getInstance(o10, true);
                    break;
                default:
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (!this.saltLength.equals((ASN1Primitive) DEFAULT_SALT_LENGTH)) {
            v2.add(new DERTaggedObject(true, 2, this.saltLength));
        }
        if (!this.trailerField.equals((ASN1Primitive) DEFAULT_TRAILER_FIELD)) {
            v2.add(new DERTaggedObject(true, 3, this.trailerField));
        }
