...
public interface NISTObjectIdentifiers {
    ...
    static {
        ...
        id_shake256 = branch.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        id_hmacWithSHA3_224 = branch.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
        id_hmacWithSHA3_256 = branch.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        id_hmacWithSHA3_384 = branch.branch("15");
        id_hmacWithSHA3_512 = branch.branch("16");
        id_shake128_len = branch.branch(Constants.VIA_REPORT_TYPE_START_GROUP);
        id_shake256_len = branch.branch("18");
        id_KmacWithSHAKE128 = branch.branch(Constants.VIA_ACT_TYPE_NINETEEN);
        ...
        id_aes192_CBC = branch2.branch(Constants.VIA_REPORT_TYPE_DATALINE);
        id_aes192_OFB = branch2.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR);
        id_aes192_CFB = branch2.branch(Constants.VIA_REPORT_TYPE_CHAT_AIO);
        id_aes192_wrap = branch2.branch(Constants.VIA_REPORT_TYPE_CHAT_AUDIO);
        id_aes192_GCM = branch2.branch(Constants.VIA_REPORT_TYPE_CHAT_VIDEO);
        id_aes192_CCM = branch2.branch("27");
        id_aes192_wrap_pad = branch2.branch(Constants.VIA_ACT_TYPE_TWENTY_EIGHT);
        ...
        id_aes256_wrap_pad = branch2.branch(a.Code);
        ...
        id_ecdsa_with_sha3_512 = branch3.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        id_rsassa_pkcs1_v1_5_with_sha3_224 = branch3.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
        id_rsassa_pkcs1_v1_5_with_sha3_256 = branch3.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
