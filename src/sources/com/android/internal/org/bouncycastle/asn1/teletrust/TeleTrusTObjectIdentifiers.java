...
public interface TeleTrusTObjectIdentifiers {
    ...
    static {
        ...
        brainpoolP384t1 = branch5.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        brainpoolP512r1 = branch5.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
        brainpoolP512t1 = branch5.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
    }
}
