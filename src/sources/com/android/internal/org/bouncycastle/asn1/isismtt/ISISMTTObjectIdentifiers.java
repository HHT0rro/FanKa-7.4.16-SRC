...
public interface ISISMTTObjectIdentifiers {
    ...
    static {
        ...
        id_isismtt_at_certInDirSince = branch2.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        id_isismtt_at_certHash = branch2.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
        id_isismtt_at_nameAtBirth = branch2.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
