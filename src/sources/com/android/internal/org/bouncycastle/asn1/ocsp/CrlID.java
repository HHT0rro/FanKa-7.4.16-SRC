...
public class CrlID extends ASN1Object {
    ...
    private CrlID(ASN1Sequence seq) {
        ...
        while (e2.hasMoreElements()) {
            ASN1TaggedObject o10 = (ASN1TaggedObject) e2.nextElement();
            switch (o10.getTagNo()) {
                case 0:
                    this.crlUrl = DERIA5String.getInstance(o10, true);
                    break;
                case 1:
                    this.crlNum = ASN1Integer.getInstance(o10, true);
                    break;
                case 2:
                    this.crlTime = ASN1GeneralizedTime.getInstance(o10, true);
                    break;
                default:
                    throw new IllegalArgumentException("unknown tag number: " + o10.getTagNo());
            }
        }
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (dERIA5String != null) {
            v2.add(new DERTaggedObject(true, 0, dERIA5String));
        }
        ASN1Integer aSN1Integer = this.crlNum;
        if (aSN1Integer != null) {
            v2.add(new DERTaggedObject(true, 1, aSN1Integer));
        }
        ASN1GeneralizedTime aSN1GeneralizedTime = this.crlTime;
        if (aSN1GeneralizedTime != null) {
            v2.add(new DERTaggedObject(true, 2, aSN1GeneralizedTime));
        }
