...
public interface PKCSObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier branch = aSN1ObjectIdentifier6.branch(Constants.VIA_REPORT_TYPE_DATALINE);
        certTypes = branch;
        x509Certificate = branch.branch("1").intern();
        sdsiCertificate = branch.branch("2").intern();
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier6.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR);
        crlTypes = branch2;
        ...
        id_rsa_KEM = branch3.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        id_alg_hss_lms_hashsig = branch3.branch(Constants.VIA_REPORT_TYPE_START_GROUP);
        id_alg_AEADChaCha20Poly1305 = branch3.branch("18");
        id_alg_hkdf_with_sha256 = branch3.branch(Constants.VIA_ACT_TYPE_TWENTY_EIGHT);
        ...
        ASN1ObjectIdentifier branch6 = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_START_GROUP);
        id_aa_ets_signerLocation = branch6;
        id_aa_ets_signerAttr = aSN1ObjectIdentifier9.branch("18");
        ASN1ObjectIdentifier branch7 = aSN1ObjectIdentifier9.branch(Constants.VIA_ACT_TYPE_NINETEEN);
