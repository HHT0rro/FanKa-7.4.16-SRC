...
public class ASN1ObjectIdentifier extends ASN1Primitive {
    ...
    public static ASN1ObjectIdentifier getInstance(ASN1TaggedObject obj, boolean explicit) {
        ...
        if (explicit || (o10 instanceof ASN1ObjectIdentifier)) {
    ...
    public ASN1ObjectIdentifier(byte[] bytes) {
        ...
        for (int i10 = 0; i10 != bytes.length; i10++) {
            int b4 = bytes[i10] & 255;
            if (value <= LONG_LIMIT) {
                long value2 = value + (b4 & 127);
                if ((b4 & 128) == 0) {
                    if (first) {
                        if (value2 < 40) {
                            objId.append('0');
                ...
                BigInteger bigValue2 = (bigValue == null ? BigInteger.valueOf(value) : bigValue).or(BigInteger.valueOf(b4 & 127));
                if ((b4 & 128) == 0) {
                    if (first) {
                        objId.append('2');
    ...
    public boolean on(ASN1ObjectIdentifier stem) {
        ...
        return id2.length() > stemId.length() && id2.charAt(stemId.length()) == '.' && id2.startsWith(stemId);
    }
    ...
    private void writeField(ByteArrayOutputStream out, BigInteger fieldValue) {
        ...
        for (int i10 = byteCount - 1; i10 >= 0; i10--) {
            tmp[i10] = (byte) ((tmpValue.intValue() & 127) | 128);
            tmpValue = tmpValue.shiftRight(7);
        }
        int i11 = byteCount - 1;
        tmp[i11] = (byte) (tmp[i11] & Byte.MAX_VALUE);
    ...
    public boolean asn1Equals(ASN1Primitive o10) {
        ...
        return this.identifier.equals(((ASN1ObjectIdentifier) o10).identifier);
    }
 ...
 */
    ...
    public static class OidHandle {
        ...
        public boolean equals(Object o10) {
            if (o10 instanceof OidHandle) {
                return Arrays.areEqual(this.enc, ((OidHandle) o10).enc);
            }
            return false;
        }
    }
