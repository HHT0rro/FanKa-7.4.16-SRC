...
public interface NSRIObjectIdentifiers {
    ...
    static {
        ...
        id_aria256_cbc = branch2.branch(Constants.VIA_REPORT_TYPE_SET_AVATAR);
        id_aria256_cfb = branch2.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
        id_aria256_ofb = branch2.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        id_aria256_ctr = branch2.branch("15");
        id_aria128_cmac = branch2.branch("21");
        id_aria192_cmac = branch2.branch(Constants.VIA_REPORT_TYPE_DATALINE);
        id_aria256_cmac = branch2.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR);
