...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    public static final ASN1ObjectIdentifier f9165c;

    /* renamed from: cn, reason: collision with root package name */
    public static final ASN1ObjectIdentifier f9166cn;

    /* renamed from: dc, reason: collision with root package name */
    public static final ASN1ObjectIdentifier f9167dc;
    ...
    public static final ASN1ObjectIdentifier f9168l;
    public static final ASN1ObjectIdentifier member;
    public static final ASN1ObjectIdentifier name;

    /* renamed from: o, reason: collision with root package name */
    public static final ASN1ObjectIdentifier f9169o;
    ...
    static {
        ...
        hashtable.put(intern33, Segment.JsonKey.START);
        ...
        hashtable2.put(Segment.JsonKey.START, intern33);
    ...
    public ASN1Encodable encodeStringValue(ASN1ObjectIdentifier oid, String value) {
        if (oid.equals((ASN1Primitive) f9167dc)) {
            return new DERIA5String(value);
        }
        if (oid.equals((ASN1Primitive) f9165c) || oid.equals((ASN1Primitive) serialNumber) || oid.equals((ASN1Primitive) dnQualifier) || oid.equals((ASN1Primitive) telephoneNumber)) {
    ...
    public String toString(X500Name name2) {
        ...
        for (int i10 = rdns.length - 1; i10 >= 0; i10--) {
            if (first) {
                first = false;
            } else {
                buf.append(',');
            }
            IETFUtils.appendRDN(buf, rdns[i10], this.defaultSymbols);
        }
        return buf.toString();
    }
}
