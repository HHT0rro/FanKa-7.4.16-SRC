...
public class SingleResponse extends ASN1Object {
    ...
    private SingleResponse(ASN1Sequence seq) {
        ...
        if (seq.size() > 4) {
            ...
            ASN1TaggedObject o10 = (ASN1TaggedObject) seq.getObjectAt(3);
            if (o10.getTagNo() == 0) {
                this.nextUpdate = ASN1GeneralizedTime.getInstance(o10, true);
            } else {
                this.singleExtensions = Extensions.getInstance(o10, true);
            }
        }
    }
