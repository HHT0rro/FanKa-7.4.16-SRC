...
public class ResponderID extends ASN1Object implements ASN1Choice {
    ...
    public static ResponderID getInstance(Object obj) {
        ...
        if (obj instanceof ASN1TaggedObject) {
            ASN1TaggedObject o10 = (ASN1TaggedObject) obj;
            if (o10.getTagNo() == 1) {
                return new ResponderID(X500Name.getInstance(o10, true));
            }
            return new ResponderID(ASN1OctetString.getInstance(o10, true));
        }
