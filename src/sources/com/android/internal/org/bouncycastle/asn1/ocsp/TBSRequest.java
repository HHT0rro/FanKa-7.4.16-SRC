...
public class TBSRequest extends ASN1Object {
    ...
    private TBSRequest(ASN1Sequence seq) {
        ...
        if (seq.getObjectAt(0) instanceof ASN1TaggedObject) {
            ASN1TaggedObject o10 = (ASN1TaggedObject) seq.getObjectAt(0);
            if (o10.getTagNo() == 0) {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (generalName != null) {
            v2.add(new DERTaggedObject(true, 1, generalName));
        }
        v2.add(this.requestList);
        Extensions extensions = this.requestExtensions;
        if (extensions != null) {
            v2.add(new DERTaggedObject(true, 2, extensions));
        }
