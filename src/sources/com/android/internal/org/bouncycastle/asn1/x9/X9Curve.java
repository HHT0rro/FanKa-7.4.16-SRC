...
public class X9Curve extends ASN1Object implements X9ObjectIdentifiers {
    ...
    public X9Curve(X9FieldID fieldID, BigInteger order, BigInteger cofactor, ASN1Sequence seq) {
        ...
        if (identifier.equals((ASN1Primitive) prime_field)) {
            BigInteger p10 = ((ASN1Integer) fieldID.getParameters()).getValue();
            ...
            this.curve = new ECCurve.Fp(p10, A, B, order, cofactor);
            ...
            int m10 = ((ASN1Integer) parameters.getObjectAt(0)).intValueExact();
            ...
            if (representation.equals((ASN1Primitive) tpBasis)) {
                int k13 = ASN1Integer.getInstance(parameters.getObjectAt(2)).intValueExact();
                k12 = k13;
                k22 = 0;
                k32 = 0;
                ...
                int k14 = ASN1Integer.getInstance(pentanomial.getObjectAt(0)).intValueExact();
                int k23 = ASN1Integer.getInstance(pentanomial.getObjectAt(1)).intValueExact();
                int k33 = ASN1Integer.getInstance(pentanomial.getObjectAt(2)).intValueExact();
                k12 = k14;
                k22 = k23;
                k32 = k33;
            } else {
            ...
            this.curve = new ECCurve.F2m(m10, k12, k22, k32, A2, B2, order, cofactor);
        } else {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (this.fieldIdentifier.equals((ASN1Primitive) prime_field)) {
            v2.add(new X9FieldElement(this.curve.getA()).toASN1Primitive());
            v2.add(new X9FieldElement(this.curve.getB()).toASN1Primitive());
        } else if (this.fieldIdentifier.equals((ASN1Primitive) characteristic_two_field)) {
            v2.add(new X9FieldElement(this.curve.getA()).toASN1Primitive());
            v2.add(new X9FieldElement(this.curve.getB()).toASN1Primitive());
        }
        if (this.seed != null) {
            v2.add(new DERBitString(this.seed));
        }
