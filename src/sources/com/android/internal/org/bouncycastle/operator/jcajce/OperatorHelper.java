...
public class OperatorHelper {
    ...
    static {
        ...
        hashMap2.put(PKCSObjectIdentifiers.rsaEncryption, RSA.RSA_ALGORITHM);
        ...
        hashMap4.put(NISTObjectIdentifiers.aes, AESEncrypt.ALGORITHM);
        hashMap4.put(NISTObjectIdentifiers.id_aes128_CBC, AESEncrypt.ALGORITHM);
        hashMap4.put(NISTObjectIdentifiers.id_aes192_CBC, AESEncrypt.ALGORITHM);
        hashMap4.put(NISTObjectIdentifiers.id_aes256_CBC, AESEncrypt.ALGORITHM);
        ...
        try {
            ...
            if (cipherName != null) {
                try {
                    ...
                    if (cipherName.equals(RSA.RSA_ALGORITHM)) {
                        try {
    ...
    public MessageDigest createDigest(AlgorithmIdentifier digAlgId) throws GeneralSecurityException {
        ...
        try {
            if (digAlgId.getAlgorithm().equals((ASN1Primitive) NISTObjectIdentifiers.id_shake256_len)) {
                dig = this.helper.createMessageDigest("SHAKE256-" + ((Object) ASN1Integer.getInstance(digAlgId.getParameters()).getValue()));
            } else {
    ...
    public Signature createRawSignature(AlgorithmIdentifier algorithm) {
        try {
            ...
            String algName2 = "NONE" + algName.substring(algName.indexOf("WITH"));
    ...
    public X509Certificate convertCertificate(X509CertificateHolder certHolder) throws CertificateException {
        try {
            CertificateFactory certFact = this.helper.createCertificateFactory(e.f29912b);
            ...
            throw new OpCertificateException("cannot find factory provider: " + e10.getMessage(), e10);
        }
    }
    ...
    public PublicKey convertPublicKey(SubjectPublicKeyInfo publicKeyInfo) throws OperatorCreationException {
        try {
            ...
            throw new OperatorCreationException("cannot find factory provider: " + e11.getMessage(), e11);
