...
public class SecP192R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f9282q = SecP192R1FieldElement.Q;
    ...
    public SecP192R1Curve() {
        ...
        this.f9263a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC")));
        this.f9264b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("64210519E59C80E70FA7E9AB72243049FEB8DEECC146B9B1")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, final int len) {
        ...
        for (int i10 = 0; i10 < len; i10++) {
            ...
            Nat192.copy(((SecP192R1FieldElement) p10.getRawXCoord()).f9283x, 0, table, pos);
            int pos2 = pos + 6;
            Nat192.copy(((SecP192R1FieldElement) p10.getRawYCoord()).f9283x, 0, table, pos2);
            pos = pos2 + 6;
        }
        return new AbstractECLookupTable() { // from class: com.android.internal.org.bouncycastle.math.ec.custom.sec.SecP192R1Curve.1
            ...
            private ECPoint createPoint(int[] x10, int[] y10) {
                return SecP192R1Curve.this.createRawPoint(new SecP192R1FieldElement(x10), new SecP192R1FieldElement(y10), SecP192R1Curve.SECP192R1_AFFINE_ZS);
            }
        };
    }
    ...
    public ECFieldElement randomFieldElementMult(SecureRandom r10) {
        int[] x10 = Nat192.create();
        SecP192R1Field.randomMult(r10, x10);
        return new SecP192R1FieldElement(x10);
    }
}
