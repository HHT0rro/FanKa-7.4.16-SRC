...
public class SecP224K1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f9284q = SecP224K1FieldElement.Q;
    ...
    public SecP224K1Curve() {
        ...
        this.f9264b = fromBigInteger(BigInteger.valueOf(5L));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, final int len) {
        ...
        for (int i10 = 0; i10 < len; i10++) {
            ...
            Nat224.copy(((SecP224K1FieldElement) p10.getRawXCoord()).f9285x, 0, table, pos);
            int pos2 = pos + 7;
            Nat224.copy(((SecP224K1FieldElement) p10.getRawYCoord()).f9285x, 0, table, pos2);
            pos = pos2 + 7;
        }
        return new AbstractECLookupTable() { // from class: com.android.internal.org.bouncycastle.math.ec.custom.sec.SecP224K1Curve.1
            ...
            private ECPoint createPoint(int[] x10, int[] y10) {
                return SecP224K1Curve.this.createRawPoint(new SecP224K1FieldElement(x10), new SecP224K1FieldElement(y10), SecP224K1Curve.SECP224K1_AFFINE_ZS);
            }
        };
    }
    ...
    public ECFieldElement randomFieldElementMult(SecureRandom r10) {
        int[] x10 = Nat224.create();
        SecP224K1Field.randomMult(r10, x10);
        return new SecP224K1FieldElement(x10);
    }
}
