...
public final class CryptoServicesRegistrar {
    ...
    public static <T> T getSizedProperty(Property property, int i10) {
        ...
        if (property.type.isAssignableFrom(DHParameters.class)) {
            for (int i11 = 0; i11 != lookupProperty.length; i11++) {
                ?? r32 = (T) ((DHParameters) lookupProperty[i11]);
                if (r32.getP().bitLength() == i10) {
                    return r32;
                }
            }
        } else if (property.type.isAssignableFrom(DSAParameters.class)) {
            for (int i12 = 0; i12 != lookupProperty.length; i12++) {
                ?? r33 = (T) ((DSAParameters) lookupProperty[i12]);
                if (r33.getP().bitLength() == i10) {
                    return r33;
                }
            }
        }
    ...
    private static void checkPermission(final Permission permission) {
        ...
        if (securityManager != null) {
            AccessController.doPrivileged(new PrivilegedAction<Object>() { // from class: com.android.internal.org.bouncycastle.crypto.CryptoServicesRegistrar.1
                ...
                public Object run() {
                    SecurityManager.this.checkPermission(permission);
                    return null;
                }
            });
        }
    ...
    private static DHParameters toDH(DSAParameters dsaParams) {
        ...
        int m10 = chooseLowerBound(pSize);
        return new DHParameters(dsaParams.getP(), dsaParams.getG(), dsaParams.getQ(), m10, 0, null, new DHValidationParameters(dsaParams.getValidationParameters().getSeed(), dsaParams.getValidationParameters().getCounter()));
    }
