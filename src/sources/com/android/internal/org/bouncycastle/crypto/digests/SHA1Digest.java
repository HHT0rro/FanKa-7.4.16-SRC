...
public class SHA1Digest extends GeneralDigest implements EncodableDigest {
    ...
    public SHA1Digest(byte[] encodedState) {
        ...
        for (int i10 = 0; i10 != this.xOff; i10++) {
            this.X[i10] = Pack.bigEndianToInt(encodedState, (i10 * 4) + 40);
        }
    }

    private void copyIn(SHA1Digest t2) {
        this.H1 = t2.H1;
        this.H2 = t2.H2;
        this.H3 = t2.H3;
        this.H4 = t2.H4;
    ...
    public void reset(Memoable other) {
        SHA1Digest d10 = (SHA1Digest) other;
        super.copyIn((GeneralDigest) d10);
        copyIn(d10);
    }
    ...
    public byte[] getEncodedState() {
        ...
        for (int i10 = 0; i10 != this.xOff; i10++) {
            Pack.intToBigEndian(this.X[i10], state, (i10 * 4) + 40);
        }
        return state;
    }
}
