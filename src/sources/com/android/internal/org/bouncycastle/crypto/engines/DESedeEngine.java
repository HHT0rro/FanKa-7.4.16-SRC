...
public class DESedeEngine extends DESEngine {
    ...
    public void init(boolean encrypting, CipherParameters params) {
        ...
        System.arraycopy((Object) keyMaster, 0, (Object) key1, 0, key1.length);
        this.workingKey1 = generateWorkingKey(encrypting, key1);
        byte[] key2 = new byte[8];
        System.arraycopy((Object) keyMaster, 8, (Object) key2, 0, key2.length);
        this.workingKey2 = generateWorkingKey(!encrypting, key2);
        if (keyMaster.length == 24) {
            byte[] key3 = new byte[8];
            System.arraycopy((Object) keyMaster, 16, (Object) key3, 0, key3.length);
