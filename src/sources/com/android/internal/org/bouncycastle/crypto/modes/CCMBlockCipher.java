...
public class CCMBlockCipher implements AEADBlockCipher {
    ...
    public CCMBlockCipher(BlockCipher c4) {
        this.cipher = c4;
    ...
    public byte[] getMac() {
        ...
        System.arraycopy((Object) this.macBlock, 0, (Object) mac, 0, mac.length);
        return mac;
    }
    ...
    public int processPacket(byte[] in, int inOff, int inLen, byte[] output, int outOff) throws IllegalStateException, InvalidCipherTextException, DataLengthException {
        ...
        byte[] bArr = this.nonce;
        int q10 = 15 - bArr.length;
        if (q10 < 4) {
            int limitLen = 1 << (q10 * 8);
            if (inLen >= limitLen) {
        ...
        iv[0] = (byte) ((q10 - 1) & 7);
        System.arraycopy((Object) bArr, 0, (Object) iv, 1, bArr.length);
        ...
        if (!this.forEncryption) {
            ...
            if (output.length >= outputLen + outOff) {
                byte b4 = 0;
                System.arraycopy((Object) in, inOff + outputLen, (Object) this.macBlock, 0, n10);
                ...
                byte[] block = new byte[i10];
                System.arraycopy((Object) in, inIndex, (Object) block, 0, outputLen - (inIndex - inOff));
                ctrCipher.processBlock(block, 0, block, 0);
                System.arraycopy((Object) block, 0, (Object) output, outIndex, outputLen - (inIndex - inOff));
            ...
            byte[] block2 = new byte[i11];
            System.arraycopy((Object) in, inIndex, (Object) block2, 0, (inLen + inOff) - inIndex);
            ctrCipher.processBlock(block2, 0, block2, 0);
            System.arraycopy((Object) block2, 0, (Object) output, outIndex, (inLen + inOff) - inIndex);
            System.arraycopy((Object) encMac, 0, (Object) output, outOff + inLen, this.macSize);
        }
        return outputLen;
    }
    ...
    private int calculateMac(byte[] data, int dataOff, int dataLen, byte[] macBlock) {
        ...
        byte[] b02 = new byte[16];
        if (hasAssociatedText()) {
            b02[0] = (byte) (b02[0] | DerValue.TAG_APPLICATION);
        }
        b02[0] = (byte) (b02[0] | ((((cMac.getMacSize() - 2) / 2) & 7) << 3));
        byte b4 = b02[0];
        byte[] bArr = this.nonce;
        b02[0] = (byte) (b4 | (((15 - bArr.length) - 1) & 7));
        System.arraycopy((Object) bArr, 0, (Object) b02, 1, bArr.length);
        int q10 = dataLen;
        int count = 1;
        while (q10 > 0) {
            b02[b02.length - count] = (byte) (q10 & 255);
            q10 >>>= 8;
            count++;
        }
        cMac.update(b02, 0, b02.length);
        if (hasAssociatedText()) {
