...
public class JCEECPrivateKey implements ECPrivateKey, com.android.internal.org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private void populateFromPrivKeyInfo(PrivateKeyInfo info) throws IOException {
        ...
        if (privKey instanceof ASN1Integer) {
            ...
            this.f9252d = derD.getValue();
        } else {
            ECPrivateKeyStructure ec2 = new ECPrivateKeyStructure((ASN1Sequence) privKey);
            this.f9252d = ec2.getKey();
    ...
    public boolean equals(Object o10) {
        if (!(o10 instanceof JCEECPrivateKey)) {
            return false;
        }
        JCEECPrivateKey other = (JCEECPrivateKey) o10;
    ...
    public String toString() {
        ...
        buf.append("             S: ").append(this.f9252d.toString(16)).append(nl);
        return buf.toString();
    }
