...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    private TBSCertList.CRLEntry f9256c;
    private X500Name certificateIssuer;
    private int hashValue;
    private boolean isHashValueSet;

    public X509CRLEntryObject(TBSCertList.CRLEntry c4) {
        this.f9256c = c4;
        this.certificateIssuer = null;
    }

    public X509CRLEntryObject(TBSCertList.CRLEntry c4, boolean isIndirect, X500Name previousCertificateIssuer) {
        this.f9256c = c4;
    ...
    private Set getExtensionOIDs(boolean critical) {
        Extensions extensions = this.f9256c.getExtensions();
        if (extensions != null) {
            Set set = new HashSet();
    ...
    private Extension getExtension(ASN1ObjectIdentifier oid) {
        Extensions exts = this.f9256c.getExtensions();
        if (exts != null) {
    ...
    public boolean equals(Object o10) {
        ...
        if (o10 instanceof X509CRLEntryObject) {
            X509CRLEntryObject other = (X509CRLEntryObject) o10;
            return this.f9256c.equals(other.f9256c);
        }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f9256c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e2) {
    ...
    public BigInteger getSerialNumber() {
        return this.f9256c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public Date getRevocationDate() {
        return this.f9256c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f9256c.getExtensions() != null;
    }
    ...
    public String toString() {
        ...
        buf.append("      userCertificate: ").append((Object) getSerialNumber()).append(nl);
        buf.append("       revocationDate: ").append((Object) getRevocationDate()).append(nl);
        buf.append("       certificateIssuer: ").append((Object) getCertificateIssuer()).append(nl);
        Extensions extensions = this.f9256c.getExtensions();
        if (extensions != null) {
            Enumeration e2 = extensions.oids();
                    ...
                    if (ext.getExtnValue() != null) {
                        ...
                        try {
                            if (oid.equals((ASN1Primitive) X509Extension.reasonCode)) {
                                buf.append((Object) CRLReason.getInstance(ASN1Enumerated.getInstance(dIn.readObject()))).append(nl);
                            } else if (oid.equals((ASN1Primitive) X509Extension.certificateIssuer)) {
                                buf.append("Certificate issuer: ").append((Object) GeneralNames.getInstance(dIn.readObject())).append(nl);
                            } else {
