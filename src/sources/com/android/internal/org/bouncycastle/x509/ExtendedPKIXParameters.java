...
public class ExtendedPKIXParameters extends PKIXParameters {
    ...
    public void setStores(List stores) {
        ...
        Iterator i10 = stores.iterator2();
        while (i10.hasNext()) {
            if (!(i10.next() instanceof Store)) {
    ...
    public void setTrustedACIssuers(Set trustedACIssuers) {
        ...
        Iterator it = trustedACIssuers.iterator2();
        while (it.hasNext()) {
    ...
    public void setNecessaryACAttributes(Set necessaryACAttributes) {
        ...
        Iterator it = necessaryACAttributes.iterator2();
        while (it.hasNext()) {
    ...
    public void setProhibitedACAttributes(Set prohibitedACAttributes) {
        ...
        Iterator it = prohibitedACAttributes.iterator2();
        while (it.hasNext()) {
            if (!(it.next() instanceof String)) {
                throw new ClassCastException("All elements of set must be of type String.");
            }
    ...
    public void setAttrCertCheckers(Set attrCertCheckers) {
        ...
        Iterator it = attrCertCheckers.iterator2();
        while (it.hasNext()) {
