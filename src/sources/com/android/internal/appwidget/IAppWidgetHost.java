...
public interface IAppWidgetHost extends IInterface {
    void appWidgetRemoved(int i10) throws RemoteException;

    void providerChanged(int i10, AppWidgetProviderInfo appWidgetProviderInfo) throws RemoteException;

    void providersChanged() throws RemoteException;

    void updateAppWidget(int i10, RemoteViews remoteViews) throws RemoteException;

    void viewDataChanged(int i10, int i11) throws RemoteException;
