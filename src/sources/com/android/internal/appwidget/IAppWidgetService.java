...
public interface IAppWidgetService extends IInterface {
    int allocateAppWidgetId(String str, int i10) throws RemoteException;

    boolean bindAppWidgetId(String str, int i10, int i11, ComponentName componentName, Bundle bundle) throws RemoteException;

    boolean bindRemoteViewsService(String str, int i10, Intent intent, IApplicationThread iApplicationThread, IBinder iBinder, IServiceConnection iServiceConnection, long j10) throws RemoteException;

    IntentSender createAppWidgetConfigIntentSender(String str, int i10, int i11) throws RemoteException;

    void deleteAllHosts() throws RemoteException;

    void deleteAppWidgetId(String str, int i10) throws RemoteException;

    void deleteHost(String str, int i10) throws RemoteException;

    int[] getAppWidgetIds(ComponentName componentName) throws RemoteException;

    int[] getAppWidgetIdsForHost(String str, int i10) throws RemoteException;

    AppWidgetProviderInfo getAppWidgetInfo(String str, int i10) throws RemoteException;

    Bundle getAppWidgetOptions(String str, int i10) throws RemoteException;

    RemoteViews getAppWidgetViews(String str, int i10) throws RemoteException;

    ParceledListSlice getInstalledProvidersForProfile(int i10, int i11, String str) throws RemoteException;

    boolean hasBindAppWidgetPermission(String str, int i10) throws RemoteException;

    boolean isBoundWidgetPackage(String str, int i10) throws RemoteException;

    boolean isRequestPinAppWidgetSupported() throws RemoteException;

    void noteAppWidgetTapped(String str, int i10) throws RemoteException;

    void notifyAppWidgetViewDataChanged(String str, int[] iArr, int i10) throws RemoteException;
    ...
    void setAppWidgetHidden(String str, int i10) throws RemoteException;

    void setBindAppWidgetPermission(String str, int i10, boolean z10) throws RemoteException;

    ParceledListSlice startListening(IAppWidgetHost iAppWidgetHost, String str, int i10, int[] iArr) throws RemoteException;

    void stopListening(String str, int i10) throws RemoteException;

    void updateAppWidgetIds(String str, int[] iArr, RemoteViews remoteViews) throws RemoteException;

    void updateAppWidgetOptions(String str, int i10, Bundle bundle) throws RemoteException;
