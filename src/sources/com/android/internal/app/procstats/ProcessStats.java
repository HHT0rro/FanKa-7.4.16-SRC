...
public final class ProcessStats implements Parcelable {
    ...
    public void add(ProcessStats other) {
        ...
        for (int ip2 = 0; ip2 < size; ip2++) {
            ...
            if (uidState == null) {
                this.mUidStates.put(uid2, uidStates2.valueAt(ip2).m2188clone());
            } else {
        ...
        for (int i10 = 0; i10 < 8; i10++) {
            ...
            jArr[i10] = jArr[i10] + other.mMemFactorDurations[i10];
        }
        this.mSysMemUsage.mergeStats(other.mSysMemUsage);
        this.mNumAggregated += other.mNumAggregated;
        long j10 = other.mTimePeriodStartClock;
        if (j10 < this.mTimePeriodStartClock) {
            this.mTimePeriodStartClock = j10;
    ...
    public void addSysMemUsage(long cachedMem, long freeMem, long zramMem, long kernelMem, long nativeMem) {
        ...
        if (i10 != -1) {
            ...
            for (int i11 = 0; i11 < 3; i11++) {
                ...
                jArr[i11 + 1] = cachedMem;
                jArr[i11 + 4] = freeMem;
                jArr[i11 + 7] = zramMem;
                jArr[i11 + 10] = kernelMem;
                jArr[i11 + 13] = nativeMem;
            }
    ...
    public void computeTotalMemoryUse(TotalMemoryUseCollection data, long now) {
        ...
        while (true) {
            ...
            data.processStateWeight[i11] = 0.0d;
            data.processStatePss[i11] = 0;
            data.processStateTime[i11] = 0;
            data.processStateSamples[i11] = 0;
            i11++;
        }
        for (int i12 = 0; i12 < 16; i12++) {
            data.sysMemUsage[i12] = 0;
        }
        data.sysMemCachedWeight = ShadowDrawableWrapper.COS_45;
        data.sysMemFreeWeight = ShadowDrawableWrapper.COS_45;
        data.sysMemZRamWeight = ShadowDrawableWrapper.COS_45;
        data.sysMemKernelWeight = ShadowDrawableWrapper.COS_45;
        data.sysMemNativeWeight = ShadowDrawableWrapper.COS_45;
            ...
            while (im2 < data.memStates.length) {
                ...
                if (sysKey == -1) {
                    ...
                    if (tmpLongs[tmpIndex + 0] < 3) {
                        ...
                        SysMemUsageTable.mergeSysMemUsage(totalMemUsage3, i10, longs, 0);
                        longs = tmpLongs;
                        idx = tmpIndex;
                    }
                }
    ...
    private static int[] splitAndParseNumbers(String s2) {
        boolean digit = false;
        int count = 0;
        int N = s2.length();
    ...
    public void writeToParcel(Parcel parcel, long j10, int i10) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            SparseArray<ProcessState> valueAt = map.valueAt(i11);
            int size2 = valueAt.size();
            for (int i12 = 0; i12 < size2; i12++) {
                valueAt.valueAt(i12).commitStateTime(j10);
            }
        }
        ArrayMap<String, SparseArray<LongSparseArray<PackageState>>> map2 = this.mPackages.getMap();
        int size3 = map2.size();
        for (int i13 = 0; i13 < size3; i13++) {
            SparseArray<LongSparseArray<PackageState>> valueAt2 = map2.valueAt(i13);
            int size4 = valueAt2.size();
            for (int i14 = 0; i14 < size4; i14++) {
                LongSparseArray<PackageState> valueAt3 = valueAt2.valueAt(i14);
                int size5 = valueAt3.size();
                int i15 = 0;
                while (i15 < size5) {
                    PackageState valueAt4 = valueAt3.valueAt(i15);
                    ...
                    for (int i19 = 0; i19 < size7; i19++) {
                        valueAt4.mServices.valueAt(i19).commitStateTime(j10);
                    }
                    int size8 = valueAt4.mAssociations.size();
                    int i20 = 0;
                    while (i20 < size8) {
                        valueAt4.mAssociations.valueAt(i20).commitStateTime(j10);
                        i20++;
                        size7 = size7;
                    }
                    i15++;
        ...
        int i21 = this.mMemFactor;
        if (i21 != -1) {
            long[] jArr = this.mMemFactorDurations;
            jArr[i21] = jArr[i21] + (j10 - this.mStartTime);
            this.mStartTime = j10;
        }
        ...
        for (int i22 = 0; i22 < size9; i22++) {
            parcel.writeInt(this.mUidStates.keyAt(i22));
            this.mUidStates.valueAt(i22).writeToParcel(parcel, j10);
        }
        parcel.writeInt(size);
        for (int i23 = 0; i23 < size; i23++) {
            writeCommonString(parcel, map.keyAt(i23));
            SparseArray<ProcessState> valueAt6 = map.valueAt(i23);
            ...
            for (int i24 = 0; i24 < size10; i24++) {
                ...
                valueAt7.writeToParcel(parcel, j10);
            }
        }
        parcel.writeInt(size3);
        for (int i25 = 0; i25 < size3; i25++) {
            writeCommonString(parcel, map2.keyAt(i25));
            SparseArray<LongSparseArray<PackageState>> valueAt8 = map2.valueAt(i25);
            int size11 = valueAt8.size();
            parcel.writeInt(size11);
            for (int i26 = 0; i26 < size11; i26++) {
                parcel.writeInt(valueAt8.keyAt(i26));
                LongSparseArray<PackageState> valueAt9 = valueAt8.valueAt(i26);
                ...
                while (i27 < size12) {
                    ...
                    int i28 = size;
                    parcel.writeLong(valueAt9.keyAt(i27));
                    PackageState valueAt10 = valueAt9.valueAt(i27);
                    ...
                    while (i29 < size13) {
                        int i30 = size13;
                        writeCommonString(parcel, valueAt10.mProcesses.keyAt(i29));
                        ProcessState valueAt11 = valueAt10.mProcesses.valueAt(i29);
                        int i31 = size3;
                        if (valueAt11.getCommonProcess() == valueAt11) {
                            parcel.writeInt(0);
                        } else {
                            parcel.writeInt(1);
                            valueAt11.writeToParcel(parcel, j10);
                        }
                        i29++;
                        size13 = i30;
                        size3 = i31;
                    ...
                    int i33 = 0;
                    while (i33 < size14) {
                        parcel.writeString(valueAt10.mServices.keyAt(i33));
                        ServiceState valueAt12 = valueAt10.mServices.valueAt(i33);
                        writeCommonString(parcel, valueAt12.getProcessName());
                        valueAt12.writeToParcel(parcel, j10);
                        i33++;
                        size14 = size14;
                    }
                    ...
                    int i34 = 0;
                    while (i34 < size15) {
                        writeCommonString(parcel, valueAt10.mAssociations.keyAt(i34));
                        AssociationState valueAt13 = valueAt10.mAssociations.valueAt(i34);
                        writeCommonString(parcel, valueAt13.getProcessName());
                        valueAt13.writeToParcel(this, parcel, j10);
                        i34++;
                        valueAt10 = valueAt10;
                    }
                    i27++;
        ...
        for (int i35 = 0; i35 < size16; i35++) {
            parcel.writeInt(this.mPageTypeNodes.get(i35).intValue());
            parcel.writeString(this.mPageTypeZones.get(i35));
            parcel.writeString(this.mPageTypeLabels.get(i35));
            parcel.writeIntArray(this.mPageTypeSizes.get(i35));
        }
    ...
    public void read(InputStream stream) {
        try {
            ...
            this.mReadError = "caught exception: " + ((Object) e2);
        }
    }
            ...
            while (true) {
                ...
                if (NPROC2 > 0) {
                    ...
                    while (NUID > 0) {
                        ...
                        if (proc != null) {
                            if (proc.readFromParcel(in, version, z10)) {
                                uid2 = uid4;
                                procName = procName2;
                            } else {
                                return;
                    ...
                    for (int i10 = 0; i10 < NPAGETYPES; i10++) {
        ...
        if (!commonProc.isMultiPackage()) {
            if (pkgState.mPackageName.equals(commonProc.getPackage()) && pkgState.mVersionCode == commonProc.getVersion()) {
                ...
                if (commonPkgState != null) {
                    ...
                    for (int i10 = commonPkgState.mServices.size() - 1; i10 >= 0; i10--) {
                        ServiceState ss = commonPkgState.mServices.valueAt(i10);
                        if (ss.getProcess() == commonProc) {
                            ss.setProcess(cloned);
                        }
                    }
                    for (int i11 = commonPkgState.mAssociations.size() - 1; i11 >= 0; i11--) {
                        AssociationState as = commonPkgState.mAssociations.valueAt(i11);
    ...
    public void updateTrackingAssociationsLocked(int curSeq, long now) {
        ...
        for (int i10 = NUM - 1; i10 >= 0; i10--) {
            AssociationState.SourceState act = this.mTrackingAssociations.get(i10);
            if (act.stopActiveIfNecessary(curSeq, now)) {
                this.mTrackingAssociations.remove(i10);
            } else {
                ...
                if (asc == null) {
                    ...
                    if (proc == null) {
                        Slog.wtf(TAG, "Tracking association without process: " + ((Object) act) + " in " + ((Object) asc));
                    } else {
                        ...
                        if (act.mProcState == procState) {
                            ...
                            if (act.mProcState < procState) {
                                ...
                                if (this.mNextInverseProcStateWarningUptime <= nowUptime) {
                                    Slog.w(TAG, "Tracking association " + ((Object) act) + " whose proc state " + act.mProcState + " is better than process " + ((Object) proc) + " proc state " + procState + " (" + this.mSkippedInverseProcStateWarningCount + " skipped)");
                                    this.mSkippedInverseProcStateWarningCount = 0;
                                    this.mNextInverseProcStateWarningUptime = INVERSE_PROC_STATE_WARNING_MIN_INTERVAL_MS + nowUptime;
                                } else {
 ...
 */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ int lambda$static$0(AssociationDumpContainer o12, AssociationDumpContainer o22) {
        int diff = o12.mState.getProcessName().compareTo(o22.mState.getProcessName());
        if (diff != 0) {
            return diff;
        }
        if (o12.mActiveTime != o22.mActiveTime) {
            return o12.mActiveTime > o22.mActiveTime ? -1 : 1;
        }
        if (o12.mTotalTime != o22.mTotalTime) {
            return o12.mTotalTime > o22.mTotalTime ? -1 : 1;
        }
        int diff2 = o12.mState.getName().compareTo(o22.mState.getName());
        if (diff2 != 0) {
            return diff2;
        }
        return 0;
    ...
    public void dumpLocked(PrintWriter pw, String reqPackage, long now, boolean dumpSummary, boolean dumpDetails, boolean dumpAll, boolean activeOnly, int section) {
        ...
        pw.print("          Start time: ");
        pw.print(DateFormat.format(TimeUtils.STARD_FROMAT, processStats4.mTimePeriodStartClock));
        pw.println();
        pw.print("        Total uptime: ");
        android.util.TimeUtils.formatDuration((processStats4.mRunning ? SystemClock.uptimeMillis() : processStats4.mTimePeriodEndUptime) - processStats4.mTimePeriodStartUptime, pw);
        pw.println();
        pw.print("  Total elapsed time: ");
        android.util.TimeUtils.formatDuration((processStats4.mRunning ? SystemClock.elapsedRealtime() : processStats4.mTimePeriodEndRealtime) - processStats4.mTimePeriodStartRealtime, pw);
        ...
        if ((section & 1) == 0) {
            ...
            while (ip6 < procMap2.size()) {
                ...
                int i11 = numTotalProcs;
                int numTotalProcs2 = 0;
                int numTotalProcs3 = i11;
                while (true) {
                    procMap = procMap2;
        ...
        if (dumpAll) {
            ...
            if (processStats.mTrackingAssociations.size() > 0) {
                ...
                for (int i12 = 0; i12 < processStats.mTrackingAssociations.size(); i12++) {
                    AssociationState.SourceState src = processStats.mTrackingAssociations.get(i12);
                    ...
                    if (asc3 == null) {
                        ...
                        android.util.TimeUtils.formatDuration(now - src.mTrackingUptime, pw);
                        pw.println();
                        pw.print("    Component: ");
    ...
    private void dumpFragmentationLocked(PrintWriter pw) {
        ...
        for (int i10 = 0; i10 < NPAGETYPES; i10++) {
            pw.format("Node %3d Zone %7s  %14s ", this.mPageTypeNodes.get(i10), this.mPageTypeZones.get(i10), this.mPageTypeLabels.get(i10));
            int[] sizes = this.mPageTypeSizes.get(i10);
            int N = sizes == null ? 0 : sizes.length;
            for (int j10 = 0; j10 < N; j10++) {
                pw.format("%6d", Integer.valueOf(sizes[j10]));
            }
            pw.println();
        }
    }
    ...
    long printMemoryCategory(PrintWriter pw, String prefix, String label, double memWeight, long totalTime, long curTotalMem, int samples) {
        if (memWeight != ShadowDrawableWrapper.COS_45) {
    ...
    void dumpTotalsLocked(PrintWriter pw, long now) {
        ...
        while (i11 < 16) {
            if (i11 == 9) {
                ...
                i10 = i11;
                totalPss2 = printMemoryCategory(pw, "  ", DumpUtils.STATE_NAMES[i11], totalMem.processStateWeight[i11], totalMem.totalTime, totalPss2, totalMem.processStateSamples[i11]);
            }
            i11 = i10 + 1;
        }
        ...
        pw.print("x over ");
        android.util.TimeUtils.formatDuration(this.mInternalSinglePssTime, pw);
        pw.println();
        pw.print("  Internal All Procs (Memory Change): ");
        pw.print(this.mInternalAllMemPssCount);
        pw.print("x over ");
        android.util.TimeUtils.formatDuration(this.mInternalAllMemPssTime, pw);
        pw.println();
        pw.print("  Internal All Procs (Polling): ");
        pw.print(this.mInternalAllPollPssCount);
        pw.print("x over ");
        android.util.TimeUtils.formatDuration(this.mInternalAllPollPssTime, pw);
        pw.println();
        pw.print("  External: ");
        pw.print(this.mExternalPssCount);
        pw.print("x over ");
        android.util.TimeUtils.formatDuration(this.mExternalPssTime, pw);
        pw.println();
        pw.print("  External Slow: ");
        pw.print(this.mExternalSlowPssCount);
        pw.print("x over ");
        android.util.TimeUtils.formatDuration(this.mExternalSlowPssTime, pw);
        pw.println();
    }
    ...
    public ArrayList<ProcessState> collectProcessesLocked(int[] screenStates, int[] memStates, int[] procStates, int[] sortProcStates, long now, String reqPackage, boolean activeOnly) {
        ...
        for (int i10 = 0; i10 < foundProcs.size(); i10++) {
            ProcessState proc2 = foundProcs.valueAt(i10);
    ...
    public void dumpCheckinLocked(PrintWriter pw, String reqPackage, int section) {
        ...
        if (sysMemUsageCount <= 0) {
            ...
            int i10 = 0;
            while (i10 < sysMemUsageCount) {
                int key = processStats.mSysMemUsage.getKeyAt(i10);
                ...
                for (int j10 = 0; j10 < 16; j10++) {
                    ...
                    pw.print(processStats.mSysMemUsage.getValue(key, j10));
                }
                i10++;
                str = str6;
            }
        ...
        for (int i11 = 0; i11 < 16; i11++) {
            pw.print(str2);
            pw.print(totalMem.processStateWeight[i11]);
            pw.print(u.bD);
            pw.print(totalMem.processStateSamples[i11]);
        }
        pw.println();
        int NPAGETYPES = processStats.mPageTypeLabels.size();
        for (int i12 = 0; i12 < NPAGETYPES; i12++) {
            pw.print("availablepages,");
            pw.print(processStats.mPageTypeLabels.get(i12));
            pw.print(str2);
            pw.print(processStats.mPageTypeZones.get(i12));
            pw.print(str2);
            int[] sizes = processStats.mPageTypeSizes.get(i12);
            int N = sizes == null ? 0 : sizes.length;
    ...
    public void dumpDebug(ProtoOutputStream proto, long now, int section) {
        ...
        for (int i10 = 0; i10 < NPAGETYPES; i10++) {
            ...
            proto.write(1120986464257L, this.mPageTypeNodes.get(i10).intValue());
            proto.write(1138166333442L, this.mPageTypeZones.get(i10));
            proto.write(1138166333443L, this.mPageTypeLabels.get(i10));
            int[] sizes = this.mPageTypeSizes.get(i10);
            int N = sizes == null ? 0 : sizes.length;
            for (int j10 = 0; j10 < N; j10++) {
                proto.write(2220498092036L, sizes[j10]);
            }
            proto.end(token);
        }
        ArrayMap<String, SparseArray<ProcessState>> procMap = this.mProcesses.getMap();
    ...
    public void dumpAggregatedProtoForStatsd(ProtoOutputStream[] protoStreams, long maxRawShardSizeBytes) {
        ...
        for (int i10 = 0; i10 <= shardIndex; i10++) {
            protoStreams[i10].flush();
        }
    }
    ...
    private void collectProcessPackageMaps(String reqPackage, boolean activeOnly, ProcessMap<ArraySet<PackageState>> procToPkgMap, SparseArray<ArraySet<String>> uidToPkgMap) {
        ...
        while (ip >= 0) {
            String pkgName = pkgMap.keyAt(ip);
            SparseArray<LongSparseArray<PackageState>> procs = pkgMap.valueAt(ip);
            int iu = procs.size() - i10;
            while (iu >= 0) {
                LongSparseArray<PackageState> vpkgs = procs.valueAt(iu);
                int iv = vpkgs.size() - i10;
                while (iv >= 0) {
                    PackageState state = vpkgs.valueAt(iv);
                    int i11 = (str == null || str.equals(pkgName)) ? i10 : 0;
                    int iproc = state.mProcesses.size() - i10;
                    while (iproc >= 0) {
                        ProcessState proc = state.mProcesses.valueAt(iproc);
                        if ((i11 != 0 || str.equals(proc.getName())) && (!activeOnly || proc.isInUse())) {
    ...
    public void dumpFilteredAssociationStatesProtoForProc(ProtoOutputStream proto, long fieldId, long now, ProcessState procState, SparseArray<ArraySet<String>> uidToPkgMap) {
        ...
        if ((!procState.isMultiPackage() || procState.getCommonProcess() == procState) && (sources = procState.mCommonSources) != null && !sources.isEmpty() && (procStatsService = IProcessStats.Stub.asInterface(ServiceManager.getService(SERVICE_NAME))) != null) {
            try {
                ...
                int i11 = 1;
                int i12 = sources.size() - 1;
                while (i12 >= 0) {
                    AssociationState.SourceState src = sources.valueAt(i12);
                    ...
                    if (duration < minimum) {
                        ...
                        AssociationState.SourceKey key = sources.keyAt(i12);
                        ...
                        if (idx2 >= 0) {
                            ...
                            if (uidToPkgMap.valueAt(idx2).size() > 1) {
                                z10 = true;
                                i10 = idx;
                                ProcessState.writeCompressedProcessName(proto, 1138166333441L, str, str2, z10);
 ...
 */
    ...
    public static final class PackageState {
        ...
        public void dumpDebug(ProtoOutputStream proto, long fieldId, long now, int section) {
            ...
            if ((section & 8) != 0) {
                for (int ia2 = 0; ia2 < this.mAssociations.size(); ia2++) {
    ...
    public static final class ProcessDataCollection {
        ...
        public void print(PrintWriter pw, long overallTime, boolean full) {
            if (this.totalTime > overallTime) {
                pw.print(StringUtils.NO_PRINT_CODE);
            }
