...
public interface IProcessStats extends IInterface {
    ...
    long getCommittedStats(long j10, int i10, boolean z10, List<ParcelFileDescriptor> list) throws RemoteException;

    long getCommittedStatsMerged(long j10, int i10, boolean z10, List<ParcelFileDescriptor> list, ProcessStats processStats) throws RemoteException;
    ...
    ParcelFileDescriptor getStatsOverTime(long j10) throws RemoteException;
 ...
 */
        ...
        protected void getCurrentStats_enforcePermission() throws SecurityException {
            this.mEnforcer.enforcePermission("android.permission.PACKAGE_USAGE_STATS", getCallingPid(), getCallingUid());
        }
