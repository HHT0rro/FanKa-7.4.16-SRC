...
public class DisplayResolveInfo implements TargetInfo, Parcelable {
    ...
    public IDisplayResolveInfoExt mDisplayResolveInfoExt;
    ...
    public DisplayResolveInfo(Intent originalIntent, ResolveInfo pri, CharSequence pLabel, CharSequence pInfo, Intent resolvedIntent, ResolverListAdapter.ResolveInfoPresentationGetter resolveInfoPresentationGetter) {
        ...
        this.mPinned = false;
        this.mDisplayResolveInfoExt = (IDisplayResolveInfoExt) ExtLoader.type(IDisplayResolveInfoExt.class).base(this).create();
    ...
    public boolean startAsCaller(ResolverActivity activity, Bundle options, int userId) {
        ...
        if (userId == 999) {
            this.mResolvedIntent.getIntentExt().setOplusFlags(4096);
        } else {
            this.mResolvedIntent.getIntentExt().setOplusFlags(2048);
        }
    ...
    public boolean startAsUser(Activity activity, Bundle options, UserHandle user) {
        if (this.mDisplayResolveInfoExt.shouldPrepareIntentForCrossProfileLaunch(activity, this.mResolvedIntent)) {
