...
public final class SelectableTargetInfo implements ChooserTargetInfo {
    ...
    private ISelectableTargetInfoExt mSelectableTargetInfoExt;
 ...
 */
    ...
    public SelectableTargetInfo(Context context, DisplayResolveInfo sourceInfo, ChooserTarget chooserTarget, float modifiedScore, SelectableTargetInfoCommunicator selectableTargetInfoComunicator, ShortcutInfo shortcutInfo) {
        ...
        this.mSelectableTargetInfoExt = (ISelectableTargetInfoExt) ExtLoader.type(ISelectableTargetInfoExt.class).base((Object) null).create();
    ...
    private String sanitizeDisplayLabel(CharSequence label) {
        SpannableStringBuilder sb2 = new SpannableStringBuilder(label);
        sb2.clearSpans();
        return sb2.toString();
    }
    ...
    public boolean startAsCaller(ResolverActivity activity, Bundle options, int userId) {
        ...
        if (this.mSelectableTargetInfoExt.shouldPrepareIntentForCrossProfileLaunch(activity.getResolverWrapper().getResolverActivityExt())) {
