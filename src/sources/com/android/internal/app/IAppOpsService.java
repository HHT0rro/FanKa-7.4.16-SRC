...
public interface IAppOpsService extends IInterface {
    ...
    int checkAudioOperation(int i10, int i11, int i12, String str) throws RemoteException;

    int checkOperation(int i10, int i11, String str) throws RemoteException;

    int checkOperationRaw(int i10, int i11, String str, String str2) throws RemoteException;

    int checkPackage(int i10, String str) throws RemoteException;

    void clearHistory() throws RemoteException;

    void collectNoteOpCallsForValidation(String str, int i10, String str2, long j10) throws RemoteException;
    ...
    void finishOperation(IBinder iBinder, int i10, int i11, String str, String str2) throws RemoteException;

    void finishProxyOperation(IBinder iBinder, int i10, AttributionSource attributionSource, boolean z10) throws RemoteException;

    void getHistoricalOps(int i10, String str, String str2, List<String> list, int i11, int i12, long j10, long j11, int i13, RemoteCallback remoteCallback) throws RemoteException;

    void getHistoricalOpsFromDiskRaw(int i10, String str, String str2, List<String> list, int i11, int i12, long j10, long j11, int i13, RemoteCallback remoteCallback) throws RemoteException;

    List<AppOpsManager.PackageOps> getOpsForPackage(int i10, String str, int[] iArr) throws RemoteException;

    List<AppOpsManager.PackageOps> getPackagesForOps(int[] iArr) throws RemoteException;

    List<AppOpsManager.PackageOps> getUidOps(int i10, int[] iArr) throws RemoteException;

    boolean isOperationActive(int i10, int i11, String str) throws RemoteException;

    boolean isProxying(int i10, String str, String str2, int i11, String str3) throws RemoteException;

    SyncNotedAppOp noteOperation(int i10, int i11, String str, String str2, boolean z10, String str3, boolean z11) throws RemoteException;

    SyncNotedAppOp noteProxyOperation(int i10, AttributionSource attributionSource, boolean z10, String str, boolean z11, boolean z12) throws RemoteException;

    void offsetHistory(long j10) throws RemoteException;

    int permissionToOpCode(String str) throws RemoteException;

    void rebootHistory(long j10) throws RemoteException;
    ...
    void resetAllModes(int i10, String str) throws RemoteException;

    void resetHistoryParameters() throws RemoteException;

    void resetPackageOpsNoHistory(String str) throws RemoteException;

    void setAudioRestriction(int i10, int i11, int i12, int i13, String[] strArr) throws RemoteException;

    void setCameraAudioRestriction(int i10) throws RemoteException;

    void setHistoryParameters(int i10, long j10, int i11) throws RemoteException;

    void setMode(int i10, int i11, String str, int i12) throws RemoteException;

    void setUidMode(int i10, int i11, int i12) throws RemoteException;

    void setUserRestriction(int i10, boolean z10, IBinder iBinder, int i11, PackageTagsList packageTagsList) throws RemoteException;

    void setUserRestrictions(Bundle bundle, IBinder iBinder, int i10) throws RemoteException;

    boolean shouldCollectNotes(int i10) throws RemoteException;

    SyncNotedAppOp startOperation(IBinder iBinder, int i10, int i11, String str, String str2, boolean z10, boolean z11, String str3, boolean z12, int i12, int i13) throws RemoteException;

    SyncNotedAppOp startProxyOperation(IBinder iBinder, int i10, AttributionSource attributionSource, boolean z10, boolean z11, String str, boolean z12, boolean z13, int i11, int i12, int i13) throws RemoteException;
    ...
    void startWatchingMode(int i10, String str, IAppOpsCallback iAppOpsCallback) throws RemoteException;

    void startWatchingModeWithFlags(int i10, String str, int i11, IAppOpsCallback iAppOpsCallback) throws RemoteException;
