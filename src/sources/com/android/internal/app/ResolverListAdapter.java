...
public class ResolverListAdapter extends BaseAdapter {
    ...
    private IResolverListAdapterWrapper mResolverListAdapterWrapper = new ResolverListAdapterWrapper();
    private IResolverListAdapterExt mResolverListAdapterExt = (IResolverListAdapterExt) ExtLoader.type(IResolverListAdapterExt.class).base(this).create();
    List<DisplayResolveInfo> mDisplayList = new ArrayList();

    /* renamed from: -$$Nest$smgetSuspendedColorMatrix, reason: not valid java name */
    static /* bridge */ /* synthetic */ ColorMatrixColorFilter m2138$$Nest$smgetSuspendedColorMatrix() {
    ...
    public DisplayResolveInfo getFilteredItem() {
        int i10;
        if (this.mFilterLastUsed && (i10 = this.mLastChosenPosition) >= 0) {
    ...
    public boolean rebuildList(boolean doPostProcessing) {
        ...
        ResolveInfo oshareResolveInfo = getWrapper().getResolverListAdapterExt().getExternalResolvedInfo(this.mContext, this.mResolverListController.getResolversForIntentAsUser(false, false, false, this.mIntents, new UserHandle(999)), this.mIntents, currentResolveList, this.mResolverListController.getUserHandle());
        if (oshareResolveInfo != null && (list = this.mIntents) != null && !list.isEmpty()) {
            currentResolveList.add(new ResolverActivity.ResolvedComponentInfo(new ComponentName(oshareResolveInfo.activityInfo.packageName, oshareResolveInfo.activityInfo.name), this.mIntents.get(0), oshareResolveInfo));
        }
    ...
    boolean finishRebuildingListWithFilteredResults(List<ResolverActivity.ResolvedComponentInfo> filteredResolveList, boolean doPostProcessing) {
        ...
        getWrapper().getResolverListAdapterExt().setPlaceholderResolveList(filteredResolveList);
    ...
    public void processSortedList(List<ResolverActivity.ResolvedComponentInfo> sortedComponents, boolean doPostProcessing) {
        ResolveInfo ri;
        int n10 = sortedComponents != null ? sortedComponents.size() : 0;
        Trace.beginSection("ResolverListAdapter#processSortedList:" + n10);
        if (this.mResolverListAdapterWrapper.getResolverListAdapterExt().sortComponentsNull(sortedComponents, true)) {
            if (this.mInitialIntents != null) {
                ...
                while (true) {
                    ...
                    Intent ii = intentArr[i10];
                    if (ii != null && (ri = this.mResolverListAdapterWrapper.getResolverListAdapterExt().getResolveInfo(ii, this.mPm)) != null) {
                        UserManager userManager = (UserManager) this.mContext.getSystemService(UserData.NAME);
            ...
            if (this.mResolverListAdapterWrapper.getResolverListAdapterExt().sortComponentsNull(sortedComponents, false)) {
        ...
        IResolverListAdapterExt resolverListAdapterExt = this.mResolverListAdapterWrapper.getResolverListAdapterExt();
        List<Intent> list = this.mIntents;
        resolverListAdapterExt.addMultiAppResolveInfoIfNeed(sortedComponents, list, this.mResolverListController.getResolversForIntentAsUser(false, false, false, list, new UserHandle(999)), this.mPm, this.mDisplayList);
    ...
    private void addResolveInfoWithAlternates(ResolverActivity.ResolvedComponentInfo rci) {
        ...
        if (rci.isPinned()) {
            Log.i(TAG, "Pinned item: " + ((Object) rci.name));
        }
        addResolveInfo(dri);
        if (replaceIntent == intent) {
            for (int i10 = 1; i10 < count; i10++) {
                Intent altIntent = rci.getIntentAt(i10);
    ...
    private void addResolveInfo(DisplayResolveInfo dri) {
        if (dri != null && dri.getResolveInfo() != null && dri.getResolveInfo().targetUserId == -2 && shouldAddResolveInfo(dri)) {
            ...
            Log.i(TAG, "Add DisplayResolveInfo component: " + ((Object) dri.getResolvedComponentName()) + ", intent component: " + ((Object) dri.getResolvedIntent().getComponent()));
        }
    }
    ...
    public TargetInfo getItem(int position) {
        int i10;
        if (this.mFilterLastUsed && (i10 = this.mLastChosenPosition) >= 0 && position >= i10) {
            position++;
        }
        if (this.mDisplayList.size() > position) {
            return this.mDisplayList.get(position);
    ...
    View onCreateView(ViewGroup parent) {
        return this.mInflater.inflate(17367295, parent, false);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: Type inference failed for: r1v0, types: [com.android.internal.app.ResolverListAdapter$3] */
    public void loadFilteredItemIconTaskAsync(final ImageView iconView) {
        ...
        if (iconView != null && iconInfo != null) {
            new AsyncTask<Void, Void, Drawable>() { // from class: com.android.internal.app.ResolverListAdapter.3
                ...
                /* JADX INFO: Access modifiers changed from: protected */
                @Override // android.os.AsyncTask
                public void onPostExecute(Drawable d10) {
                    iconView.setImageDrawable(d10);
                }
            }.execute(new Void[0]);
        }
    }
 ...
 */
    ...
    public interface ResolverListCommunicator {
        ...
        void onPostListReady(ResolverListAdapter resolverListAdapter, boolean z10, boolean z11);
 ...
 */
    ...
    public static class ViewHolder {
        ...
        public void bindIcon(TargetInfo info) {
            ...
            if (info.isSuspended()) {
                this.icon.setColorFilter(ResolverListAdapter.m2138$$Nest$smgetSuspendedColorMatrix());
            } else {
    ...
    public class LoadLabelTask extends AsyncTask<Void, Void, CharSequence[]> {
        ...
        public CharSequence[] doInBackground(Void... voids) {
            ...
            if (ResolverListAdapter.this.mIsAudioCaptureDevice) {
                ...
                boolean hasRecordPermission = PermissionChecker.checkPermissionForPreflight(ResolverListAdapter.this.mContext, "android.permission.RECORD_AUDIO", -1, uid, packageName) == 0;
    ...
    public class LoadIconTask extends AsyncTask<Void, Void, Drawable> {
        ...
        public void onPostExecute(Drawable d10) {
            ...
            if (otherProfile == displayResolveInfo) {
                ...
                this.mDisplayResolveInfo.setDisplayIcon(d10);
                ResolverListAdapter.this.notifyDataSetChanged();
            }
        }
    }
    ...
    public static class ResolveInfoPresentationGetter extends ActivityInfoPresentationGetter {
        ...
        Drawable getIconSubstituteInternal() {
            ...
            try {
                ...
                Log.e(ResolverListAdapter.TAG, "SUBSTITUTE_SHARE_TARGET_APP_NAME_AND_ICON permission granted but couldn't find resources for package", e2);
            }
 ...
 */
    ...
    public static abstract class TargetPresentationGetter {
        ...
        TargetPresentationGetter(Context ctx, int iconDpi, ApplicationInfo ai) {
            ...
            this.mHasSubstitutePermission = packageManager.checkPermission("android.permission.SUBSTITUTE_SHARE_TARGET_APP_NAME_AND_ICON", ai.packageName) == 0;
        }
    ...
    public IResolverListAdapterWrapper getWrapper() {
        return this.mResolverListAdapterWrapper;
    }
 ...
 */
    /* loaded from: C:\Users\35037\Desktop\fankahook\2\class11.dex.bak */
    public class ResolverListAdapterWrapper implements IResolverListAdapterWrapper {
        public ResolverListAdapterWrapper() {
        }

        @Override // com.android.internal.app.IResolverListAdapterWrapper
        public IResolverListAdapterExt getResolverListAdapterExt() {
            if (ResolverListAdapter.this.mResolverListAdapterExt == null) {
                return IResolverListAdapterExt.DEFAULT;
            }
            return ResolverListAdapter.this.mResolverListAdapterExt;
        }
    }
}
