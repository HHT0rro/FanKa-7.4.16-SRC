...
public interface ISoundTriggerSession extends IInterface {
    ...
    int getParameter(ParcelUuid parcelUuid, int i10) throws RemoteException;
    ...
    SoundTrigger.ModelParamRange queryParameter(ParcelUuid parcelUuid, int i10) throws RemoteException;

    int setParameter(ParcelUuid parcelUuid, int i10, int i11) throws RemoteException;

    int startRecognition(SoundTrigger.GenericSoundModel genericSoundModel, IRecognitionStatusCallback iRecognitionStatusCallback, SoundTrigger.RecognitionConfig recognitionConfig, boolean z10) throws RemoteException;
