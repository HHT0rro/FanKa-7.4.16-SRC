...
public interface IVoiceInteractionSoundTriggerSession extends IInterface {
    ...
    int getParameter(int i10, int i11) throws RemoteException;

    SoundTrigger.ModelParamRange queryParameter(int i10, int i11) throws RemoteException;

    int setParameter(int i10, int i11, int i12) throws RemoteException;

    int startRecognition(int i10, String str, IHotwordRecognitionStatusCallback iHotwordRecognitionStatusCallback, SoundTrigger.RecognitionConfig recognitionConfig, boolean z10) throws RemoteException;

    int stopRecognition(int i10, IHotwordRecognitionStatusCallback iHotwordRecognitionStatusCallback) throws RemoteException;
