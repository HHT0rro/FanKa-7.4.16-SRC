...
public interface IVoiceInteractorCallback extends IInterface {
    ...
    void deliverCommandResult(IVoiceInteractorRequest iVoiceInteractorRequest, boolean z10, Bundle bundle) throws RemoteException;

    void deliverCompleteVoiceResult(IVoiceInteractorRequest iVoiceInteractorRequest, Bundle bundle) throws RemoteException;

    void deliverConfirmationResult(IVoiceInteractorRequest iVoiceInteractorRequest, boolean z10, Bundle bundle) throws RemoteException;

    void deliverPickOptionResult(IVoiceInteractorRequest iVoiceInteractorRequest, boolean z10, VoiceInteractor.PickOptionRequest.Option[] optionArr, Bundle bundle) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IVoiceInteractorCallback {
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 7:
                    return LandingPageUtHelper.XAD_UT_LP_DESTROY;
                default:
                    return null;
            }
        }
