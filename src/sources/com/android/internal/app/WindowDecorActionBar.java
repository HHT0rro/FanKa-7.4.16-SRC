...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        ActionBarOverlayLayout findViewById = decor.findViewById(16908958);
        this.mOverlayLayout = findViewById;
        if (findViewById != null) {
            findViewById.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(16908736));
        this.mContextView = decor.findViewById(16908741);
        this.mContainerView = decor.findViewById(16908737);
        this.mSplitView = decor.findViewById(16909558);
        ...
        TypedArray a10 = this.mContext.obtainStyledAttributes(null, R.styleable.ActionBar, 16843470, 0);
        if (a10.getBoolean(21, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a10.getDimensionPixelSize(20, 0);
        if (elevation != 0) {
    ...
    public void dispatchMenuVisibilityChanged(boolean isVisible) {
        ...
        for (int i10 = 0; i10 < count; i10++) {
            this.mMenuVisibilityListeners.get(i10).onMenuVisibilityChanged(isVisible);
        }
    }
    ...
    public void setBackgroundDrawable(Drawable d10) {
        this.mContainerView.setPrimaryBackground(d10);
    }

    @Override // android.app.ActionBar
    public void setStackedBackgroundDrawable(Drawable d10) {
        this.mContainerView.setStackedBackground(d10);
    }
    ...
    public void setSplitBackgroundDrawable(Drawable d10) {
        ActionBarContainer actionBarContainer = this.mSplitView;
        if (actionBarContainer != null) {
            actionBarContainer.setSplitBackground(d10);
        }
    }
    ...
    private void configureTab(ActionBar.Tab tab, int position) {
        ...
        for (int i10 = position + 1; i10 < count; i10++) {
    ...
    public void removeTabAt(int position) {
        ...
        for (int i10 = position; i10 < newTabCount; i10++) {
            this.mTabs.get(i10).setPosition(i10);
        }
    ...
    public void doShow(boolean fromSystem) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || fromSystem)) {
            ...
            ObjectAnimator a10 = ObjectAnimator.ofFloat(this.mContainerView, (Property<ActionBarContainer, Float>) View.TRANSLATION_Y, 0.0f);
            a10.addUpdateListener(this.mUpdateListener);
            AnimatorSet.Builder b4 = anim.play(a10);
            if (this.mContentAnimations && (view2 = this.mContentView) != null) {
                b4.with(ObjectAnimator.ofFloat(view2, View.TRANSLATION_Y, startingY, 0.0f));
            }
            ActionBarContainer actionBarContainer = this.mSplitView;
            if (actionBarContainer != null && this.mContextDisplayMode == 1) {
                actionBarContainer.setTranslationY(actionBarContainer.getHeight());
                this.mSplitView.setVisibility(0);
                b4.with(ObjectAnimator.ofFloat(this.mSplitView, (Property<ActionBarContainer, Float>) View.TRANSLATION_Y, 0.0f));
            }
    ...
    public void doHide(boolean fromSystem) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || fromSystem)) {
            ...
            ObjectAnimator a10 = ObjectAnimator.ofFloat(this.mContainerView, (Property<ActionBarContainer, Float>) View.TRANSLATION_Y, endingY);
            a10.addUpdateListener(this.mUpdateListener);
            AnimatorSet.Builder b4 = anim.play(a10);
            if (this.mContentAnimations && (view = this.mContentView) != null) {
                b4.with(ObjectAnimator.ofFloat(view, View.TRANSLATION_Y, 0.0f, endingY));
            }
            ActionBarContainer actionBarContainer = this.mSplitView;
            if (actionBarContainer != null && actionBarContainer.getVisibility() == 0) {
                this.mSplitView.setAlpha(1.0f);
                b4.with(ObjectAnimator.ofFloat(this.mSplitView, (Property<ActionBarContainer, Float>) View.TRANSLATION_Y, this.mSplitView.getHeight()));
            }
    ...
    void animateToMode(boolean toActionMode) {
        ...
        if (shouldAnimateContextView()) {
            if (toActionMode) {
                fadeIn2 = this.mDecorToolbar.setupAnimatorToVisibility(8, 100L);
