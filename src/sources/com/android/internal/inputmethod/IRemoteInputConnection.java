...
public interface IRemoteInputConnection extends IInterface {
    ...
    void clearMetaKeyStates(InputConnectionCommandHeader inputConnectionCommandHeader, int i10) throws RemoteException;
    ...
    void commitContent(InputConnectionCommandHeader inputConnectionCommandHeader, InputContentInfo inputContentInfo, int i10, Bundle bundle, AndroidFuture androidFuture) throws RemoteException;
    ...
    void commitText(InputConnectionCommandHeader inputConnectionCommandHeader, CharSequence charSequence, int i10) throws RemoteException;

    void commitTextWithTextAttribute(InputConnectionCommandHeader inputConnectionCommandHeader, CharSequence charSequence, int i10, TextAttribute textAttribute) throws RemoteException;

    void deleteSurroundingText(InputConnectionCommandHeader inputConnectionCommandHeader, int i10, int i11) throws RemoteException;

    void deleteSurroundingTextInCodePoints(InputConnectionCommandHeader inputConnectionCommandHeader, int i10, int i11) throws RemoteException;
    ...
    void getCursorCapsMode(InputConnectionCommandHeader inputConnectionCommandHeader, int i10, AndroidFuture androidFuture) throws RemoteException;

    void getExtractedText(InputConnectionCommandHeader inputConnectionCommandHeader, ExtractedTextRequest extractedTextRequest, int i10, AndroidFuture androidFuture) throws RemoteException;

    void getSelectedText(InputConnectionCommandHeader inputConnectionCommandHeader, int i10, AndroidFuture androidFuture) throws RemoteException;

    void getSurroundingText(InputConnectionCommandHeader inputConnectionCommandHeader, int i10, int i11, int i12, AndroidFuture androidFuture) throws RemoteException;

    void getTextAfterCursor(InputConnectionCommandHeader inputConnectionCommandHeader, int i10, int i11, AndroidFuture androidFuture) throws RemoteException;

    void getTextBeforeCursor(InputConnectionCommandHeader inputConnectionCommandHeader, int i10, int i11, AndroidFuture androidFuture) throws RemoteException;

    void performContextMenuAction(InputConnectionCommandHeader inputConnectionCommandHeader, int i10) throws RemoteException;

    void performEditorAction(InputConnectionCommandHeader inputConnectionCommandHeader, int i10) throws RemoteException;
    ...
    void replaceText(InputConnectionCommandHeader inputConnectionCommandHeader, int i10, int i11, CharSequence charSequence, int i12, TextAttribute textAttribute) throws RemoteException;

    void requestCursorUpdates(InputConnectionCommandHeader inputConnectionCommandHeader, int i10, int i11, AndroidFuture androidFuture) throws RemoteException;

    void requestCursorUpdatesWithFilter(InputConnectionCommandHeader inputConnectionCommandHeader, int i10, int i11, int i12, AndroidFuture androidFuture) throws RemoteException;
    ...
    void setComposingRegion(InputConnectionCommandHeader inputConnectionCommandHeader, int i10, int i11) throws RemoteException;

    void setComposingRegionWithTextAttribute(InputConnectionCommandHeader inputConnectionCommandHeader, int i10, int i11, TextAttribute textAttribute) throws RemoteException;

    void setComposingText(InputConnectionCommandHeader inputConnectionCommandHeader, CharSequence charSequence, int i10) throws RemoteException;

    void setComposingTextWithTextAttribute(InputConnectionCommandHeader inputConnectionCommandHeader, CharSequence charSequence, int i10, TextAttribute textAttribute) throws RemoteException;

    void setImeConsumesInput(InputConnectionCommandHeader inputConnectionCommandHeader, boolean z10) throws RemoteException;

    void setSelection(InputConnectionCommandHeader inputConnectionCommandHeader, int i10, int i11) throws RemoteException;
