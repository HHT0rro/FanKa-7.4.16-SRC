...
public interface IInputMethodSession extends IInterface {
    ...
    void invalidateInput(EditorInfo editorInfo, IRemoteInputConnection iRemoteInputConnection, int i10) throws RemoteException;
    ...
    void updateExtractedText(int i10, ExtractedText extractedText) throws RemoteException;

    void updateSelection(int i10, int i11, int i12, int i13, int i14, int i15) throws RemoteException;

    void viewClicked(boolean z10) throws RemoteException;
