...
public final class InputMethodDebug {
    ...
    public static String dumpViewInfo(View view) {
        ...
        sb2.append(",focus=" + view.hasFocus());
        sb2.append(",windowFocus=" + view.hasWindowFocus());
        sb2.append(",window=" + ((Object) view.getWindowToken()));
        sb2.append(",displayId=" + view.getContext().getDisplayId());
        sb2.append(",temporaryDetach=" + view.isTemporarilyDetached());
        sb2.append(",hasImeFocus=" + view.hasImeFocus());
        return sb2.toString();
    }
}
