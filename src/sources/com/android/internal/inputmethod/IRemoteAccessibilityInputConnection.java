...
public interface IRemoteAccessibilityInputConnection extends IInterface {
    ...
    void commitText(InputConnectionCommandHeader inputConnectionCommandHeader, CharSequence charSequence, int i10, TextAttribute textAttribute) throws RemoteException;
