...
public interface IInputMethodPrivilegedOperations extends IInterface {
    ...
    void applyImeVisibilityAsync(IBinder iBinder, boolean z10, ImeTracker.Token token) throws RemoteException;

    void createInputContentUriToken(Uri uri, String str, AndroidFuture androidFuture) throws RemoteException;

    void hideMySoftInput(int i10, int i11, AndroidFuture androidFuture) throws RemoteException;

    void notifyUserActionAsync() throws RemoteException;

    void onStylusHandwritingReady(int i10, int i11) throws RemoteException;

    void reportFullscreenModeAsync(boolean z10) throws RemoteException;

    void reportStartInputAsync(IBinder iBinder) throws RemoteException;

    void resetStylusHandwriting(int i10) throws RemoteException;

    void setImeWindowStatusAsync(int i10, int i11) throws RemoteException;
    ...
    void showMySoftInput(int i10, AndroidFuture androidFuture) throws RemoteException;

    void switchToNextInputMethod(boolean z10, AndroidFuture androidFuture) throws RemoteException;

    void switchToPreviousInputMethod(AndroidFuture androidFuture) throws RemoteException;

    void updateStatusIconAsync(String str, int i10) throws RemoteException;
