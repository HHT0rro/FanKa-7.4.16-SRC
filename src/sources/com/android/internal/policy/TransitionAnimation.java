...
public class TransitionAnimation {
    ...
    private static final ITransitionAnimationExt.IStaticExt mTransitionAnimationStaticExt = (ITransitionAnimationExt.IStaticExt) ExtLoader.type(ITransitionAnimationExt.IStaticExt.class).create();
    ...
    private final Interpolator mThumbnailFadeInInterpolator = new Interpolator() { // from class: com.android.internal.policy.TransitionAnimation$$ExternalSyntheticLambda0
        ...
        public final float getInterpolation(float f10) {
            float lambda$new$0;
            lambda$new$0 = TransitionAnimation.this.lambda$new$0(f10);
            return lambda$new$0;
        }
    };
    private final Interpolator mThumbnailFadeOutInterpolator = new Interpolator() { // from class: com.android.internal.policy.TransitionAnimation$$ExternalSyntheticLambda1
        ...
        public final float getInterpolation(float f10) {
            float lambda$new$1;
            lambda$new$1 = TransitionAnimation.this.lambda$new$1(f10);
            return lambda$new$1;
        }
    };
    ...
    public /* synthetic */ float lambda$new$0(float input) {
        if (input >= 0.5f) {
            float t2 = (input - 0.5f) / 0.5f;
            return this.mFastOutLinearInInterpolator.getInterpolation(t2);
        }
        return 0.0f;
    }
    ...
    public /* synthetic */ float lambda$new$1(float input) {
        if (input < 0.5f) {
            float t2 = input / 0.5f;
            return this.mLinearOutSlowInInterpolator.getInterpolation(t2);
        }
        return 1.0f;
    }
    ...
    public Animation loadKeyguardUnoccludeAnimation() {
        return loadDefaultAnimationRes(17432776);
    }
    ...
    public Animation loadVoiceActivityOpenAnimation(boolean enter) {
        ...
        return loadDefaultAnimationRes(i10);
    }
    ...
    public Animation loadCrossProfileAppEnterAnimation() {
        return loadAnimationRes("android", 17432753);
    }

    public Animation loadCrossProfileAppThumbnailEnterAnimation() {
        return loadAnimationRes("android", 17432609);
    }
    ...
    public Animation createClipRevealAnimationLockedCompat(int transit, boolean enter, Rect appFrame, Rect displayFrame, Rect startRect) {
        ...
        if (enter) {
            ...
            if (appHeight <= 0) {
                ...
                float t10 = this.mTmpRect.top / displayFrame.height();
                t2 = t10;
            }
            int translationY2 = this.mClipRevealTranslationY + ((int) ((displayFrame.height() / 7.0f) * t2));
            int translationX2 = 0;
        ...
        if (transit == 14) {
            ...
            if (transit != 15) {
                ...
                anim.setFillAfter(z10);
                return anim;
            }
            f10 = 1.0f;
        }
        anim = new AlphaAnimation(f10, 0.0f);
        z10 = true;
    ...
    public Animation createThumbnailEnterExitAnimationLockedCompat(boolean enter, boolean scaleUp, Rect containingFrame, int transit, HardwareBuffer thumbnailHeader, Rect startRect) {
        ...
        switch (thumbTransitState) {
            case 0:
                ...
                a10 = new ScaleAnimation(scaleW, 1.0f, scaleH, 1.0f, computePivot(this.mTmpRect.left, scaleW), computePivot(this.mTmpRect.top, scaleH));
                break;
            case 1:
                if (transit == 14) {
                    a10 = new AlphaAnimation(1.0f, 0.0f);
                    break;
                } else {
                    a10 = new AlphaAnimation(1.0f, 1.0f);
                    break;
                }
            case 2:
                a10 = new AlphaAnimation(1.0f, 1.0f);
        ...
        return prepareThumbnailAnimation(a10, appWidth, appHeight, transit);
    }
    ...
    public Animation createAspectScaledThumbnailEnterExitAnimationLocked(boolean enter, boolean scaleUp, int orientation, int transit, Rect containingFrame, Rect contentInsets, Rect surfaceInsets, Rect stableInsets, boolean freeform, Rect startRect, Rect defaultStartRect) {
        ...
        switch (thumbTransitState) {
            ...
            case 3:
                if (freeform && scaleUp) {
                    a10 = createAspectScaledThumbnailEnterFreeformAnimationLocked(containingFrame, surfaceInsets, startRect, defaultStartRect);
                    appHeight = appHeight2;
                    break;
                } else if (freeform) {
                    a10 = createAspectScaledThumbnailExitFreeformAnimationLocked(containingFrame, surfaceInsets, startRect, defaultStartRect);
                    appHeight = appHeight2;
                    break;
                } else {
                    AnimationSet set = new AnimationSet(true);
                    ...
                    if (shouldScaleDownThumbnailTransition(orientation)) {
                        ...
                        float x10 = (containingFrame.width() / 2.0f) - ((containingFrame.width() / 2.0f) * scale);
                        float targetY = this.mTmpRect.top - containingFrame.top;
                        float y10 = (containingFrame.height() / 2.0f) - ((containingFrame.height() / 2.0f) * scale);
                        if (this.mLowRamRecentsEnabled && contentInsets.top == 0 && scaleUp) {
                            appHeight = appHeight2;
                            this.mTmpFromClipRect.top += stableInsets.top;
                            y10 += stableInsets.top;
                        } else {
                            appHeight = appHeight2;
                        }
                        float scale2 = targetX - x10;
                        float startY = targetY - y10;
                        if (!scaleUp) {
            ...
            case 1:
                if (transit == 14) {
                    ...
                    Animation a11 = new AlphaAnimation(1.0f, 1.0f);
                    a10 = a11;
                    appHeight = appHeight2;
                    break;
                }
            case 2:
                if (transit == 14) {
                    a10 = new AlphaAnimation(0.0f, 1.0f);
                    appHeight = appHeight2;
                    break;
                } else {
                    Animation a12 = new AlphaAnimation(1.0f, 1.0f);
                    a10 = a12;
                    appHeight = appHeight2;
                    break;
                }
        ...
        return prepareThumbnailAnimationWithDuration(a10, appWidth, appHeight, 336L, this.mTouchResponseInterpolator);
    }
    ...
    public HardwareBuffer createCrossProfileAppsThumbnail(Drawable thumbnailDrawable, Rect frame) {
        ...
        int thumbnailSize = this.mContext.getResources().getDimensionPixelSize(17105155);
    ...
    private Animation prepareThumbnailAnimation(Animation a10, int appWidth, int appHeight, int transit) {
        int duration;
        switch (transit) {
            case 6:
            case 7:
        ...
        return prepareThumbnailAnimationWithDuration(a10, appWidth, appHeight, duration, this.mDecelerateInterpolator);
    }
    ...
    public static Animation prepareThumbnailAnimationWithDuration(Animation a10, int appWidth, int appHeight, long duration, Interpolator interpolator) {
        if (a10 == null) {
            return null;
        }
        if (duration > 0) {
        ...
        a10.initialize(appWidth, appHeight, appWidth, appHeight);
        return a10;
    }
    ...
    public static Animation loadAnimationSafely(Context context, int resId, String tag) {
        try {
            try {
                try {
                    return mTransitionAnimationStaticExt.hookLoadAnimationSafely(context, context.getPackageName(), resId, AnimationUtils.loadAnimation(context, resId));
                } catch (Exception e2) {
                    Slog.w(tag, "fail to add corners to animation ", e2);
                    return AnimationUtils.loadAnimation(context, resId);
                }
            } catch (Resources.NotFoundException | InflateException e10) {
                Slog.w(tag, "Unable to load animation resource", e10);
                return null;
            }
        } catch (RuntimeException e11) {
            Slog.w(tag, "Unable to load animation: Unknown animation name", e11);
            return null;
        }
    }
    ...
    public static Animation createHiddenByKeyguardExit(Context context, LogDecelerateInterpolator interpolator, boolean onWallpaper, boolean goingToNotificationShade, boolean subtleAnimation) {
        ...
        if (goingToNotificationShade) {
            return AnimationUtils.loadAnimation(context, 17432675);
        }
        if (subtleAnimation) {
            resource = 17432676;
        } else if (onWallpaper) {
        ...
        for (int i10 = animations.size() - 1; i10 >= 0; i10--) {
            animations.get(i10).setInterpolator(interpolator);
        }
        return set;
    }

    public static void configureScreenshotLayer(SurfaceControl.Transaction t2, SurfaceControl layer, ScreenCapture.ScreenshotHardwareBuffer buffer) {
        t2.setBuffer(layer, buffer.getHardwareBuffer());
        t2.setDataSpace(layer, buffer.getColorSpace().getDataSpace());
        if (buffer.containsHdrLayers()) {
            t2.setDimmingEnabled(layer, false);
        }
    }
    ...
    public static float getBorderLuma(SurfaceControl surfaceControl, int w3, int h10) {
        ScreenCapture.ScreenshotHardwareBuffer buffer = ScreenCapture.captureLayers(surfaceControl, new Rect(0, 0, w3, h10), 1.0f);
        if (buffer == null) {
            return 0.0f;
        }
    ...
    public static float getBorderLuma(HardwareBuffer hwBuffer, ColorSpace colorSpace) {
        ...
        if (hwBuffer != null && (format = hwBuffer.getFormat()) == 1 && !hasProtectedContent(hwBuffer)) {
            ...
            if (image != null && image.getPlaneCount() >= 1) {
                ...
                int i10 = 0;
                int size = width - 10;
                for (int x10 = 0; x10 < size; x10 += 10) {
                    int i11 = i10 + 1;
                    borderLumas[i10] = getPixelLuminance(buffer, x10, 0, pixelStride, rowStride);
                    i10 = i11 + 1;
                    borderLumas[i11] = getPixelLuminance(buffer, x10, height - 1, pixelStride, rowStride);
                }
                int y10 = 0;
                int size2 = height - 10;
                while (y10 < size2) {
                    int i12 = i10 + 1;
                    borderLumas[i10] = getPixelLuminance(buffer, 0, y10, pixelStride, rowStride);
                    i10 = i12 + 1;
                    borderLumas[i12] = getPixelLuminance(buffer, width - 1, y10, pixelStride, rowStride);
                    y10 += 10;
                    plane = plane;
                }
                ir.close();
    ...
    private static int getPixelLuminance(ByteBuffer buffer, int x10, int y10, int pixelStride, int rowStride) {
        int color = buffer.getInt((y10 * rowStride) + (x10 * pixelStride));
        int r10 = color & 255;
        int g3 = (color >> 8) & 255;
        int b4 = (color >> 16) & 255;
        return (((r10 * 8) + (g3 * 22)) + (b4 * 2)) >> 5;
    }
}
