...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    private IPhoneWindowExt mPhoneWindowExt;
    ...
    private IPhoneWindowWrapper mWrapper;
 ...
 */
    ...
    public PhoneWindow(Context context) {
        ...
        this.mInvalidatePanelMenuRunnable = new Runnable() { // from class: com.android.internal.policy.PhoneWindow.1
            ...
            public void run() {
                for (int i10 = 0; i10 <= 13; i10++) {
                    if ((PhoneWindow.this.mInvalidatePanelMenuFeatures & (1 << i10)) != 0) {
                        PhoneWindow.this.doInvalidatePanelMenu(i10);
                    }
                }
        ...
        this.mWrapper = new PhoneWindowWrapper();
        this.mPhoneWindowExt = (IPhoneWindowExt) ExtLoader.type(IPhoneWindowExt.class).base(this).create();
        this.mLayoutInflater = LayoutInflater.from(context);
        this.mRenderShadowsInCompositor = Settings.Global.getInt(context.getContentResolver(), "render_shadows_in_compositor", 1) != 0;
        this.mProxyOnBackInvokedDispatcher = new ProxyOnBackInvokedDispatcher(context);
        this.mPhoneWindowExt.init(context);
    }
    ...
    public PhoneWindow(Context context, Window preservedWindow, ViewRootImpl.ActivityConfigCallback activityConfigCallback) {
        ...
        if (Settings.Global.getInt(context.getContentResolver(), "force_resizable_activities", 0) != 0) {
            forceResizable = true;
        } else {
            forceResizable = false;
        }
        if (!forceResizable && !context.getPackageManager().hasSystemFeature("android.software.picture_in_picture")) {
            z10 = false;
        }
        this.mSupportsPictureInPicture = z10;
    ...
    public void setContentView(int layoutResID) {
        ...
        Window.Callback cb2 = getCallback();
        if (cb2 != null && !isDestroyed()) {
            cb2.onContentChanged();
        }
    ...
    public final boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        Window.Callback cb2 = getCallback();
        if (cb2 != null) {
            st.createdPanelView = cb2.onCreatePanelView(st.featureId);
        }
        ...
        if (st.createdPanelView == null) {
            if (st.menu == null || st.refreshMenuContent) {
                ...
                if (cb2 == null || !cb2.onCreatePanelMenu(st.featureId, st.menu)) {
                    st.setMenu(null);
            ...
            if (!cb2.onPreparePanel(st.featureId, st.createdPanelView, st.menu)) {
    ...
    private void openPanel(PanelFeatureState st, KeyEvent event) {
        ...
        Window.Callback cb2 = getCallback();
        if (cb2 != null && !cb2.onMenuOpened(st.featureId, st.menu)) {
            closePanel(st, true);
            return;
        }
        ...
        st.isHandled = false;
        WindowManager.LayoutParams lp3 = new WindowManager.LayoutParams(width, -2, st.f9301x, st.f9302y, 1003, 8519680, st.decorView.mDefaultOpacity);
        if (st.isCompact) {
    ...
    public final void closeAllPanels() {
        ...
        for (int i10 = 0; i10 < N; i10++) {
            PanelFeatureState panel = panels[i10];
            if (panel != null) {
    ...
    public boolean onMenuItemSelected(MenuBuilder menu, MenuItem item) {
        ...
        Window.Callback cb2 = getCallback();
        if (cb2 != null && !isDestroyed() && (panel = findMenuPanel(menu.getRootMenu())) != null) {
            return cb2.onMenuItemSelected(panel.featureId, item);
        }
        return false;
    }
        ...
        if (decorContentParent != null && decorContentParent.canShowOverflowMenu() && (!ViewConfiguration.get(getContext()).hasPermanentMenuKey() || this.mDecorContentParent.isOverflowMenuShowPending())) {
            ...
            if (!this.mDecorContentParent.isOverflowMenuShowing() || !toggleMenuMode) {
                if (cb2 != null && !isDestroyed()) {
                    ...
                    if (st != null && st.menu != null && !st.refreshMenuContent && cb2.onPreparePanel(0, st.createdPanelView, st.menu)) {
                        cb2.onMenuOpened(8, st.menu);
                        this.mDecorContentParent.showOverflowMenu();
                        return;
                    }
                    return;
            ...
            if (st2 != null && cb2 != null && !isDestroyed()) {
                cb2.onPanelClosed(8, st2.menu);
                return;
            }
            return;
        }
    ...
    protected boolean initializePanelDecor(PanelFeatureState st) {
        ...
        TypedArray a10 = getContext().obtainStyledAttributes(null, R.styleable.Window, 0, st.listPresenterTheme);
        float elevation = a10.getDimension(37, 0.0f);
        if (elevation != 0.0f) {
    ...
    public boolean performContextMenuIdentifierAction(int id2, int flags) {
        ContextMenuBuilder contextMenuBuilder = this.mContextMenu;
        if (contextMenuBuilder != null) {
            return contextMenuBuilder.performIdentifierAction(id2, flags);
        }
        return false;
    }
    ...
    protected void onIntChanged(int featureId, int value) {
        ...
        } else if (featureId == 7 && (titleContainer = (FrameLayout) findViewById(16909647)) != null) {
    ...
    public void setIcon(int resId) {
        this.mIconRes = resId;
        int i10 = this.mResourcesSetFlags | 1;
        this.mResourcesSetFlags = i10;
        this.mResourcesSetFlags = i10 & (-5);
        DecorContentParent decorContentParent = this.mDecorContentParent;
        if (decorContentParent != null) {
    ...
    public boolean onKeyDown(int featureId, int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            ...
            case 25:
            case 164:
                this.mPhoneWindowExt.hookForInputLogV("onKeyDown adjust Volume:" + keyCode + " | " + isActivePhoneCallOngoing());
    ...
    public boolean onKeyUp(int featureId, int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            ...
            case 24:
            case 25:
                this.mPhoneWindowExt.hookForInputLogV("onKeyUp adjust Volume:" + keyCode);
    ...
    private void restorePanelState(SparseArray<Parcelable> icicles) {
        for (int i10 = icicles.size() - 1; i10 >= 0; i10--) {
            int curFeatureId = icicles.keyAt(i10);
    ...
    public void openPanelsAfterRestore() {
        ...
        for (int i10 = panels.length - 1; i10 >= 0; i10--) {
            PanelFeatureState st = panels[i10];
            if (st != null) {
                st.applyFrozenState();
 ...
 */
    ...
    public class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(MenuBuilder menu, boolean allMenusAreClosing) {
            ...
            PanelFeatureState panel = PhoneWindow.this.findMenuPanel(isSubMenu ? rootMenu : menu);
            if (panel != null) {
                if (isSubMenu) {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            Window.Callback cb2;
            if (subMenu == null && PhoneWindow.this.hasFeature(8) && (cb2 = PhoneWindow.this.getCallback()) != null && !PhoneWindow.this.isDestroyed()) {
                cb2.onMenuOpened(8, subMenu);
                return true;
            }
            return true;
        }
 ...
 */
    ...
    public final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            Window.Callback cb2 = PhoneWindow.this.getCallback();
            if (cb2 != null) {
                cb2.onMenuOpened(8, subMenu);
                return true;
            }
    ...
    protected ViewGroup generateLayout(DecorView decor) {
        ...
        TypedArray a10 = getWindowStyle();
        this.mIsFloating = a10.getBoolean(4, false);
        ...
        if (a10.getBoolean(3, false)) {
            requestFeature(1);
        } else if (a10.getBoolean(15, false)) {
            requestFeature(8);
        }
        if (a10.getBoolean(17, false)) {
            requestFeature(9);
        }
        if (a10.getBoolean(16, false)) {
            requestFeature(10);
        }
        if (a10.getBoolean(9, false)) {
            setFlags(1024, (~getForcedWindowFlags()) & 1024);
        }
        if (a10.getBoolean(23, false)) {
            setFlags(67108864, (~getForcedWindowFlags()) & 67108864);
        }
        if (a10.getBoolean(24, false)) {
            setFlags(134217728, (~getForcedWindowFlags()) & 134217728);
        }
        if (a10.getBoolean(14, false)) {
            setFlags(1048576, (~getForcedWindowFlags()) & 1048576);
        }
        if (a10.getBoolean(18, getContext().getApplicationInfo().targetSdkVersion >= 11)) {
            setFlags(8388608, (~getForcedWindowFlags()) & 8388608);
        }
        a10.getValue(19, this.mMinWidthMajor);
        a10.getValue(20, this.mMinWidthMinor);
        if (DEBUG) {
        ...
        if (a10.hasValue(66)) {
            ...
            a10.getValue(66, this.mFixedWidthMajor);
        }
        if (a10.hasValue(67)) {
            if (this.mFixedWidthMinor == null) {
                this.mFixedWidthMinor = new TypedValue();
            }
            a10.getValue(67, this.mFixedWidthMinor);
        }
        if (a10.hasValue(64)) {
            if (this.mFixedHeightMajor == null) {
                this.mFixedHeightMajor = new TypedValue();
            }
            a10.getValue(64, this.mFixedHeightMajor);
        }
        if (a10.hasValue(65)) {
            if (this.mFixedHeightMinor == null) {
                this.mFixedHeightMinor = new TypedValue();
            }
            a10.getValue(65, this.mFixedHeightMinor);
        }
        if (a10.getBoolean(25, false)) {
            requestFeature(12);
        }
        if (a10.getBoolean(44, false)) {
            requestFeature(13);
        }
        this.mIsTranslucent = a10.getBoolean(5, false);
        Context context = getContext();
        ...
        if (!this.mForcedStatusBarColor) {
            this.mStatusBarColor = a10.getColor(34, -16777216);
        }
        if (!this.mForcedNavigationBarColor) {
            this.mPhoneWindowExt.hookGenerateLayout(this, a10, context);
            context.getColor(R.color.navigation_bar_compatible);
            int navBarDefaultColor = context.getColor(R.color.navigation_bar_default);
            int navBarColor = a10.getColor(35, navBarDefaultColor);
            if (navBarColor != navBarDefaultColor || context.getResources().getBoolean(R.bool.config_navBarDefaultTransparent)) {
                this.mNavigationBarColor = navBarColor != navBarDefaultColor ? navBarColor : getNavigationBarColor();
            }
            this.mNavigationBarDividerColor = a10.getColor(49, 0);
        }
        if (!targetPreQ) {
            this.mEnsureStatusBarContrastWhenTransparent = a10.getBoolean(51, false);
            this.mEnsureNavigationBarContrastWhenTransparent = a10.getBoolean(52, true);
        }
        WindowManager.LayoutParams params = getAttributes();
        if (!this.mIsFloating) {
            if (!targetPreL && a10.getBoolean(33, false)) {
        ...
        if (a10.getBoolean(62, false)) {
            params.privateFlags |= 64;
        }
        int sysUiVis = decor.getSystemUiVisibility();
        int statusFlag = a10.getBoolean(45, false) ? 8192 : 0;
        int navFlag = a10.getBoolean(48, false) ? 16 : 0;
        decor.setSystemUiVisibility((sysUiVis & (-8209)) | statusFlag | navFlag);
        if (a10.hasValue(50)) {
            int mode = a10.getInt(50, -1);
            if (mode < 0 || mode > 3) {
                throw new UnsupportedOperationException("Unknown windowLayoutInDisplayCutoutMode: " + a10.getString(50));
            }
            params.layoutInDisplayCutoutMode = mode;
        }
        if ((this.mAlwaysReadCloseOnTouchAttr || getContext().getApplicationInfo().targetSdkVersion >= 11) && a10.getBoolean(21, false)) {
            setCloseOnTouchOutsideIfNotSet(true);
        }
        if (!hasSoftInputMode()) {
            params.softInputMode = a10.getInt(13, params.softInputMode);
        }
        if (!a10.getBoolean(11, this.mIsFloating)) {
            z10 = false;
        } else {
            ...
            if (haveDimAmount()) {
                ...
                z10 = false;
                params.dimAmount = a10.getFloat(0, 0.5f);
            }
        }
        if (!a10.getBoolean(54, z10)) {
            i10 = 0;
        } else {
            ...
            i10 = 0;
            params.setBlurBehindRadius(a10.getDimensionPixelSize(53, 0));
        }
        setBackgroundBlurRadius(a10.getDimensionPixelSize(55, i10));
        if (params.windowAnimations == 0) {
            params.windowAnimations = a10.getResourceId(8, i10);
        }
        if (getContainer() == null) {
            if (this.mBackgroundDrawable == null) {
                if (this.mFrameResource == 0) {
                    this.mFrameResource = a10.getResourceId(2, 0);
                }
                if (a10.hasValue(1)) {
                    this.mBackgroundDrawable = a10.getDrawable(1);
                }
            }
            if (a10.hasValue(46)) {
                this.mBackgroundFallbackDrawable = a10.getDrawable(46);
            }
            if (this.mLoadElevation) {
                this.mElevation = a10.getDimension(37, 0.0f);
            }
            this.mClipToOutline = a10.getBoolean(38, false);
            this.mTextColor = a10.getColor(7, 0);
        }
        int features = getLocalFeatures();
        if ((features & 24) != 0) {
            if (this.mIsFloating) {
                TypedValue res = new TypedValue();
                getContext().getTheme().resolveAttribute(17956923, res, true);
                layoutResource = res.resourceId;
            } else {
                layoutResource = 17367312;
            }
            removeFeature(8);
        } else if ((features & 36) != 0 && (features & 256) == 0) {
            layoutResource = 17367308;
        } else {
            int layoutResource2 = features & 128;
            if (layoutResource2 != 0) {
                if (this.mIsFloating) {
                    TypedValue res2 = new TypedValue();
                    getContext().getTheme().resolveAttribute(17956920, res2, true);
                    layoutResource = res2.resourceId;
                } else {
                    layoutResource = 17367307;
                }
                removeFeature(8);
            } else {
                ...
                if (layoutResource3 == 0) {
                    if (this.mIsFloating) {
                        ...
                        getContext().getTheme().resolveAttribute(17956922, res3, true);
                        layoutResource = res3.resourceId;
                    } else {
                        int layoutResource4 = features & 256;
                        if (layoutResource4 != 0) {
                            layoutResource = a10.getResourceId(63, 17367306);
                        } else {
                            layoutResource = 17367311;
                        }
                    }
                } else {
                    int layoutResource5 = features & 1024;
                    if (layoutResource5 != 0) {
                        layoutResource = 17367310;
                    } else {
                        layoutResource = 17367309;
                    }
                }
            }
        }
        ...
        if (contentParent == null) {
            Log.e(TAG, "Window couldn't find content container view. LayoutResource: " + layoutResource + ";IsFloating: " + this.mIsFloating + "; Features: 0X " + Integer.toHexString(features));
    ...
    private void installDecor() {
        ...
        if (this.mContentParent == null) {
            ...
            DecorContentParent decorContentParent = this.mDecor.findViewById(16908958);
            if (decorContentParent != null) {
                ...
                for (int i10 = 0; i10 < 13; i10++) {
                    if (((1 << i10) & localFeatures) != 0) {
                        this.mDecorContentParent.initFeature(i10);
                    }
                }
                ...
                if (textView != null) {
                    if ((getLocalFeatures() & 2) != 0) {
                        View titleContainer = findViewById(16909647);
    ...
    private Transition getTransition(Transition currentValue, Transition defaultValue, int id2) {
        ...
        int transitionId = getWindowStyle().getResourceId(id2, -1);
    ...
    private Drawable loadImageURI(Uri uri) {
        try {
            ...
            Log.w(TAG, "Unable to open content: " + ((Object) uri));
            return null;
        }
    }
    ...
    private DrawableFeatureState getDrawableState(int featureId, boolean required) {
        ...
        DrawableFeatureState[] ar2 = drawableFeatureStateArr;
        if (drawableFeatureStateArr == null || ar2.length <= featureId) {
            DrawableFeatureState[] nar = new DrawableFeatureState[featureId + 1];
            if (ar2 != null) {
                System.arraycopy(ar2, 0, nar, 0, ar2.length);
            }
            ar2 = nar;
            this.mDrawables = nar;
        }
        DrawableFeatureState st = ar2[featureId];
        if (st == null) {
    ...
    private PanelFeatureState getPanelState(int featureId, boolean required, PanelFeatureState convertPanelState) {
        ...
        PanelFeatureState[] ar2 = panelFeatureStateArr;
        if (panelFeatureStateArr == null || ar2.length <= featureId) {
        ...
        PanelFeatureState st = ar2[featureId];
        if (st == null) {
            ...
            ar2[featureId] = panelFeatureState;
            return st2;
        }
        return st;
    }
    ...
    private ImageView getLeftIconView() {
        ...
        ImageView imageView2 = (ImageView) findViewById(16909194);
    ...
    public void dispatchWindowAttributesChanged(WindowManager.LayoutParams attrs) {
        if (DEBUG) {
            Log.d(TAG, "dispatchWindowAttributesChanged callers:" + Debug.getCallers(5));
        }
        Trace.traceBegin(32L, "dispatchWindowAttributesChanged callers:" + Debug.getCallers(5));
    ...
    private ProgressBar getCircularProgressBar(boolean shouldInstallDecor) {
        ...
        ProgressBar progressBar2 = (ProgressBar) findViewById(16909402);
    ...
    private ProgressBar getHorizontalProgressBar(boolean shouldInstallDecor) {
        ...
        ProgressBar progressBar2 = (ProgressBar) findViewById(16909404);
    ...
    private ImageView getRightIconView() {
        ...
        ImageView imageView2 = (ImageView) findViewById(16909455);
    ...
    public void callOnPanelClosed(int featureId, PanelFeatureState panel, Menu menu) {
        ...
        if ((panel == null || panel.isOpen) && !isDestroyed()) {
            cb2.onPanelClosed(featureId, menu);
        }
    }

    private boolean isTvUserSetupComplete() {
        boolean isTvSetupComplete = Settings.Secure.getInt(getContext().getContentResolver(), "user_setup_complete", 0) != 0;
        return isTvSetupComplete & (Settings.Secure.getInt(getContext().getContentResolver(), "tv_user_setup_complete", 0) != 0);
    }
    ...
    private boolean launchDefaultSearch(KeyEvent event) {
        ...
        if (cb2 == null || isDestroyed()) {
            ...
            try {
                result = cb2.onSearchRequested(searchEvent);
            } catch (AbstractMethodError e2) {
                Log.e(TAG, "WindowCallback " + cb2.getClass().getName() + " does not implement method onSearchRequested(SearchEvent); fa", e2);
                result = cb2.onSearchRequested();
            }
        }
        if (!result && (getContext().getResources().getConfiguration().uiMode & 15) == 4) {
            ...
            args.putLong(IntentCompat.EXTRA_TIME, event.getEventTime());
        ...
        if (controller != null && this.mOnModeChangedListener == null) {
            ...
            this.mOnModeChangedListener = new AudioManager.OnModeChangedListener() { // from class: com.android.internal.policy.PhoneWindow$$ExternalSyntheticLambda1
                ...
                public final void onModeChanged(int i10) {
                    PhoneWindow.this.lambda$setMediaController$1(i10);
                }
            };
    ...
    public long getTransitionBackgroundFadeDuration() {
        long j10 = this.mBackgroundFadeDurationMillis;
        if (j10 < 0) {
            return 300L;
        }
        return j10;
 ...
 */
    ...
    public static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            TypedArray a10 = context.obtainStyledAttributes(R.styleable.Theme);
            this.background = a10.getResourceId(46, 0);
            this.fullBackground = a10.getResourceId(47, 0);
            this.windowAnimations = a10.getResourceId(93, 0);
            this.isCompact = a10.getBoolean(377, false);
            this.listPresenterTheme = a10.getResourceId(378, 16974855);
            a10.recycle();
        }
        ...
        MenuView getListMenuView(Context context, MenuPresenter.Callback cb2) {
            if (this.menu == null) {
                return null;
            }
            if (!this.isCompact) {
                getIconMenuView(context, cb2);
            }
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter = new ListMenuPresenter(17367204, this.listPresenterTheme);
                this.listMenuPresenter = listMenuPresenter;
                listMenuPresenter.setCallback(cb2);
                this.listMenuPresenter.setId(16909203);
        ...
        MenuView getIconMenuView(Context context, MenuPresenter.Callback cb2) {
            if (this.menu == null) {
                return null;
            }
            if (this.iconMenuPresenter == null) {
                ...
                iconMenuPresenter.setCallback(cb2);
                this.iconMenuPresenter.setId(16909108);
 ...
 */
    ...
    public static class RotationWatcher extends IRotationWatcher.Stub {
        ...
        public void removeWindow(PhoneWindow phoneWindow) {
            synchronized (this.mWindows) {
                int i10 = 0;
                while (i10 < this.mWindows.size()) {
                    WeakReference<PhoneWindow> ref = this.mWindows.get(i10);
                    PhoneWindow win = ref.get();
                    if (win != null && win != phoneWindow) {
                        i10++;
                    }
                    this.mWindows.remove(i10);
                }
            }
        }
 ...
 */
    ...
    @Override // android.view.Window
    public IPhoneWindowWrapper getWrapper() {
 ...
 */
    /* loaded from: C:\Users\35037\Desktop\fankahook\2\class11.dex.bak */
    private class PhoneWindowWrapper extends Window.WindowWrapper implements IPhoneWindowWrapper {
        private PhoneWindowWrapper() {
            super();
        }

        @Override // com.android.internal.policy.IPhoneWindowWrapper
        public void setForcedNavigationBarColor(boolean isForced) {
            PhoneWindow.this.mForcedNavigationBarColor = isForced;
        }

        @Override // com.android.internal.policy.IPhoneWindowWrapper
        public boolean isForcedNavigationBarColor() {
            return PhoneWindow.this.mForcedNavigationBarColor;
        }

        @Override // com.android.internal.policy.IPhoneWindowWrapper
        public void setForcedStatusBarColor(boolean isForced) {
            PhoneWindow.this.mForcedStatusBarColor = isForced;
        }

        @Override // com.android.internal.policy.IPhoneWindowWrapper
        public CharSequence getTitle() {
            return PhoneWindow.this.mTitle;
        }

        @Override // com.android.internal.policy.IPhoneWindowWrapper
        public DecorView getDecorView() {
            return PhoneWindow.this.mDecor;
        }

        @Override // android.view.Window.WindowWrapper, android.view.IWindowWrapper
        public IPhoneWindowExt getExtImpl() {
            return PhoneWindow.this.mPhoneWindowExt;
        }
    }
}
