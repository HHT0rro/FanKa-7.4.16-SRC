 ...
 */
    ...
    public static Rect resizeDrag(float x10, float y10, float startDragX, float startDragY, Rect originalBounds, int ctrlType, int minVisibleWidth, int minVisibleHeight, Point maxVisibleSize, boolean preserveOrientation, boolean startOrientationWasLandscape) {
        int width1;
        int height1;
        int height2;
        int width2;
        int deltaX = Math.round(x10 - startDragX);
        int deltaY = Math.round(y10 - startDragY);
