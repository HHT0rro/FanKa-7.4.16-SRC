...
public interface IPlatformCompat extends IInterface {
    ...
    boolean clearOverride(long j10, String str) throws RemoteException;

    boolean clearOverrideForTest(long j10, String str) throws RemoteException;

    void clearOverrides(String str) throws RemoteException;

    void clearOverridesForTest(String str) throws RemoteException;

    int disableTargetSdkChanges(String str, int i10) throws RemoteException;

    int enableTargetSdkChanges(String str, int i10) throws RemoteException;
    ...
    boolean isChangeEnabled(long j10, ApplicationInfo applicationInfo) throws RemoteException;
    ...
    void reportChange(long j10, ApplicationInfo applicationInfo) throws RemoteException;
 ...
 */
    ...
    public static abstract class Stub extends Binder implements IPlatformCompat {
        ...
        static final String[] PERMISSIONS_isChangeEnabled = {"android.permission.LOG_COMPAT_CHANGE", "android.permission.READ_COMPAT_CHANGE_CONFIG"};
        static final String[] PERMISSIONS_isChangeEnabledByPackageName = {"android.permission.LOG_COMPAT_CHANGE", "android.permission.READ_COMPAT_CHANGE_CONFIG"};
        static final String[] PERMISSIONS_isChangeEnabledByUid = {"android.permission.LOG_COMPAT_CHANGE", "android.permission.READ_COMPAT_CHANGE_CONFIG"};
        static final String[] PERMISSIONS_getAppConfig = {"android.permission.LOG_COMPAT_CHANGE", "android.permission.READ_COMPAT_CHANGE_CONFIG"};
 ...
 */
        ...
        protected void reportChange_enforcePermission() throws SecurityException {
            this.mEnforcer.enforcePermission("android.permission.LOG_COMPAT_CHANGE", getCallingPid(), getCallingUid());
        }
        ...
        protected void setOverrides_enforcePermission() throws SecurityException {
            this.mEnforcer.enforcePermission("android.permission.OVERRIDE_COMPAT_CHANGE_CONFIG", getCallingPid(), getCallingUid());
        }

        protected void putAllOverridesOnReleaseBuilds_enforcePermission() throws SecurityException {
            this.mEnforcer.enforcePermission("android.permission.OVERRIDE_COMPAT_CHANGE_CONFIG_ON_RELEASE_BUILD", getCallingPid(), getCallingUid());
        }
        ...
        protected void listAllChanges_enforcePermission() throws SecurityException {
            this.mEnforcer.enforcePermission("android.permission.READ_COMPAT_CHANGE_CONFIG", getCallingPid(), getCallingUid());
        }
