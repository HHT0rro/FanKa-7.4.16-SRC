...
public class CompatibilityChangeInfo implements Parcelable {
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("CompatibilityChangeInfo(").append(getId());
        if (getName() != null) {
            sb2.append("; name=").append(getName());
        }
        if (getEnableSinceTargetSdk() != -1) {
            sb2.append("; enableSinceTargetSdk=").append(getEnableSinceTargetSdk());
        }
        if (getDisabled()) {
            sb2.append("; disabled");
        }
        if (getLoggingOnly()) {
            sb2.append("; loggingOnly");
        }
        if (getOverridable()) {
            sb2.append("; overridable");
        }
    ...
    public boolean equals(Object o10) {
        ...
        if (o10 == null || !(o10 instanceof CompatibilityChangeInfo)) {
            return false;
        }
        CompatibilityChangeInfo that = (CompatibilityChangeInfo) o10;
