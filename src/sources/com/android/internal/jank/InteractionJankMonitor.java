 ...
 */
    ...
    public interface TimeFunction {
        void invoke(long j10, long j11, long j12);
    }
 ...
 */
    ...
    public FrameTracker createFrameTracker(Configuration config, Session session) {
        ...
        if (!config.hasValidView()) {
            ...
            Log.d(TAG, "create FrameTracker fails: view=" + ((Object) view) + ", attached=" + attached + ", hasViewRoot=" + hasViewRoot + ", hasRenderer=" + hasRenderer, new Throwable());
            return null;
        }
    ...
    public boolean begin(View v2, int cujType) {
        try {
            return begin(Configuration.Builder.withView(cujType, v2));
        ...
        try {
            ...
            postEventLogToWorkerThread(new TimeFunction() { // from class: com.android.internal.jank.InteractionJankMonitor$$ExternalSyntheticLambda6
                ...
                public final void invoke(long j10, long j11, long j12) {
                    EventLogTags.writeJankCujEventsBeginRequest(r0.mCujType, j10, j11, j12, InteractionJankMonitor.Configuration.this.mTag);
                }
            });
    ...
    public boolean end(final int cujType) {
        postEventLogToWorkerThread(new TimeFunction() { // from class: com.android.internal.jank.InteractionJankMonitor$$ExternalSyntheticLambda9
            @Override // com.android.internal.jank.InteractionJankMonitor.TimeFunction
            public final void invoke(long j10, long j11, long j12) {
                EventLogTags.writeJankCujEventsEndRequest(cujType, j10, j11, j12);
            }
        });
    ...
    public boolean cancel(final int cujType) {
        postEventLogToWorkerThread(new TimeFunction() { // from class: com.android.internal.jank.InteractionJankMonitor$$ExternalSyntheticLambda8
            @Override // com.android.internal.jank.InteractionJankMonitor.TimeFunction
            public final void invoke(long j10, long j11, long j12) {
                EventLogTags.writeJankCujEventsCancelRequest(cujType, j10, j11, j12);
            }
        });
 ...
 */
        ...
        private void validate() {
            ...
            if (this.mSurfaceOnly) {
                ...
                String err = "invalid view: view=" + ((Object) this.mView) + ", attached=" + attached + ", hasViewRoot=" + hasViewRoot + ", hasRenderer=" + hasRenderer;
                msg.append(err);
            }
            if (shouldThrow) {
    ...
    public static class Session {
        ...
        private String generateSessionName(String cujName, String cujPostfix) {
            ...
            if (cujName.length() > 80) {
                throw new IllegalArgumentException(TextUtils.formatSimple("The length of cuj name <%s> exceeds %d", new Object[]{cujName, 80}));
            }
            if (hasPostfix && cujPostfix.length() > (remaining = 100 - cujName.length())) {
                cujPostfix = cujPostfix.substring(0, remaining - 3).concat("...");
            }
            if (hasPostfix) {
                return TextUtils.formatSimple("J<%s::%s>", new Object[]{cujName, cujPostfix});
            }
            return TextUtils.formatSimple("J<%s>", new Object[]{cujName});
        }
