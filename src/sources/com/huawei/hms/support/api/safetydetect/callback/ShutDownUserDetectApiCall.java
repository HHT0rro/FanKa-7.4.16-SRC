...
public class ShutDownUserDetectApiCall extends AbstractTaskApiCall<Void> {
    public ShutDownUserDetectApiCall(Context context, String str, String str2, boolean z10) {
