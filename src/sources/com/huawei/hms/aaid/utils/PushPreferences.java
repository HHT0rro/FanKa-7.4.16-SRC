...
public class PushPreferences {
    ...
    public SharedPreferences f28925a;
    ...
    public PushPreferences(Context context, String str) {
        ...
        if (b4 == null) {
            ...
            this.f28925a = context.getSharedPreferences(str, 0);
        }
    }
    ...
    private File a(Context context, String str) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 24) {
                file = new File(((Object) context.getDataDir()) + "/shared_prefs", str + ".xml");
            } else {
    ...
    public boolean clear() {
        SharedPreferences sharedPreferences = this.f28925a;
    ...
    public boolean removeKey(String str) {
        ...
        SharedPreferences sharedPreferences = this.f28925a;
        if (sharedPreferences == null || !sharedPreferences.contains(str) || (edit = this.f28925a.edit()) == null) {
            return false;
        }
    ...
    public boolean write(ContentValues contentValues) {
        if (this.f28925a == null || contentValues == null) {
            return false;
        }
        boolean z10 = true;
    ...
    public boolean removeKey(String[] strArr) {
        ...
        for (String str : strArr) {
            if (this.f28925a.contains(str)) {
                this.f28925a.edit().remove(str);
            }
        }
        this.f28925a.edit().commit();
        return true;
    }
}
