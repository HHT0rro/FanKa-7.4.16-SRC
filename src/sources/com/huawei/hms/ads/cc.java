...
public class cc extends cq<com.huawei.openalliance.ad.views.AppDownloadButton> {
    private int L;

    /* renamed from: a, reason: collision with root package name */
    private Typeface f29072a;

    public cc(com.huawei.openalliance.ad.views.AppDownloadButton appDownloadButton) {
    ...
    public void Code(AttributeSet attributeSet) {
        ...
        if (!TextUtils.isEmpty(attributeValue2)) {
            ...
            this.f29072a = typeface;
        }
        String attributeValue3 = attributeSet.getAttributeValue(null, "fontFamily");
        if (TextUtils.isEmpty(attributeValue3)) {
            ((com.huawei.openalliance.ad.views.AppDownloadButton) this.Code).Code(this.f29072a, this.L);
        } else {
