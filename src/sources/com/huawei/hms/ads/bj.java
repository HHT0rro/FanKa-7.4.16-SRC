        ...
        Code(context, str, new ab() { // from class: com.huawei.hms.ads.bj.1
            ...
            public void Code(AdContentData adContentData) {
                ...
                if (adEventReport2 != null) {
                    kv.Code(context, adContentData, com.huawei.openalliance.ad.constant.ae.C, Long.valueOf(adEventReport2.D() == null ? 0L : adEventReport.D().longValue()), Long.valueOf(adEventReport.L() != null ? adEventReport.L().longValue() : 0L), Integer.valueOf(adEventReport.a() == null ? 0 : adEventReport.a().intValue()), Integer.valueOf(adEventReport.b() != null ? adEventReport.b().intValue() : 0));
                }
