...
public class p1 {
    ...
    public static boolean a(String str, String str2, int i10) {
        ...
        if (TextUtils.isEmpty(a10) || TextUtils.isEmpty(str2)) {
            ...
            String a11 = a(a10, i10);
            if (!TextUtils.isEmpty(a11)) {
                if (str2.equals(ta.b.b(a10))) {
                    return true;
                }
                if (!str2.equals(ta.b.b(a11))) {
                    return false;
                }
                try {
    ...
    public static boolean b(String str) {
        if (p.f30190a.booleanValue()) {
            return true;
        }
        for (String str2 : f30198a) {
            if (a(str, str2, 2)) {
                return true;
            }
        }
