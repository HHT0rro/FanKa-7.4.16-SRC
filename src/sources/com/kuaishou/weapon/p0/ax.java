...
public class ax {
    ...
    private JSONObject f35811a;

    public ax(Context context) {
        if (Engine.loadSuccess) {
            try {
                String pqr = Engine.getInstance(context).pqr(Integer.valueOf(ck.f35937g).intValue(), 1, 0, "");
                if (TextUtils.isEmpty(pqr)) {
                    return;
                }
                this.f35811a = new JSONObject(pqr);
    ...
    public String a(String str) {
        JSONObject jSONObject = this.f35811a;
        if (jSONObject != null) {
            try {
