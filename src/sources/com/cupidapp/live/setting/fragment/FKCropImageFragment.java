...
/* compiled from: FKCropImageFragment.kt */
@kotlin.d
/* loaded from: C:\Users\35037\Desktop\fankahook\2\class.dex */
public final class FKCropImageFragment extends FKBaseCropImageFragment {

    /* renamed from: i, reason: collision with root package name */
    @NotNull
    public Map<Integer, View> f18113i = new LinkedHashMap();
    ...
    public View a1(int i10) {
        View findViewById;
        Map<Integer, View> map = this.f18113i;
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        return inflater.inflate(R$layout.fragment_crop_layout, viewGroup, false);
    }
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle bundle) {
        ...
        ((FKTitleBarLayout) a1(R$id.cropImageTitleLayout)).setLeftImageClickEvent(new Function1<View, kotlin.p>() { // from class: com.cupidapp.live.setting.fragment.FKCropImageFragment$onViewCreated$1
            {
                super(1);
            }
            ...
            public final void invoke2(@Nullable View view2) {
                FKCropImageFragment.this.S0();
            }
        });
        TextView saveButton = (TextView) a1(R$id.saveButton);
        kotlin.jvm.internal.s.h(saveButton, "saveButton");
        y.d(saveButton, new Function1<View, kotlin.p>() { // from class: com.cupidapp.live.setting.fragment.FKCropImageFragment$onViewCreated$2
            {
                super(1);
            }
