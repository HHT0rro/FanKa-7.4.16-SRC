...
public final class AdvanceFilterUiModel extends FilterUiModel {
    ...
    public AdvanceFilterUiModel(@NotNull List<? extends Object> list, boolean z10, @NotNull String tabName, @NotNull String tabKey, @Nullable VipDiscountDescriptionResult vipDiscountDescriptionResult) {
