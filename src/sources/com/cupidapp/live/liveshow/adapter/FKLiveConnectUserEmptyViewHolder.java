...
public final class FKLiveConnectUserEmptyViewHolder extends FKBaseRecyclerViewHolder {
    ...
    public static final class a {
        ...
        public final FKLiveConnectUserEmptyViewHolder a(@NotNull ViewGroup parent) {
            s.i(parent, "parent");
            return new FKLiveConnectUserEmptyViewHolder(z.b(parent, R$layout.view_holder_live_connect_user_empty, false, 2, null));
        }
    }
    ...
    public void n(@Nullable Object obj) {
        if (obj instanceof FKEmptyViewModel) {
            ...
            if (emptyImage != null) {
                ((ImageView) this.itemView.findViewById(R$id.emptyConnectImage)).setImageResource(emptyImage.intValue());
            }
            Integer emptyTextRes = fKEmptyViewModel.getEmptyTextRes();
            if (emptyTextRes != null) {
                ((TextView) this.itemView.findViewById(R$id.emptyConnectText)).setText(this.itemView.getContext().getString(emptyTextRes.intValue()));
            }
        }
    }
}
