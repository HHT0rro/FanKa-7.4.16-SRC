...
/* compiled from: LikedUnMatchBanLogic.kt */
@d
/* loaded from: C:\Users\35037\Desktop\fankahook\2\class.dex */
public final class a implements ILikedUnMatchLogic {
    ...
    public Observable<Result<UserListResult>> e(@Nullable String str) {
        return a.C0836a.j(NetworkClient.f11868a.N(), str, 0, 2, null);
    }

    @Override // com.cupidapp.live.profile.logic.ILikedUnMatchLogic
    @NotNull
    public Observable<Result<Object>> f() {
        return NetworkClient.f11868a.N().c0(null, 2);
    }

    @Override // com.cupidapp.live.profile.logic.ILikedUnMatchLogic
    public int getTitle() {
        return R$string.ban_log_off_user;
    }
}
