...
public final class YouFollowedUserListFragment extends RelationUserListFragment {

    /* renamed from: n, reason: collision with root package name */
    @NotNull
    public Map<Integer, View> f17786n = new LinkedHashMap();
    ...
    public SensorPosition O0() {
        return SensorPosition.MyAloha;
    }

    @Override // com.cupidapp.live.profile.fragment.RelationUserListFragment
    public void P1(@NotNull User user) {
        s.i(user, "user");
        String value = ViewProfilePrefer.FollowingUserToProfile.getValue();
        boolean me2 = user.getMe();
        SensorPosition sensorPosition = SensorPosition.MyAloha;
        SensorScene sensorScene = SensorScene.FollowingList;
    ...
    public View W0(int i10) {
        View findViewById;
        Map<Integer, View> map = this.f17786n;
    ...
    @Override // com.cupidapp.live.profile.fragment.RelationUserListFragment
    public void k1() {
        v1().d(new NonexistentUserEnterViewModel(RelationType.YouFollowed));
    }
    ...
    public RelationType u1() {
        return RelationType.YouFollowed;
    }

    @Override // com.cupidapp.live.profile.fragment.RelationUserListFragment
    @NotNull
    public Observable<Result<UserListResult>> w1(@Nullable String str) {
        int i10 = a.f17787a[s1().ordinal()];
        if (i10 == 1) {
            return a.C0836a.p(NetworkClient.f11868a.N(), str, 0, 2, null);
        }
        if (i10 == 2) {
            return a.C0836a.r(NetworkClient.f11868a.N(), str, 0, 2, null);
        }
        if (i10 == 3) {
            return a.C0836a.w(NetworkClient.f11868a.N(), str, 0, 2, null);
        }
