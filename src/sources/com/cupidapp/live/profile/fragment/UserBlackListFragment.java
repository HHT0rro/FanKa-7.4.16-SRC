...
public final class UserBlackListFragment extends FKBaseListFragment<User> {

    /* renamed from: j, reason: collision with root package name */
    @NotNull
    public Map<Integer, View> f17785j = new LinkedHashMap();

    /* renamed from: i, reason: collision with root package name */
    @NotNull
    public final Lazy f17784i = kotlin.c.b(new Function0<UserListItemAdapter>() { // from class: com.cupidapp.live.profile.fragment.UserBlackListFragment$userListItemAdapter$2
        {
            super(0);
        }
        ...
        public final UserListItemAdapter invoke() {
            ...
            final UserBlackListFragment userBlackListFragment = UserBlackListFragment.this;
            userListItemAdapter.l().g(new Function1<Object, p>() { // from class: com.cupidapp.live.profile.fragment.UserBlackListFragment$userListItemAdapter$2$1$1
                {
                    super(1);
                }
                ...
                public final void invoke2(@Nullable Object obj) {
                    if (obj instanceof User) {
                        User user = (User) obj;
                        UserProfileActivity.G.a(UserBlackListFragment.this.getContext(), user, new ProfileSensorContext(ViewProfilePrefer.BlackListToProfile.getValue(), null, user.getMe(), SensorPosition.BlackListPage, SensorPosition.PrivacySetting, SensorScene.BlackList), (r21 & 8) != 0 ? false : true, (r21 & 16) != 0 ? null : null, (r21 & 32) != 0 ? null : null, (r21 & 64) != 0 ? null : null, (r21 & 128) != 0 ? false : false);
                    }
                }
            });
    ...
    public View T0(int i10) {
        View findViewById;
        Map<Integer, View> map = this.f17785j;
    ...
    public Observable<Result<ListResult<User>>> e1(@Nullable String str) {
        return a.C0836a.h(NetworkClient.f11868a.N(), str, 0, 2, null);
    }

    public final UserListItemAdapter m1() {
        return (UserListItemAdapter) this.f17784i.getValue();
    }
    ...
    public final void onEvent(@NotNull UserProfileDataChangeEvent event) {
        ...
        while (true) {
            ...
            if (!iterator2.hasNext()) {
                ...
                obj = iterator2.next();
                if ((obj instanceof User) && s.d(((User) obj).userId(), event.getUser().userId())) {
                    break;
                }
            }
        }
