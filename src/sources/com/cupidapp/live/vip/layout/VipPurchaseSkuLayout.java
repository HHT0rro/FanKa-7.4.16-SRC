...
import com.cupidapp.live.vip.adapter.APlusVipPriceRecyclerAdapter;
...
/* compiled from: VipPurchaseSkuLayout.kt */
@kotlin.d
/* loaded from: C:\Users\35037\Desktop\fankahook\2\class.dex */
public final class VipPurchaseSkuLayout extends RecyclerView {

    /* renamed from: b, reason: collision with root package name */
    @NotNull
    public final Lazy f18795b;

    /* renamed from: c, reason: collision with root package name */
    @Nullable
    public Function1<? super VipPurchasePriceModel, p> f18796c;

    /* renamed from: d, reason: collision with root package name */
    @NotNull
    public Map<Integer, View> f18797d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VipPurchaseSkuLayout(@NotNull Context context) {
        super(context);
        s.i(context, "context");
        this.f18797d = new LinkedHashMap();
        this.f18795b = kotlin.c.b(new Function0<APlusVipPriceRecyclerAdapter>() { // from class: com.cupidapp.live.vip.layout.VipPurchaseSkuLayout$vipPurchasePriceAdapter$2
            {
                super(0);
            }
            ...
            @NotNull
            public final APlusVipPriceRecyclerAdapter invoke() {
                final APlusVipPriceRecyclerAdapter aPlusVipPriceRecyclerAdapter = new APlusVipPriceRecyclerAdapter();
                final VipPurchaseSkuLayout vipPurchaseSkuLayout = VipPurchaseSkuLayout.this;
                aPlusVipPriceRecyclerAdapter.l().g(new Function1<Object, p>() { // from class: com.cupidapp.live.vip.layout.VipPurchaseSkuLayout$vipPurchasePriceAdapter$2$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(@Nullable Object obj) {
                        if (obj instanceof VipPurchasePriceModel) {
                            VipPurchaseSkuLayout.this.n((VipPurchasePriceModel) obj);
                            VipPurchaseSkuLayout.this.smoothScrollToPosition(aPlusVipPriceRecyclerAdapter.j().indexOf(obj));
                        }
                    }
                });
                return aPlusVipPriceRecyclerAdapter;
            }
        });
        m();
    }

    private final APlusVipPriceRecyclerAdapter getVipPurchasePriceAdapter() {
        return (APlusVipPriceRecyclerAdapter) this.f18795b.getValue();
    }
    ...
    public final void m() {
        ...
        addItemDecoration(new AddExtraSpacingDecoration(h.c(this, 4.0f), 0, h.c(this, 4.0f), 0, h.c(this, 16.0f)));
    }
    ...
    public final void n(VipPurchasePriceModel vipPurchasePriceModel) {
        ...
        getVipPurchasePriceAdapter().notifyDataSetChanged();
        Function1<? super VipPurchasePriceModel, p> function1 = this.f18796c;
        if (function1 != null) {
    ...
    public final void setSelectCurrentPriceCallback(@Nullable Function1<? super VipPurchasePriceModel, p> function1) {
        this.f18796c = function1;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VipPurchaseSkuLayout(@NotNull Context context, @Nullable AttributeSet attributeSet) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VipPurchaseSkuLayout(@NotNull Context context, @Nullable AttributeSet attributeSet, int i10) {
