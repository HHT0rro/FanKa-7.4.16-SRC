...
public final class ci {
    ...
    private static final String[] f7525b = {"arm64-v8a", "x86_64"};

    /* renamed from: c, reason: collision with root package name */
    private static final String[] f7526c = {"arm", "x86"};
    ...
    */
    public static java.lang.String a(android.content.Context r7) {
        ...
        L27:
            ...
            com.amap.api.col.s.dc.a(r0, r2, r4)
        L2d:
            java.lang.String r0 = ""
        L2f:
        ...
        L4a:
            ...
            if (r3 != 0) goto L9c
            java.lang.String[] r3 = com.amap.api.col.s.ci.f7525b     // Catch: java.lang.Throwable -> L96
            ...
            java.lang.String[] r1 = com.amap.api.col.s.ci.f7526c     // Catch: java.lang.Throwable -> L96
        ...
        L96:
            ...
            com.amap.api.col.s.dc.a(r7, r2, r1)
        L9c:
        ...
        La4:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.col.s.ci.a(android.content.Context):java.lang.String");
    }

    public static ch b() throws bv {
        return new ch.a("co", BuildConfig.VERSION_NAME, "AMap_co_1.0.0").a(new String[]{"com.amap.co", "com.amap.opensdk.co", "com.amap.location"}).a();
    }

    public static String c(String str) {
        return str.length() < 2 ? "" : cb.a(str.substring(1));
    }
    ...
    public static PublicKey d() throws CertificateException, InvalidKeySpecException, NoSuchAlgorithmException, NullPointerException, IOException {
        ...
        try {
            byteArrayInputStream = new ByteArrayInputStream(cb.b(""));
            try {
    ...
    public static byte[] c() {
        try {
            ...
            String[] split2 = new StringBuffer(new String(cb.b(new String(bArr)))).reverse().toString().split(",");
    ...
    public static ch a() throws bv {
        return new ch.a("collection", "1.0", "AMap_collection_1.0").a(new String[]{"com.amap.api.collection"}).a();
    }
    ...
    public static void a(Context context, String str, String str2, JSONObject jSONObject) {
        String str3;
        String string;
        String e2 = bw.e(context);
        String a10 = ce.a(e2);
        String a11 = bw.a(context);
        try {
            ...
            if ("INVALID_USER_SCODE".equals(str3)) {
                ...
                if (a10.equals(string2) || a10.equals(string)) {
                    StringBuilder sb3 = new StringBuilder();
                ...
                if (string.length() > 0 && !a11.equals(string)) {
        ...
        f("SHA1Package:".concat(String.valueOf(e2)));
        f("key:".concat(String.valueOf(a11)));
