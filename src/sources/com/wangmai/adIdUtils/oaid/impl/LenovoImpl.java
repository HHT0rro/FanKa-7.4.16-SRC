...
import com.wangmai.adIdUtils.oaid.lib.zui.deviceidservice.IDeviceidInterface;
...
public class LenovoImpl implements IOAID {
    ...
    public void doGet(IGetter iGetter) {
        ...
        OAIDService.bind(this.context, intent, iGetter, new OAIDService.RemoteCaller() { // from class: com.wangmai.adIdUtils.oaid.impl.LenovoImpl.1
