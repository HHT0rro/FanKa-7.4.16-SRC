...
public class KSAdInfoData implements Serializable {
    ...
    public KSAdInfoData setCreativeId(long j10) {
        this.creativeId = j10;
        return this;
    }
    ...
    public KSAdInfoData setInteractionType(int i10) {
        this.interactionType = i10;
        return this;
    }

    public KSAdInfoData setMaterialType(int i10) {
    ...
    public String toString() {
        return "KSAdInfoData{adDescription='" + this.adDescription + "', productName='" + this.productName + "', adSource='" + this.adSource + "', imageUrlArray=" + ((Object) this.imageUrlArray) + ", videoUrl='" + this.videoUrl + "', videoCoverImageUrl='" + this.videoCoverImageUrl + "', materialType=" + this.materialType + ", appIconUrl='" + this.appIconUrl + "', appName='" + this.appName + "', interactionType=" + this.interactionType + ", creativeId=" + this.creativeId + '}';
    }
}
