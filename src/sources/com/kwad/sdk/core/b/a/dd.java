...
public final class dd implements com.kwad.sdk.core.d<AdInfo.DownloadSafeInfo> {
    ...
    private static JSONObject b2(AdInfo.DownloadSafeInfo downloadSafeInfo, JSONObject jSONObject) {
        ...
        if (j10 != 0) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "packageSize", j10);
        }
        String str4 = downloadSafeInfo.appVersion;
        if (str4 != null && !str4.equals("")) {
            com.kwad.sdk.utils.t.putValue(jSONObject, AttributionReporter.APP_VERSION, downloadSafeInfo.appVersion);
        }
        ...
        if (z10) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "secWindowPopNoWifiSwitch", z10);
        }
        boolean z11 = downloadSafeInfo.secWindowPopSwitch;
        if (z11) {
            com.kwad.sdk.utils.t.putValue(jSONObject, "secWindowPopSwitch", z11);
        }
