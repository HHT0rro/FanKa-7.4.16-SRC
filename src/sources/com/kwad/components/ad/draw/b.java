    ...
    public b(@NonNull Context context) {
        ...
        this.bU = new View.OnClickListener() { // from class: com.kwad.components.ad.draw.b.1
            ...
            public final void onClick(View view) {
                com.kwad.components.core.e.d.a.a(new a.C0461a(b.this.bO.mRootContainer.getContext()).aq(b.this.bO.mAdTemplate).b(b.this.bO.mApkDownloadHelper).ao(false).an(3).a(new a.b() { // from class: com.kwad.components.ad.draw.b.1.1
