...
public final class l extends a implements View.OnClickListener, com.kwad.sdk.widget.c {
    ...
    private void c(View view, final int i10) {
        if (view == this.eD) {
            ...
            com.kwad.components.core.e.d.a.a(new a.C0461a(getContext()).aq(this.mAdTemplate).al(5).am(i10).b(this.mApkDownloadHelper).an(view == this.eI ? 1 : 2).ao(view == this.eI).a(new a.b() { // from class: com.kwad.components.ad.feed.b.l.1
