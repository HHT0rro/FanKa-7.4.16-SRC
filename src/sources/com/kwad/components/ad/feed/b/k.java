...
public final class k extends a implements View.OnClickListener, com.kwad.sdk.widget.c {
    ...
    private void c(View view, final int i10) {
        if (view == this.eD) {
            ...
            com.kwad.components.core.e.d.a.a(new a.C0461a(getContext()).al(5).am(i10).aq(this.mAdTemplate).b(this.mApkDownloadHelper).an(view == this.eI ? 1 : 2).ao(view == this.eI).a(new a.b() { // from class: com.kwad.components.ad.feed.b.k.1
    ...
    public final void b(@NonNull AdResultData adResultData) {
        ...
        if (ba2.size() > 0) {
            ...
            KSImageLoader.loadFeeImage(this.fv, ba2.get(0), this.mAdTemplate, this.ez);
        } else {
