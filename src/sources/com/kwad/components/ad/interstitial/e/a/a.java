...
public abstract class a extends com.kwad.components.ad.interstitial.e.b implements j {
    ...
    public final void a(a.C0481a c0481a) {
        c cVar = this.jK;
        if (cVar == null || cVar.f36522ie == null) {
            return;
        }
        ...
        switch (c4) {
            case 0:
                this.jK.f36522ie.onSkippedAd();
                return;
            case 1:
                this.jK.f36522ie.onAdShow();
                return;
            case 2:
                this.jK.f36522ie.onAdClosed();
                return;
            case 3:
                this.jK.f36522ie.onPageDismiss();
                return;
            case 4:
                this.jK.f36522ie.onAdClicked();
                return;
            default:
                return;
        }
