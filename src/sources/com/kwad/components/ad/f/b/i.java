...
public final class i extends com.kwad.components.ad.f.a.a implements View.OnClickListener {
    ...
    private void ez() {
        com.kwad.components.core.e.d.a.a(new a.C0461a(this.mDetailVideoView.getContext()).aq(this.mN.mAdTemplate).b(this.mN.mApkDownloadHelper).v(this.mN.mO.getPlayDuration()).a(new a.b() { // from class: com.kwad.components.ad.f.b.i.2
