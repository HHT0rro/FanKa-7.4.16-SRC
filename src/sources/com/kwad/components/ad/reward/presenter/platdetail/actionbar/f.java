...
public final class f extends com.kwad.components.ad.reward.presenter.b {
    ...
    private boolean f36592va;

    /* renamed from: vb, reason: collision with root package name */
    private long f36593vb;
    private int cP = -1;
    private RewardActionBarControl.d uI = new RewardActionBarControl.d() { // from class: com.kwad.components.ad.reward.presenter.platdetail.actionbar.f.1
        ...
        public final boolean f(a aVar) {
            f fVar = f.this;
            fVar.f36592va = fVar.f(aVar);
            return f.this.f36592va;
        }
    };
    ...
    private aq.b cU = new aq.b() { // from class: com.kwad.components.ad.reward.presenter.platdetail.actionbar.f.7
        ...
        public final void a(aq.a aVar) {
            ...
            long elapsedRealtime = SystemClock.elapsedRealtime() - f.this.f36593vb;
    ...
    private void aH() {
        int i10 = this.cP;
        com.kwad.sdk.core.e.c.w("RewardActionBarWeb", "show webCard fail, reason: " + (i10 == -1 ? "timeout" : i10 != 1 ? "h5error" : "others"));
    }
    ...
    private void ay() {
        ...
        this.f36593vb = SystemClock.elapsedRealtime();
