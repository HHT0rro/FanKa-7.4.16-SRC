...
public abstract class CodedInputStream {
        ...
        */
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.currentByteBufferLimit != j13) {
                long j14 = j13 + 1;
                byte b4 = UnsafeUtil.getByte(j13);
                if (b4 >= 0) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    long j15 = j14 + 1;
                    int i11 = b4 ^ (UnsafeUtil.getByte(j14) << 7);
                    if (i11 >= 0) {
                        long j16 = j15 + 1;
    ...
    public static final class StreamDecoder extends CodedInputStream {
        ...
        private ByteString readBytesSlowPath(int i10) throws IOException {
            ...
            byte[] bArr = new byte[i10];
            System.arraycopy((Object) this.buffer, i11, (Object) bArr, 0, i13);
            ...
            if (i10 >= 0) {
                ...
                if (i13 - this.sizeLimit <= 0) {
                    ...
                    if (i13 <= i14) {
                        ...
                        byte[] bArr = new byte[i10];
                        System.arraycopy((Object) this.buffer, this.pos, (Object) bArr, 0, i15);
                    ...
                    if (this.refillCallback == null) {
                        ...
                        while (i15 < i10) {
                            try {
                                ...
                                if (skip < 0 || skip > j10) {
                                    throw new IllegalStateException(((Object) this.input.getClass()) + "#skip returned invalid result: " + skip + "\nThe InputStream implementation is buggy.");
                                }
                                if (skip == 0) {
                                    break;
                                } else {
        ...
        private boolean tryRefillBuffer(int i10) throws IOException {
            ...
            if (i11 + i10 > this.bufferSize) {
                ...
                if (i14 > 0) {
                    ...
                    if (i15 > i14) {
                        byte[] bArr = this.buffer;
                        System.arraycopy((Object) bArr, i14, (Object) bArr, 0, i15 - i14);
                    }
                ...
                if (read == 0 || read < -1 || read > this.buffer.length) {
                    throw new IllegalStateException(((Object) this.input.getClass()) + "#read(byte[]) returned invalid result: " + read + "\nThe InputStream implementation is buggy.");
                }
                if (read <= 0) {
                    return false;
                }
