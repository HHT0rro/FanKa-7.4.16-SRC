...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    public static final class BoundedByteString extends LiteralByteString {
        ...
        public void copyToInternal(byte[] bArr, int i10, int i11, int i12) {
            System.arraycopy((Object) this.bytes, getOffsetIntoBytes() + i10, (Object) bArr, i11, i12);
        }
    ...
    public static class LiteralByteString extends LeafByteString {
        ...
        @Override // com.google.protobuf.ByteString
        public void copyToInternal(byte[] bArr, int i10, int i11, int i12) {
            System.arraycopy((Object) this.bytes, i10, (Object) bArr, i11, i12);
        }
    ...
    public static final class Output extends OutputStream {
        ...
        private byte[] copyArray(byte[] bArr, int i10) {
            ...
            System.arraycopy((Object) bArr, 0, (Object) bArr2, 0, Math.min(bArr.length, i10));
            return bArr2;
        }
        ...
        public synchronized void write(byte[] bArr, int i10, int i11) {
            ...
            if (i11 <= length - i12) {
                System.arraycopy((Object) bArr, i10, (Object) bArr2, i12, i11);
                this.bufferPos += i11;
            } else {
                int length2 = bArr2.length - i12;
                System.arraycopy((Object) bArr, i10, (Object) bArr2, i12, length2);
                int i13 = i11 - length2;
                flushFullBuffer(i13);
                System.arraycopy((Object) bArr, i10 + length2, (Object) this.buffer, 0, i13);
                this.bufferPos = i13;
            }
        }
    }
    ...
    public static ByteString copyFrom(Iterable<ByteString> iterable) {
        ...
        if (!(iterable instanceof Collection)) {
            size = 0;
            Iterator<ByteString> iterator2 = iterable.iterator2();
        ...
        return balancedConcat(iterable.iterator2(), size);
    }
}
