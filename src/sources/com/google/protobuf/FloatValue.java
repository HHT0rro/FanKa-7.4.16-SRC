...
public final class FloatValue extends GeneratedMessageV3 implements FloatValueOrBuilder {
    ...
    public int hashCode() {
        ...
        int hashCode = ((((((MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_PREMIUM_SMS_DENY + getDescriptor().hashCode()) * 37) + 1) * 53) + Float.floatToIntBits(getValue())) * 29) + getUnknownFields().hashCode();
