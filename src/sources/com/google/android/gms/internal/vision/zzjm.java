...
public final class zzjm {
    ...
    static {
        ...
        zzd = zzjmVar4;
        zzjm zzjmVar5 = new zzjm("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(ShadowDrawableWrapper.COS_45));
        zze = zzjmVar5;
    ...
    private zzjm(String str, int i10, Class cls, Class cls2, Object obj) {
        this.zzk = cls;
        this.zzl = cls2;
        this.zzm = obj;
    }
