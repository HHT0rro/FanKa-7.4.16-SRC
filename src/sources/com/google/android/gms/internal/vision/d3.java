...
public final class d3 implements Parcelable.Creator<zzgf> {
    ...
    public final /* synthetic */ zzgf createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < F) {
            ...
            switch (SafeParcelReader.v(z10)) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    arrayList = SafeParcelReader.t(parcel, z10, zzgn.CREATOR);
                    break;
                case 11:
                    arrayList2 = SafeParcelReader.t(parcel, z10, zzgb.CREATOR);
                    break;
                default:
        ...
        return new zzgf(i10, rect, f10, f11, f12, f13, f14, f15, f16, arrayList, arrayList2);
    }
