...
public final class zziv {
    ...
    private zziv(String str, int i10, int i11, zzix zzixVar, zzjm zzjmVar) {
        int i12;
        this.zzba = i11;
        this.zzbb = zzixVar;
        this.zzaz = zzjmVar;
        int i13 = t4.f25644a[zzixVar.ordinal()];
        if (i13 == 1) {
        ...
        this.zzbd = (zzixVar != zzix.SCALAR || (i12 = t4.f25645b[zzjmVar.ordinal()]) == 1 || i12 == 2 || i12 == 3) ? false : true;
    }
