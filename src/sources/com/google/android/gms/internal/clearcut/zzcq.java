...
public final class zzcq {
    ...
    static {
        ...
        zzla = zzcqVar4;
        zzcq zzcqVar5 = new zzcq("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(ShadowDrawableWrapper.COS_45));
        zzlb = zzcqVar5;
    ...
    private zzcq(String str, int i10, Class cls, Class cls2, Object obj) {
        this.zzlh = cls;
        this.zzli = cls2;
        this.zzlj = obj;
    }
