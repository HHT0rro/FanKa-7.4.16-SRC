...
public final class zzcb {
    ...
    static {
        ...
        for (zzcb zzcbVar52 : values) {
            zzjb[zzcbVar52.f24149id] = zzcbVar52;
        }
    }

    private zzcb(String str, int i10, int i11, zzcd zzcdVar, zzcq zzcqVar) {
        int i12;
        this.f24149id = i11;
        this.zziy = zzcdVar;
        this.zzix = zzcqVar;
        int i13 = u0.f24052a[zzcdVar.ordinal()];
        this.zziz = (i13 == 1 || i13 == 2) ? zzcqVar.zzbq() : null;
        this.zzja = (zzcdVar != zzcd.SCALAR || (i12 = u0.f24053b[zzcqVar.ordinal()]) == 1 || i12 == 2 || i12 == 3) ? false : true;
    }
