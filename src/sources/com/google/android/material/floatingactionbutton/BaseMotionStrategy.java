...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(@NonNull MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(Attributes.Style.OPACITY)) {
            arrayList.add(motionSpec.getAnimator(Attributes.Style.OPACITY, this.fab, View.ALPHA));
        }
        if (motionSpec.hasPropertyValues(n.f28264e)) {
            arrayList.add(motionSpec.getAnimator(n.f28264e, this.fab, View.SCALE_Y));
            arrayList.add(motionSpec.getAnimator(n.f28264e, this.fab, View.SCALE_X));
        }
