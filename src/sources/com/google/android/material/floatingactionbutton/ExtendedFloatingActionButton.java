...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        private void offsetIfNeeded(@NonNull CoordinatorLayout coordinatorLayout, @NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            if (extendedFloatingActionButton.getRight() >= coordinatorLayout.getWidth() - layoutParams.rightMargin) {
                ...
                i10 = extendedFloatingActionButton.getLeft() <= layoutParams.leftMargin ? -rect.left : 0;
            }
            ...
            if (i10 != 0) {
                ViewCompat.offsetLeftAndRight(extendedFloatingActionButton, i10);
            }
        }
        ...
        public void extendOrShow(@NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            OnChangedCallback onChangedCallback = z10 ? this.internalAutoShrinkCallback : this.internalAutoHideCallback;
            if (z10) {
    ...
    public void performMotion(@NonNull final MotionStrategy motionStrategy, @Nullable final OnChangedCallback onChangedCallback) {
        ...
        Iterator<Animator.AnimatorListener> iterator2 = motionStrategy.getListeners().iterator2();
