...
public final class Advice extends GeneratedMessageV3 implements AdviceOrBuilder {
    ...
    private static final Parser<Advice> PARSER = new a();
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements AdviceOrBuilder {
        ...
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return f.f53890d.ensureFieldAccessorsInitialized(Advice.class, Builder.class);
        }
    ...
    /* loaded from: C:\Users\35037\Desktop\fankahook\2\class8.dex */
    public static class a extends AbstractParser<Advice> {
        ...
        public Advice parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            return new Advice(codedInputStream, extensionRegistryLite, null);
        }
    }

    public /* synthetic */ Advice(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, a aVar) throws InvalidProtocolBufferException {
    ...
    public int hashCode() {
        ...
        int hashCode = ((((((MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_PREMIUM_SMS_DENY + getDescriptor().hashCode()) * 37) + 2) * 53) + getDescription().hashCode()) * 29) + this.unknownFields.hashCode();
    ...
    public /* synthetic */ Advice(GeneratedMessageV3.Builder builder, a aVar) {
        this(builder);
    }
