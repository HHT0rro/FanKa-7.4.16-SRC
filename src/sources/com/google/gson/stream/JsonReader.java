...
public class JsonReader implements Closeable {
    ...
    static {
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() { // from class: com.google.gson.stream.JsonReader.1
            ...
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                ...
                throw new IllegalStateException("Expected a name but was " + ((Object) jsonReader.peek()) + jsonReader.locationString());
            }
        };
    }
    ...
    private boolean fillBuffer(int i10) throws IOException {
        ...
        if (i15 != i14) {
            int i16 = i15 - i14;
            this.limit = i16;
            System.arraycopy((Object) cArr, i14, (Object) cArr, 0, i16);
        } else {
            this.limit = 0;
        }
        this.pos = 0;
    ...
    */
    ...
    private int peekKeyword() throws IOException {
        ...
        for (int i11 = 1; i11 < length; i11++) {
            ...
            char c10 = this.buffer[this.pos + i11];
