...
public final class ReportServiceGrpc {
    ...
    public static final String SERVICE_NAME = "com.irisdt.page.ReportService";
    ...
    public interface AsyncService {
        void batchReport(PageDurationProtos.Requests requests, StreamObserver<PageDurationProtos.Response> streamObserver);
    }
    ...
    public static final class ReportServiceFutureStub extends AbstractFutureStub<ReportServiceFutureStub> {
        public n<PageDurationProtos.Response> batchReport(PageDurationProtos.Requests requests) {
    ...
    public static abstract class ReportServiceImplBase implements BindableService, AsyncService {
        @Override // com.irisdt.page.ReportServiceGrpc.AsyncService
        public /* synthetic */ void batchReport(PageDurationProtos.Requests requests, StreamObserver streamObserver) {
    ...
    @RpcMethod(fullMethodName = "com.irisdt.page.ReportService/BatchReport", methodType = MethodDescriptor.MethodType.UNARY, requestType = PageDurationProtos.Requests.class, responseType = PageDurationProtos.Response.class)
    public static MethodDescriptor<PageDurationProtos.Requests, PageDurationProtos.Response> getBatchReportMethod() {
        MethodDescriptor<PageDurationProtos.Requests, PageDurationProtos.Response> methodDescriptor = getBatchReportMethod;
    ...
    public static ReportServiceBlockingStub newBlockingStub(Channel channel) {
        return (ReportServiceBlockingStub) AbstractBlockingStub.newStub(new AbstractStub.StubFactory<ReportServiceBlockingStub>() { // from class: com.irisdt.page.ReportServiceGrpc.2
    ...
    public static ReportServiceFutureStub newFutureStub(Channel channel) {
        return (ReportServiceFutureStub) AbstractFutureStub.newStub(new AbstractStub.StubFactory<ReportServiceFutureStub>() { // from class: com.irisdt.page.ReportServiceGrpc.3
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // io.grpc.stub.AbstractStub.StubFactory
    ...
    public static ReportServiceStub newStub(Channel channel) {
        return (ReportServiceStub) AbstractAsyncStub.newStub(new AbstractStub.StubFactory<ReportServiceStub>() { // from class: com.irisdt.page.ReportServiceGrpc.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // io.grpc.stub.AbstractStub.StubFactory
