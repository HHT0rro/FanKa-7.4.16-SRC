...
public final class ReportServiceGrpc {
    ...
    public static final String SERVICE_NAME = "com.irisdt.client.ReportService";
    ...
    public interface AsyncService {
        void batchReport(ClientProtos.Requests requests, StreamObserver<ClientProtos.Response> streamObserver);
    }
    ...
    public static final class ReportServiceFutureStub extends AbstractFutureStub<ReportServiceFutureStub> {
        public n<ClientProtos.Response> batchReport(ClientProtos.Requests requests) {
    ...
    public static abstract class ReportServiceImplBase implements BindableService, AsyncService {
        @Override // com.irisdt.client.ReportServiceGrpc.AsyncService
        public /* synthetic */ void batchReport(ClientProtos.Requests requests, StreamObserver streamObserver) {
            c.a(this, requests, streamObserver);
        }
    ...
    @RpcMethod(fullMethodName = "com.irisdt.client.ReportService/BatchReport", methodType = MethodDescriptor.MethodType.UNARY, requestType = ClientProtos.Requests.class, responseType = ClientProtos.Response.class)
    public static MethodDescriptor<ClientProtos.Requests, ClientProtos.Response> getBatchReportMethod() {
        MethodDescriptor<ClientProtos.Requests, ClientProtos.Response> methodDescriptor = getBatchReportMethod;
    ...
    public static ReportServiceBlockingStub newBlockingStub(Channel channel) {
        return (ReportServiceBlockingStub) AbstractBlockingStub.newStub(new AbstractStub.StubFactory<ReportServiceBlockingStub>() { // from class: com.irisdt.client.ReportServiceGrpc.2
    ...
    public static ReportServiceFutureStub newFutureStub(Channel channel) {
        return (ReportServiceFutureStub) AbstractFutureStub.newStub(new AbstractStub.StubFactory<ReportServiceFutureStub>() { // from class: com.irisdt.client.ReportServiceGrpc.3
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // io.grpc.stub.AbstractStub.StubFactory
    ...
    public static ReportServiceStub newStub(Channel channel) {
        return (ReportServiceStub) AbstractAsyncStub.newStub(new AbstractStub.StubFactory<ReportServiceStub>() { // from class: com.irisdt.client.ReportServiceGrpc.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // io.grpc.stub.AbstractStub.StubFactory
