...
public final class ReportServiceGrpc {
    ...
    public interface AsyncService {
        void batchReport(CustomEventProtos.Requests requests, StreamObserver<CustomEventProtos.Response> streamObserver);
    }
    ...
    public static final class ReportServiceFutureStub extends AbstractFutureStub<ReportServiceFutureStub> {
        public n<CustomEventProtos.Response> batchReport(CustomEventProtos.Requests requests) {
    ...
    public static abstract class ReportServiceImplBase implements BindableService, AsyncService {
        @Override // com.irisdt.event.ReportServiceGrpc.AsyncService
        public /* synthetic */ void batchReport(CustomEventProtos.Requests requests, StreamObserver streamObserver) {
    ...
    public static final class ReportServiceStub extends AbstractAsyncStub<ReportServiceStub> {
        public void batchReport(CustomEventProtos.Requests requests, StreamObserver<CustomEventProtos.Response> streamObserver) {
    ...
    @RpcMethod(fullMethodName = "com.irisdt.event.ReportService/BatchReport", methodType = MethodDescriptor.MethodType.UNARY, requestType = CustomEventProtos.Requests.class, responseType = CustomEventProtos.Response.class)
    public static MethodDescriptor<CustomEventProtos.Requests, CustomEventProtos.Response> getBatchReportMethod() {
        ...
        if (methodDescriptor == null) {
            synchronized (ReportServiceGrpc.class) {
                ...
                if (methodDescriptor == null) {
                    methodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName(MethodDescriptor.generateFullMethodName(SERVICE_NAME, "BatchReport")).setSampledToLocalTracing(true).setRequestMarshaller(ProtoUtils.marshaller(CustomEventProtos.Requests.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(CustomEventProtos.Response.getDefaultInstance())).setSchemaDescriptor(new ReportServiceMethodDescriptorSupplier("BatchReport")).build();
    ...
    public static ReportServiceBlockingStub newBlockingStub(Channel channel) {
        return (ReportServiceBlockingStub) AbstractBlockingStub.newStub(new AbstractStub.StubFactory<ReportServiceBlockingStub>() { // from class: com.irisdt.event.ReportServiceGrpc.2
    ...
    public static ReportServiceFutureStub newFutureStub(Channel channel) {
        return (ReportServiceFutureStub) AbstractFutureStub.newStub(new AbstractStub.StubFactory<ReportServiceFutureStub>() { // from class: com.irisdt.event.ReportServiceGrpc.3
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // io.grpc.stub.AbstractStub.StubFactory
    ...
    public static ReportServiceStub newStub(Channel channel) {
        return (ReportServiceStub) AbstractAsyncStub.newStub(new AbstractStub.StubFactory<ReportServiceStub>() { // from class: com.irisdt.event.ReportServiceGrpc.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // io.grpc.stub.AbstractStub.StubFactory
    ...
    public static final class MethodHandlers<Req, Resp> implements ServerCalls.UnaryMethod<Req, Resp>, ServerCalls.ServerStreamingMethod<Req, Resp>, ServerCalls.ClientStreamingMethod<Req, Resp>, ServerCalls.BidiStreamingMethod<Req, Resp> {
        ...
        public void invoke(Req req, StreamObserver<Resp> streamObserver) {
            if (this.methodId == 0) {
                this.serviceImpl.batchReport((CustomEventProtos.Requests) req, streamObserver);
                return;
            }
