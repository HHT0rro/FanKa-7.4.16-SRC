...
public final class ReportServiceGrpc {
    ...
    public static final String SERVICE_NAME = "com.irisdt.perf.ReportService";
    private static volatile MethodDescriptor<PerfProtos.Requests, PerfProtos.Response> getBatchReportMethod;
    private static volatile ServiceDescriptor serviceDescriptor;

    /* loaded from: C:\Users\35037\Desktop\fankahook\2\class10.dex */
    public interface AsyncService {
        void batchReport(PerfProtos.Requests requests, StreamObserver<PerfProtos.Response> streamObserver);
    }
    ...
    public static final class ReportServiceBlockingStub extends AbstractBlockingStub<ReportServiceBlockingStub> {
        public PerfProtos.Response batchReport(PerfProtos.Requests requests) {
            return (PerfProtos.Response) ClientCalls.blockingUnaryCall(getChannel(), ReportServiceGrpc.getBatchReportMethod(), getCallOptions(), requests);
        }
    ...
    public static final class ReportServiceFutureStub extends AbstractFutureStub<ReportServiceFutureStub> {
        public n<PerfProtos.Response> batchReport(PerfProtos.Requests requests) {
    ...
    public static abstract class ReportServiceImplBase implements BindableService, AsyncService {
        @Override // com.irisdt.perf.ReportServiceGrpc.AsyncService
        public /* synthetic */ void batchReport(PerfProtos.Requests requests, StreamObserver streamObserver) {
    ...
    @RpcMethod(fullMethodName = "com.irisdt.perf.ReportService/BatchReport", methodType = MethodDescriptor.MethodType.UNARY, requestType = PerfProtos.Requests.class, responseType = PerfProtos.Response.class)
    public static MethodDescriptor<PerfProtos.Requests, PerfProtos.Response> getBatchReportMethod() {
        ...
        if (methodDescriptor == null) {
            synchronized (ReportServiceGrpc.class) {
                ...
                if (methodDescriptor == null) {
                    methodDescriptor = MethodDescriptor.newBuilder().setType(MethodDescriptor.MethodType.UNARY).setFullMethodName(MethodDescriptor.generateFullMethodName(SERVICE_NAME, "BatchReport")).setSampledToLocalTracing(true).setRequestMarshaller(ProtoUtils.marshaller(PerfProtos.Requests.getDefaultInstance())).setResponseMarshaller(ProtoUtils.marshaller(PerfProtos.Response.getDefaultInstance())).setSchemaDescriptor(new ReportServiceMethodDescriptorSupplier("BatchReport")).build();
    ...
    public static ReportServiceBlockingStub newBlockingStub(Channel channel) {
        return (ReportServiceBlockingStub) AbstractBlockingStub.newStub(new AbstractStub.StubFactory<ReportServiceBlockingStub>() { // from class: com.irisdt.perf.ReportServiceGrpc.2
    ...
    public static ReportServiceFutureStub newFutureStub(Channel channel) {
        return (ReportServiceFutureStub) AbstractFutureStub.newStub(new AbstractStub.StubFactory<ReportServiceFutureStub>() { // from class: com.irisdt.perf.ReportServiceGrpc.3
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // io.grpc.stub.AbstractStub.StubFactory
    ...
    public static ReportServiceStub newStub(Channel channel) {
        return (ReportServiceStub) AbstractAsyncStub.newStub(new AbstractStub.StubFactory<ReportServiceStub>() { // from class: com.irisdt.perf.ReportServiceGrpc.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // io.grpc.stub.AbstractStub.StubFactory
