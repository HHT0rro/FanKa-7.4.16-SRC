 ...
 */
    ...
    public interface OnTraceEnabledChangeListener {
        void onTraceEnabledChange(boolean z10);
    }
    ...
    public int getPackageId(Resources resources, String packageName) {
        ...
        for (int i10 = 0; i10 < packageIdentifiers.size(); i10++) {
            String name = packageIdentifiers.valueAt(i10);
            if (packageName.equals(name)) {
                return packageIdentifiers.keyAt(i10);
            }
        }
