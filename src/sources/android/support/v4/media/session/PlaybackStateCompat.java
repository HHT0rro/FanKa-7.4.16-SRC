...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static PlaybackStateCompat fromPlaybackState(Object obj) {
        ...
        if (customActions != null) {
            ...
            Iterator<PlaybackState.CustomAction> iterator2 = customActions.iterator2();
            while (iterator2.hasNext()) {
                arrayList.add(CustomAction.fromCustomAction(iterator2.next()));
            }
        }
    ...
    public Object getPlaybackState() {
        if (this.mStateFwk == null) {
            ...
            Iterator<CustomAction> iterator2 = this.mCustomActions.iterator2();
            while (iterator2.hasNext()) {
                builder.addCustomAction((PlaybackState.CustomAction) iterator2.next().getCustomAction());
            }
    ...
    public String toString() {
        return "PlaybackState {state=" + this.mState + ", position=" + this.mPosition + ", buffered position=" + this.mBufferedPosition + ", speed=" + this.mSpeed + ", updated=" + this.mUpdateTime + ", actions=" + this.mActions + ", error code=" + this.mErrorCode + ", error message=" + this.mErrorMessage + ", custom actions=" + ((Object) this.mCustomActions) + ", active item id=" + this.mActiveItemId + i.f4738d;
    }
