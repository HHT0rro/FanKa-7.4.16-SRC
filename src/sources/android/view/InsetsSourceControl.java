...
public class InsetsSourceControl implements Parcelable {
    ...
    public boolean equals(Object o10) {
        ...
        InsetsSourceControl that = (InsetsSourceControl) o10;
    ...
    public String toString() {
        return "InsetsSourceControl: {" + Integer.toHexString(this.mId) + " mType=" + WindowInsets.Type.toString(this.mType) + (this.mInitiallyVisible ? " initiallyVisible" : "") + " mSurfacePosition=" + ((Object) this.mSurfacePosition) + " mInsetsHint=" + ((Object) this.mInsetsHint) + (this.mSkipAnimationOnce ? " skipAnimationOnce" : "") + i.f4738d;
    }
