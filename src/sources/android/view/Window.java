...
public abstract class Window {
    ...
    private IWindowWrapper mWrapper = new WindowWrapper();
    private IWindowExt mWindowExt = (IWindowExt) ExtLoader.type(IWindowExt.class).base(this).create();
 ...
 */
    ...
    public interface DecorCallback {
        boolean onDrawLegacyNavigationBarBackgroundChanged(boolean z10);

        void onSystemBarAppearanceChanged(int i10);
    }
 ...
 */
    ...
    public interface OnWindowDismissedCallback {
        void onWindowDismissed(boolean z10, boolean z11);
    }
 ...
 */
    ...
    public interface WindowControllerCallback {
        ...
        void updateNavigationBarColor(int i10);

        void updateStatusBarColor(int i10);
    }
 ...
 */
        ...
        if (wp.type >= 1000 && wp.type <= 1999) {
            ...
            if (curTitle == null || curTitle.length() == 0) {
                ...
                if (this.mAppName != null) {
                    title.append(u.bD).append(this.mAppName);
                }
                wp.setTitle(title);
            }
            ...
            if (curTitle == null || curTitle.length() == 0) {
                ...
                if (this.mAppName != null) {
                    title2.append(u.bD).append(this.mAppName);
                }
                wp.setTitle(title2);
            }
        } else {
    ...
    public int getColorMode() {
        return this.mWindowExt.getColorMode(getAttributes().getColorMode());
    }
    ...
    public void setAttributes(WindowManager.LayoutParams a10) {
        this.mWindowAttributes.copyFrom(a10);
        dispatchWindowAttributesChanged(this.mWindowAttributes);
    }
    ...
    private boolean isOutOfBounds(Context context, MotionEvent event) {
        ...
        View decorView = getDecorView();
        return x10 < (-slop) || y10 < (-slop) || x10 > decorView.getWidth() + slop || y10 > decorView.getHeight() + slop;
    }

    public boolean requestFeature(int featureId) {
        int flag = 1 << featureId;
        int i10 = this.mFeatures | flag;
        this.mFeatures = i10;
        int i11 = this.mLocalFeatures;
        Window window = this.mContainer;
        this.mLocalFeatures = i11 | (window != null ? (~window.mFeatures) & flag : flag);
        return (i10 & flag) != 0;
    }
    ...
    public void removeFeature(int featureId) {
        int flag = 1 << featureId;
        this.mFeatures &= ~flag;
        int i10 = this.mLocalFeatures;
        Window window = this.mContainer;
        this.mLocalFeatures = i10 & (~(window != null ? (~window.mFeatures) & flag : flag));
    }
    ...
    public <T extends View> T findViewById(int i10) {
        return (T) getDecorView().findViewById(i10);
    }
    ...
    public static int getDefaultFeatures(Context context) {
        ...
        if (res.getBoolean(17891608)) {
            features = 0 | 1;
        }
        if (res.getBoolean(17891607)) {
            return features | 64;
        }
        return features;
    }
    ...
    public IWindowWrapper getWrapper() {
 ...
 */
    /* loaded from: C:\Users\35037\Desktop\fankahook\2\class11.dex.bak */
    public class WindowWrapper implements IWindowWrapper {
        public WindowWrapper() {
        }

        @Override // android.view.IWindowWrapper
        public IWindowExt getExtImpl() {
            return Window.this.mWindowExt;
        }

        @Override // android.view.IWindowWrapper
        public boolean isSetCloseOnTouchOutside() {
            return Window.this.mSetCloseOnTouchOutside;
        }

        @Override // android.view.IWindowWrapper
        public void setCloseOnTouchOutside(boolean closeOnTouchOutside) {
            Window.this.mCloseOnTouchOutside = closeOnTouchOutside;
        }
    }
}
