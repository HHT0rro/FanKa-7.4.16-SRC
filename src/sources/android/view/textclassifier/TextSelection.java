...
public final class TextSelection implements Parcelable {
    ...
    private TextSelection(int startIndex, int endIndex, Map<String, Float> entityConfidence, String id2, TextClassification textClassification, Bundle extras) {
 ...
 */
    ...
    public static final class Builder {
        ...
        public TextSelection build() {
            ...
            return new TextSelection(i10, i11, map, str, textClassification, bundle);
        }
    }
 ...
 */
        ...
        public static final class Builder {
            ...
            public Request build() {
                ...
                boolean z10 = this.mDarkLaunchAllowed;
                boolean z11 = this.mIncludeTextClassification;
                Bundle bundle = this.mExtras;
                if (bundle == null) {
                    bundle = Bundle.EMPTY;
                }
                return new Request(spannedString, i10, i11, localeList, z10, z11, bundle);
            }
        }
