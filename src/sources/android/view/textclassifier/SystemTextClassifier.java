...
public final class SystemTextClassifier implements TextClassifier {
    ...
    public TextSelection suggestSelection(TextSelection.Request request) {
        ...
        try {
            ...
            Log.e("androidtc", "Error suggesting selection for text. Using fallback.", e2);
        }
    ...
    public TextClassification classifyText(TextClassification.Request request) {
        ...
        try {
            request.setSystemTextClassifierMetadata(this.mSystemTcMetadata);
            BlockingCallback<TextClassification> callback = new BlockingCallback<>("textclassification", this.mSettings);
            ...
            Log.e("androidtc", "Error classifying text. Using fallback.", e2);
        }
    ...
    public TextLinks generateLinks(TextLinks.Request request) {
        ...
        try {
            ...
            Log.e("androidtc", "Error generating links. Using fallback.", e2);
        }
        return this.mFallback.generateLinks(request);
    }
    ...
    public void onSelectionEvent(SelectionEvent event) {
        ...
        try {
            ...
            Log.e("androidtc", "Error reporting selection event.", e2);
        }
    }
    ...
    public void onTextClassifierEvent(TextClassifierEvent event) {
        ...
        try {
            ...
            Log.e("androidtc", "Error reporting textclassifier event.", e2);
        }
    }
    ...
    public TextLanguage detectLanguage(TextLanguage.Request request) {
        ...
        try {
            ...
            Log.e("androidtc", "Error detecting language.", e2);
        }
    ...
    public void destroy() {
        try {
            ...
            Log.e("androidtc", "Error destroying classification session.", e2);
        }
    }
    ...
    public void initializeRemoteSession(TextClassificationContext classificationContext, TextClassificationSessionId sessionId) {
        ...
        try {
            ...
            Log.e("androidtc", "Error starting a new classification session.", e2);
        }
    }
        ...
        public T get() {
            if (Looper.myLooper() != Looper.getMainLooper()) {
                try {
                    ...
                    Log.e("androidtc", "Interrupted during ResponseReceiver.get(): " + this.mName, e2);
                }
            }
