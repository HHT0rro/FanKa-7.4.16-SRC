 ...
 */
    ...
    private TextClassification(String text, Drawable legacyIcon, String legacyLabel, Intent legacyIntent, View.OnClickListener legacyOnClickListener, List<RemoteAction> actions, EntityConfidence entityConfidence, String id2, Bundle extras) {
        this.mText = text;
    ...
    public static View.OnClickListener createIntentOnClickListener(final PendingIntent intent) {
        ...
        return new View.OnClickListener() { // from class: android.view.textclassifier.TextClassification$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                TextClassification.lambda$createIntentOnClickListener$0(intent, view);
            }
        };
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void lambda$createIntentOnClickListener$0(PendingIntent intent, View v2) {
        try {
 ...
 */
        ...
        public static final class Builder {
            ...
            public Request build() {
                ...
                return new Request(spannedString, i10, i11, localeList, zonedDateTime, bundle);
            }
        }
