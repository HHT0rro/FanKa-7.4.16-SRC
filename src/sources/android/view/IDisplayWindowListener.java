...
public interface IDisplayWindowListener extends IInterface {
    ...
    void onDisplayAdded(int i10) throws RemoteException;

    void onDisplayConfigurationChanged(int i10, Configuration configuration) throws RemoteException;

    void onDisplayRemoved(int i10) throws RemoteException;

    void onFixedRotationFinished(int i10) throws RemoteException;

    void onFixedRotationStarted(int i10, int i11) throws RemoteException;

    void onKeepClearAreasChanged(int i10, List<Rect> list, List<Rect> list2) throws RemoteException;
