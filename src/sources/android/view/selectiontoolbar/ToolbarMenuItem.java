 ...
 */
    ...
    ToolbarMenuItem(int itemId, CharSequence title, CharSequence contentDescription, int groupId, Icon icon, CharSequence tooltipText, int priority) {
        this.mItemId = itemId;
        this.mTitle = title;
        AnnotationValidations.validate(NonNull.class, (NonNull) null, title);
    ...
    public String toString() {
        return "ToolbarMenuItem { itemId = " + this.mItemId + ", title = " + ((Object) this.mTitle) + ", contentDescription = " + ((Object) this.mContentDescription) + ", groupId = " + this.mGroupId + ", icon = " + ((Object) this.mIcon) + ", tooltipText = " + ((Object) this.mTooltipText) + ", priority = " + this.mPriority + " }";
    }
    ...
    public boolean equals(Object o10) {
        ...
        ToolbarMenuItem that = (ToolbarMenuItem) o10;
 ...
 */
    ...
    public static final class Builder {
        ...
        public ToolbarMenuItem build() {
            ...
            ToolbarMenuItem o10 = new ToolbarMenuItem(this.mItemId, this.mTitle, this.mContentDescription, this.mGroupId, this.mIcon, this.mTooltipText, this.mPriority);
            return o10;
        }
