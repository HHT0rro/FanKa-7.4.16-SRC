...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_SYSTEM_FINGERPRINT_KEYMODE = 317;
 ...
 */
    ...
    private static native String nativeKeyCodeToString(int i10);
    ...
    public static int getDeadChar(int accent, int c4) {
        return KeyCharacterMap.getDeadChar(accent, c4);
    }
    ...
    */
    ...
    private KeyEvent(KeyEvent origEvent, int id2, long eventTime, int action, int newRepeat, byte[] hmac, String characters) {
        this.mDisplayId = -1;
        this.mId = id2;
    ...
    private static KeyEvent obtain(int id2, long downTimeNanos, long eventTimeNanos, int action, int code, int repeat, int metaState, int deviceId, int scancode, int flags, int source, int displayId, byte[] hmac, String characters) {
        KeyEvent ev = obtain();
        ev.mId = id2;
    ...
    public final void setTainted(boolean tainted) {
        int i10 = this.mFlags;
        this.mFlags = tainted ? i10 | Integer.MIN_VALUE : i10 & Integer.MAX_VALUE;
    }
 ...
 */
    ...
    public static String metaStateToString(int metaState) {
        ...
        while (metaState != 0) {
            ...
            metaState >>>= 1;
            if (isSet) {
                String name = META_SYMBOLIC_NAMES[i10];
                if (result == null) {
                    if (metaState == 0) {
                        return name;
                    }
