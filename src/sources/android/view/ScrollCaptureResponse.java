...
public class ScrollCaptureResponse implements Parcelable {
    ...
    public String toString() {
        return "ScrollCaptureResponse { description = " + this.mDescription + ", connection = " + ((Object) this.mConnection) + ", windowBounds = " + ((Object) this.mWindowBounds) + ", boundsInWindow = " + ((Object) this.mBoundsInWindow) + ", windowTitle = " + this.mWindowTitle + ", packageName = " + this.mPackageName + ", messages = " + ((Object) this.mMessages) + " }";
    }
 ...
 */
    ...
    public static class Builder {
        ...
        public ScrollCaptureResponse build() {
            checkNotUsed();
            long j10 = this.mBuilderFieldsSet | 128;
            ...
            ScrollCaptureResponse o10 = new ScrollCaptureResponse(this.mDescription, this.mConnection, this.mWindowBounds, this.mBoundsInWindow, this.mWindowTitle, this.mPackageName, this.mMessages);
            return o10;
        }
