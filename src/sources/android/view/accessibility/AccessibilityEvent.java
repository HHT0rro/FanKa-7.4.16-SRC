 ...
 */
    ...
    void init(AccessibilityEvent event) {
        ...
        if (arrayList != null) {
            ...
            for (int i10 = 0; i10 < recordCount; i10++) {
                AccessibilityRecord record = event.mRecords.get(i10);
    ...
    public void setSealed(boolean sealed) {
        ...
        if (records != null) {
            ...
            for (int i10 = 0; i10 < recordCount; i10++) {
                AccessibilityRecord record = records.get(i10);
    ...
    private static String contentChangeTypesToString(int types) {
        return BitUtils.flagsToString(types, new IntFunction() { // from class: android.view.accessibility.AccessibilityEvent$$ExternalSyntheticLambda2
            ...
            public final Object apply(int i10) {
                ...
                singleContentChangeTypeToString = AccessibilityEvent.singleContentChangeTypeToString(i10);
    ...
    private static String speechStateChangeTypesToString(int types) {
        return BitUtils.flagsToString(types, new IntFunction() { // from class: android.view.accessibility.AccessibilityEvent$$ExternalSyntheticLambda1
            ...
            public final Object apply(int i10) {
                ...
                singleSpeechStateChangeTypeToString = AccessibilityEvent.singleSpeechStateChangeTypeToString(i10);
    ...
    private static String windowChangeTypesToString(int types) {
        return BitUtils.flagsToString(types, new IntFunction() { // from class: android.view.accessibility.AccessibilityEvent$$ExternalSyntheticLambda0
            ...
            public final Object apply(int i10) {
                ...
                singleWindowChangeTypeToString = AccessibilityEvent.singleWindowChangeTypeToString(i10);
    ...
    public void writeToParcel(Parcel parcel, int i10) {
        ...
        writeAccessibilityRecordToParcel(this, parcel, i10);
        int recordCount = getRecordCount();
        parcel.writeInt(recordCount);
        for (int i11 = 0; i11 < recordCount; i11++) {
            writeAccessibilityRecordToParcel(this.mRecords.get(i11), parcel, i10);
        }
    }

    private void writeAccessibilityRecordToParcel(AccessibilityRecord accessibilityRecord, Parcel parcel, int i10) {
        ...
        TextUtils.writeToParcel(accessibilityRecord.mClassName, parcel, i10);
        TextUtils.writeToParcel(accessibilityRecord.mContentDescription, parcel, i10);
        TextUtils.writeToParcel(accessibilityRecord.mBeforeText, parcel, i10);
        parcel.writeParcelable(accessibilityRecord.mParcelableData, i10);
    ...
    public String toString() {
        ...
        if (z10) {
            ...
            for (int i10 = 0; i10 < getRecordCount(); i10++) {
                builder.append("  Record ").append(i10).append(u.bD);
                getRecord(i10).appendTo(builder).append("\n");
            }
        } else {
