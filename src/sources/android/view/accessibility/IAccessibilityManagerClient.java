...
public interface IAccessibilityManagerClient extends IInterface {
    void notifyServicesStateChanged(long j10) throws RemoteException;

    void setFocusAppearance(int i10, int i11) throws RemoteException;

    void setRelevantEventTypes(int i10) throws RemoteException;
