...
public interface IWindowMagnificationConnectionCallback extends IInterface {
    ...
    void onAccessibilityActionPerformed(int i10) throws RemoteException;

    void onChangeMagnificationMode(int i10, int i11) throws RemoteException;

    void onMove(int i10) throws RemoteException;

    void onPerformScaleAction(int i10, float f10) throws RemoteException;

    void onSourceBoundsChanged(int i10, Rect rect) throws RemoteException;

    void onWindowMagnifierBoundsChanged(int i10, Rect rect) throws RemoteException;
