...
public interface IAccessibilityInteractionConnection extends IInterface {
    ...
    void findAccessibilityNodeInfoByAccessibilityId(long j10, Region region, int i10, IAccessibilityInteractionConnectionCallback iAccessibilityInteractionConnectionCallback, int i11, int i12, long j11, MagnificationSpec magnificationSpec, float[] fArr, Bundle bundle) throws RemoteException;

    void findAccessibilityNodeInfosByText(long j10, String str, Region region, int i10, IAccessibilityInteractionConnectionCallback iAccessibilityInteractionConnectionCallback, int i11, int i12, long j11, MagnificationSpec magnificationSpec, float[] fArr) throws RemoteException;

    void findAccessibilityNodeInfosByViewId(long j10, String str, Region region, int i10, IAccessibilityInteractionConnectionCallback iAccessibilityInteractionConnectionCallback, int i11, int i12, long j11, MagnificationSpec magnificationSpec, float[] fArr) throws RemoteException;

    void findFocus(long j10, int i10, Region region, int i11, IAccessibilityInteractionConnectionCallback iAccessibilityInteractionConnectionCallback, int i12, int i13, long j11, MagnificationSpec magnificationSpec, float[] fArr) throws RemoteException;

    void focusSearch(long j10, int i10, Region region, int i11, IAccessibilityInteractionConnectionCallback iAccessibilityInteractionConnectionCallback, int i12, int i13, long j11, MagnificationSpec magnificationSpec, float[] fArr) throws RemoteException;

    void notifyOutsideTouch() throws RemoteException;

    void performAccessibilityAction(long j10, int i10, Bundle bundle, int i11, IAccessibilityInteractionConnectionCallback iAccessibilityInteractionConnectionCallback, int i12, int i13, long j11) throws RemoteException;

    void takeScreenshotOfWindow(int i10, ScreenCapture.ScreenCaptureListener screenCaptureListener, IAccessibilityInteractionConnectionCallback iAccessibilityInteractionConnectionCallback) throws RemoteException;
 ...
 */
    ...
    public static class Default implements IAccessibilityInteractionConnection {
        ...
        @Override // android.view.accessibility.IAccessibilityInteractionConnection
        public void attachAccessibilityOverlayToWindow(SurfaceControl sc2) throws RemoteException {
        }
