 ...
 */
    ...
    public static void apply(int gravity, int w3, int h10, Rect container, Rect outRect) {
        apply(gravity, w3, h10, container, 0, 0, outRect);
    }

    public static void apply(int gravity, int w3, int h10, Rect container, Rect outRect, int layoutDirection) {
        int absGravity = getAbsoluteGravity(gravity, layoutDirection);
        apply(absGravity, w3, h10, container, 0, 0, outRect);
    }

    public static void apply(int gravity, int w3, int h10, Rect container, int xAdj, int yAdj, Rect outRect) {
        switch (gravity & 6) {
            case 0:
                outRect.left = container.left + (((container.right - container.left) - w3) / 2) + xAdj;
                outRect.right = outRect.left + w3;
                if ((gravity & 8) == 8) {
        ...
        switch (gravity & 96) {
            case 0:
                outRect.top = container.top + (((container.bottom - container.top) - h10) / 2) + yAdj;
                outRect.bottom = outRect.top + h10;
                if ((gravity & 128) == 128) {
            ...
            case 64:
                ...
                outRect.top = outRect.bottom - h10;
    ...
    public static void apply(int gravity, int w3, int h10, Rect container, int xAdj, int yAdj, Rect outRect, int layoutDirection) {
        int absGravity = getAbsoluteGravity(gravity, layoutDirection);
        apply(absGravity, w3, h10, container, xAdj, yAdj, outRect);
    }
