 ...
 */
                ...
                switch (scp.mWhat) {
                    case 1:
                        try {
                            ...
                            Log.e(SpellCheckerSession.TAG, "Failed to cancel " + ((Object) e2));
                            break;
                        }
                    case 2:
                        try {
                            ...
                            Log.e(SpellCheckerSession.TAG, "Failed to get suggestions " + ((Object) e10));
                            break;
                        }
                    case 3:
                        try {
                            ...
                            Log.e(SpellCheckerSession.TAG, "Failed to close " + ((Object) e11));
                            break;
                        }
                    case 4:
                        try {
                            ...
                            Log.e(SpellCheckerSession.TAG, "Failed to get suggestions " + ((Object) e12));
                            break;
                        }
                }
            } else {
        ...
        private void processOrEnqueueTask(SpellCheckerParams scp) {
            int i10;
            synchronized (this) {
                if (scp.mWhat == 3 && ((i10 = this.mState) == 2 || i10 == 3)) {
                    return;
                }
                int i11 = this.mState;
                if (i11 != 0 && i11 != 1) {
