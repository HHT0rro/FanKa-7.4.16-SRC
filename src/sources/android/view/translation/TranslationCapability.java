 ...
 */
    ...
    public String toString() {
        return "TranslationCapability { state = " + modelStateToString(this.mState) + ", sourceSpec = " + ((Object) this.mSourceSpec) + ", targetSpec = " + ((Object) this.mTargetSpec) + ", uiTranslationEnabled = " + this.mUiTranslationEnabled + ", supportedTranslationFlags = " + this.mSupportedTranslationFlags + " }";
    }
    ...
    TranslationCapability(Parcel in) {
        ...
        this.mUiTranslationEnabled = uiTranslationEnabled;
        this.mSupportedTranslationFlags = supportedTranslationFlags;
        AnnotationValidations.validate(TranslationContext.TranslationFlag.class, (Annotation) null, supportedTranslationFlags);
    }
