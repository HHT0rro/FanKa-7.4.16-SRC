...
public interface ITranslationDirectManager extends IInterface {
    ...
    void onFinishTranslationSession(int i10) throws RemoteException;

    void onTranslationRequest(TranslationRequest translationRequest, int i10, ICancellationSignal iCancellationSignal, ITranslationCallback iTranslationCallback) throws RemoteException;
