...
public interface ITranslationManager extends IInterface {
    ...
    void getServiceSettingsActivity(IResultReceiver iResultReceiver, int i10) throws RemoteException;

    void onSessionCreated(TranslationContext translationContext, int i10, IResultReceiver iResultReceiver, int i11) throws RemoteException;

    void onTranslationCapabilitiesRequest(int i10, int i11, ResultReceiver resultReceiver, int i12) throws RemoteException;

    void onTranslationFinished(boolean z10, IBinder iBinder, ComponentName componentName, int i10) throws RemoteException;

    void registerTranslationCapabilityCallback(IRemoteCallback iRemoteCallback, int i10) throws RemoteException;

    void registerUiTranslationStateCallback(IRemoteCallback iRemoteCallback, int i10) throws RemoteException;

    void unregisterTranslationCapabilityCallback(IRemoteCallback iRemoteCallback, int i10) throws RemoteException;

    void unregisterUiTranslationStateCallback(IRemoteCallback iRemoteCallback, int i10) throws RemoteException;

    void updateUiTranslationState(int i10, TranslationSpec translationSpec, TranslationSpec translationSpec2, List<AutofillId> list, IBinder iBinder, int i11, UiTranslationSpec uiTranslationSpec, int i12) throws RemoteException;
