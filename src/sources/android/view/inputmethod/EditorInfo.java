 ...
 */
    ...
    public void setSupportedHandwritingGestures(List<Class<? extends HandwritingGesture>> gestures) {
        ...
        for (Class<? extends HandwritingGesture> gesture : gestures) {
            ...
            if (gesture.equals(SelectGesture.class)) {
                ...
                throw new IllegalArgumentException("Unknown gesture type: " + ((Object) gesture));
            }
        }
    ...
    public List<Class<? extends HandwritingGesture>> getSupportedHandwritingGestures() {
        ...
        int i10 = this.mSupportedHandwritingGestureTypes;
        if (i10 == 0) {
            return list;
        }
        if ((i10 & 1) == 1) {
    ...
    public void setSupportedHandwritingGesturePreviews(Set<Class<? extends PreviewableHandwritingGesture>> gestures) {
        ...
        for (Class<? extends PreviewableHandwritingGesture> gesture : gestures) {
            ...
            if (gesture.equals(SelectGesture.class)) {
                ...
                throw new IllegalArgumentException("Unsupported gesture type for preview: " + ((Object) gesture));
            }
        }
    ...
    public Set<Class<? extends PreviewableHandwritingGesture>> getSupportedHandwritingGesturePreviews() {
        ...
        int i10 = this.mSupportedHandwritingGesturePreviewTypes;
        if (i10 == 0) {
            return set;
        }
        if ((i10 & 1) == 1) {
    ...
    public void setInitialSurroundingSubText(CharSequence subText, int subTextStart) {
        ...
        int i10 = this.initialSelStart;
        int i11 = this.initialSelEnd;
        int subTextSelStart = i10 > i11 ? i11 - subTextStart : i10 - subTextStart;
        int subTextSelEnd = i10 > i11 ? i10 - subTextStart : i11 - subTextStart;
    ...
    public CharSequence getInitialTextBeforeCursor(int length, int flags) {
        ...
        int n10 = Math.min(length, selStart);
        if ((flags & 1) != 0) {
            return this.mInitialSurroundingText.getText().subSequence(selStart - n10, selStart);
        }
        return TextUtils.substring(this.mInitialSurroundingText.getText(), selStart - n10, selStart);
    }
    ...
    public CharSequence getInitialSelectedText(int flags) {
        ...
        int i10 = this.initialSelEnd;
        int correctedTextSelStart = correctedTextSelEnd > i10 ? i10 : correctedTextSelEnd;
        if (correctedTextSelEnd <= i10) {
            correctedTextSelEnd = i10;
        }
    ...
    public CharSequence getInitialTextAfterCursor(int length, int flags) {
        ...
        int n10 = Math.min(length, surroundingTextLength - selEnd);
        if ((flags & 1) != 0) {
            return this.mInitialSurroundingText.getText().subSequence(selEnd, selEnd + n10);
        }
        return TextUtils.substring(this.mInitialSurroundingText.getText(), selEnd, selEnd + n10);
    }
    ...
    public final void makeCompatible(int targetSdkVersion) {
        if (targetSdkVersion < 11) {
            ...
            switch (i10 & 4095) {
                case 2:
                case 18:
                    this.inputType = (i10 & 16773120) | 2;
                    return;
                case 209:
                    this.inputType = (i10 & 16773120) | 33;
                    return;
                case 225:
                    this.inputType = (i10 & 16773120) | 129;
                    return;
                default:
                    return;
            }
    ...
    public void dump(Printer pw, String prefix, boolean dumpExtras) {
        ...
        pw.println(prefix + "packageName=" + this.packageName + " autofillId=" + ((Object) this.autofillId) + " fieldId=" + this.fieldId + " fieldName=" + this.fieldName);
        if (dumpExtras) {
            pw.println(prefix + "extras=" + ((Object) this.extras));
        }
        pw.println(prefix + "hintLocales=" + ((Object) this.hintLocales));
