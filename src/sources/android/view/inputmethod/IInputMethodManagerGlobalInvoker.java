...
public final class IInputMethodManagerGlobalInvoker {
    ...
    public static IInputMethodManager getService() {
        ...
        if (service == null) {
            if (InputMethodManager.isInEditModeInternal() || (service = IInputMethodManager.Stub.asInterface(ServiceManager.getService("input_method"))) == null) {
                return null;
            }
    ...
    private static void handleRemoteExceptionOrRethrow(RemoteException e2, Consumer<RemoteException> exceptionHandler) {
    ...
    public static void startProtoDump(byte[] protoDump, int source, String where, Consumer<RemoteException> exceptionHandler) {
        ...
        try {
            ...
            handleRemoteExceptionOrRethrow(e2, exceptionHandler);
        }
    }
