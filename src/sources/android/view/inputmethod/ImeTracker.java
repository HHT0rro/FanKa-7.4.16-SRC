 ...
 */
    ...
    void onCancelled(Token token, int i10);

    void onFailed(Token token, int i10);

    void onHidden(Token token);

    void onProgress(Token token, int i10);

    Token onRequestHide(String str, int i10, int i11, int i12);

    Token onRequestShow(String str, int i10, int i11, int i12);

    void onShown(Token token);

    void onTodo(Token token, int i10);
 ...
 */
    ...
    public class AnonymousClass1 implements ImeTracker {
        ...
        private String getTag(String component) {
            ...
            return component + u.bD + Integer.toHexString(ThreadLocalRandom.current().nextInt());
        }
    }
        ...
        private static Map<Integer, String> getFieldMapping(Class<?> cls, final String fieldPrefix) {
            return (Map) Arrays.stream(cls.getDeclaredFields()).filter(new Predicate() { // from class: android.view.inputmethod.ImeTracker$Debug$$ExternalSyntheticLambda0
                ...
                public final boolean test(Object obj) {
                    boolean startsWith;
                    startsWith = ((Field) obj).getName().startsWith(String.this);
                    return startsWith;
                }
 ...
 */
    ...
    public static final class ImeJankTracker {
        ...
        public void onRequestAnimation(InputMethodJankContext inputMethodJankContext, int i10, boolean z10) {
            if (inputMethodJankContext.getDisplayContext() == null || inputMethodJankContext.getTargetSurfaceControl() == null) {
                return;
            }
            InteractionJankMonitor.getInstance().begin(InteractionJankMonitor.Configuration.Builder.withSurface(69, inputMethodJankContext.getDisplayContext(), inputMethodJankContext.getTargetSurfaceControl()).setTag(String.format(Locale.US, "%d@%d@%s", Integer.valueOf(i10), Integer.valueOf(!z10 ? 1 : 0), inputMethodJankContext.getHostPackageName())));
        }
