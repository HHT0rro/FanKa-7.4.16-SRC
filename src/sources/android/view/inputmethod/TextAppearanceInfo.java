...
public final class TextAppearanceInfo implements Parcelable {
    ...
    TextAppearanceInfo(Parcel in) {
        ...
        this.mTextLocales = (LocaleList) LocaleList.CREATOR.createFromParcel(in);
    ...
    public boolean equals(Object o10) {
        ...
        if (!(o10 instanceof TextAppearanceInfo)) {
            return false;
        }
        TextAppearanceInfo that = (TextAppearanceInfo) o10;
