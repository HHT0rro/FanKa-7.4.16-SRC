...
public final class CursorAnchorInfo implements Parcelable {
    ...
    private static boolean areSameFloatImpl(float a10, float b4) {
        return (Float.isNaN(a10) && Float.isNaN(b4)) || a10 == b4;
    }
    ...
    public boolean equals(Object obj) {
        ...
        while (true) {
            ...
            if (fArr[i10] != that.mMatrixValues[i10]) {
                return false;
            }
            i10++;
        }
    ...
    public String toString() {
        return "CursorAnchorInfo{mHashCode=" + this.mHashCode + " mSelection=" + this.mSelectionStart + "," + this.mSelectionEnd + " mComposingTextStart=" + this.mComposingTextStart + " mComposingText=" + ((Object) this.mComposingText) + " mInsertionMarkerFlags=" + this.mInsertionMarkerFlags + " mInsertionMarkerHorizontal=" + this.mInsertionMarkerHorizontal + " mInsertionMarkerTop=" + this.mInsertionMarkerTop + " mInsertionMarkerBaseline=" + this.mInsertionMarkerBaseline + " mInsertionMarkerBottom=" + this.mInsertionMarkerBottom + " mCharacterBoundsArray=" + ((Object) this.mCharacterBoundsArray) + " mEditorBoundsInfo=" + ((Object) this.mEditorBoundsInfo) + " mVisibleLineBounds=" + ((Object) getVisibleLineBounds()) + " mMatrix=" + Arrays.toString(this.mMatrixValues) + " mTextAppearanceInfo=" + ((Object) this.mTextAppearanceInfo) + i.f4738d;
    }
 ...
 */
    ...
    public static final class Builder {
        ...
        public Builder addVisibleLineBounds(float left, float top, float right, float bottom) {
            ...
            int i10 = this.mVisibleLineBoundsCount;
            if (length <= i10 + 4) {
                this.mVisibleLineBounds = Arrays.copyOf(fArr, (i10 + 4) * 2);
            }
            float[] fArr2 = this.mVisibleLineBounds;
            int i11 = this.mVisibleLineBoundsCount;
            int i12 = i11 + 1;
            this.mVisibleLineBoundsCount = i12;
            fArr2[i11] = left;
            int i13 = i12 + 1;
            this.mVisibleLineBoundsCount = i13;
            fArr2[i12] = top;
            int i14 = i13 + 1;
            this.mVisibleLineBoundsCount = i14;
            fArr2[i13] = right;
            this.mVisibleLineBoundsCount = i14 + 1;
            fArr2[i14] = bottom;
            return this;
        }
    ...
    public static CursorAnchorInfo create(Builder builder) {
        ...
        if (builder.mMatrixInitialized) {
            System.arraycopy((Object) builder.mMatrixValues, 0, (Object) matrixValues, 0, 9);
        } else {
