        ...
        boolean cancel(int propertyConstant) {
            ...
            if ((this.mPropertyMask & propertyConstant) != 0 && (arrayList = this.mNameValuesHolder) != null) {
                ...
                for (int i10 = 0; i10 < count; i10++) {
                    NameValuesHolder nameValuesHolder = this.mNameValuesHolder.get(i10);
                    if (nameValuesHolder.mNameConstant == propertyConstant) {
                        this.mNameValuesHolder.remove(i10);
 ...
 */
    ...
    public void start() {
        this.mView.mViewExt.checkNeedBoostedPropertyAnimator(this);
    ...
    public void cancel() {
        if (this.mAnimatorMap.size() > 0) {
            ...
            Set<Animator> animatorSet = mAnimatorMapCopy.h();
    ...
    public void startAnimation() {
        ...
        for (int i10 = 0; i10 < propertyCount; i10++) {
            NameValuesHolder nameValuesHolder = nameValueList.get(i10);
    ...
    private void animatePropertyBy(int constantName, float startValue, float byValue) {
        if (this.mAnimatorMap.size() > 0) {
            ...
            Set<Animator> animatorSet = this.mAnimatorMap.h();
            Iterator<Animator> iterator2 = animatorSet.iterator2();
            while (true) {
                if (!iterator2.hasNext()) {
                    break;
                }
                Animator runningAnim = iterator2.next();
    ...
    public class AnimatorEventListener implements Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationStart(Animator animation) {
            if (ViewPropertyAnimator.this.mAnimatorSetupMap != null) {
                Runnable r10 = (Runnable) ViewPropertyAnimator.this.mAnimatorSetupMap.get(animation);
                if (r10 != null) {
                    r10.run();
                }
            ...
            if (ViewPropertyAnimator.this.mAnimatorOnStartMap != null) {
                Runnable r11 = (Runnable) ViewPropertyAnimator.this.mAnimatorOnStartMap.get(animation);
                if (r11 != null) {
                    r11.run();
                }
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if (ViewPropertyAnimator.this.mAnimatorCleanupMap != null) {
                Runnable r10 = (Runnable) ViewPropertyAnimator.this.mAnimatorCleanupMap.get(animation);
                if (r10 != null) {
                    r10.run();
                }
            ...
            if (ViewPropertyAnimator.this.mAnimatorOnEndMap != null) {
                Runnable r11 = (Runnable) ViewPropertyAnimator.this.mAnimatorOnEndMap.get(animation);
                if (r11 != null) {
                    r11.run();
                }
                ViewPropertyAnimator.this.mAnimatorOnEndMap.remove(animation);
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            if (valueList != null) {
                ...
                for (int i10 = 0; i10 < count; i10++) {
                    NameValuesHolder values = valueList.get(i10);
            ...
            int count2 = propertyMask & ViewPropertyAnimator.TRANSFORM_MASK;
