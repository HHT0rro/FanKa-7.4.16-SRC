 ...
 */
    ...
    public FrameMetrics(FrameMetrics other) {
        ...
        System.arraycopy((Object) other.mTimingData, 0, (Object) jArr, 0, jArr.length);
    }
    ...
    public long getMetric(int id2) {
        long[] jArr;
        if (id2 < 0 || id2 > 13 || (jArr = this.mTimingData) == null) {
            return -1L;
        }
        if (id2 == 9) {
