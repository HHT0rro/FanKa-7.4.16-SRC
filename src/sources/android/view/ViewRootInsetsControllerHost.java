...
public class ViewRootInsetsControllerHost implements InsetsController.Host {
    ...
    @Override // android.view.InsetsController.Host
    public void addOnPreDrawRunnable(final Runnable r10) {
    ...
    public void applySurfaceParams(SyncRtSurfaceTransactionApplier.SurfaceParams... params) {
        ...
        this.mApplier.applyParams(t2, params);
        t2.apply();
    }

    @Override // android.view.InsetsController.Host
    public void postInsetsAnimationCallback(Runnable r10) {
        this.mViewRoot.mChoreographer.postCallback(2, r10, null);
    }
    ...
    public void updateRequestedVisibleTypes(int types) {
        try {
            ...
            Log.e("VRInsetsControllerHost", "Failed to call insetsModified", e2);
        }
    }
