 ...
 */
    ...
    public String toString() {
        ...
        return str + ", frame=[" + this.frameLeft + "," + this.frameTop + "," + this.frameRight + "," + this.frameBottom + "], touchableRegion=" + ((Object) this.touchableRegion) + ", scaleFactor=" + this.scaleFactor + ", transform=" + ((Object) this.transform) + ", windowToken=" + ((Object) this.windowToken) + ", displayId=" + this.displayId + ", isClone=" + ((this.inputConfig & 65536) != 0);
    }
