...
public interface IContentCaptureManager extends IInterface {
    ...
    void finishSession(int i10) throws RemoteException;
    ...
    void resetTemporaryService(int i10) throws RemoteException;

    void setDefaultServiceEnabled(int i10, boolean z10) throws RemoteException;

    void setTemporaryService(int i10, String str, int i11) throws RemoteException;

    void shareData(DataShareRequest dataShareRequest, IDataShareWriteAdapter iDataShareWriteAdapter) throws RemoteException;

    void startSession(IBinder iBinder, IBinder iBinder2, ComponentName componentName, int i10, int i11, IResultReceiver iResultReceiver) throws RemoteException;
