...
public final class ContentCaptureEvent implements Parcelable {
    ...
    public static final Parcelable.Creator<ContentCaptureEvent> CREATOR = new Parcelable.Creator<ContentCaptureEvent>() { // from class: android.view.contentcapture.ContentCaptureEvent.1
        ...
        public ContentCaptureEvent createFromParcel(Parcel parcel) {
            ...
            AutofillId id2 = (AutofillId) parcel.readParcelable(null, AutofillId.class);
            if (id2 != null) {
 ...
 */
    ...
    public ContentCaptureEvent setAutofillId(AutofillId id2) {
        this.mId = (AutofillId) Objects.requireNonNull(id2);
        return this;
    }
    ...
    public ContentCaptureEvent addAutofillId(AutofillId id2) {
        ...
        if (this.mIds == null) {
            ...
            if (autofillId == null) {
                Log.w(TAG, "addAutofillId(" + ((Object) id2) + ") called without an initial id");
            } else {
    ...
    public void restoreComposingSpan() {
        int i10;
        int i11 = this.mComposingStart;
        if (i11 <= -1 || (i10 = this.mComposingEnd) <= -1) {
            return;
        }
        CharSequence charSequence = this.mText;
        if (charSequence instanceof Spannable) {
            BaseInputConnection.setComposingSpans((Spannable) charSequence, i11, i10);
        } else {
    ...
    public void restoreSelectionSpans() {
        ...
        if (charSequence instanceof SpannableString) {
            ...
            int i10 = this.mSelectionStartIndex;
            ss.setSpan(obj, i10, i10, 0);
            Object obj2 = Selection.SELECTION_END;
            int i11 = this.mSelectionEndIndex;
            ss.setSpan(obj2, i11, i11, 0);
            return;
        }
    ...
    public void mergeEvent(ContentCaptureEvent event) {
        ...
        if (eventType == 2) {
            ...
            if (ids != null) {
                if (id2 != null) {
                    Log.w(TAG, "got TYPE_VIEW_DISAPPEARED event with both id and ids: " + ((Object) event));
                }
                for (int i10 = 0; i10 < ids.size(); i10++) {
                    addAutofillId(ids.get(i10));
                }
                return;
            }
            if (id2 != null) {
            ...
            throw new IllegalArgumentException("mergeEvent(): got TYPE_VIEW_DISAPPEARED event with neither id or ids: " + ((Object) event));
        }
        if (eventType == 3) {
    ...
    public String toString() {
        ...
        if (this.mId != null) {
            string.append(", id=").append((Object) this.mId);
        }
        if (this.mIds != null) {
            string.append(", ids=").append((Object) this.mIds);
        }
        ViewNode viewNode = this.mNode;
        if (viewNode != null) {
            String className = viewNode.getClassName();
            string.append(", class=").append(className);
            string.append(", id=").append((Object) this.mNode.getAutofillId());
        ...
        if (this.mClientContext != null) {
            string.append(", context=").append((Object) this.mClientContext);
        }
        if (this.mInsets != null) {
            string.append(", insets=").append((Object) this.mInsets);
        }
        if (this.mBounds != null) {
            string.append(", bounds=").append((Object) this.mBounds);
        }
        if (this.mComposingStart > -1) {
            string.append(", composing=[").append(this.mComposingStart).append(",").append(this.mComposingEnd).append("]");
        }
        if (this.mSelectionStartIndex > -1) {
            string.append(", selection=[").append(this.mSelectionStartIndex).append(",").append(this.mSelectionEndIndex).append("]");
        }
