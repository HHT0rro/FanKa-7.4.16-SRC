...
public final class ContentCaptureContext implements Parcelable {
    public static final Parcelable.Creator<ContentCaptureContext> CREATOR = new Parcelable.Creator<ContentCaptureContext>() { // from class: android.view.contentcapture.ContentCaptureContext.1
        ...
        public ContentCaptureContext createFromParcel(Parcel parcel) {
            ...
            if (hasClientContext) {
                LocusId id2 = (LocusId) parcel.readParcelable(null, LocusId.class);
 ...
 */
    ...
    public static final class Builder {
        ...
        public Builder(LocusId id2) {
            this.mId = (LocusId) Objects.requireNonNull(id2);
        }
    ...
    public String toString() {
        ...
        if (fromServer()) {
            builder.append("act=").append(ComponentName.flattenToShortString(this.mComponentName)).append(", activityId=").append((Object) this.mActivityId).append(", displayId=").append(this.mDisplayId).append(", windowToken=").append((Object) this.mWindowToken).append(", flags=").append(this.mFlags);
        } else {
            builder.append("id=").append((Object) this.mId);
            if (this.mExtras != null) {
    ...
    public void writeToParcel(Parcel parcel, int i10) {
        ...
        if (this.mHasClientContext) {
            parcel.writeParcelable(this.mId, i10);
            parcel.writeBundle(this.mExtras);
        }
        parcel.writeParcelable(this.mComponentName, i10);
        if (fromServer()) {
            parcel.writeInt(this.mDisplayId);
            parcel.writeStrongBinder(this.mWindowToken);
            parcel.writeInt(this.mFlags);
            this.mActivityId.writeToParcel(parcel, i10);
        }
    }
}
