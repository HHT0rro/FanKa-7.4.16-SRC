 ...
 */
    ...
    private static native char nativeGetCharacter(long j10, int i10, int i11);

    private static native char nativeGetDisplayLabel(long j10, int i10);

    private static native KeyEvent[] nativeGetEvents(long j10, char[] cArr);

    private static native boolean nativeGetFallbackAction(long j10, int i10, int i11, FallbackAction fallbackAction);

    private static native int nativeGetKeyboardType(long j10);

    private static native char nativeGetMatch(long j10, int i10, char[] cArr, int i11);

    private static native char nativeGetNumber(long j10, int i10);

    private static native KeyCharacterMap nativeObtainEmptyKeyCharacterMap(int i10);
    ...
    static {
        ...
        addCombining(MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_DND_DENY, 180);
        addCombining(MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_APPDRAW_ALLOW, 710);
        addCombining(MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_APPDRAW_DENY, 732);
        addCombining(MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_VRHELPER_ALLOW, 175);
        addCombining(MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_SETTINGS_CHANGE_ALLOW, 728);
        addCombining(MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_SETTINGS_CHANGE_DENY, 729);
        addCombining(MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_NOTIVIEW_ALLOW, 168);
        ...
        addCombining(803, 46);
        addCombining(MetricsProto.MetricsEvent.ACTION_APP_FORCE_STOP, 184);
        addCombining(MetricsProto.MetricsEvent.MANAGE_EXTERNAL_SOURCES, 731);
        ...
        addCombining(MetricsProto.MetricsEvent.ACTION_PICTURE_IN_PICTURE_MINIMIZED, 45);
        ...
        sparseIntArray.append(MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_UNL_DATA_ALLOW, 39);
        sparseIntArray.append(MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_UNL_DATA_DENY, 34);
        sparseIntArray2.append(96, 768);
        sparseIntArray2.append(94, MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_APPDRAW_ALLOW);
        sparseIntArray2.append(126, MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_APPDRAW_DENY);
        sparseIntArray2.append(39, MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_DND_DENY);
        sparseIntArray2.append(34, MetricsProto.MetricsEvent.APP_SPECIAL_PERMISSION_NOTIVIEW_ALLOW);
    ...
    public static KeyCharacterMap load(int deviceId) {
        InputManagerGlobal im2 = InputManagerGlobal.getInstance();
        InputDevice inputDevice = im2.getInputDevice(deviceId);
        if (inputDevice == null && (inputDevice = im2.getInputDevice(-1)) == null) {
    ...
    public static int getDeadChar(int accent, int c4) {
        int combined;
        if (c4 == accent || 32 == c4) {
            return accent;
        }
        ...
        synchronized (sparseIntArray) {
            ...
            if (combined == -1) {
                StringBuilder sb2 = sDeadKeyBuilder;
                sb2.setLength(0);
                sb2.append((char) c4);
                sb2.append((char) combining);
                String result = Normalizer.normalize(sb2, Normalizer.Form.NFC);
                if (result.codePointCount(0, result.length()) == 1) {
                    i10 = result.codePointAt(0);
                }
                combined = i10;
