...
public final class DisplayCutout {
    ...
    private static final int DISABLE_ROUNDED_CORNER;
 ...
 */
    ...
    static {
        ...
        DISABLE_ROUNDED_CORNER = SystemProperties.getInt("vendor.display.disable_rounded_corner", 0);
        sCachedCutout = pair;
    }
 ...
 */
    ...
    public static class Bounds {
        ...
        private Bounds(Rect[] rects, boolean copyArguments) {
            ...
            if (copyArguments) {
                ...
                for (int i10 = 0; i10 < 4; i10++) {
                    this.mRects[i10] = new Rect(rects[i10]);
                }
                return;
            }
            for (Rect rect : rects) {
        ...
        public Rect[] getRects() {
            ...
            for (int i10 = 0; i10 < 4; i10++) {
                rects[i10] = new Rect(this.mRects[i10]);
            }
            return rects;
        }
        ...
        public boolean equals(Object o10) {
            ...
            if (o10 instanceof Bounds) {
                Bounds b4 = (Bounds) o10;
                return Arrays.deepEquals(this.mRects, b4.mRects);
            }
            return false;
        }
 ...
 */
    ...
    public static class CutoutPathParserInfo {
        ...
        public boolean equals(Object o10) {
            ...
            if (!(o10 instanceof CutoutPathParserInfo)) {
                return false;
            }
            CutoutPathParserInfo c4 = (CutoutPathParserInfo) o10;
            return this.mDisplayWidth == c4.mDisplayWidth && this.mDisplayHeight == c4.mDisplayHeight && this.mPhysicalDisplayWidth == c4.mPhysicalDisplayWidth && this.mPhysicalDisplayHeight == c4.mPhysicalDisplayHeight && this.mDensity == c4.mDensity && this.mCutoutSpec.equals(c4.mCutoutSpec) && this.mRotation == c4.mRotation && this.mScale == c4.mScale && this.mPhysicalPixelDisplaySizeRatio == c4.mPhysicalPixelDisplaySizeRatio;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static Rect getCopyOrRef(Rect r10, boolean copyArguments) {
        if (r10 == null) {
            return ZERO_RECT;
        }
        if (copyArguments) {
    ...
    public static Rect[] extractBoundsFromList(Rect safeInsets, List<Rect> boundingRects) {
        ...
        for (int i10 = 0; i10 < sortedBounds.length; i10++) {
            sortedBounds[i10] = ZERO_RECT;
        }
    ...
    public boolean equals(Object o10) {
        ...
        if (!(o10 instanceof DisplayCutout)) {
            return false;
        }
        DisplayCutout c4 = (DisplayCutout) o10;
        return this.mSafeInsets.equals(c4.mSafeInsets) && this.mBounds.equals(c4.mBounds) && this.mWaterfallInsets.equals(c4.mWaterfallInsets) && this.mCutoutPathParserInfo.equals(c4.mCutoutPathParserInfo);
    }
    ...
    public DisplayCutout inset(int insetLeft, int insetTop, int insetRight, int insetBottom) {
        ...
        for (int i10 = 0; i10 < bounds.length; i10++) {
            if (!bounds[i10].equals(ZERO_RECT)) {
                bounds[i10].offset(-insetLeft, -insetTop);
            }
        }
    ...
    public static DisplayCutout fromBoundingRect(int left, int top, int right, int bottom, int pos) {
        ...
        int i10 = 0;
        while (i10 < 4) {
            bounds[i10] = pos == i10 ? new Rect(left, top, right, bottom) : new Rect();
            i10++;
        }
    ...
    private static String getDisplayCutoutPath(Resources res, String displayUniqueId) {
        ...
        String[] array = res.getStringArray(17236040);
        if (index >= 0 && index < array.length) {
            return array[index];
        }
        return res.getString(17039994);
    }

    private static String getDisplayCutoutApproximationRect(Resources res, String displayUniqueId) {
        int index = DisplayUtils.getDisplayUniqueIdConfigIndex(res, displayUniqueId);
        String[] array = res.getStringArray(17236039);
        if (index >= 0 && index < array.length) {
            return array[index];
        }
        return res.getString(17039996);
    }

    public static boolean getMaskBuiltInDisplayCutout(Resources res, String displayUniqueId) {
        boolean maskCutout;
        int index = DisplayUtils.getDisplayUniqueIdConfigIndex(res, displayUniqueId);
        TypedArray array = res.obtainTypedArray(17236099);
        if (index >= 0 && index < array.length()) {
    ...
    public static boolean getFillBuiltInDisplayCutout(Resources res, String displayUniqueId) {
        boolean fillCutout;
        int index = DisplayUtils.getDisplayUniqueIdConfigIndex(res, displayUniqueId);
        TypedArray array = res.obtainTypedArray(17236073);
        if (index >= 0 && index < array.length()) {
    ...
    public static DisplayCutout fromResourcesRectApproximation(Resources res, String displayUniqueId, int physicalDisplayWidth, int physicalDisplayHeight, int displayWidth, int displayHeight) {
        return (DisplayCutout) pathAndDisplayCutoutFromSpec(getDisplayCutoutPath(res, displayUniqueId), getDisplayCutoutApproximationRect(res, displayUniqueId), physicalDisplayWidth, physicalDisplayHeight, displayWidth, displayHeight, DisplayMetrics.DENSITY_DEVICE_STABLE / 160.0f, getWaterfallInsets(res, displayUniqueId)).second;
    }
    ...
    public static DisplayCutout fromSpec(String pathSpec, int displayWidth, int displayHeight, float density, Insets waterfallInsets) {
        return (DisplayCutout) pathAndDisplayCutoutFromSpec(pathSpec, null, displayWidth, displayHeight, displayWidth, displayHeight, density, waterfallInsets).second;
    }
    ...
    public DisplayCutout getRotated(int startWidth, int startHeight, int fromRotation, int toRotation) {
        ...
        for (int i10 = 0; i10 < newBounds.length; i10++) {
            if (!newBounds[i10].isEmpty()) {
                RotationUtils.rotateBounds(newBounds[i10], displayBounds, rotation);
            }
        }
    ...
    public static Rect computeSafeInsets(int displayW, int displayH, DisplayCutout cutout) {
        if (displayW == displayH) {
            throw new UnsupportedOperationException("not implemented: display=" + displayW + LanguageTag.PRIVATEUSE + displayH + " cutout=" + ((Object) cutout));
        }
 ...
 */
    ...
    public static final class ParcelableWrapper implements Parcelable {
        ...
        public boolean equals(Object o10) {
            return (o10 instanceof ParcelableWrapper) && this.mInner.equals(((ParcelableWrapper) o10).mInner);
        }
