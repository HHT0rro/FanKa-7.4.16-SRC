...
public class TextureView extends View {
    ...
    public ITextureViewSocExt mTextureViewSocExt;
 ...
 */
    ...
    private static native boolean nLockCanvas(long j10, Canvas canvas, Rect rect);

    private static native void nUnlockCanvasAndPost(long j10, Canvas canvas);
    ...
    public TextureView(Context context) {
        ...
        this.mTextureViewSocExt = (ITextureViewSocExt) ExtLoader.type(ITextureViewSocExt.class).base(this).create();
    ...
    private void releaseSurfaceTexture() {
        if (this.mSurface != null) {
            ...
            if (this.mListener != null) {
                this.mTextureViewSocExt.boforeOnDestory();
                shouldRelease = this.mListener.onSurfaceTextureDestroyed(this.mSurface);
                this.mTextureViewSocExt.afterOnDestory();
            }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (canvas.isHardwareAccelerated()) {
            ...
            if (layer != null) {
                ...
                this.mTextureViewSocExt.hookPerfHint();
            }
        }
    }
    ...
    TextureLayer getTextureLayer() {
        ...
        if (this.mUpdateSurface) {
            ...
            this.mLayer.setSurfaceTexture(this.mSurface);
            this.mSurface.setDefaultBufferSize(getWidth(), getHeight());
            SurfaceTextureListener surfaceTextureListener2 = this.mListener;
            if (surfaceTextureListener2 != null) {
                surfaceTextureListener2.onSurfaceTextureSizeChanged(this.mSurface, getWidth(), getHeight());
            }
        }
        return this.mLayer;
    }
