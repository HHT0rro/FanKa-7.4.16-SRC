...
public class ViewConfiguration {
    ...
    private static final int PRESSED_STATE_DURATION = 12;
    ...
    private ViewConfiguration(Context context) {
        ...
        this.mScrollbarSize = res.getDimensionPixelSize(17105118);
        ...
        res.getValue(17105067, multiplierValue, true);
        ...
        if (!this.sHasPermanentMenuKeySet) {
            int configVal = res.getInteger(17694933);
            switch (configVal) {
                case 1:
        ...
        int dimensionPixelSize = res.getDimensionPixelSize(17105124);
        this.mTouchSlop = dimensionPixelSize;
        this.mHandwritingSlop = res.getDimensionPixelSize(17105122);
        this.mHoverSlop = res.getDimensionPixelSize(17105123);
        this.mMinScrollbarTouchTarget = res.getDimensionPixelSize(17105099);
        ...
        this.mMinimumFlingVelocity = res.getDimensionPixelSize(17105127);
        this.mMaximumFlingVelocity = res.getDimensionPixelSize(17105125);
        int configMinRotaryEncoderFlingVelocity = res.getDimensionPixelSize(17105128);
        int configMaxRotaryEncoderFlingVelocity = res.getDimensionPixelSize(17105126);
        ...
        this.mGlobalActionsKeyTimeout = res.getInteger(17694852);
        this.mHorizontalScrollFactor = res.getDimensionPixelSize(17105084);
        this.mVerticalScrollFactor = res.getDimensionPixelSize(17105121);
        this.mShowMenuShortcutsWhenKeyboardPresent = res.getBoolean(R.bool.config_showMenuShortcutsWhenKeyboardPresent);
        this.mMinScalingSpan = res.getDimensionPixelSize(17105097);
        this.mScreenshotChordKeyTimeout = res.getInteger(17694963);
        this.mSmartSelectionInitializedTimeout = res.getInteger(17694976);
        this.mSmartSelectionInitializingTimeout = res.getInteger(17694977);
