 ...
 */
    ...
    public static final class InternalInsetsInfo {
        ...
        public boolean equals(Object o10) {
            ...
            InternalInsetsInfo other = (InternalInsetsInfo) o10;
    ...
    public final void dispatchOnWindowAttachedChange(boolean attached) {
        ...
        if (listeners != null && listeners.size() > 0) {
            Iterator<OnWindowAttachListener> iterator2 = listeners.iterator2();
            while (iterator2.hasNext()) {
                OnWindowAttachListener listener = iterator2.next();
                if (attached) {
    ...
    public final void dispatchOnWindowFocusChange(boolean hasFocus) {
        ...
        if (listeners != null && listeners.size() > 0) {
            Iterator<OnWindowFocusChangeListener> iterator2 = listeners.iterator2();
            while (iterator2.hasNext()) {
                OnWindowFocusChangeListener listener = iterator2.next();
    ...
    public void dispatchOnWindowVisibilityChange(int visibility) {
        ...
        if (listeners != null && listeners.size() > 0) {
            Iterator<OnWindowVisibilityChangeListener> iterator2 = listeners.iterator2();
            while (iterator2.hasNext()) {
                OnWindowVisibilityChangeListener listener = iterator2.next();
    ...
    public final void dispatchOnGlobalFocusChange(View oldFocus, View newFocus) {
        ...
        if (listeners != null && listeners.size() > 0) {
            Iterator<OnGlobalFocusChangeListener> iterator2 = listeners.iterator2();
            while (iterator2.hasNext()) {
                OnGlobalFocusChangeListener listener = iterator2.next();
    ...
    public final boolean dispatchOnPreDraw() {
        ...
        if (listeners != null && listeners.size() > 0) {
            ...
            try {
                int count = access.size();
                for (int i10 = 0; i10 < count; i10++) {
                    OnPreDrawListener preDrawListener = access.get(i10);
    ...
    public final void dispatchOnTouchModeChanged(boolean inTouchMode) {
        ...
        if (listeners != null && listeners.size() > 0) {
            Iterator<OnTouchModeChangeListener> iterator2 = listeners.iterator2();
            while (iterator2.hasNext()) {
                OnTouchModeChangeListener listener = iterator2.next();
    ...
    public final void dispatchOnScrollChanged() {
        ...
        if (listeners != null && listeners.size() > 0) {
            ...
            try {
                int count = access.size();
                for (int i10 = 0; i10 < count; i10++) {
                    access.get(i10).onScrollChanged();
                }
            } finally {
                listeners.end();
            }
    ...
    public final void dispatchOnComputeInternalInsets(InternalInsetsInfo inoutInfo) {
        ...
        if (listeners != null && listeners.size() > 0) {
            ...
            try {
                int count = access.size();
                for (int i10 = 0; i10 < count; i10++) {
                    access.get(i10).onComputeInternalInsets(inoutInfo);
                }
            } finally {
                listeners.end();
            }
    ...
    public final void dispatchOnEnterAnimationComplete() {
        ...
        if (listeners != null && !listeners.isEmpty()) {
            Iterator<OnEnterAnimationCompleteListener> iterator2 = listeners.iterator2();
            while (iterator2.hasNext()) {
                OnEnterAnimationCompleteListener listener = iterator2.next();
