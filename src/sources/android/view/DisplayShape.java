...
public final class DisplayShape implements Parcelable {
    ...
    public static String getSpecString(Resources res, String displayUniqueId) {
        ...
        TypedArray array = res.obtainTypedArray(17236041);
        if (index >= 0 && index < array.length()) {
            spec = array.getString(index);
        } else {
            spec = res.getString(17039998);
        }
        array.recycle();
        return spec;
    }
    ...
    public boolean equals(Object o10) {
        ...
        if (!(o10 instanceof DisplayShape)) {
            return false;
        }
        DisplayShape ds = (DisplayShape) o10;
    ...
    public String toString() {
        return "DisplayShape{ spec=" + this.mDisplayShapeSpec.hashCode() + " displayWidth=" + this.mDisplayWidth + " displayHeight=" + this.mDisplayHeight + " physicalPixelDisplaySizeRatio=" + this.mPhysicalPixelDisplaySizeRatio + " rotation=" + this.mRotation + " offsetX=" + this.mOffsetX + " offsetY=" + this.mOffsetY + " scale=" + this.mScale + i.f4738d;
    }
