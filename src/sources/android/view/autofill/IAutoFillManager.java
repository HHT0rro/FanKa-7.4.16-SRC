...
public interface IAutoFillManager extends IInterface {
    void addClient(IAutoFillManagerClient iAutoFillManagerClient, ComponentName componentName, int i10, IResultReceiver iResultReceiver) throws RemoteException;

    void cancelSession(int i10, int i11) throws RemoteException;

    void disableOwnedAutofillServices(int i10) throws RemoteException;

    void finishSession(int i10, int i11, int i12) throws RemoteException;
    ...
    void isServiceEnabled(int i10, String str, IResultReceiver iResultReceiver) throws RemoteException;

    void isServiceSupported(int i10, IResultReceiver iResultReceiver) throws RemoteException;

    void onPendingSaveUi(int i10, IBinder iBinder) throws RemoteException;

    void removeClient(IAutoFillManagerClient iAutoFillManagerClient, int i10) throws RemoteException;

    void restoreSession(int i10, IBinder iBinder, IBinder iBinder2, IResultReceiver iResultReceiver) throws RemoteException;
    ...
    void setAuthenticationResult(Bundle bundle, int i10, int i11, int i12) throws RemoteException;

    void setAutofillFailure(int i10, List<AutofillId> list, int i11) throws RemoteException;

    void setHasCallback(int i10, int i11, boolean z10) throws RemoteException;

    void setUserData(UserData userData) throws RemoteException;

    void startSession(IBinder iBinder, IBinder iBinder2, AutofillId autofillId, Rect rect, AutofillValue autofillValue, int i10, boolean z10, int i11, ComponentName componentName, boolean z11, IResultReceiver iResultReceiver) throws RemoteException;

    void updateSession(int i10, AutofillId autofillId, Rect rect, AutofillValue autofillValue, int i11, int i12, int i13) throws RemoteException;
