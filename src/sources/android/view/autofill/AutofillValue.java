...
public final class AutofillValue implements Parcelable {
    ...
    public CharSequence getTextValue() {
        Preconditions.checkState(isText(), "value must be a text value, not type=%d", new Object[]{Integer.valueOf(this.mType)});
    ...
    public boolean getToggleValue() {
        Preconditions.checkState(isToggle(), "value must be a toggle value, not type=%d", new Object[]{Integer.valueOf(this.mType)});
    ...
    public int getListValue() {
        Preconditions.checkState(isList(), "value must be a list value, not type=%d", new Object[]{Integer.valueOf(this.mType)});
    ...
    public long getDateValue() {
        Preconditions.checkState(isDate(), "value must be a date value, not type=%d", new Object[]{Integer.valueOf(this.mType)});
    ...
    public static AutofillValue forText(CharSequence value) {
        if (Helper.sVerbose && !Looper.getMainLooper().isCurrentThread()) {
            Log.v(TAG, "forText() not called on main thread: " + ((Object) Thread.currentThread()));
        }
        if (value == null) {
            return null;
        }
