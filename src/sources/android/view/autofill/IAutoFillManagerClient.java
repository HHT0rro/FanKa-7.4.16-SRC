...
public interface IAutoFillManagerClient extends IInterface {
    void authenticate(int i10, int i11, IntentSender intentSender, Intent intent, boolean z10) throws RemoteException;

    void autofill(int i10, List<AutofillId> list, List<AutofillValue> list2, boolean z10) throws RemoteException;

    void autofillContent(int i10, AutofillId autofillId, ClipData clipData) throws RemoteException;

    void dispatchUnhandledKey(int i10, AutofillId autofillId, KeyEvent keyEvent) throws RemoteException;

    void getAugmentedAutofillClient(IResultReceiver iResultReceiver) throws RemoteException;

    void notifyDisableAutofill(long j10, ComponentName componentName) throws RemoteException;

    void notifyFillDialogTriggerIds(List<AutofillId> list) throws RemoteException;

    void notifyFillUiHidden(int i10, AutofillId autofillId) throws RemoteException;

    void notifyFillUiShown(int i10, AutofillId autofillId) throws RemoteException;

    void notifyNoFillUi(int i10, AutofillId autofillId, int i11) throws RemoteException;

    void requestHideFillUi(int i10, AutofillId autofillId) throws RemoteException;

    void requestShowFillUi(int i10, AutofillId autofillId, int i11, int i12, Rect rect, IAutofillWindowPresenter iAutofillWindowPresenter) throws RemoteException;

    void requestShowSoftInput(AutofillId autofillId) throws RemoteException;

    void setSaveUiState(int i10, boolean z10) throws RemoteException;

    void setSessionFinished(int i10, List<AutofillId> list) throws RemoteException;

    void setState(int i10) throws RemoteException;

    void setTrackedViews(int i10, AutofillId[] autofillIdArr, boolean z10, boolean z11, AutofillId[] autofillIdArr2, AutofillId autofillId) throws RemoteException;
