 ...
 */
    ...
    private InputDevice(Parcel in) {
        ...
        this.mHostUsiVersion = (HostUsiVersion) HostUsiVersion.CREATOR.createFromParcel(in);
        ...
        for (int i10 = 0; i10 < numRanges; i10++) {
 ...
 */
    ...
    public static class Builder {
        ...
        public InputDevice build() {
            ...
            for (int i10 = 0; i10 < numRanges; i10++) {
                MotionRange range = this.mMotionRanges.get(i10);
 ...
 */
    ...
    public void writeToParcel(Parcel parcel, int i10) {
        this.mKeyCharacterMap.writeToParcel(parcel, i10);
        ...
        this.mHostUsiVersion.writeToParcel(parcel, i10);
        parcel.writeInt(this.mAssociatedDisplayId);
        int size = this.mMotionRanges.size();
        int i11 = size <= 1000 ? size : 1000;
        parcel.writeInt(i11);
        for (int i12 = 0; i12 < i11; i12++) {
            MotionRange motionRange = this.mMotionRanges.get(i12);
    ...
    public String toString() {
        ...
        description.append("  Location: ").append(this.mIsExternal ? BuildConfig.FLAVOR : "built-in").append("\n");
        ...
        description.append("  USI Version: ").append((Object) getHostUsiVersion()).append("\n");
        ...
        appendSourceDescriptionIfApplicable(description, 1048584, "touchpad");
        appendSourceDescriptionIfApplicable(description, 16777232, "joystick");
        appendSourceDescriptionIfApplicable(description, 1025, "gamepad");
        description.append(" )\n");
        int numAxes = this.mMotionRanges.size();
        for (int i10 = 0; i10 < numAxes; i10++) {
            MotionRange range = this.mMotionRanges.get(i10);
