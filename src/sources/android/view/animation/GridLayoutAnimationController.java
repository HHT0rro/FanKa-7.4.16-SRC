 ...
 */
    ...
    public GridLayoutAnimationController(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.GridLayoutAnimation);
        Animation.Description d10 = Animation.Description.parseValue(a10.peekValue(0), context);
        this.mColumnDelay = d10.value;
        Animation.Description d11 = Animation.Description.parseValue(a10.peekValue(1), context);
        this.mRowDelay = d11.value;
        this.mDirection = a10.getInt(2, 0);
        this.mDirectionPriority = a10.getInt(3, 0);
        a10.recycle();
    }
