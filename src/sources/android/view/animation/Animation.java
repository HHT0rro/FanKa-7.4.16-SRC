 ...
 */
    ...
    public Animation(Context context, AttributeSet attrs) {
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.Animation);
        setDuration(a10.getInt(2, 0));
        setStartOffset(a10.getInt(5, 0));
        setFillEnabled(a10.getBoolean(9, this.mFillEnabled));
        setFillBefore(a10.getBoolean(3, this.mFillBefore));
        setFillAfter(a10.getBoolean(4, this.mFillAfter));
        setRepeatCount(a10.getInt(6, this.mRepeatCount));
        setRepeatMode(a10.getInt(7, 1));
        setZAdjustment(a10.getInt(8, 0));
        setBackdropColor(a10.getInt(12, 0));
        setDetachWallpaper(a10.getBoolean(10, false));
        setShowWallpaper(a10.getBoolean(14, false));
        setHasRoundedCorners(a10.getBoolean(13, false));
        setShowBackdrop(a10.getBoolean(11, false));
        int resID = a10.getResourceId(1, 0);
        a10.recycle();
        if (resID > 0) {
    ...
    public Animation mo547clone() throws CloneNotSupportedException {
    ...
    public void restrictDuration(long durationMillis) {
        long j10 = this.mStartOffset;
        if (j10 > durationMillis) {
            this.mStartOffset = durationMillis;
            this.mDuration = 0L;
            this.mRepeatCount = 0;
            return;
        }
        long dur = this.mDuration + j10;
        if (dur > durationMillis) {
            this.mDuration = durationMillis - j10;
            dur = durationMillis;
        }
        if (this.mDuration <= 0) {
            this.mDuration = 0L;
        ...
        if (i10 < 0 || i10 > durationMillis || i10 * dur > durationMillis) {
            int i11 = ((int) (durationMillis / dur)) - 1;
    ...
    public boolean getTransformation(long currentTime, Transformation outTransformation) {
        ...
        boolean z10 = this.mMore;
        if (!z10 && this.mOneMoreTime) {
            this.mOneMoreTime = false;
            return true;
        }
        return z10;
    ...
    public static class Description {
        ...
        public static Description parseValue(TypedValue value, Context context) {
            ...
            if (value == null) {
                ...
                if (value.type == 6) {
                    d10.type = (value.data & 15) == 1 ? 2 : 1;
                    d10.value = TypedValue.complexToFloat(value.data);
                    return d10;
                }
                if (value.type == 4) {
                    d10.type = 0;
                    d10.value = value.getFloat();
                    return d10;
                }
                if (value.type >= 16 && value.type <= 31) {
                    d10.type = 0;
                    d10.value = value.data;
                    return d10;
                }
                if (value.type == 5) {
                    d10.type = 0;
                    d10.value = TypedValue.complexToDimension(value.data, context.getResources().getDisplayMetrics());
                    return d10;
                }
            }
            d10.type = 0;
