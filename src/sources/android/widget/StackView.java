...
public class StackView extends AdapterViewAnimator {
    ...
    public StackView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.StackView, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.StackView, attrs, a10, defStyleAttr, defStyleRes);
        this.mResOutColor = a10.getColor(1, 0);
        this.mClickColor = a10.getColor(0, 0);
        a10.recycle();
        initStackView();
    }
    ...
    private void transformViewAtIndex(int index, View view, boolean animate) {
        ...
        float r10 = (index2 * 1.0f) / (this.mMaxNumActiveViews - 2);
        float scale = 1.0f - ((1.0f - r10) * 0.0f);
        float perspectiveTranslationY = r10 * maxPerspectiveShiftY;
        ...
        float perspectiveTranslationX = (1.0f - r10) * maxPerspectiveShiftX;
        ...
        if (animate) {
            PropertyValuesHolder translationX = PropertyValuesHolder.ofFloat(Key.TRANSLATION_X, transX);
            PropertyValuesHolder translationY = PropertyValuesHolder.ofFloat(Key.TRANSLATION_Y, transY);
            ...
            ObjectAnimator oa2 = ObjectAnimator.ofPropertyValuesHolder(view, scalePropX, scalePropY, translationY, translationX);
            oa2.setDuration(100L);
            if (view instanceof StackFrame) {
                ((StackFrame) view).setTransformAnimator(oa2);
            }
            oa2.start();
            return;
        }
    ...
    private void setupStackSlider(View v2, int mode) {
        this.mStackSlider.setMode(mode);
        if (v2 != null) {
            this.mHighlight.setImageBitmap(sHolographicHelper.createResOutline(v2, this.mResOutColor));
            this.mHighlight.setRotation(v2.getRotation());
            this.mHighlight.setTranslationY(v2.getTranslationY());
            this.mHighlight.setTranslationX(v2.getTranslationX());
            this.mHighlight.bringToFront();
            v2.bringToFront();
            this.mStackSlider.setView(v2);
            v2.setVisibility(0);
        }
    }
    ...
    public void showNext() {
        ...
        if (!this.mTransitionIsSetup && (v2 = getViewAtRelativeIndex(1)) != null) {
            setupStackSlider(v2, 0);
    ...
    public void showPrevious() {
        ...
        if (!this.mTransitionIsSetup && (v2 = getViewAtRelativeIndex(0)) != null) {
            setupStackSlider(v2, 0);
    ...
    public void showOnly(int childIndex, boolean animate) {
        ...
        for (int i10 = this.mCurrentWindowEnd; i10 >= this.mCurrentWindowStart; i10--) {
            ...
            if (vm != null && (v2 = this.mViewsMap.get(Integer.valueOf(index)).view) != null) {
                v2.bringToFront();
            }
        }
    ...
    void updateClickFeedback() {
        if (!this.mClickFeedbackIsValid) {
            View v2 = getViewAtRelativeIndex(1);
            if (v2 != null) {
                this.mClickFeedback.setImageBitmap(sHolographicHelper.createClickOutline(v2, this.mClickColor));
                this.mClickFeedback.setTranslationX(v2.getTranslationX());
                this.mClickFeedback.setTranslationY(v2.getTranslationY());
            }
    ...
    private void updateChildTransforms() {
        for (int i10 = 0; i10 < getNumActiveViews(); i10++) {
            View v2 = getViewAtRelativeIndex(i10);
            if (v2 != null) {
                transformViewAtIndex(i10, v2, false);
            }
        }
    }
 ...
 */
    ...
    public static class StackFrame extends FrameLayout {
        ...
        void setTransformAnimator(ObjectAnimator oa2) {
            this.transformAnimator = new WeakReference<>(oa2);
        }

        void setSliderAnimator(ObjectAnimator oa2) {
            this.sliderAnimator = new WeakReference<>(oa2);
        }

        boolean cancelTransformAnimator() {
            ObjectAnimator oa2;
            WeakReference<ObjectAnimator> weakReference = this.transformAnimator;
            if (weakReference != null && (oa2 = weakReference.get()) != null) {
                oa2.cancel();
                return true;
            }
            return false;
    ...
    FrameLayout getFrameForChild() {
        ...
        int i10 = this.mFramePadding;
        fl.setPadding(i10, i10, i10, i10);
        return fl;
    }
    ...
    private void onLayout() {
        ...
        int newSlideAmount = Math.round(getMeasuredHeight() * 0.7f);
    ...
    private void beginGestureIfNeeded(float deltaY) {
        ...
        if (((int) Math.abs(deltaY)) > this.mTouchSlop && this.mSwipeGestureType == 0) {
            ...
            boolean endOfStack = this.mLoopViews && adapterCount == 1 && (((i11 = this.mStackMode) == 0 && swipeGestureType == 1) || (i11 == 1 && swipeGestureType == 2));
            boolean beginningOfStack = this.mLoopViews && adapterCount == 1 && (((i10 = this.mStackMode) == 1 && swipeGestureType == 1) || (i10 == 0 && swipeGestureType == 2));
            ...
            View v2 = getViewAtRelativeIndex(activeIndex);
            if (v2 == null) {
                return;
            }
            setupStackSlider(v2, stackMode);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action & 255) {
            ...
            case 2:
                beginGestureIfNeeded(deltaY);
                int i10 = this.mSlideAmount;
                float rx = deltaX / (i10 * 1.0f);
                int i11 = this.mSwipeGestureType;
                if (i11 == 2) {
                    float r10 = ((deltaY - (this.mTouchSlop * 1.0f)) / i10) * 1.0f;
                    if (this.mStackMode == 1) {
                        r10 = 1.0f - r10;
                    }
                    this.mStackSlider.setYProgress(1.0f - r10);
                    this.mStackSlider.setXProgress(rx);
                    return true;
                }
                if (i11 == 1) {
                    float r11 = ((-((this.mTouchSlop * 1.0f) + deltaY)) / i10) * 1.0f;
                    if (this.mStackMode == 1) {
                        r11 = 1.0f - r11;
                    }
                    this.mStackSlider.setYProgress(r11);
                    this.mStackSlider.setXProgress(rx);
                    return true;
                }
                return true;
    ...
    private void onSecondaryPointerUp(MotionEvent ev) {
        ...
        if (pointerId == this.mActivePointerId) {
            ...
            View v2 = getViewAtRelativeIndex(activeViewIndex);
            if (v2 == null) {
                return;
            }
            for (int index = 0; index < ev.getPointerCount(); index++) {
                if (index != activePointerIndex) {
                    float x10 = ev.getX(index);
                    float y10 = ev.getY(index);
                    this.mTouchRect.set(v2.getLeft(), v2.getTop(), v2.getRight(), v2.getBottom());
                    if (this.mTouchRect.contains(Math.round(x10), Math.round(y10))) {
                        float oldX = ev.getX(activePointerIndex);
                        float oldY = ev.getY(activePointerIndex);
                        this.mInitialY += y10 - oldY;
                        this.mInitialX += x10 - oldX;
    ...
    private void handlePointerUp(MotionEvent ev) {
        ...
        if (deltaY > this.mSwipeThreshold && this.mSwipeGestureType == 2 && this.mStackSlider.mMode == 0) {
            ...
            int i10 = this.mSwipeGestureType;
            if (i10 == 1) {
                int i11 = this.mStackMode;
                float finalYProgress = i11 != 1 ? 0.0f : 1.0f;
                if (i11 == 0 || this.mStackSlider.mMode != 0) {
                ...
                ObjectAnimator pa2 = ObjectAnimator.ofPropertyValuesHolder(animationSlider, snapBackX, snapBackY);
                pa2.setDuration(duration2);
                pa2.setInterpolator(new LinearInterpolator());
                pa2.start();
            } else if (i10 == 2) {
                int i12 = this.mStackMode;
                float finalYProgress2 = i12 == 1 ? 0.0f : 1.0f;
                if (i12 == 1 || this.mStackSlider.mMode != 0) {
                ...
                ObjectAnimator pa3 = ObjectAnimator.ofPropertyValuesHolder(animationSlider2, snapBackX2, snapBackY2);
                pa3.setDuration(duration);
                pa3.start();
            }
        }
        this.mActivePointerId = -1;
 ...
 */
    ...
    public class StackSlider {
        ...
        private float cubic(float r10) {
            return ((float) (Math.pow((r10 * 2.0f) - 1.0f, 3.0d) + 1.0d)) / 2.0f;
        }

        private float highlightAlphaInterpolator(float r10) {
            if (r10 >= 0.4f) {
                return cubic(1.0f - ((r10 - 0.4f) / (1.0f - 0.4f))) * 0.85f;
            }
            return cubic(r10 / 0.4f) * 0.85f;
        }

        private float viewAlphaInterpolator(float r10) {
            if (r10 > 0.3f) {
                return (r10 - 0.3f) / (1.0f - 0.3f);
            }
            return 0.0f;
        }

        private float rotationInterpolator(float r10) {
            if (r10 >= 0.2f) {
                return (r10 - 0.2f) / (1.0f - 0.2f);
            }
            return 0.0f;
        }

        void setView(View v2) {
            this.mView = v2;
        }

        public void setYProgress(float r10) {
            float r11 = Math.max(0.0f, Math.min(1.0f, r10));
            this.mYProgress = r11;
            ...
            switch (this.mMode) {
                case 0:
                    viewLp.setVerticalOffset(Math.round((-r11) * stackDirection * StackView.this.mSlideAmount));
                    highlightLp.setVerticalOffset(Math.round((-r11) * stackDirection * StackView.this.mSlideAmount));
                    StackView.this.mHighlight.setAlpha(highlightAlphaInterpolator(r11));
                    float alpha = viewAlphaInterpolator(1.0f - r11);
                    ...
                    this.mView.setRotationX(stackDirection * 90.0f * rotationInterpolator(r11));
                    StackView.this.mHighlight.setRotationX(stackDirection * 90.0f * rotationInterpolator(r11));
                    return;
                case 1:
                    float r12 = (1.0f - r11) * 0.2f;
                    viewLp.setVerticalOffset(Math.round(stackDirection * r12 * StackView.this.mSlideAmount));
                    highlightLp.setVerticalOffset(Math.round(stackDirection * r12 * StackView.this.mSlideAmount));
                    StackView.this.mHighlight.setAlpha(highlightAlphaInterpolator(r12));
                    return;
                case 2:
                    float r13 = r11 * 0.2f;
                    viewLp.setVerticalOffset(Math.round((-stackDirection) * r13 * StackView.this.mSlideAmount));
                    highlightLp.setVerticalOffset(Math.round((-stackDirection) * r13 * StackView.this.mSlideAmount));
                    StackView.this.mHighlight.setAlpha(highlightAlphaInterpolator(r13));
                    return;
                default:
                    return;
            }
        ...
        public void setXProgress(float r10) {
            float r11 = Math.max(-2.0f, Math.min(2.0f, r10));
            this.mXProgress = r11;
            View view = this.mView;
            if (view == null) {
                return;
            ...
            LayoutParams highlightLp = (LayoutParams) StackView.this.mHighlight.getLayoutParams();
            float r12 = r11 * 0.2f;
            viewLp.setHorizontalOffset(Math.round(StackView.this.mSlideAmount * r12));
            highlightLp.setHorizontalOffset(Math.round(StackView.this.mSlideAmount * r12));
        }
        ...
        private float getDuration(boolean invert, float velocity) {
            ...
            LayoutParams viewLp = (LayoutParams) view.getLayoutParams();
            float d10 = (float) Math.hypot(viewLp.horizontalOffset, viewLp.verticalOffset);
            float maxd = (float) Math.hypot(StackView.this.mSlideAmount, StackView.this.mSlideAmount * 0.4f);
            if (d10 > maxd) {
                d10 = maxd;
            }
            if (velocity == 0.0f) {
                return (invert ? 1.0f - (d10 / maxd) : d10 / maxd) * 400.0f;
            }
            float duration = invert ? d10 / Math.abs(velocity) : (maxd - d10) / Math.abs(velocity);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // android.widget.AdapterViewAnimator
    public LayoutParams createOrReuseLayoutParams(View v2) {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (heightSpecMode == 0) {
            if (haveChildRefSize) {
                i10 = Math.round(this.mReferenceChildHeight * (1.1111112f + 1.0f)) + this.mPaddingTop + this.mPaddingBottom;
            } else {
                i10 = 0;
            }
            heightSpecSize = i10;
 ...
 */
    ...
    public class LayoutParams extends ViewGroup.LayoutParams {
        ...
        LayoutParams(Context c4, AttributeSet attrs) {
            super(c4, attrs);
            this.parentRect = new Rect();
            this.invalidateRect = new Rect();
            this.invalidateRectf = new RectF();
        ...
        void invalidateGlobalRegion(View v2, Rect r10) {
            this.globalInvalidateRect.set(r10);
            this.globalInvalidateRect.union(0, 0, StackView.this.getWidth(), StackView.this.getHeight());
            View p10 = v2;
            if (v2.getParent() == null || !(v2.getParent() instanceof View)) {
                return;
            }
            boolean firstPass = true;
            this.parentRect.set(0, 0, 0, 0);
            while (p10.getParent() != null && (p10.getParent() instanceof View) && !this.parentRect.contains(this.globalInvalidateRect)) {
                if (!firstPass) {
                    this.globalInvalidateRect.offset(p10.getLeft() - p10.getScrollX(), p10.getTop() - p10.getScrollY());
                }
                firstPass = false;
                p10 = (View) p10.getParent();
                this.parentRect.set(p10.getScrollX(), p10.getScrollY(), p10.getWidth() + p10.getScrollX(), p10.getHeight() + p10.getScrollY());
                p10.invalidate(this.globalInvalidateRect.left, this.globalInvalidateRect.top, this.globalInvalidateRect.right, this.globalInvalidateRect.bottom);
            }
            p10.invalidate(this.globalInvalidateRect.left, this.globalInvalidateRect.top, this.globalInvalidateRect.right, this.globalInvalidateRect.bottom);
        }
 ...
 */
    ...
    public static class HolographicHelper {
        ...
        Bitmap createClickOutline(View v2, int color) {
            return createOutline(v2, 1, color);
        }

        Bitmap createResOutline(View v2, int color) {
            return createOutline(v2, 0, color);
        }

        Bitmap createOutline(View v2, int type, int color) {
            ...
            Bitmap bitmap = Bitmap.createBitmap(v2.getResources().getDisplayMetrics(), v2.getMeasuredWidth(), v2.getMeasuredHeight(), Bitmap.Config.ARGB_8888);
            this.mCanvas.setBitmap(bitmap);
            float rotationX = v2.getRotationX();
            float rotation = v2.getRotation();
            ...
            v2.draw(this.mCanvas);
            v2.setRotationX(rotationX);
            v2.setRotation(rotation);
            v2.setTranslationY(translationY);
            v2.setTranslationX(translationX);
