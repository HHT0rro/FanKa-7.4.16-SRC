 ...
 */
    ...
    public interface OnYearSelectedListener {
        void onYearChanged(YearPickerView yearPickerView, int i10);
    }
    ...
    public YearPickerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mViewSize = res.getDimensionPixelOffset(17105175);
        this.mChildSize = res.getDimensionPixelOffset(17105176);
 ...
 */
    ...
    public static class YearAdapter extends BaseAdapter {
        private static final int ITEM_LAYOUT = 17367385;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (hasNewView) {
                v2 = (TextView) this.mInflater.inflate(17367385, parent, false);
            } else {
                v2 = (TextView) convertView;
            }
            int year = getYearForPosition(position);
            boolean activated = this.mActivatedYear == year;
            if (hasNewView || v2.isActivated() != activated) {
                if (activated) {
                    textAppearanceResId = 16974762;
                } else {
                    textAppearanceResId = 16974761;
                }
                v2.setTextAppearance(textAppearanceResId);
                v2.setActivated(activated);
            }
            v2.setText(Integer.toString(year));
            return v2;
        }
