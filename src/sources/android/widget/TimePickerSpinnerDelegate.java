...
class TimePickerSpinnerDelegate extends TimePicker.AbstractTimePickerDelegate {
    ...
    public TimePickerSpinnerDelegate(TimePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int layoutResourceId = a10.getResourceId(13, R.layout.time_picker_legacy);
        a10.recycle();
        LayoutInflater inflater = LayoutInflater.from(this.mContext);
        View view = inflater.inflate(layoutResourceId, (ViewGroup) this.mDelegator, true);
        view.setSaveFromParentEnabled(false);
        NumberPicker numberPicker = (NumberPicker) delegator.findViewById(16909104);
        ...
        EditText editText = (EditText) numberPicker.findViewById(16909322);
        this.mHourSpinnerInput = editText;
        editText.setImeOptions(5);
        TextView textView = (TextView) this.mDelegator.findViewById(16908974);
        this.mDivider = textView;
        if (textView != null) {
            setDividerText();
        }
        NumberPicker numberPicker2 = (NumberPicker) this.mDelegator.findViewById(16909253);
        ...
        if (amPmView instanceof Button) {
            ...
            EditText editText3 = (EditText) numberPicker3.findViewById(16909322);
            this.mAmPmSpinnerInput = editText3;
            editText3.setImeOptions(6);
        }
        if (isAmPmAtStart()) {
            ViewGroup amPmParent = (ViewGroup) delegator.findViewById(16909639);
    ...
    private void getHourFormatData() {
        ...
        for (int i10 = 0; i10 < lengthPattern; i10++) {
            char c4 = bestDateTimePattern.charAt(i10);
            if (c4 == 'H' || c4 == 'h' || c4 == 'K' || c4 == 'k') {
                this.mHourFormat = c4;
                if (i10 + 1 < lengthPattern && c4 == bestDateTimePattern.charAt(i10 + 1)) {
    ...
    private void setContentDescriptions() {
        trySetContentDescription(this.mMinuteSpinner, 16909130, R.string.time_picker_increment_minute_button);
        trySetContentDescription(this.mMinuteSpinner, 16908959, R.string.time_picker_decrement_minute_button);
        trySetContentDescription(this.mHourSpinner, 16909130, R.string.time_picker_increment_hour_button);
        trySetContentDescription(this.mHourSpinner, 16908959, R.string.time_picker_decrement_hour_button);
        NumberPicker numberPicker = this.mAmPmSpinner;
        if (numberPicker != null) {
            trySetContentDescription(numberPicker, 16909130, R.string.time_picker_increment_set_pm_button);
            trySetContentDescription(this.mAmPmSpinner, 16908959, R.string.time_picker_decrement_set_am_button);
        }
    }
