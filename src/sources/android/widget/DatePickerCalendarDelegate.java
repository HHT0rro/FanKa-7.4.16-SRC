...
public class DatePickerCalendarDelegate extends DatePicker.AbstractDatePickerDelegate {
    ...
    public DatePickerCalendarDelegate(DatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a10 = this.mContext.obtainStyledAttributes(attrs, R.styleable.DatePicker, defStyleAttr, defStyleRes);
        LayoutInflater inflater = (LayoutInflater) this.mContext.getSystemService("layout_inflater");
        int layoutResourceId = a10.getResourceId(19, 17367148);
        ...
        ViewGroup header = (ViewGroup) this.mContainer.findViewById(16908949);
        TextView textView = (TextView) header.findViewById(16908951);
        this.mHeaderYear = textView;
        textView.setOnClickListener(onClickListener);
        TextView textView2 = (TextView) header.findViewById(16908950);
        this.mHeaderMonthDay = textView2;
        textView2.setOnClickListener(onClickListener);
        int monthHeaderTextAppearance = a10.getResourceId(10, 0);
        ...
        headerTextColor = headerTextColor == null ? a10.getColorStateList(18) : headerTextColor;
        ...
        if (a10.hasValueOrEmpty(0)) {
            header.setBackground(a10.getDrawable(0));
        }
        a10.recycle();
        ViewAnimator viewAnimator = (ViewAnimator) this.mContainer.findViewById(16908785);
        this.mAnimator = viewAnimator;
        DayPickerView dayPickerView = (DayPickerView) viewAnimator.findViewById(16908948);
        ...
        YearPickerView yearPickerView = (YearPickerView) this.mAnimator.findViewById(16908952);
