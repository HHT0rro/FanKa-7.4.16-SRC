 ...
 */
        ...
        public LayoutParams(Context c4, AttributeSet attrs) {
            ...
            TypedArray a10 = c4.obtainStyledAttributes(attrs, R.styleable.TableRow_Cell);
            this.column = a10.getInt(0, -1);
            int i10 = a10.getInt(1, 1);
            this.span = i10;
            if (i10 <= 1) {
                this.span = 1;
            }
    ...
    public View getVirtualChildAt(int i10) {
        ...
        int deflectedIndex = this.mColumnToChildIndex.get(i10, -1);
        if (deflectedIndex != -1) {
    ...
    private void mapIndexAndColumns() {
        if (this.mColumnToChildIndex == null) {
            ...
            for (int i10 = 0; i10 < count; i10++) {
                ...
                int j10 = 0;
                while (j10 < layoutParams.span) {
                    columnToChild.put(virtualCount, i10);
                    j10++;
                    virtualCount++;
                }
            }
    ...
    public void measureChildBeforeLayout(View child, int childIndex, int widthMeasureSpec, int totalWidth, int heightMeasureSpec, int totalHeight) {
        if (this.mConstrainedColumnWidths != null) {
            ...
            for (int i10 = 0; i10 < span; i10++) {
                columnWidth += constrainedColumnWidths[childIndex + i10];
            }
            int i11 = lp.gravity;
            boolean isHorizontalGravity = Gravity.isHorizontal(i11);
