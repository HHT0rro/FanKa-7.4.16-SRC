 ...
 */
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<ProgressBar> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mMinId = propertyMapper.mapInt(Attributes.Style.MIN, 16844089);
    ...
    public ProgressBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        initProgressBar();
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.ProgressBar, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.ProgressBar, attrs, a10, defStyleAttr, defStyleRes);
        this.mNoInvalidate = true;
        Drawable progressDrawable = a10.getDrawable(8);
        ...
        this.mDuration = a10.getInt(9, this.mDuration);
        this.mMinWidth = a10.getDimensionPixelSize(11, this.mMinWidth);
        this.mMaxWidth = a10.getDimensionPixelSize(0, this.mMaxWidth);
        this.mMinHeight = a10.getDimensionPixelSize(12, this.mMinHeight);
        this.mMaxHeight = a10.getDimensionPixelSize(1, this.mMaxHeight);
        this.mBehavior = a10.getInt(10, this.mBehavior);
        int resID = a10.getResourceId(13, 17432587);
        if (resID > 0) {
            setInterpolator(context, resID);
        }
        setMin(a10.getInt(26, this.mMin));
        setMax(a10.getInt(2, this.mMax));
        setProgress(a10.getInt(3, this.mProgress));
        setSecondaryProgress(a10.getInt(4, this.mSecondaryProgress));
        Drawable indeterminateDrawable = a10.getDrawable(7);
        ...
        boolean z10 = a10.getBoolean(6, this.mOnlyIndeterminate);
        this.mOnlyIndeterminate = z10;
        this.mNoInvalidate = false;
        setIndeterminate(z10 || a10.getBoolean(5, this.mIndeterminate));
        this.mMirrorForRtl = a10.getBoolean(15, this.mMirrorForRtl);
        if (a10.hasValue(17)) {
            if (this.mProgressTintInfo == null) {
                this.mProgressTintInfo = new ProgressTintInfo();
            }
            this.mProgressTintInfo.mProgressBlendMode = Drawable.parseBlendMode(a10.getInt(17, -1), null);
        ...
        if (a10.hasValue(16)) {
            ...
            this.mProgressTintInfo.mProgressTintList = a10.getColorStateList(16);
        ...
        if (a10.hasValue(19)) {
            ...
            this.mProgressTintInfo.mProgressBackgroundBlendMode = Drawable.parseBlendMode(a10.getInt(19, -1), null);
        ...
        if (a10.hasValue(18)) {
            ...
            this.mProgressTintInfo.mProgressBackgroundTintList = a10.getColorStateList(18);
        ...
        if (a10.hasValue(21)) {
            ...
            this.mProgressTintInfo.mSecondaryProgressBlendMode = Drawable.parseBlendMode(a10.getInt(21, -1), null);
        ...
        if (a10.hasValue(20)) {
            ...
            this.mProgressTintInfo.mSecondaryProgressTintList = a10.getColorStateList(20);
        ...
        if (a10.hasValue(23)) {
            ...
            this.mProgressTintInfo.mIndeterminateBlendMode = Drawable.parseBlendMode(a10.getInt(23, -1), null);
        ...
        if (a10.hasValue(22)) {
            ...
            this.mProgressTintInfo.mIndeterminateTintList = a10.getColorStateList(22);
    ...
    private static boolean needsTileify(Drawable dr) {
        if (dr instanceof LayerDrawable) {
            ...
            for (int i10 = 0; i10 < N; i10++) {
                if (needsTileify(orig.getDrawable(i10))) {
                    return true;
                }
            }
            return false;
        ...
        for (int i11 = 0; i11 < N2; i11++) {
            if (needsTileify(in.getStateDrawable(i11))) {
                return true;
            }
        }
        return false;
    ...
    private Drawable tileify(Drawable drawable, boolean clip) {
        if (drawable instanceof LayerDrawable) {
            ...
            for (int i10 = 0; i10 < N; i10++) {
                int id2 = orig.getId(i10);
                outDrawables[i10] = tileify(orig.getDrawable(i10), id2 == 16908301 || id2 == 16908303);
            }
            LayerDrawable clone = new LayerDrawable(outDrawables);
            for (int i11 = 0; i11 < N; i11++) {
                clone.setId(i11, orig.getId(i11));
                clone.setLayerGravity(i11, orig.getLayerGravity(i11));
                clone.setLayerWidth(i11, orig.getLayerWidth(i11));
                clone.setLayerHeight(i11, orig.getLayerHeight(i11));
                clone.setLayerInsetLeft(i11, orig.getLayerInsetLeft(i11));
                clone.setLayerInsetRight(i11, orig.getLayerInsetRight(i11));
                clone.setLayerInsetTop(i11, orig.getLayerInsetTop(i11));
                clone.setLayerInsetBottom(i11, orig.getLayerInsetBottom(i11));
                clone.setLayerInsetStart(i11, orig.getLayerInsetStart(i11));
                clone.setLayerInsetEnd(i11, orig.getLayerInsetEnd(i11));
            }
            return clone;
        }
        if (drawable instanceof StateListDrawable) {
            ...
            for (int i12 = 0; i12 < N2; i12++) {
                out.addState(in.getStateSet(i12), tileify(in.getStateDrawable(i12), clip));
            }
            return out;
        }
    ...
    private Drawable tileifyIndeterminate(Drawable drawable) {
        if (drawable instanceof AnimationDrawable) {
            ...
            for (int i10 = 0; i10 < N; i10++) {
                Drawable frame = tileify(background.getFrame(i10), true);
                frame.setLevel(10000);
                newBg.addFrame(frame, background.getDuration(i10));
            }
    ...
    public void setIndeterminateDrawableTiled(Drawable d10) {
        if (d10 != null) {
            d10 = tileifyIndeterminate(d10);
        }
        setIndeterminateDrawable(d10);
    }
    ...
    public void setProgressDrawable(Drawable d10) {
        ...
        if (drawable != d10) {
            ...
            if (d10 != null) {
                ...
                int drawableHeight = d10.getMinimumHeight();
    ...
    private Drawable getTintTarget(int layerId, boolean shouldFallback) {
        Drawable layer = null;
        Drawable d10 = this.mProgressDrawable;
        if (d10 == null) {
            return null;
        }
        this.mProgressDrawable = d10.mutate();
        if (d10 instanceof LayerDrawable) {
            layer = ((LayerDrawable) d10).findDrawableByLayerId(layerId);
        }
    ...
    public void onResolveDrawables(int layoutDirection) {
        Drawable d10 = this.mCurrentDrawable;
        if (d10 != null) {
            d10.setLayoutDirection(layoutDirection);
        }
        Drawable drawable = this.mIndeterminateDrawable;
        if (drawable != null) {
        ...
        public void run() {
            synchronized (ProgressBar.this) {
                ...
                for (int i10 = 0; i10 < count; i10++) {
                    RefreshData rd2 = (RefreshData) ProgressBar.this.mRefreshData.get(i10);
                    ProgressBar.this.doRefreshProgress(rd2.f825id, rd2.progress, rd2.fromUser, true, rd2.animate);
                    rd2.recycle();
                }
 ...
 */
    ...
    public static class RefreshData {
        ...
        public static RefreshData obtain(int id2, int progress, boolean fromUser, boolean animate) {
            RefreshData rd2 = (RefreshData) sPool.acquire();
            if (rd2 == null) {
                rd2 = new RefreshData();
            }
            rd2.f825id = id2;
            rd2.progress = progress;
            rd2.fromUser = fromUser;
            rd2.animate = animate;
            return rd2;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void doRefreshProgress(int id2, int progress, boolean fromUser, boolean callBackToApp, boolean animate) {
        ObjectAnimator objectAnimator;
        int range = this.mMax - this.mMin;
        float scale = range > 0 ? (progress - r1) / range : 0.0f;
        boolean isPrimary = id2 == 16908301;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setVisualProgress(int id2, float progress) {
        this.mVisualProgress = progress;
        Drawable d10 = this.mCurrentDrawable;
        if ((d10 instanceof LayerDrawable) && (d10 = ((LayerDrawable) d10).findDrawableByLayerId(id2)) == null) {
            d10 = this.mCurrentDrawable;
        }
        if (d10 != null) {
        ...
        onVisualProgressChanged(id2, progress);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void onVisualProgressChanged(int id2, float progress) {
    }

    private synchronized void refreshProgress(int id2, int progress, boolean fromUser, boolean animate) {
        if (this.mUiThreadId == Thread.currentThread().getId()) {
            doRefreshProgress(id2, progress, fromUser, true, animate);
        } else {
            if (this.mRefreshProgressRunnable == null) {
                this.mRefreshProgressRunnable = new RefreshProgressRunnable();
            }
            RefreshData rd2 = RefreshData.obtain(id2, progress, fromUser, animate);
            this.mRefreshData.add(rd2);
    ...
    public synchronized void setMin(int min) {
        ...
        if (z10 && min > (i10 = this.mMax)) {
            min = i10;
        }
        this.mMinInitialized = true;
        if (z10 && min != this.mMin) {
            this.mMin = min;
            postInvalidate();
    ...
    public synchronized void setMax(int max) {
        ...
        if (z10 && max < (i10 = this.mMin)) {
            max = i10;
        }
        this.mMaxInitialized = true;
        if (z10 && max != this.mMax) {
            this.mMax = max;
            postInvalidate();
    ...
    public void onSizeChanged(int w3, int h10, int oldw, int oldh) {
        updateDrawableBounds(w3, h10);
    }

    private void updateDrawableBounds(int w3, int h10) {
        int w10 = w3 - (this.mPaddingRight + this.mPaddingLeft);
        int h11 = h10 - (this.mPaddingTop + this.mPaddingBottom);
        int right = w10;
        int bottom = h11;
        int top = 0;
        int left = 0;
        ...
        if (drawable != null) {
            if (this.mOnlyIndeterminate && !(drawable instanceof AnimationDrawable)) {
                ...
                float boundAspect = w10 / h11;
                if (intrinsicAspect != boundAspect) {
                    if (boundAspect > intrinsicAspect) {
                        int width = (int) (h11 * intrinsicAspect);
                        left = (w10 - width) / 2;
                        right = left + width;
                    } else {
                        int height = (int) (w10 * (1.0f / intrinsicAspect));
                        int top2 = (h11 - height) / 2;
                        bottom = top2 + height;
                        top = top2;
                    }
                }
    ...
    public synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (d10 != null) {
            ...
            dh = Math.max(this.mMinHeight, Math.min(this.mMaxHeight, d10.getIntrinsicHeight()));
        }
        updateDrawableState();
 ...
 */
    ...
    public void onAttachedToWindow() {
        ...
        if (this.mRefreshData != null) {
            synchronized (this) {
                ...
                for (int i10 = 0; i10 < count; i10++) {
                    RefreshData rd2 = this.mRefreshData.get(i10);
                    doRefreshProgress(rd2.f825id, rd2.progress, rd2.fromUser, true, rd2.animate);
                    rd2.recycle();
                }
    ...
    public void onInitializeAccessibilityNodeInfoInternal(AccessibilityNodeInfo info) {
        ...
        if (getStateDescription() == null) {
            if (isIndeterminate()) {
                info.setStateDescription(getResources().getString(17040530));
            } else {
