 ...
 */
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<Switch> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mTrackId = propertyMapper.mapObject(FFmpegMediaMetadataRetriever.METADATA_KEY_TRACK, 16843631);
    ...
    public Switch(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.Switch, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.Switch, attrs, a10, defStyleAttr, defStyleRes);
        Drawable drawable = a10.getDrawable(2);
        this.mThumbDrawable = drawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        Drawable drawable2 = a10.getDrawable(4);
        this.mTrackDrawable = drawable2;
        if (drawable2 != null) {
            drawable2.setCallback(this);
        }
        this.mTextOn = a10.getText(0);
        this.mTextOff = a10.getText(1);
        this.mShowText = a10.getBoolean(11, true);
        this.mThumbTextPadding = a10.getDimensionPixelSize(7, 0);
        this.mSwitchMinWidth = a10.getDimensionPixelSize(5, 0);
        this.mSwitchPadding = a10.getDimensionPixelSize(6, 0);
        this.mSplitTrack = a10.getBoolean(8, false);
        this.mUseFallbackLineSpacing = context.getApplicationInfo().targetSdkVersion >= 28;
        ColorStateList thumbTintList = a10.getColorStateList(9);
        if (thumbTintList != null) {
            this.mThumbTintList = thumbTintList;
            this.mHasThumbTint = true;
        }
        BlendMode thumbTintMode = Drawable.parseBlendMode(a10.getInt(10, -1), null);
        ...
        ColorStateList trackTintList = a10.getColorStateList(12);
        if (trackTintList != null) {
            this.mTrackTintList = trackTintList;
            this.mHasTrackTint = true;
        }
        BlendMode trackTintMode = Drawable.parseBlendMode(a10.getInt(13, -1), null);
        ...
        int appearance = a10.getResourceId(3, 0);
        if (appearance != 0) {
    ...
    private boolean hitThumb(float x10, float y10) {
        ...
        int thumbTop = i10 - i11;
        int thumbLeft = (this.mSwitchLeft + thumbOffset) - i11;
        int i12 = this.mThumbWidth + thumbLeft + this.mTempRect.left + this.mTempRect.right;
        int i13 = this.mTouchSlop;
        int thumbRight = i12 + i13;
        int thumbBottom = this.mSwitchBottom + i13;
        return x10 > ((float) thumbLeft) && x10 < ((float) thumbRight) && y10 > ((float) thumbTop) && y10 < ((float) thumbBottom);
    }
            ...
            case 2:
                switch (this.mTouchMode) {
                    ...
                    case 2:
                        ...
                        float thumbScrollOffset = x12 - this.mTouchX;
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        switch (getGravity() & 112) {
            case 16:
                ...
                int switchTop3 = height - (i10 / 2);
                int switchBottom2 = i10 + switchTop3;
