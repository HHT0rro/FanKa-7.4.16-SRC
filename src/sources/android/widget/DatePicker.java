 ...
 */
    ...
    public DatePicker(final Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.DatePicker, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.DatePicker, attrs, a10, defStyleAttr, defStyleRes);
        boolean isDialogMode = a10.getBoolean(17, false);
        int requestedMode = a10.getInt(16, 1);
        int firstDayOfWeek = a10.getInt(3, 0);
        a10.recycle();
        ...
        this.mDelegate.setAutoFillChangeListener(new OnDateChangedListener() { // from class: android.widget.DatePicker$$ExternalSyntheticLambda0
            ...
            public final void onDateChanged(DatePicker datePicker, int i10, int i11, int i12) {
                DatePicker.this.lambda$new$0(context, datePicker, i10, i11, i12);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$0(Context context, DatePicker v2, int y10, int m10, int d10) {
    ...
    static abstract class AbstractDatePickerDelegate implements DatePickerDelegate {
        ...
        public final void autofill(AutofillValue value) {
            if (value == null || !value.isDate()) {
                Log.w(DatePicker.LOG_TAG, ((Object) value) + " could not be autofilled into " + ((Object) this));
                return;
            }
