...
public abstract class CursorTreeAdapter extends BaseExpandableListAdapter implements Filterable, CursorFilter.CursorFilterClient {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            v2 = newGroupView(this.mContext, cursor, isExpanded, parent);
        } else {
            v2 = convertView;
        }
        bindGroupView(v2, this.mContext, cursor, isExpanded);
        return v2;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            v2 = newChildView(this.mContext, cursor, isLastChild, parent);
        } else {
            v2 = convertView;
        }
        bindChildView(v2, this.mContext, cursor, isLastChild);
        return v2;
    }
