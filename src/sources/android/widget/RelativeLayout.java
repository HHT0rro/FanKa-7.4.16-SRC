 ...
 */
    ...
    private void initFromAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.RelativeLayout, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.RelativeLayout, attrs, a10, defStyleAttr, defStyleRes);
        this.mIgnoreGravity = a10.getResourceId(1, -1);
        this.mGravity = a10.getInt(0, this.mGravity);
        a10.recycle();
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (child2.getVisibility() == 8) {
                ...
                if (!isWrapContentWidth) {
                    ...
                    if (targetSdkVersion < 19) {
                        ...
                        int i13 = myWidth3 - params2.mLeft;
                        myHeight = myHeight2;
                        int myHeight3 = params2.leftMargin;
                        width3 = Math.max(width3, i13 + myHeight3);
                    }
                } else {
                    myHeight = myHeight2;
                    if (targetSdkVersion < 19) {
        ...
        if (horizontalGravity || verticalGravity) {
            ...
            Gravity.apply(this.mGravity, i14 - left, bottom3 - top2, selfBounds, contentBounds, layoutDirection);
        ...
        if (isLayoutRtl()) {
            ...
            for (int i18 = 0; i18 < myWidth2; i18++) {
                View child7 = views5[i18];
    ...
    private int compareLayoutPosition(LayoutParams p12, LayoutParams p22) {
        int topDiff = p12.mTop - p22.mTop;
        if (topDiff != 0) {
            return topDiff;
        }
        return p12.mLeft - p22.mLeft;
    }
    ...
    private View getRelatedView(int[] rules, int relation) {
        ...
        if (id2 == 0 || (node = (DependencyGraph.Node) this.mGraph.mKeyNodes.get(id2)) == null) {
            return null;
        }
        View v2 = node.view;
        while (v2.getVisibility() == 8) {
            int[] rules2 = ((LayoutParams) v2.getLayoutParams()).getRules(v2.getLayoutDirection());
            DependencyGraph.Node node2 = (DependencyGraph.Node) this.mGraph.mKeyNodes.get(rules2[relation]);
            if (node2 == null || v2 == node2.view) {
                return null;
            }
            v2 = node2.view;
        }
    ...
    private LayoutParams getRelatedViewParams(int[] rules, int relation) {
        View v2 = getRelatedView(rules, relation);
        if (v2 != null) {
            ViewGroup.LayoutParams params = v2.getLayoutParams();
            if (params instanceof LayoutParams) {
                return (LayoutParams) v2.getLayoutParams();
            }
            return null;
        }
        return null;
    ...
    private int getRelatedViewBaselineOffset(int[] rules) {
        int baseline;
        View v2 = getRelatedView(rules, 4);
        if (v2 != null && (baseline = v2.getBaseline()) != -1) {
            ViewGroup.LayoutParams params = v2.getLayoutParams();
            if (params instanceof LayoutParams) {
                LayoutParams anchorParams = (LayoutParams) v2.getLayoutParams();
    ...
    public boolean dispatchPopulateAccessibilityEventInternal(AccessibilityEvent event) {
        ...
        int count = getChildCount();
        for (int i10 = 0; i10 < count; i10++) {
            this.mTopToBottomLeftToRightSet.add(getChildAt(i10));
        }
 ...
 */
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c4, AttributeSet attrs) {
            ...
            TypedArray a10 = c4.obtainStyledAttributes(attrs, R.styleable.RelativeLayout_Layout);
            int targetSdkVersion = c4.getApplicationInfo().targetSdkVersion;
            if (targetSdkVersion >= 17 && c4.getApplicationInfo().hasRtlSupport()) {
                z10 = false;
            } else {
                z10 = true;
            }
            this.mIsRtlCompatibilityMode = z10;
            ...
            for (int i10 = 0; i10 < N; i10++) {
                ...
                switch (attr) {
                    case 0:
                        rules[0] = a10.getResourceId(attr, 0);
                        break;
                    case 1:
                        rules[1] = a10.getResourceId(attr, 0);
                        break;
                    case 2:
                        rules[2] = a10.getResourceId(attr, 0);
                        break;
                    case 3:
                        rules[3] = a10.getResourceId(attr, 0);
                        break;
                    case 4:
                        rules[4] = a10.getResourceId(attr, 0);
                        break;
                    case 5:
                        rules[5] = a10.getResourceId(attr, 0);
                        break;
                    case 6:
                        rules[6] = a10.getResourceId(attr, 0);
                        break;
                    case 7:
                        rules[7] = a10.getResourceId(attr, 0);
                        break;
                    case 8:
                        rules[8] = a10.getResourceId(attr, 0);
                        break;
                    case 9:
                        rules[9] = a10.getBoolean(attr, false) ? -1 : 0;
                        break;
                    case 10:
                        rules[10] = a10.getBoolean(attr, false) ? -1 : 0;
                        break;
                    case 11:
                        rules[11] = a10.getBoolean(attr, false) ? -1 : 0;
                        break;
                    case 12:
                        rules[12] = a10.getBoolean(attr, false) ? -1 : 0;
                        break;
                    case 13:
                        rules[13] = a10.getBoolean(attr, false) ? -1 : 0;
                        break;
                    case 14:
                        rules[14] = a10.getBoolean(attr, false) ? -1 : 0;
                        break;
                    case 15:
                        rules[15] = a10.getBoolean(attr, false) ? -1 : 0;
                        break;
                    case 16:
                        this.alignWithParent = a10.getBoolean(attr, false);
                        break;
                    case 17:
                        rules[16] = a10.getResourceId(attr, 0);
                        break;
                    case 18:
                        rules[17] = a10.getResourceId(attr, 0);
                        break;
                    case 19:
                        rules[18] = a10.getResourceId(attr, 0);
                        break;
                    case 20:
                        rules[19] = a10.getResourceId(attr, 0);
                        break;
                    case 21:
                        rules[20] = a10.getBoolean(attr, false) ? -1 : 0;
                        break;
                    case 22:
                        rules[21] = a10.getBoolean(attr, false) ? -1 : 0;
                        break;
                }
            }
            this.mRulesChanged = true;
            System.arraycopy((Object) rules, 0, (Object) initialRules, 0, 22);
            a10.recycle();
        }
        ...
        public LayoutParams(LayoutParams source) {
            ...
            System.arraycopy((Object) source.mRules, 0, (Object) iArr, 0, 22);
            System.arraycopy((Object) source.mInitialRules, 0, (Object) this.mInitialRules, 0, 22);
        }
        ...
        private void resolveRules(int layoutDirection) {
            ...
            System.arraycopy((Object) this.mInitialRules, 0, (Object) this.mRules, 0, 22);
            if (this.mIsRtlCompatibilityMode) {
                ...
                int i16 = iArr2[18];
                if ((i16 != 0 || iArr2[19] != 0) && (iArr2[5] != 0 || iArr2[7] != 0)) {
                    iArr2[5] = 0;
                    iArr2[7] = 0;
                }
                if (i16 != 0) {
                    iArr2[isLayoutRtl ? (char) 7 : (char) 5] = i16;
                    iArr2[18] = 0;
                }
                int i17 = iArr2[19];
                if (i17 != 0) {
                    iArr2[isLayoutRtl ? (char) 5 : (char) 7] = i17;
                    iArr2[19] = 0;
                }
                int i18 = iArr2[16];
                if ((i18 != 0 || iArr2[17] != 0) && (iArr2[0] != 0 || iArr2[1] != 0)) {
                    iArr2[0] = 0;
                    iArr2[1] = 0;
                }
                if (i18 != 0) {
                    iArr2[isLayoutRtl ? (char) 1 : (char) 0] = i18;
                    iArr2[16] = 0;
                }
                int i19 = iArr2[17];
                if (i19 != 0) {
                    iArr2[isLayoutRtl ? (char) 0 : (char) 1] = i19;
                    iArr2[17] = 0;
                }
                int i20 = iArr2[20];
                if ((i20 != 0 || iArr2[21] != 0) && (iArr2[9] != 0 || iArr2[11] != 0)) {
                    iArr2[9] = 0;
                    iArr2[11] = 0;
                }
                if (i20 != 0) {
                    iArr2[isLayoutRtl ? (char) 11 : '\t'] = i20;
                    iArr2[20] = 0;
                }
                int i21 = iArr2[21];
                if (i21 != 0) {
                    iArr2[isLayoutRtl ? '\t' : (char) 11] = i21;
                    iArr2[21] = 0;
                }
            }
            this.mRulesChanged = false;
    ...
    public static class DependencyGraph {
        ...
        void getSortedViews(View[] sorted, int... rules) {
            ...
            while (true) {
                ...
                for (int i10 = 0; i10 < count; i10++) {
                    Node dependent = dependents.keyAt(i10);
