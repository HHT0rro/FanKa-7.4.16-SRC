...
public class SelectionActionModeHelper {
    ...
    public SelectionActionModeHelper(Editor editor) {
        ...
        if (getTextClassificationSettings().isSmartSelectionAnimationEnabled()) {
            ...
            int i10 = editor.getTextView().mHighlightColor;
            Objects.requireNonNull(textView);
            this.mSmartSelectSprite = new SmartSelectSprite(context2, i10, new Runnable() { // from class: android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda8
    ...
    private List<SmartSelectSprite.RectangleWithTextSelectionLayout> convertSelectionToRectangles(TextView textView, int start, int end) {
        ...
        Layout.SelectionRectangleConsumer consumer = new Layout.SelectionRectangleConsumer() { // from class: android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda4
            public final void accept(float f10, float f11, float f12, float f13, int i10) {
                SelectionActionModeHelper.mergeRectangleIntoList(List.this, new RectF(f10, f11, f12, f13), new SelectionActionModeHelper$$ExternalSyntheticLambda5(), new Function() { // from class: android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda7
                    @Override // java.util.function.Function
                    public final Object apply(Object obj) {
                        return SelectionActionModeHelper.lambda$convertSelectionToRectangles$1(i10, (RectF) obj);
                    }
                });
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ SmartSelectSprite.RectangleWithTextSelectionLayout lambda$convertSelectionToRectangles$1(int textSelectionLayout, RectF r10) {
        return new SmartSelectSprite.RectangleWithTextSelectionLayout(r10, textSelectionLayout);
    }
    ...
    public static final class SelectionTracker {
        ...
        private void onClassifiedSelection(SelectionResult result) {
            if (isSelectionStarted()) {
                ...
                this.mAllowReset = (this.mSelectionStart == this.mOriginalStart && i10 == this.mOriginalEnd) ? false : true;
            }
        }
        ...
        private boolean isSelectionStarted() {
            ...
            return i11 >= 0 && (i10 = this.mSelectionEnd) >= 0 && i11 != i10;
        }
    ...
    public static final class SelectionMetricsLogger {
        ...
        public void logSelectionStarted(TextClassifier classificationSession, TextClassificationContext classificationContext, CharSequence text, int index, int invocationMethod) {
            try {
                ...
                Preconditions.checkArgumentInRange(index, 0, text.length(), Attributes.Style.INDEX);
    ...
    public static final class TextClassificationAsyncTask extends AsyncTask<Void, Void, SelectionResult> {
        ...
        public SelectionResult doInBackground(Void... params) {
            ...
            try {
                ...
                Log.w(SelectionActionModeHelper.LOG_TAG, "TextClassificationAsyncTask failed.", e2);
            }
 ...
 */
    ...
    public static final class TextClassificationHelper {
        ...
        private void trimText() {
            ...
            int i11 = this.mTrimStart;
            this.mRelativeStart = i10 - i11;
            this.mRelativeEnd = this.mSelectionEnd - i11;
        }
    }
