 ...
 */
        ...
        public LayoutParams(Context c4, AttributeSet attrs) {
            super(c4, attrs);
            this.gravity = -1;
            TypedArray a10 = c4.obtainStyledAttributes(attrs, R.styleable.FrameLayout_Layout);
 ...
 */
    ...
    public FrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mForegroundPaddingBottom = 0;
        this.mMatchParentChildren = new ArrayList<>(1);
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.FrameLayout, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.FrameLayout, attrs, a10, defStyleAttr, defStyleRes);
        if (a10.getBoolean(0, false)) {
