...
public abstract class AbsSpinner extends AdapterView<SpinnerAdapter> {
    ...
    abstract void layout(int i10, boolean z10);
    ...
    public AbsSpinner(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        initAbsSpinner();
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.AbsSpinner, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.AbsSpinner, attrs, a10, defStyleAttr, defStyleRes);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int i11 = this.mSelectionLeftPadding;
        if (i10 > i11) {
        ...
        int i13 = this.mSelectionTopPadding;
        if (i12 > i13) {
        ...
        int i15 = this.mSelectionRightPadding;
        if (i14 > i15) {
    ...
    public void recycleAllViews() {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            int index = position + i10;
            recycleBin.put(index, v2);
        }
    }
 ...
 */
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "AbsSpinner.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " selectedId=" + this.selectedId + " position=" + this.position + i.f4738d;
        }
    }
 ...
 */
    ...
    public class RecycleBin {
        ...
        public void put(int position, View v2) {
            this.mScrapHeap.put(position, v2);
        }
        ...
        public void clear() {
            ...
            for (int i10 = 0; i10 < count; i10++) {
                View view = scrapHeap.valueAt(i10);
                if (view != null) {
