...
public class ExpandableListConnector extends BaseAdapter implements Filterable {
    ...
    public void refreshExpGroupMetadataList(boolean forceChildrenCountRefresh, boolean syncGroupPositions) {
        ...
        if (syncGroupPositions) {
            ...
            for (int i10 = egmlSize - 1; i10 >= 0; i10--) {
                GroupMetadata curGm = egml.get(i10);
        ...
        int lastGPos = 0;
        for (int i11 = 0; i11 < egmlSize; i11++) {
            GroupMetadata curGm2 = egml.get(i11);
    ...
    public boolean isGroupExpanded(int groupPosition) {
        for (int i10 = this.mExpGroupMetadataList.size() - 1; i10 >= 0; i10--) {
            GroupMetadata groupMetadata = this.mExpGroupMetadataList.get(i10);
    ...
    public void setExpandedGroupMetadataList(ArrayList<GroupMetadata> expandedGroupMetadataList) {
        ...
        for (int i10 = expandedGroupMetadataList.size() - 1; i10 >= 0; i10--) {
            if (expandedGroupMetadataList.get(i10).gPos >= numGroups) {
                return;
            }
        }
