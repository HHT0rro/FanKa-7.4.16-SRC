 ...
 */
    ...
    public TimePicker(final Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.TimePicker, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.TimePicker, attrs, a10, defStyleAttr, defStyleRes);
        boolean isDialogMode = a10.getBoolean(10, false);
        int requestedMode = a10.getInt(8, 1);
        a10.recycle();
        ...
        this.mDelegate.setAutoFillChangeListener(new OnTimeChangedListener() { // from class: android.widget.TimePicker$$ExternalSyntheticLambda0
            ...
            public final void onTimeChanged(TimePicker timePicker, int i10, int i11) {
                TimePicker.this.lambda$new$0(context, timePicker, i10, i11);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$0(Context context, TimePicker v2, int h10, int m10) {
    ...
    public static abstract class AbstractTimePickerDelegate implements TimePickerDelegate {
        ...
        public final void autofill(AutofillValue value) {
            if (value == null || !value.isDate()) {
                Log.w(TimePicker.LOG_TAG, ((Object) value) + " could not be autofilled into " + ((Object) this));
                return;
            }
        ...
        public final AutofillValue getAutofillValue() {
            long j10 = this.mAutofilledValue;
            if (j10 != 0) {
                return AutofillValue.forDate(j10);
            }
            Calendar cal = Calendar.getInstance(this.mLocale);
            cal.set(11, getHour());
