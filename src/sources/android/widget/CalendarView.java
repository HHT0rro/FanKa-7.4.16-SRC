 ...
 */
    ...
    public interface CalendarViewDelegate {
        boolean getBoundsForDate(long j10, Rect rect);
        ...
        void setDate(long j10, boolean z10, boolean z11);

        void setDateTextAppearance(int i10);

        void setFirstDayOfWeek(int i10);

        void setFocusedMonthDateColor(int i10);
        ...
        void setSelectedDateVerticalBar(int i10);

        void setSelectedDateVerticalBar(Drawable drawable);

        void setSelectedWeekBackgroundColor(int i10);

        void setShowWeekNumber(boolean z10);

        void setShownWeekCount(int i10);

        void setUnfocusedMonthDateColor(int i10);

        void setWeekDayTextAppearance(int i10);

        void setWeekNumberColor(int i10);

        void setWeekSeparatorLineColor(int i10);
    }
 ...
 */
    ...
    public interface OnDateChangeListener {
        void onSelectedDayChange(CalendarView calendarView, int i10, int i11, int i12);
    }
