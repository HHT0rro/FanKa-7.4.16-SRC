 ...
 */
    ...
    public ExpandableListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.ExpandableListView, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.ExpandableListView, attrs, a10, defStyleAttr, defStyleRes);
        this.mGroupIndicator = a10.getDrawable(0);
        this.mChildIndicator = a10.getDrawable(1);
        this.mIndicatorLeft = a10.getDimensionPixelSize(2, 0);
        int dimensionPixelSize = a10.getDimensionPixelSize(3, 0);
        ...
        this.mChildIndicatorLeft = a10.getDimensionPixelSize(4, -1);
        this.mChildIndicatorRight = a10.getDimensionPixelSize(5, -1);
        this.mChildDivider = a10.getDrawable(6);
        if (!isRtlCompatibilityMode()) {
            this.mIndicatorStart = a10.getDimensionPixelSize(7, -2);
            this.mIndicatorEnd = a10.getDimensionPixelSize(8, -2);
            this.mChildIndicatorStart = a10.getDimensionPixelSize(9, -1);
            this.mChildIndicatorEnd = a10.getDimensionPixelSize(10, -1);
        }
        a10.recycle();
    }
    ...
    private void resolveIndicator() {
        ...
        if (isLayoutRtl) {
            int i10 = this.mIndicatorStart;
            if (i10 >= 0) {
                this.mIndicatorRight = i10;
            }
            int i11 = this.mIndicatorEnd;
            if (i11 >= 0) {
                this.mIndicatorLeft = i11;
            }
        } else {
            int i12 = this.mIndicatorStart;
            if (i12 >= 0) {
                this.mIndicatorLeft = i12;
            }
            int i13 = this.mIndicatorEnd;
            if (i13 >= 0) {
    ...
    private void resolveChildIndicator() {
        boolean isLayoutRtl = isLayoutRtl();
        if (isLayoutRtl) {
            int i10 = this.mChildIndicatorStart;
            if (i10 >= -1) {
                this.mChildIndicatorRight = i10;
            }
            int i11 = this.mChildIndicatorEnd;
            if (i11 >= -1) {
                this.mChildIndicatorLeft = i11;
                return;
            }
            return;
        }
        int i12 = this.mChildIndicatorStart;
        if (i12 >= -1) {
            this.mChildIndicatorLeft = i12;
        }
        int i13 = this.mChildIndicatorEnd;
        if (i13 >= -1) {
            this.mChildIndicatorRight = i13;
        }
    }
                ...
                if (b4 < 0) {
                    ...
                    if (pos.position.type == lastItemType) {
                        ...
                        if (!isLayoutRtl) {
                            ...
                            int i13 = indicatorRect.left;
                            int temp2 = this.mPaddingRight;
                            indicatorRect.left = i13 - temp2;
    ...
    public void setOnItemClickListener(AdapterView.OnItemClickListener l10) {
        super.setOnItemClickListener(l10);
    }
    ...
    public boolean performItemClick(View v2, int position, long id2) {
        if (isHeaderOrFooterPosition(position)) {
            return super.performItemClick(v2, position, id2);
        }
        int adjustedPosition = getFlatPositionForConnector(position);
        return handleItemClick(v2, adjustedPosition, id2);
    }

    boolean handleItemClick(View v2, int position, long id2) {
        boolean returnValue;
        ExpandableListConnector.PositionMetadata posMetadata = this.mConnector.getUnflattenedPos(position);
        long id3 = getChildOrGroupId(posMetadata.position);
        if (posMetadata.position.type == 2) {
            OnGroupClickListener onGroupClickListener = this.mOnGroupClickListener;
            if (onGroupClickListener != null && onGroupClickListener.onGroupClick(this, v2, posMetadata.position.groupPos, id3)) {
                posMetadata.recycle();
                return true;
            }
            ...
            if (this.mOnChildClickListener != null) {
                playSoundEffect(0);
                return this.mOnChildClickListener.onChildClick(this, v2, posMetadata.position.groupPos, posMetadata.position.childPos, id3);
            }
            returnValue = false;
        }
        posMetadata.recycle();
    ...
    public static long getPackedPositionForChild(int groupPosition, int childPosition) {
        return ((groupPosition & 2147483647L) << 32) | Long.MIN_VALUE | (childPosition & (-1));
    }

    public static long getPackedPositionForGroup(int groupPosition) {
        return (groupPosition & 2147483647L) << 32;
    }
    ...
    ContextMenu.ContextMenuInfo createContextMenuInfo(View view, int flatListPosition, long id2) {
        if (!isHeaderOrFooterPosition(flatListPosition)) {
            ...
            long id3 = getChildOrGroupId(pos);
            long packedPosition = pos.getPackedPosition();
            pm.recycle();
            return new ExpandableListContextMenuInfo(view, packedPosition, id3);
        }
