 ...
 */
    ...
    /* JADX WARN: Type inference failed for: r6v4, types: [android.widget.SpinnerAdapter] */
    /* JADX WARN: Type inference failed for: r6v5 */
    /* JADX WARN: Type inference failed for: r6v6 */
    public Spinner(Context context, AttributeSet attributeSet, int i10, int i11, int i12, Resources.Theme theme) {
        super(context, attributeSet, i10, i11);
        int i13;
        ?? r62;
        this.mTempRect = new Rect();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.Spinner, i10, i11);
        saveAttributeDataForStyleable(context, R.styleable.Spinner, attributeSet, obtainStyledAttributes, i10, i11);
        if (theme != null) {
        ...
        switch (i13) {
            case 0:
                DialogPopupIA dialogPopupIA = null;
            ...
            case 1:
                r62 = 0;
                final DropdownPopup dropdownPopup = new DropdownPopup(this.mPopupContext, attributeSet, i10, i11);
                TypedArray obtainStyledAttributes2 = this.mPopupContext.obtainStyledAttributes(attributeSet, R.styleable.Spinner, i10, i11);
    ...
    public void setOnItemClickListenerInt(AdapterView.OnItemClickListener l10) {
    ...
    int measureContentWidth(SpinnerAdapter adapter, Drawable background) {
        ...
        int count = end - start;
        for (int i10 = Math.max(0, start - (15 - count)); i10 < end; i10++) {
            int positionType = adapter.getItemViewType(i10);
            if (positionType != itemType) {
                itemType = positionType;
                itemView = null;
            }
            itemView = adapter.getView(i10, itemView, this);
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: android.widget.Spinner.DropdownPopup.1
                ...
                public void onItemClick(AdapterView parent, View v2, int position, long id2) {
                    ...
                    if (Spinner.this.mOnItemClickListener != null) {
                        Spinner.this.performItemClick(v2, position, DropdownPopup.this.mAdapter.getItemId(position));
                    }
