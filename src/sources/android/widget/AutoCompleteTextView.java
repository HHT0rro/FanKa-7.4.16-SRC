 ...
 */
    ...
    public AutoCompleteTextView(Context context, AttributeSet attributeSet, int i10, int i11, Resources.Theme theme) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.AutoCompleteTextView, i10, i11);
        saveAttributeDataForStyleable(context, R.styleable.AutoCompleteTextView, attributeSet, obtainStyledAttributes, i10, i11);
        if (theme == null) {
        ...
        if (context2 != context) {
            TypedArray obtainStyledAttributes2 = context2.obtainStyledAttributes(attributeSet, R.styleable.AutoCompleteTextView, i10, i11);
            saveAttributeDataForStyleable(context, R.styleable.AutoCompleteTextView, attributeSet, obtainStyledAttributes, i10, i11);
        ...
        int resourceId2 = typedArray.getResourceId(1, 17367329);
        CharSequence text = typedArray.getText(0);
        if (typedArray != obtainStyledAttributes) {
            typedArray.recycle();
        }
        ListPopupWindow listPopupWindow = new ListPopupWindow(this.mPopupContext, attributeSet, i10, i11);
    ...
    public void setDropDownBackgroundDrawable(Drawable d10) {
        this.mPopup.setBackgroundDrawable(d10);
    }

    public void setDropDownBackgroundResource(int id2) {
        this.mPopup.setBackgroundDrawable(getContext().getDrawable(id2));
    }
 ...
 */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void performCompletion(View selectedView, int position, long id2) {
        Object selectedItem;
        if (isPopupShowing()) {
            if (position < 0) {
        ...
        if (adapter != null && (imm = (InputMethodManager) getContext().getSystemService(InputMethodManager.class)) != null) {
            ...
            for (int i10 = 0; i10 < count; i10++) {
                if (adapter.isEnabled(i10)) {
                    ...
                    long id2 = adapter.getItemId(i10);
                    completions[realCount] = new CompletionInfo(id2, realCount, convertSelectionToString(item));
                    realCount++;
                }
            }
            if (realCount != count) {
 ...
 */
    ...
    private class DropDownItemClickListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView parent, View v2, int position, long id2) {
            AutoCompleteTextView.this.performCompletion(v2, position, id2);
        }
    }
