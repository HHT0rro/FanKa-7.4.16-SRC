...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl, SubtitleController.Anchor {
    ...
    public VideoView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mSHCallback = new SurfaceHolder.Callback() { // from class: android.widget.VideoView.7
            ...
            public void surfaceChanged(SurfaceHolder holder, int format, int w3, int h10) {
                VideoView.this.mSurfaceWidth = w3;
                VideoView.this.mSurfaceHeight = h10;
                boolean isValidState = VideoView.this.mTargetState == 3;
                boolean hasValidSize = VideoView.this.mVideoWidth == w3 && VideoView.this.mVideoHeight == h10;
    ...
    public void openVideo() {
        ...
        release(false);
        int i10 = this.mAudioFocusType;
        if (i10 != 0) {
            this.mAudioManager.requestAudioFocus(null, this.mAudioAttributes, i10, 0);
        }
        try {
            ...
            Iterator<Pair<InputStream, MediaFormat>> iterator2 = this.mPendingSubtitleTracks.iterator2();
            while (iterator2.hasNext()) {
                Pair<InputStream, MediaFormat> pending = iterator2.next();
                try {
            ...
            Log.w(TAG, "Unable to open content: " + ((Object) this.mUri), ex);
            this.mCurrentState = -1;
            this.mTargetState = -1;
            this.mErrorListener.onError(this.mMediaPlayer, 1, 0);
        } catch (IllegalArgumentException ex2) {
            Log.w(TAG, "Unable to open content: " + ((Object) this.mUri), ex2);
            this.mCurrentState = -1;
            this.mTargetState = -1;
            this.mErrorListener.onError(this.mMediaPlayer, 1, 0);
        } finally {
