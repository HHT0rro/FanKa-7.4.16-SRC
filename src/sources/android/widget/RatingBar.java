 ...
 */
    ...
    public RatingBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mNumStars = 5;
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.RatingBar, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.RatingBar, attrs, a10, defStyleAttr, defStyleRes);
        int numStars = a10.getInt(0, this.mNumStars);
        setIsIndicator(a10.getBoolean(3, !this.mIsUserSeekable));
        float rating = a10.getFloat(1, -1.0f);
        float stepSize = a10.getFloat(2, -1.0f);
        a10.recycle();
    ...
    public void onInitializeAccessibilityNodeInfoInternal(AccessibilityNodeInfo info) {
        ...
        params.put("rating", Float.valueOf(getRating()));
        params.put("max", Float.valueOf(scaledMax));
        info.setStateDescription(PluralsMessageFormatter.format(getContext().getResources(), params, 17041470));
    }
