 ...
 */
    ...
    public DayPickerPagerAdapter(Context context, int layoutResId, int calendarViewId) {
        ...
        TypedArray ta2 = context.obtainStyledAttributes(new int[]{16843820});
        this.mDayHighlightColor = ta2.getColorStateList(0);
        ta2.recycle();
    }
    ...
    public void setFirstDayOfWeek(int weekStart) {
        ...
        for (int i10 = 0; i10 < count; i10++) {
            SimpleMonthView monthView = this.mItems.valueAt(i10).calendar;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        SimpleMonthView v2 = (SimpleMonthView) itemView.findViewById(this.mCalendarViewId);
        v2.setOnDayClickListener(this.mOnDayClickListener);
        v2.setMonthTextAppearance(this.mMonthTextAppearance);
        v2.setDayOfWeekTextAppearance(this.mDayOfWeekTextAppearance);
        v2.setDayTextAppearance(this.mDayTextAppearance);
        ColorStateList colorStateList = this.mDaySelectorColor;
        if (colorStateList != null) {
            v2.setDaySelectorColor(colorStateList);
        }
        ColorStateList colorStateList2 = this.mDayHighlightColor;
        if (colorStateList2 != null) {
            v2.setDayHighlightColor(colorStateList2);
        }
        ColorStateList colorStateList3 = this.mCalendarTextColor;
        if (colorStateList3 != null) {
            v2.setMonthTextColor(colorStateList3);
            v2.setDayOfWeekTextColor(this.mCalendarTextColor);
            v2.setDayTextColor(this.mCalendarTextColor);
        }
        ...
        v2.setMonthParams(selectedDay, month, year, this.mFirstDayOfWeek, enabledDayRangeStart, enabledDayRangeEnd);
        ViewHolder holder = new ViewHolder(position, itemView, v2);
    ...
    public CharSequence getPageTitle(int position) {
        SimpleMonthView v2 = this.mItems.get(position).calendar;
        if (v2 != null) {
            return v2.getMonthYearLabel();
        }
        return null;
    }
