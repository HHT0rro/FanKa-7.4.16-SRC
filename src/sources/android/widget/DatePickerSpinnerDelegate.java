...
public class DatePickerSpinnerDelegate extends DatePicker.AbstractDatePickerDelegate {
    ...
    public DatePickerSpinnerDelegate(DatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int layoutResourceId = attributesArray.getResourceId(20, 17367146);
        ...
        this.mSpinners = (LinearLayout) view2.findViewById(16909374);
        CalendarView calendarView = (CalendarView) this.mDelegator.findViewById(16908859);
        ...
        NumberPicker numberPicker = (NumberPicker) this.mDelegator.findViewById(16908954);
        ...
        this.mDaySpinnerInput = (EditText) numberPicker.findViewById(16909322);
        NumberPicker numberPicker2 = (NumberPicker) this.mDelegator.findViewById(16909266);
        ...
        this.mMonthSpinnerInput = (EditText) numberPicker2.findViewById(16909322);
        ...
        this.mYearSpinnerInput = (EditText) numberPicker3.findViewById(16909322);
    ...
    public void setCurrentLocale(Locale locale) {
        ...
        if (usingNumericMonths()) {
            ...
            for (int i10 = 0; i10 < this.mNumberOfMonths; i10++) {
                this.mShortMonths[i10] = String.format("%d", Integer.valueOf(i10 + 1));
            }
        }
    }
    ...
    private void reorderSpinners() {
        ...
        for (int i10 = 0; i10 < spinnerCount; i10++) {
            switch (order[i10]) {
                case 'M':
                    this.mSpinners.addView(this.mMonthSpinner);
                    setImeOptions(this.mMonthSpinner, spinnerCount, i10);
                    break;
                case 'd':
                    this.mSpinners.addView(this.mDaySpinner);
                    setImeOptions(this.mDaySpinner, spinnerCount, i10);
                    break;
                case 'y':
                    this.mSpinners.addView(this.mYearSpinner);
                    setImeOptions(this.mYearSpinner, spinnerCount, i10);
                    break;
                default:
    ...
    private void setImeOptions(NumberPicker spinner, int spinnerCount, int spinnerIndex) {
        ...
        TextView input = (TextView) spinner.findViewById(16909322);
        input.setImeOptions(imeOptions);
    }

    private void setContentDescriptions() {
        trySetContentDescription(this.mDaySpinner, 16909130, 17040137);
        trySetContentDescription(this.mDaySpinner, 16908959, 17040133);
        trySetContentDescription(this.mMonthSpinner, 16909130, 17040138);
        trySetContentDescription(this.mMonthSpinner, 16908959, 17040134);
        trySetContentDescription(this.mYearSpinner, 16909130, 17040139);
        trySetContentDescription(this.mYearSpinner, 16908959, 17040135);
    }
