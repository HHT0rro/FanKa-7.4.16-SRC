 ...
 */
    ...
    public boolean performItemClick(View view, int position, long id2) {
        ...
        if (this.mOnItemClickListener != null) {
            if (!(this instanceof Spinner) && view != null && view.isSoundEffectsEnabled()) {
                playSoundEffect(0);
            }
 ...
 */
    ...
    public int getPositionForView(View view) {
        ...
        while (true) {
            try {
                View v2 = (View) listItem.getParent();
                if (v2 == null || v2.equals(this)) {
                    break;
                }
                listItem = v2;
        ...
        if (listItem != null) {
            ...
            for (int i10 = 0; i10 < childCount; i10++) {
                if (getChildAt(i10).equals(listItem)) {
 ...
 */
    ...
    private void fireOnSelected() {
        ...
        if (selection >= 0) {
            ...
            this.mOnItemSelectedListener.onItemSelected(this, v2, selection, getAdapter().getItemId(selection));
        } else {
    ...
    public void rememberSyncState() {
        if (getChildCount() > 0) {
            ...
            if (i10 >= 0) {
                View v2 = getChildAt(i10 - this.mFirstPosition);
