...
public class NumberPicker extends LinearLayout {
    private static final int DEFAULT_LAYOUT_RESOURCE_ID = 17367251;
 ...
 */
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int layoutResId = attributesArray.getResourceId(3, 17367251);
        if (layoutResId != 17367251) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (!z10) {
            ImageButton imageButton = (ImageButton) findViewById(16909130);
        ...
        if (!z10) {
            ImageButton imageButton2 = (ImageButton) findViewById(16908959);
        ...
        EditText editText = (EditText) findViewById(16909322);
        ...
        editText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: android.widget.NumberPicker.3
            ...
            public void onFocusChange(View v2, boolean hasFocus) {
                if (hasFocus) {
                    ...
                    NumberPicker.this.validateInputTextView(v2);
                }
            }
        });
        ...
        if (getFocusable() == 16) {
            setFocusable((int) r02);
            setFocusableInTouchMode(r02);
        }
    }
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (changed) {
            ...
            int i11 = this.mSelectionDividerHeight;
        ...
        if (AccessibilityManager.getInstance(this.mContext).isEnabled()) {
            ...
            switch (action) {
                case 7:
                    ...
                    if (i10 != hoveredVirtualViewId && i10 != -1) {
                        provider.sendAccessibilityEventForVirtualView(i10, 256);
    ...
    public void scrollBy(int x10, int y10) {
        ...
        if (!z10 && y10 > 0 && selectorIndices[1] <= this.mMinValue) {
            this.mCurrentScrollOffset = this.mInitialScrollOffset;
            return;
        }
        if (!z10 && y10 < 0 && selectorIndices[1] >= this.mMaxValue) {
            this.mCurrentScrollOffset = this.mInitialScrollOffset;
            return;
        }
        ...
        if (startScrollOffset != i10) {
            onScrollChanged(0, i10, 0, startScrollOffset);
        }
    }
    ...
    private void tryComputeMaxWidth() {
        ...
        if (strArr == null) {
            ...
            for (int i10 = 0; i10 <= 9; i10++) {
                float digitWidth = this.mSelectorWheelPaint.measureText(formatNumberWithLocale(i10));
            ...
            for (int i11 = 0; i11 < valueCount; i11++) {
                float textWidth = this.mSelectorWheelPaint.measureText(this.mDisplayedValues[i11]);
    ...
    public void onDraw(Canvas canvas) {
        ...
        float x10 = (this.mRight - this.mLeft) / 2;
        float y10 = this.mCurrentScrollOffset;
        ...
        for (int i10 = 0; i10 < selectorIndices.length; i10++) {
            int selectorIndex = selectorIndices[i10];
            String scrollSelectorValue = this.mSelectorIndexToStringCache.get(selectorIndex);
            if ((showSelectorWheel && i10 != 1) || (i10 == 1 && this.mInputText.getVisibility() != 0)) {
                canvas.drawText(scrollSelectorValue, x10, y10, this.mSelectorWheelPaint);
            }
            y10 += this.mSelectorElementHeight;
        }
    ...
    private void initializeSelectorWheelIndices() {
        ...
        for (int i10 = 0; i10 < this.mSelectorIndices.length; i10++) {
            int selectorIndex = (i10 - 1) + current;
            if (this.mWrapSelectorWheel) {
                selectorIndex = getWrappedSelectorIndex(selectorIndex);
            }
            selectorIndices[i10] = selectorIndex;
            ensureCachedScrollSelectorValue(selectorIndices[i10]);
        }
    }
    ...
    private void initializeSelectorWheel() {
        ...
        int i10 = (int) ((totalTextGapHeight / textGapCount) + 0.5f);
        this.mSelectorTextGapHeight = i10;
        this.mSelectorElementHeight = this.mTextSize + i10;
        int editTextTextPosition = this.mInputText.getBaseline() + this.mInputText.getTop();
        int i11 = editTextTextPosition - (this.mSelectorElementHeight * 1);
        this.mInitialScrollOffset = i11;
    ...
    public int getWrappedSelectorIndex(int selectorIndex) {
        ...
        if (selectorIndex < i12) {
            return (i10 - ((i12 - selectorIndex) % (i10 - i12))) + 1;
        }
        return selectorIndex;
    }

    private void incrementSelectorIndices(int[] selectorIndices) {
        for (int i10 = 0; i10 < selectorIndices.length - 1; i10++) {
            selectorIndices[i10] = selectorIndices[i10 + 1];
        }
        int i11 = selectorIndices.length;
        int nextScrollSelectorIndex = selectorIndices[i11 - 2] + 1;
    ...
    private void decrementSelectorIndices(int[] selectorIndices) {
        for (int i10 = selectorIndices.length - 1; i10 > 0; i10--) {
            selectorIndices[i10] = selectorIndices[i10 - 1];
        }
        int i11 = selectorIndices[1];
        int nextScrollSelectorIndex = i11 - 1;
    ...
    private void ensureCachedScrollSelectorValue(int selectorIndex) {
        ...
        if (selectorIndex < i10 || selectorIndex > this.mMaxValue) {
            ...
            String[] strArr = this.mDisplayedValues;
            if (strArr != null) {
                int displayedValueIndex = selectorIndex - i10;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void validateInputTextView(View v2) {
        String str = String.valueOf(((TextView) v2).getText());
    ...
    public int getSelectedPos(String value) {
        if (this.mDisplayedValues == null) {
            ...
            for (int i10 = 0; i10 < this.mDisplayedValues.length; i10++) {
                ...
                if (this.mDisplayedValues[i10].toLowerCase().startsWith(value)) {
                    return this.mMinValue + i10;
                }
            }
            try {
                int i11 = Integer.parseInt(value);
                return i11;
