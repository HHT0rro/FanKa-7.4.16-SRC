...
public abstract class ResourceCursorAdapter extends CursorAdapter {
    ...
    @Deprecated
    public ResourceCursorAdapter(Context context, int layout, Cursor c4) {
        super(context, c4);
    ...
    public ResourceCursorAdapter(Context context, int layout, Cursor c4, boolean autoRequery) {
        super(context, c4, autoRequery);
        this.mDropDownLayout = layout;
        this.mLayout = layout;
        LayoutInflater layoutInflater = (LayoutInflater) context.getSystemService("layout_inflater");
        this.mInflater = layoutInflater;
    ...
    public ResourceCursorAdapter(Context context, int layout, Cursor c4, int flags) {
        super(context, c4, flags);
        this.mDropDownLayout = layout;
        this.mLayout = layout;
        LayoutInflater layoutInflater = (LayoutInflater) context.getSystemService("layout_inflater");
        this.mInflater = layoutInflater;
