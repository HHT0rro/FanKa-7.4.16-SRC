 ...
 */
    ...
    public TextClock(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.TextClock, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.TextClock, attrs, a10, defStyleAttr, defStyleRes);
        try {
            this.mFormat12 = a10.getText(0);
            this.mFormat24 = a10.getText(1);
            this.mTimeZone = a10.getString(2);
            a10.recycle();
            init();
        } catch (Throwable th) {
            a10.recycle();
    ...
    private static CharSequence abc(CharSequence a10, CharSequence b4, CharSequence c4) {
        return a10 == null ? b4 == null ? c4 : b4 : a10;
    }
    ...
    public void onVisibilityAggregated(boolean isVisible) {
        ...
        boolean z10 = this.mShouldRunTicker;
        if (!z10 && isVisible) {
    ...
    public void encodeProperties(ViewHierarchyEncoder stream) {
        ...
        CharSequence s2 = getFormat12Hour();
        stream.addProperty("format12Hour", s2 == null ? null : s2.toString());
        CharSequence s10 = getFormat24Hour();
        stream.addProperty("format24Hour", s10 == null ? null : s10.toString());
        CharSequence charSequence = this.mFormat;
        stream.addProperty("format", charSequence != null ? charSequence.toString() : null);
