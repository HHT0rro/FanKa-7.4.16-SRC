 ...
 */
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<CompoundButton> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mButtonId = propertyMapper.mapObject(Attributes.InputType.BUTTON, 16843015);
    ...
    public CompoundButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.CompoundButton, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.CompoundButton, attrs, a10, defStyleAttr, defStyleRes);
        Drawable d10 = a10.getDrawable(1);
        if (d10 != null) {
            lambda$setButtonIconAsync$1(d10);
        }
        if (a10.hasValue(3)) {
            this.mButtonBlendMode = Drawable.parseBlendMode(a10.getInt(3, -1), this.mButtonBlendMode);
            this.mHasButtonBlendMode = true;
        }
        if (a10.hasValue(2)) {
            this.mButtonTintList = a10.getColorStateList(2);
    ...
    protected CharSequence getButtonStateDescription() {
        if (isChecked()) {
            return getResources().getString(17039840);
        }
        return getResources().getString(17040928);
    }
 ...
 */
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "CompoundButton.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " checked=" + this.checked + i.f4738d;
        }
    }
    ...
    public void encodeProperties(ViewHierarchyEncoder stream) {
        ...
        stream.addProperty(Attributes.Style.CHECKED, isChecked());
    }
