 ...
 */
    ...
    public TabHost(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mTabLayoutId = a10.getResourceId(4, 0);
        a10.recycle();
        if (this.mTabLayoutId == 0) {
            this.mTabLayoutId = 17367347;
        }
        initTabHost();
    }
    ...
    public void setCurrentTabByTag(String tag) {
        ...
        for (int i10 = 0; i10 < count; i10++) {
            if (this.mTabSpecs.get(i10).getTag().equals(tag)) {
                setCurrentTab(i10);
                return;
            }
        }
    ...
    public void setCurrentTab(int index) {
        int i10;
        if (index < 0 || index >= this.mTabSpecs.size() || index == (i10 = this.mCurrentTab)) {
            return;
        }
        if (i10 != -1) {
            this.mTabSpecs.get(i10).mContentStrategy.tabClosed();
        }
 ...
 */
    ...
    private class IntentContentStrategy implements ContentStrategy {
        ...
        public View getContentView() {
            ...
            Window w3 = TabHost.this.mLocalActivityManager.startActivity(this.mTag, this.mIntent);
            View wd2 = w3 != null ? w3.getDecorView() : null;
            View view = this.mLaunchedView;
            if (view != wd2 && view != null && view.getParent() != null) {
                TabHost.this.mTabContent.removeView(this.mLaunchedView);
            }
            this.mLaunchedView = wd2;
            if (wd2 != null) {
                wd2.setVisibility(0);
