...
public class AdapterViewFlipper extends AdapterViewAnimator {
    ...
    public AdapterViewFlipper(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a10 = context.obtainStyledAttributes(attrs, R.styleable.AdapterViewFlipper, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.AdapterViewFlipper, attrs, a10, defStyleAttr, defStyleRes);
        this.mFlipInterval = a10.getInt(0, 10000);
