...
public class ClientWindowFrames implements Parcelable {
    ...
    public String toString() {
        ...
        return "ClientWindowFrames{frame=" + this.frame.toShortString(sb2) + " display=" + this.displayFrame.toShortString(sb2) + " parentFrame=" + this.parentFrame.toShortString(sb2) + (this.attachedFrame != null ? " attachedFrame=" + this.attachedFrame.toShortString() : "") + (this.isParentFrameClippedByDisplayCutout ? " parentClippedByDisplayCutout" : "") + (this.compatScale != 1.0f ? " sizeCompatScale=" + this.compatScale : "") + i.f4738d;
    }
