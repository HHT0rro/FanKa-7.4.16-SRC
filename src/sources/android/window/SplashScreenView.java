 ...
 */
    ...
    public static class Builder {
        ...
        public SplashScreenView build() {
            ...
            final SplashScreenView view = (SplashScreenView) layoutInflater.inflate(17367340, (ViewGroup) null, false);
            ...
            view.mBrandingImageView = view.findViewById(16909555);
            ...
            if ((this.mIconDrawable instanceof IconAnimateListener) || this.mSurfacePackage != null) {
                ...
                ImageView imageView = (ImageView) view.findViewById(16909556);
            ...
            if (SplashScreenView.DEBUG) {
                Log.d(SplashScreenView.TAG, "Build " + ((Object) view) + "\nIcon: view: " + ((Object) view.mIconView) + " drawable: " + ((Object) this.mIconDrawable) + " size: " + this.mIconSize + "\nBranding: view: " + ((Object) view.mBrandingImageView) + " drawable: " + ((Object) this.mBrandingDrawable) + " size w: " + this.mBrandingImageWidth + " h: " + this.mBrandingImageHeight);
            }
            Trace.traceEnd(32L);
            return view;
        }
        ...
        private SurfaceView createSurfaceView(SplashScreenView splashScreenView) {
            ...
            if (this.mSurfacePackage == null) {
                ...
                viewHost.setView(imageView, i10, i10);
            ...
            if (i11 != 0) {
                FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(i11, i11);
                lp.gravity = 17;
    ...
    void initIconAnimation(Drawable drawable) {
        ...
        aniDrawable.prepareAnimate(new LongConsumer() { // from class: android.window.SplashScreenView$$ExternalSyntheticLambda0
            ...
            public final void accept(long j10) {
                SplashScreenView.this.animationStartCallback(j10);
            }
        });
    ...
    private void releaseAnimationSurfaceHost() {
        ...
        if (this.mSurfacePackage != null && surfaceControlViewHost == null) {
            this.mSurfacePackage = null;
            this.mClientCallback.sendResult((Bundle) null);
        }
    }
