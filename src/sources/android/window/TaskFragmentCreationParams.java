...
public final class TaskFragmentCreationParams implements Parcelable {
    ...
    public String toString() {
        return "TaskFragmentCreationParams{ organizer=" + ((Object) this.mOrganizer) + " fragmentToken=" + ((Object) this.mFragmentToken) + " ownerToken=" + ((Object) this.mOwnerToken) + " initialRelativeBounds=" + ((Object) this.mInitialRelativeBounds) + " windowingMode=" + this.mWindowingMode + " pairedFragmentToken=" + ((Object) this.mPairedPrimaryFragmentToken) + " pairedActivityToken=" + ((Object) this.mPairedActivityToken) + i.f4738d;
    }
