...
public interface ITaskFragmentOrganizerController extends IInterface {
    ...
    void applyTransaction(WindowContainerTransaction windowContainerTransaction, int i10, boolean z10) throws RemoteException;

    boolean isActivityEmbedded(IBinder iBinder) throws RemoteException;

    void onTransactionHandled(IBinder iBinder, WindowContainerTransaction windowContainerTransaction, int i10, boolean z10) throws RemoteException;
