...
public interface IWindowOrganizerController extends IInterface {
    ...
    int startLegacyTransition(int i10, RemoteAnimationAdapter remoteAnimationAdapter, IWindowContainerTransactionCallback iWindowContainerTransactionCallback, WindowContainerTransaction windowContainerTransaction) throws RemoteException;

    IBinder startNewTransition(int i10, WindowContainerTransaction windowContainerTransaction) throws RemoteException;
 ...
 */
    ...
    public static class Default implements IWindowOrganizerController {
        ...
        public void applyTransaction(WindowContainerTransaction t2) throws RemoteException {
        }

        @Override // android.window.IWindowOrganizerController
        public int applySyncTransaction(WindowContainerTransaction t2, IWindowContainerTransactionCallback callback) throws RemoteException {
            return 0;
        }

        @Override // android.window.IWindowOrganizerController
        public IBinder startNewTransition(int type, WindowContainerTransaction t2) throws RemoteException {
            return null;
        }

        @Override // android.window.IWindowOrganizerController
        public void startTransition(IBinder transitionToken, WindowContainerTransaction t2) throws RemoteException {
        }

        @Override // android.window.IWindowOrganizerController
        public int startLegacyTransition(int type, RemoteAnimationAdapter adapter, IWindowContainerTransactionCallback syncCallback, WindowContainerTransaction t2) throws RemoteException {
            return 0;
        }

        @Override // android.window.IWindowOrganizerController
        public int finishTransition(IBinder transitionToken, WindowContainerTransaction t2, IWindowContainerTransactionCallback callback) throws RemoteException {
            return 0;
        }
