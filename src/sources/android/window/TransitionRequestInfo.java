 ...
 */
    ...
    public static class DisplayChange implements Parcelable {
        ...
        public String toString() {
            return "DisplayChange { displayId = " + this.mDisplayId + ", startAbsBounds = " + ((Object) this.mStartAbsBounds) + ", endAbsBounds = " + ((Object) this.mEndAbsBounds) + ", startRotation = " + this.mStartRotation + ", endRotation = " + this.mEndRotation + ", physicalDisplayChanged = " + this.mPhysicalDisplayChanged + " }";
        }
    ...
    public TransitionRequestInfo(int type, ActivityManager.RunningTaskInfo triggerTask, RemoteTransition remoteTransition, DisplayChange displayChange) {
        this.mType = type;
        AnnotationValidations.validate(WindowManager.TransitionType.class, (Annotation) null, type);
    ...
    public String toString() {
        return "TransitionRequestInfo { type = " + WindowManager.transitTypeToString(this.mType) + ", triggerTask = " + ((Object) this.mTriggerTask) + ", remoteTransition = " + ((Object) this.mRemoteTransition) + ", displayChange = " + ((Object) this.mDisplayChange) + " }";
    }
