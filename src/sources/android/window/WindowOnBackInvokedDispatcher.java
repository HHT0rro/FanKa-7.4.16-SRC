...
public class WindowOnBackInvokedDispatcher implements OnBackInvokedDispatcher {
    ...
    private void sendCancelledIfInProgress(OnBackInvokedCallback callback) {
        ...
        if (isInProgress && (callback instanceof OnBackAnimationCallback)) {
            ...
            Log.w(TAG, "sendCancelIfRunning: isInProgress=" + isInProgress + "callback=" + ((Object) callback));
        }
    }
    ...
    private void setTopOnBackInvokedCallback(OnBackInvokedCallback callback) {
        ...
        if (callback != null) {
            try {
                ...
                Log.e(TAG, "Failed to set OnBackInvokedCallback to WM. Error: " + ((Object) e2));
                return;
            }
        }
    ...
    public void dump(String prefix, final PrintWriter writer) {
        ...
        writer.println(innerPrefix + "Top Callback: " + ((Object) getTopCallback()));
        ...
        this.mAllCallbacks.forEach(new BiConsumer() { // from class: android.window.WindowOnBackInvokedDispatcher$$ExternalSyntheticLambda1
            ...
            public final void accept(Object obj, Object obj2) {
                PrintWriter.this.println(innerPrefix + "  Callback: " + ((Object) ((OnBackInvokedCallback) obj)) + " Priority=" + ((Object) ((Integer) obj2)));
            }
        });
    }
