...
public class h implements com.huawei.appgallery.coreservice.internal.support.parcelable.b.c<int[]> {
    ...
    public void a(Parcel parcel, Field field, int i10, int[] iArr, int i11, boolean z10) {
        if (iArr == null) {
            if (z10) {
    ...
    public final int[] d(Parcel parcel, int i10) {
        ...
        try {
            ...
            com.huawei.appgallery.coreservice.internal.support.parcelable.b.b.f27602a.d("IntegerArrayTypeProcess", "error readIntArray:" + e2.getMessage());
        }
