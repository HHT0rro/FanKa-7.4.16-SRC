...
public class l implements com.huawei.appgallery.coreservice.internal.support.parcelable.b.c<String[]> {
    public static String[] d(Parcel parcel, int i10) {
        ...
        try {
            ...
            com.huawei.appgallery.coreservice.internal.support.parcelable.b.b.f27602a.d("StringArrayTypeProcess", "error readStringArray:" + e2.getMessage());
        }
