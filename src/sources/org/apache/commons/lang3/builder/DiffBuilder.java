...
public class DiffBuilder implements Builder<DiffResult> {
    ...
    public DiffBuilder append(String str, final byte b4, final byte b10) {
        validateFieldNameNotNull(str);
        if (!this.objectsTriviallyEqual && b4 != b10) {
    ...
    public DiffBuilder append(String str, final char c4, final char c10) {
        validateFieldNameNotNull(str);
        if (!this.objectsTriviallyEqual && c4 != c10) {
    ...
    public DiffBuilder append(String str, final short s2, final short s10) {
        validateFieldNameNotNull(str);
        if (!this.objectsTriviallyEqual && s2 != s10) {
